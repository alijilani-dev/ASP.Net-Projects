<%@ Page Title="Technology & Travel" Language="VB" MasterPageFile="~/Personal/personal.master" AutoEventWireup="false" CodeFile="technology_travel.aspx.vb" Inherits="Technology_TravelPage" %>

<asp:Content ID="ContentTechnology_Travel" ContentPlaceHolderID="PlaceHolderPersonal" runat="server" ClientIDMode="AutoID" EnableViewState="False" ViewStateMode="Disabled" >
<!-- ###################################################Personal_Page_Content#################################################### -->

    <div class="box1">
      <h2>Technology & Travel </h2>
