...
#End Region
    ...
    Private Sub SendAdvPlanMail()
        ...
        strBody = "<html><body>Hello,<br><p>Thank you for the time and interest you had shown in knowing more about Advertisement Plans on CpuTrade.cc.</p>" & _
                "<p>We have attached a document, which gives you more information on different plans, which you may wish to book.</p>" & _
                "<p>Looking forward to hear from you.</p><br><br>Best Regards<br>Sales & Customer Support<br>www.CpuTrade.cc</body></html>"
        ...
        objMessage.Subject = "CpuTrade.cc: Thank you for your Advertisement enquiry."
        objMessage.From = "sales@CpuTrade.cc"
        objMessage.To = txtEmail.Text.ToString
        objMessage.bcc = "ads@phonetrade.cc, sales@CpuTrade.cc"
        objMessage.HTMLBody = CStr("" & strBody)
        objMessage.AddAttachment(Server.MapPath("CpuTrade_AdPlans.xls"))
        '==This section provides the configuration information for the remote SMTP server.
        'Response.Write(Server.MapPath("CpuTrade_AdPlans.xls"))
