...
#End Region
    ...
    Private Sub DLMainlink_ItemDataBound(ByVal sender As System.Object, ByVal e As System.Web.UI.WebControls.DataListItemEventArgs)
        Dim hprLinks1 As HyperLink
        ...
        '    Try
        hprLinks1 = e.Item.FindControl("hprLinks1")
        hprLinks1.Attributes.Add("onmouseover", "this.src='" & DataBinder.Eval(e.Item.DataItem, "img_url_mouseover") & "'")
        hprLinks1.Attributes.Add("onmouseout", "this.src='" & DataBinder.Eval(e.Item.DataItem, "img_url") & "'")
