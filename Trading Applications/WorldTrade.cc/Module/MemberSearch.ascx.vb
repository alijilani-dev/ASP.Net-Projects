...
#Region "Private variables"
    ...
    Private ln_LoggedIn As New Boolean
...
#End Region
    ...
    '    GetBindData()
    'End Sub
    'Private Sub DLResult_ItemCommand(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
    '    cTraderDetail.FillTraderDetail(DLResult.DataKeys(e.Item.ItemIndex))
    '    TDSearchResult.Visible = False
    '    TDTraderDetails.Visible = True
    'End Sub
    'Private Sub DLMembers_ItemCommand(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
