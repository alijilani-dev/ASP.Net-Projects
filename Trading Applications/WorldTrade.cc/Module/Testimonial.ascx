		...
		<TR>
			<TD style="BORDER-RIGHT: #cf8e40 1px solid; BORDER-TOP: #cf8e40 1px solid; BORDER-LEFT: #cf8e40 1px solid; BORDER-BOTTOM: #cf8e40 1px solid"
				...
				<asp:DataList id="DLTestimonial" runat="server" Width="100%">
					<AlternatingItemStyle BackColor="#fff4e7"></AlternatingItemStyle>
					<ItemTemplate>
						<TABLE class="normaltext" id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TR>
								<TD colSpan="2">
									<asp:Label id="lblText" runat="server" CSSclass="normaltext">
										<%# DataBinder.Eval(Container, "DataItem.TText") %>
									</asp:Label></TD>
							</TR>
							<TR>
								<TD class="normaltext" width="79%">
									<asp:Label id="lblMemberName" runat="server" ForeColor="#B34700" Font-Bold="True">
