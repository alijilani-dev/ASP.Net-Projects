					...
					<ItemStyle HorizontalAlign="Left"></ItemStyle>
						<ItemTemplate>
							<asp:Label id="lblSpec" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Spec") %>'>
								...
								<TABLE class="normaltext" id="Table_Detail" style="BORDER-RIGHT: #FFB154 thin solid; BORDER-TOP: #FFB154 thin solid; MARGIN: 1px; BORDER-LEFT: #FFB154 thin solid; BORDER-BOTTOM: #FFB154 thin solid; DISPLAY: none"
					...
					<asp:TemplateColumn HeaderText="  ">
						...
						<ItemTemplate>
							<asp:Panel id="Panel1" runat="server" EnableViewState="False">
								...
								<b><font color="#274B01"><%# DataBinder.Eval(Container, "DataItem.Member_company") %></font></b><br>
