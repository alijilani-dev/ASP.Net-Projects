								...
								<tr vAlign="top" height="27">
									<td style="BACKGROUND-IMAGE: url(../images/postform_bar_bg.gif); VERTICAL-ALIGN: middle; BACKGROUND-REPEAT: repeat-x"
										width="100%"><B><FONT face="Verdana" color="#fea300" size="1">
												<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0" style="BACKGROUND-IMAGE: url(../images/postform_bar_bg.gif); VERTICAL-ALIGN: middle; BACKGROUND-REPEAT: repeat-x">
													<TR>
														...
														<TD>
															<asp:datalist id="DLDealingIn" runat="server" Height="30px" Width="531px" CssClass="normalText"
																RepeatDirection="Horizontal" RepeatColumns="3" ItemStyle-HorizontalAlign="CENTER">
