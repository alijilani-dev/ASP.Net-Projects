...
sql="Update Members set member_id='" & strmember_id & "', password='" & strpassword & _
		...
		'Response.Write(sql)
			...
			if Request.Form("chkMail")="1" then			
				...
				'This is to send b4 activation '/Cputrade
				...
				'Query ="http://www.Cputrade.cc/AdminCp/cPanel/Activate_email.asp?mem=" & replace(strName,"&","@*@") & "&usr1=" & strmember_id & "&pd=" & strpassword
			...
			'strHTML="<font color=red>Basheer here</font>"
												
'				Set MyCDONTSMail = CreateObject("CDONTS.NewMail")
'				MyCDONTSMail.From= "info@Cputrade.cc"
'				MyCDONTSMail.To= strToMail
'				MyCDONTSMail.BCC= "sales@Cputrade.cc"
'				'MyCDONTSMail.BCC= "abash2002@yahoo.com"
'				MyCDONTSMail.Subject="Your account is activated - Cputrade.cc"
...
strHTML = "<html><head><title>Cputrade.cc</title><link href=""body.css"" rel=""stylesheet"" type=""text/css"">"
...
strHTML =  strHTML & "      <tr><td><img src=""http://www.Cputrade.cc/images/Cputradetop_features.jpg"" width=""550"" height=""76""></td>      </tr>"
...
strHTML =  strHTML & "<td height=""85"" ><p align=""justify"" class=""body"">Thank you for registering your Company with <STRONG><strong>Cputrade.cc</strong></STRONG>, your trusted online source of B2B Mobile Phone Trading   solution.</p>"
...
strHTML =  strHTML & "<p><span class=""body"">Logon to: <A title=""http://www.Cputrade.cc/PortalDefault.aspx?Main_Links_ID=24"" href=""http://www.Cputrade.cc/PortalDefault.aspx?Main_Links_ID=24"">http://www.Cputrade.cc/PortalDefault.aspx?Main_Links_ID=24</A></span> <BR>"
strHTML =  strHTML & "<span class=""body""><br>Now that you have registered your Company with us, you may be asking yourself,"
strHTML =  strHTML & "&nbsp;<i>&quot;Now what?&quot; </i> </span></p></td></tr><tr><td ><p class=""body""><strong>&nbsp;<br>GETTING STARTED: </strong><br>&nbsp;Cputrade Registration Getting Started Guide: <br>"
...
strHTML =  strHTML & "<table border=""0"" width=""100%"" id=""table1"" cellspacing=""0"" cellpadding=""0"" class=""body""><tr><td width=""7"">&nbsp;</td><td><strong>Cputrade.CC FREQUENTLY ASKED QUESTIONS <br>"
strHTML =  strHTML & "&nbsp;</strong></td></tr><tr><td width=""7"">&nbsp;</td><td><p align=""justify""><strong>1. What services are included when I Signup with Cputrade? </strong>                  <br>"
...
strHTML =  strHTML & "</strong>This is set up automatically when your Account is activated. After ACTIVATION of your Account, you should login to Cputrade.cc Members Area while connected to the Internet; you should be able to View your Membership Menu Bar along Welcome message. You can click <strong>&#8216;POST MY OFFER'</strong> link to start posting &nbsp;your <strong>BUY</strong> or <strong>SELL</strong> Deals. <br>"
...
strHTML =  strHTML & "<strong>MSN:</strong>						( <a href=""mailto:(trading_support@hotmail.com"">Trading_support@hotmail.com</a> )<br><strong>Yahoo:</strong> ( <a href=""mailto:(Cputrade_live@yahoo.com"">Cputrade_live@yahoo.com</a> )"
strHTML =  strHTML & "<p align=""justify"">If you have a question or need any information, please &nbsp;email to our support team at: <a href=""mailto:sales@Cputrade.cc"">sales@Cputrade.cc</a>"
strHTML =  strHTML & "<br><br>Sincerely, <br>Support Team<br><strong>"
strHTML =  strHTML & "<a target=""_blank"" href=""http://www.Cputrade.cc/"">www.Cputrade.cc</a></strong><br><br><br>"
strHTML =  strHTML & "</td></tr><tr><td width=""547"" height=""36"" valign=""middle""><div align=""center""><span class=""body"">"
strHTML =  strHTML & "<font size=""1"">You received this email because you have registered with  Cputrade.cc<br>"
...
strHTML = replace(strHTML,"*Pwd*",strpassword)
					...
					objMessage.Subject = "Your account is activated - Cputrade.cc"
