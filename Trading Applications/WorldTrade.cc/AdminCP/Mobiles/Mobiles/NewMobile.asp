...
set rsTemp = Server.CreateObject("Adodb.Recordset")
	...
	Dim Games, MobileColor, Camera, Descriptions
...
if len(strMsg)>0 then 
	...
	AdditionalInfo = Request.Form("txtAddInfo")
	
	NetworkTypeCode = Request.Form("cboNetwork")
	Announced = Request.Form("txtAnnounced")
	Status = Request.Form("cboStatus")

	Weight = Request.Form("txtWeight")
	Dimension = Request.Form("txtDimension")
	PhoneBook = Request.Form("txtPhBook")
	
	CallRecords = Request.Form("txtCallRecords")
	DispTypeCode = Request.Form("cboDispType")
	DisplayInfo = Request.Form("txtDispTypeInfo")
	
	DispSize = Request.Form("txtDisplaySize")
	RingtoneTypeCode = Request.Form("cboRingType")
	CustomizeTone = Request.Form("chkRingDownload")
	
	Vibration = Request.Form("chkVibration")
	BatteryInfo = Request.Form("txtBattery")
	OSType = Request.Form("txtOSType")
	
	GPRS = Request.Form("txtGPRS")
	DataSpeed = Request.Form("txtDataSpeed")
	...
	Games = Request.Form("txtGames")
	MobileColor = Request.Form("txtMobileColor")
	Camera = Request.Form("chkCamera")

	CameraInfo = Request.Form("txtCameraInfo")
	Features = Request.Form("txtFeatures")
	Model3G = Request.Form("chk3G")
	Descriptions = Request.Form("txtDescription")
end if
 ...
 function FormSubmit()
{
		...
		{
			document.frmMobiles.hdAction.value="Add";
        ...
        <table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" class="Border2">
          <tr>
            <td><table width="100%" border="0" cellpadding="2" cellspacing="0" class="contact">
                <tr>
                  <td class="HeadingBackGroundLeft">Step 1: provide information 
                    on model</td>
                </tr>
              </table></td>
          </tr>
          ...
          <tr> 
            <td width="100%" bgcolor="#FFFFFF" class="LightBackground"><table width=100% border=0 align=Center class="Border">
                ...
                <tr Class=TableBackGround> 
                  ...
                  <td><input name=txtModel type=text class=Textbox id="txtModel" value="<%=ModelNo%>" maxlength="20"> 
                    <a href="#">Check it</a></td>
                </tr>
                <tr Class=TableBackGround>
                ...
                <tr Class=TableBackGround> 
                  ...
                  <option value="select">[--Select--]</option>
					 ...
					 <SCRIPT LANGUAGE=javascript>
					 document.frmMobiles.cboNetwork.options[0].selected=true;
					/*	value = "<%=NetworkTypeCode%>" 
						for (i=0;i<document.frmMobiles.cboNetwork.length;i++)
							if (document.frmMobiles.cboNetwork.options[i].value==value)
								document.frmMobiles.cboNetwork.selectedIndex = i;
						*/
					</SCRIPT>
                    <font color="#0000FF">Press ctrl+mouse click to select more 
                    items</font> <script language=javascript>
          ...
          <tr> 
            <td width="100%" bgcolor="#FFFFFF" class="LightBackground"><table width=100% border=0 align=Center class="contact">
                ...
                <tr Class=TableBackGround> 
                  ...
                  <td> 
                    <input name="txtDimension" type=text class=Textbox id="txtDimension" value="<%=Dimension%>" maxlength="30">
          ...
          <tr> 
            <td width="100%" bgcolor="#FFFFFF" class="LightBackground"><table width=100% border=0 align=Center class="contact">
                ...
                <tr Class=TableBackGround> 
                  ...
                  <td width="68%"><font color="#0000FF">No. of Ph Book entries that can be stored Max. 255 Char.<br></font> 
            ...
            <td width="100%" bgcolor="#FFFFFF" class="LightBackground"><table width=100% border=0 align=Center class="contact">
                ...
                <tr Class=TableBackGround> 
                  ...
                  <option value="select">[--Select--]</option>
					 ...
					 <SCRIPT LANGUAGE=javascript>
					 document.frmMobiles.cboRingType.options[0].selected=true;
					/*	value = "<%=RingtoneTypeCode%>" 
						for (i=0;i<document.frmMobiles.cboRingType.length;i++)
							if (document.frmMobiles.cboRingType.options[i].value==value)
								document.frmMobiles.cboRingType.selectedIndex = i;
					*/</SCRIPT>
					<font color="#0000FF">Press ctrl+mouse click to select more items</font>
					 <SCRIPT LANGUAGE=javascript>
                ...
                <tr Class=TableBackGround>
                  ...
                  <td><input name="chkRingDownload" type="checkbox" id="chkRingDownload" value="1" <%if CustomizeTone & ""="1" then Response.Write "checked"%>>
                    Downloadable ?</td>
                </tr>
                <tr Class=TableBackGround> 
                  <td align=right class="contact">Vibration</td>
                  <td> <input name="chkVibration" type="checkbox" id="chkVibration" value="1" <%if Vibration & ""="1" then Response.Write "checked"%>>
                  </td>
                </tr>
                <tr height=2> 
                  <td colspan="2" align=right class="HeadingWithBackGround"></td>
          ...
          <tr> 
            <td width="100%" bgcolor="#FFFFFF" class="LightBackground"><table width=100% border=0 align=Center class="contact">
                ...
                <tr Class=TableBackGround> 
                  ...
                  <td width="68%" valign="top"><font color="#0000FF">Duration of talk time and etc. Max 255 char.</font>
          ...
          <tr> 
            <td width="100%" bgcolor="#FFFFFF" class="LightBackground"><table width=100% border=0 align=Center class="contact">
                ...
                <tr Class=TableBackGround> 
                  ...
                  <td width="68%"><input name="chkClock" type="checkbox" id="chkClock" value="1"  <%if Clock & ""="1" then Response.Write "checked"%>> 
                  </td>
                </tr>
                <tr Class=TableBackGround> 
                  <td align=right class="contact">Alarm</td>
                  <td><input name="chkAlarm" type="checkbox" id="chkAlarm" value="1"  <%if Alarm & ""="1" then Response.Write "checked"%>> 
                  </td>
                </tr>
                <tr Class=TableBackGround> 
                  <td align=right class="contact">Messaging</td>
                  <td><input name="chkSMS" type="checkbox" id="chkSMS" value="1"  <%if SMS & ""="1" then Response.Write "checked"%>>
                    SMS 
                    <input name="chkMMS" type="checkbox" id="chkMMS" value="1"  <%if MMS & ""="1" then Response.Write "checked"%>>
                    MMS 
                    <input name="chkEmail" type="checkbox" id="chkEmail" value="1"  <%if EmailMsg & ""="1" then Response.Write "checked"%>>
                    Email 
                    <input name="chkInstMsg" type="checkbox" id="chkInstMsg" value="1"  <%if InstantMsg & ""="1" then Response.Write "checked"%>>
                    Instant Message</td>
                </tr>
                <tr Class=TableBackGround> 
                  <td align=right class="contact">Camera</td>
                  <td><input name="chkCamera" type="checkbox" id="chkCamera" value="1"  <%if Camera & ""="1" then Response.Write "checked"%>>
                    Yes/No 
                ...
                <tr Class=TableBackGround>
                  ...
                  <td> 
                    <input name="chkInfraRed" type="checkbox" id="chkInfraRed" value="1"  <%if InfraRed & ""="1" then Response.Write "checked"%>></td>
                </tr>
                <tr Class=TableBackGround> 
                  <td align=right class="contact">3G</td>
                  <td><input name="chk3G" type="checkbox" id="chk3G" value="1"  <%if Model3G & ""="1" then Response.Write "checked"%>></td>
                </tr>
                <tr Class=TableBackGround> 
                ...
                <tr> 
                  ...
                  <td class="LightBackground"> <input type=Submit name=btnOk value="    Add    " class=Buttons> 
