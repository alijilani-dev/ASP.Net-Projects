...
'StrConnection ="Provider=SQLOLEDB.1;Persist Security Info=False;User ID=phonetradecc;PWD=phonetradecc*18;Initial Catalog=phonetradecc;Data Source=BASHEER"

'StrConnection ="Provider=SQLOLEDB.1;Persist Security Info=False;User ID=ireb;PWD=123ireuae;Initial Catalog=irebuae;Data Source=sql15.webcontrolcenter.com"

'StrConnection ="Provider=SQLOLEDB.1;Persist Security Info=False;User ID=phonetradecc;PWD=phonetradecc*18;Initial Catalog=phonetradecc;Data Source=213.42.18.90"

'StrConnection ="Provider=SQLOLEDB.1;Persist Security Info=False;User ID=trade;PWD=etrade;Initial Catalog=trade;Data Source=SRFZE-SERVER-01"

StrConnection ="Provider=SQLOLEDB.1;Persist Security Info=False;User ID=trade;PWD=etrade;Initial Catalog=trade;Data Source=213.42.18.90"
