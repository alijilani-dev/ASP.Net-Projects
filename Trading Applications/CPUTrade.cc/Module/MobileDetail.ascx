...
<div align="center">
	<TABLE id="Table8" cellPadding="2" width="650" border="0" class="normaltext" cellspacing="4">
		<TR>
			<TD align="center" style="BORDER-RIGHT: #CF8E40 1px solid; BORDER-TOP: #CF8E40 1px solid; BORDER-LEFT: #CF8E40 1px solid; BORDER-BOTTOM: #CF8E40 1px solid"
				colspan="2" bgcolor="#CF8E40" class="boxhdn" height="25">
				<b>&nbsp; </b>
		...
		<TR>
			...
			<TD class="normaltext" style="BORDER-RIGHT: #CF8E40 1px solid; BORDER-TOP: #CF8E40 1px solid; BORDER-LEFT: #CF8E40 1px solid; BORDER-BOTTOM: #CF8E40 1px solid"
