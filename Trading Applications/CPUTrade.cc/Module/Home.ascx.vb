...
#Region "Private Variables"
    ...
    Private pi_obj_ProdCategory As New Trade_BL.ProductCategory
...
#End Region
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        imgLogin.Attributes.Add("onMouseover", "ddrivetip('By logging into CPUTRADE you accept the Terms and Conditions of the site!','', 300)")
    ...
    Private Sub FillProduct()
        ...
        pi_obj_ProdCategory = New Trade_BL.ProductCategory
        dt_MobileModel = pi_obj_ProdCategory.GetProductCategory()
