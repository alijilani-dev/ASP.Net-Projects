					...
					<TD id="TDAction" runat="server">
						<TABLE id="tbl_Action" cellSpacing="1" cellPadding="1" width="100%" border="1">
							...
							<TR>
							  ...
							  <TD style="HEIGHT: 30px"><asp:RequiredFieldValidator ID="RFVLink" Visible="false" runat="server" ErrorMessage="Enter Link to visit" ControlToValidate="PR_Img"></asp:RequiredFieldValidator></TD>
							</TR>
							<TR>
