...
%>
            ...
            <td><a href='javascript:MoveToTools(<%=rsMain("MemberCode")%>,1);' class="link3"> 
              ...
              <a href='#' class="link3"><img src="../images/Mail1.jpg" alt="Send thanks message" width="24" height="17" border="0" onClick="MM_openBrWindow('ThanksMail.asp?Id=<%=rsMain("MemberCode")%>&proc=1','ThanksMail','width=300,height=250')"></a> 
              <a href='#' class="link3"><img src="../images/Mail1.jpg" alt="Send PRINT Form" width="24" height="17" border="0" onClick="MM_openBrWindow('ThanksMail.asp?Id=<%=rsMain("MemberCode")%>&proc=2','ThanksMail','width=300,height=250')"></a> 
            </td>
          </tr>
             <%rsMain.moveNext
		i=i+1
