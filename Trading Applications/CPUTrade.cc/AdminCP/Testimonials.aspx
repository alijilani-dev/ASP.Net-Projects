<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Testimonials.aspx.vb" Inherits="Trade.Admin.Tetimonials"%>
			...
			<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="1">
				...
				<TR>
					<TD id="TDView" runat="server">
						<asp:DataGrid id="DGTestimonials" runat="server" Width="100%" AutoGenerateColumns="False" AllowPaging="True">
							...
							<Columns>
								...
								<asp:BoundColumn Visible="False" DataField="Tid" HeaderText="ID"></asp:BoundColumn>
								<asp:BoundColumn DataField="Member_ID" HeaderText="Member ID"></asp:BoundColumn>
								<asp:BoundColumn DataField="Ttext" HeaderText="Testimonial"></asp:BoundColumn>
						...
						<TABLE id="tbl_Action" cellSpacing="1" cellPadding="1" width="100%" border="1">
							<TR>
								...
								<TD style="HEIGHT: 20px">
									<asp:TextBox id="tbTID" runat="server" ReadOnly="True"></asp:TextBox></TD>
								<TD style="HEIGHT: 20px"></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 255px; HEIGHT: 52px">Member</TD>
								<TD style="WIDTH: 5px; HEIGHT: 52px">:</TD>
								<TD style="HEIGHT: 52px">
									<asp:DropDownList id="ddlMember" runat="server" Width="152px"></asp:DropDownList></TD>
							...
							<TR>
								...
								<TD style="WIDTH: 5px; HEIGHT: 52px">:</TD>
								<TD style="HEIGHT: 52px">
									<asp:TextBox id="tbT_Detail" runat="server" Width="100%" MaxLength="1000" TextMode="MultiLine"
										Height="146px"></asp:TextBox></TD>
								<TD style="HEIGHT: 52px">
									<asp:RequiredFieldValidator id="RFVText" runat="server" ErrorMessage="Enter Text to Shown" ControlToValidate="tbT_Detail"></asp:RequiredFieldValidator></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 255px">Show</TD>
								<TD style="WIDTH: 5px">:</TD>
								<TD>
									<asp:CheckBox id="chkShowTestimonials" runat="server"></asp:CheckBox></TD>
								<TD></TD>
							</TR>
							<TR>
