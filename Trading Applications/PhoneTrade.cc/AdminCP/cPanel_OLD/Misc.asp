...
<table width="80%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#999999">
  <tr bgcolor="#FFFFFF"> 
    <td width="17%"><strong><a href="MailingProc.asp">Send mail alert</a> </strong></td>
    <td width="15%"><strong><a href="Stats.asp">Statistics</a></strong></td>
    <td width="18%"><strong><a href="TradingFloorNew.asp">Export to Excel</a></strong></td>
    <td width="50%">&nbsp;</td>
  </tr>
</table>
</body>
