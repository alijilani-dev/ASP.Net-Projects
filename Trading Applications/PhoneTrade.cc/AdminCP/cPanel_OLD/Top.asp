	...
	<table width=100% border=0 cellpadding="2">
          <tr>
            ...
            <td width="16%" align=Center class=HeadingWithBackGround Id=Link3 onClick="JavaScript:Move('PostMessage.asp')" onmouseover="JavaScript:Show(3)">Post/Edit 
              Message</td>
            <td width="14%" align=Center class=HeadingWithBackGround Id=Link4 onClick="JavaScript:Move('Misc.asp')" onmouseover="JavaScript:Show(4)">Miscellaneous</td>
            <td width="37%" align=Center class=HeadingWithBackGround Id=Link5 onClick="JavaScript:Logout()" onmouseover="JavaScript:Show(5)">Logout</td>
          </tr>
        </table>
    </td></tr>		
</table>
...
var sc_project=785488; 
var sc_partition=6; 
var sc_security="0bb17fb0"; 
</script>

<script type="text/javascript" language="javascript" src="http://www.statcounter.com/counter/counter.js"></script><noscript><a href="http://www.statcounter.com/" target="_blank"><img  src="http://c7.statcounter.com/counter.php?sc_project=785488&amp;java=0&amp;security=0bb17fb0" alt="counter" border="0"></a> </noscript>
