<%
if len(trim(Request.form("name")))=0 and len(Request.form("workphone"))=0 and len(Request.form("cellphone"))=0 and  len(Request.form("email"))=0 then
	Response.Redirect("how_volunteer.htm")
end if
...
objMessage.Subject = "Volunteer Information From Manzil" 
objMessage.From = "volunteer@helpmanzil.com" 
objMessage.To = "rememberus@gmail.com" 
...
strHTML=strHTML & "<p><font face=""Verdana, Arial, Helvetica, sans-serif"">dear <b>" & lcase(Request.form("name")) & "</b><br>" 
strHTML=strHTML & "thank you very much for contacting manzil, a non-profit centre focussing on individuals with mental challenges. <br><br>"
strHTML=strHTML & "your details have been submitted to the manzil volunteer co-ordinator, and you shall be hearing from us shortly.<br><br>"
strHTML=strHTML & "regards,<br>director, manzil<br><br>"
strHTML=strHTML & "note: please note that this content is automatically generated from the manzil website to acknowledge your effort to contact us, so please do not reply to this."
strHTML=strHTML & "</font></p></body></html>"


Set objMessage = CreateObject("CDO.Message") 
objMessage.Subject = "Volunteering @ Manzil" 
objMessage.From = "volunteer@helpmazil.com" 
          ...
          <td width="780" align="left" valign="top" bgcolor="#FFFFFF"><table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                <td><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="780" height="126">
                    <param name="movie" value="images/banner%20anim2.swf">
                    <param name="quality" value="high">
                    <embed src="images/banner%20anim2.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="780" height="126"></embed></object></td>
              </tr>
            </table>
