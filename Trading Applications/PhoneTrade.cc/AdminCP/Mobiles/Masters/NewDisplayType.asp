 ...
 function FormSubmit()
{
	...
	document.frmDispType.hdAction.value="Add";
        ...
        <table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" class="Border2">
          <tr> 
            <td><table width="100%" border="0" cellpadding="2" cellspacing="0" class="contact">
                <tr> 
                  <td class="HeadingBackGroundLeft">Add new Display type</td>
                </tr>
              </table></td>
          </tr>
        </table>
          ...
          <tr> 
            <td width="100%" bgcolor="#FFFFFF" class="LightBackground"><table width=100% border=0 align=Center class="Border">
                ...
                <tr Class=TableBackGround> 
                  ...
                  <td width="68%"><input name=txtDisplaytype type=text class=Textbox id="txtDisplaytype" value="" maxlength="100"></td>
                </tr>
                <tr height=2> 
