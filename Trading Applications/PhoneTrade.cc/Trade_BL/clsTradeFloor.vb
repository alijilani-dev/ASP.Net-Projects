...
#Region "Private Variables"
    ...
    Private pi_Str_MoreSpec As String
    ...
    'Private pi_Str_StockLocation As String     /* Confusion to be removed. */
...
#Region "Properties"
    ...
    Public Property Spec() As String
        ...
        End Set
    End Property
    Public Property MoreSpec() As String
        Get
            Return pi_Str_MoreSpec
        End Get
        Set(ByVal Value As String)
            pi_Str_MoreSpec = Value
        End Set
    End Property
...
#Region "get Select ALL / SINGLE TradeFloor"
    ...
    Public Function GetHotOffer(Optional ByVal prm_Days As Integer = 2) As DataTable
        ...
        Try
            ...
            ds = pi_helper.ExecuteDataset(GlobalData.ConnectionString, CommandType.StoredProcedure, "USP_SELECT_TRADING_HOTOFFER", idbparameter)
            myDatatable = ds.Tables(0)
        Catch ex As Exception
            System.Diagnostics.Debug.WriteLine(ex.Message)
...
#Region "INSERT TradeFloor"
    Public Function Insert() As Boolean
        ...
        idb_TradeFloor_parameter(10).Value = String.Empty 'Me.Spec
        ' ** Ali **: Reason: Additional Specification information along with the posted offer information comming from TradeFloor.ascx
        idb_TradeFloor_parameter(11) = GlobalData.DataHelper.GetParameter("@MoreSpec", DbType.String, 50, ParameterDirection.Input)
        idb_TradeFloor_parameter(11).Value = Me.MoreSpec
        ' ** Ali **
        idb_TradeFloor_parameter(12) = GlobalData.DataHelper.GetParameter("@Warranty", DbType.String, 100, ParameterDirection.Input)
        idb_TradeFloor_parameter(12).Value = String.Empty 'Me.Warranty

        idb_TradeFloor_parameter(13) = GlobalData.DataHelper.GetParameter("@ProviderLogo", DbType.Boolean, 1, ParameterDirection.Input)
        idb_TradeFloor_parameter(13).Value = Me.ProviderLogo

        idb_TradeFloor_parameter(14) = GlobalData.DataHelper.GetParameter("@Packaging", DbType.String, 100, ParameterDirection.Input)
        idb_TradeFloor_parameter(14).Value = String.Empty 'Me.Packaging

        idb_TradeFloor_parameter(15) = GlobalData.DataHelper.GetParameter("@RequestDate", DbType.DateTime, 8, ParameterDirection.Input)
        idb_TradeFloor_parameter(15).Value = Me.RequestDate

        idb_TradeFloor_parameter(16) = GlobalData.DataHelper.GetParameter("@ShippingTerms", DbType.String, 100, ParameterDirection.Input)
        idb_TradeFloor_parameter(16).Value = Me.ShippingTerms

        idb_TradeFloor_parameter(17) = GlobalData.DataHelper.GetParameter("@Country_ID", DbType.Int32, 4, ParameterDirection.Input)
        idb_TradeFloor_parameter(17).Value = Me.Country_ID

        idb_TradeFloor_parameter(18) = GlobalData.DataHelper.GetParameter("@Location", DbType.String, 100, ParameterDirection.Input)
        idb_TradeFloor_parameter(18).Value = String.Empty 'Me.Location

        idb_TradeFloor_parameter(19) = GlobalData.DataHelper.GetParameter("@post_desc", DbType.String, 1000, ParameterDirection.Input)
        idb_TradeFloor_parameter(19).Value = Me.post_desc

        idb_TradeFloor_parameter(20) = GlobalData.DataHelper.GetParameter("@Status", DbType.String, 20, ParameterDirection.Input)
        idb_TradeFloor_parameter(20).Value = Me.Status

        'idb_TradeFloor_parameter(21) = GlobalData.DataHelper.GetParameter("@StockLocation", DbType.String, 20, ParameterDirection.Input)
        'idb_TradeFloor_parameter(21).Value = Me.StockLocation
...
#Region "DELETE TradeFloor Offer Based upon Trading_ID"
...
#Region "UPDATE TradeFloor"
    Public Function Update(Optional ByVal lSaveChanges As Boolean = False) As Boolean
        ...
        If (lSaveChanges) Then
            idb_TradeFloor_parameter(15) = GlobalData.DataHelper.GetParameter("@RequestDate", DbType.DateTime, 8, ParameterDirection.Input)
            idb_TradeFloor_parameter(15).Value = "1753-01-01 00:00:00.000"
        Else
            idb_TradeFloor_parameter(15) = GlobalData.DataHelper.GetParameter("@RequestDate", DbType.DateTime, 8, ParameterDirection.Input)
            idb_TradeFloor_parameter(15).Value = Me.RequestDate
        End If
