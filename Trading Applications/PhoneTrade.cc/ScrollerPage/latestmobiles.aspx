	...
	<body MS_POSITIONING="GridLayout" onload="clearTimeout(idSpnTimeOut1);applyEffect_Latest();">
		<div align="center">
			<table style="border:1px solid #3f8bd7; WIDTH: 176px; BACKGROUND-REPEAT: repeat-x"
				cellSpacing="0" cellPadding="0" height="118" background="../images/bg_cell.gif"
				border="0" id="table47">
				<tr>
				...
				<tr>
					<td width="168" align="center" valign="top">
						<table border="0" width="100%" id="table48" cellspacing="0" cellpadding="0">
							<tr>
								<td>
									<!-- Newly added on Jan 25th Second test as like-->
	<span id="spnLatest"  onmouseover="clearTimeout(idSpnTimeOut1);" style="filter: progid:DXImageTransform.Microsoft.GradientWipe(GradientSize=0.50,wipestyle=2,motion=reverse); width: 168px; height: 97px" onmouseout="idSpnTimeOut1 = setTimeout('applyEffect_Latest()',1000);">
