...
arr_Models[1] = {BGclr:"#D7E6FF", manuf:"NOKIA", model:"6230i", gif:"Thumb/m_6111small.jpg", links:"56"};
arr_Models[2] = {BGclr:"white", manuf:"MOTOROLA", model:"V3", gif:"Thumb/m_6270small.jpg", links:"15"};
arr_Models[3] = {BGclr:"#D7E6FF", manuf:"SAMSUNG", model:"D500", gif:"Thumb/m_7370-70.jpg", links:"68"};
*/
<%=strPhotos%>
...
function applyEffect() {
	...
	spnTrans.innerHTML = getItems(arr_Models[currArrID++]);
