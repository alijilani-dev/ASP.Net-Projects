...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<div align="center">
		<table style="BORDER-RIGHT: #3F8BD7 1px solid; BORDER-TOP: #3F8BD7 1px solid; BORDER-LEFT: #3F8BD7 1px solid; BORDER-BOTTOM: #3F8BD7 1px solid; BACKGROUND-REPEAT: repeat-x" cellSpacing="0" cellPadding="0" width="176" height="262" background="../images/bg_cell.gif" border="0" id="table47">
				<tr>
				...
				<tr>
					<td class="boxhdn" style="color: white; background-repeat: no-repeat" colSpan="2" height="19" bgcolor="#3F8BD7">
					&nbsp;New Members</td>
				</tr>
				<tr>
					<td width="91">
				...
				<tr>
					...
					<div id="containerPhones" style="DISPLAY: inline; VISIBILITY: visible; OVERFLOW: hidden; WIDTH: 168px; HEIGHT: 235px; BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; BACKGROUND-COLOR: transparent; BORDER-BOTTOM-STYLE: none">
										...
										<TABLE width="96%" border="0" align="center" cellPadding="1" cellSpacing="2" id="Table1">
											<TR>
											  <TD align="center" vAlign="middle" bgColor="white">
													...
													-->
                                                    <br><asp:HyperLink ID=hlinkcompanyName Font-Bold="True" ForeColor="#0000C0" runat="server" CssClass="normaltext" NavigateUrl='<%# "../PortalDefault.aspx?Main_Links_ID=2&Member_ID=" & DataBinder.Eval(Container, "DataItem.Member_ID") %>' Target="_parent"> <%# DataBinder.Eval(Container, "DataItem.member_company") %> </asp:HyperLink>
                                                    <!--
