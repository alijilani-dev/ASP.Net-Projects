...
<div align="center">
	...
	<table id="table4" style="BORDER-RIGHT: #3f8bd7 1px solid; BORDER-TOP: #3f8bd7 1px solid; BORDER-LEFT: #3f8bd7 1px solid; WIDTH: 388px; height: 150px;BORDER-BOTTOM: #3f8bd7 1px solid; BACKGROUND-REPEAT: repeat-x;"
		cellspacing="0" cellpadding="0" width="388" background="../images/bg_cell.gif" border="0">
		<tbody>
			<tr>
				<td class="boxhdn" width="99%" bgcolor="#3f8bd7" height="19">&nbsp;Change Password
				</td>
			</tr>
			<tr>
				<td height="3">
