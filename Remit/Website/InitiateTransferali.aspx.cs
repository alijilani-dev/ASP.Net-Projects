...
namespace Evernet.MoneyExchange.Admin {
	public class InitiateTransferali : System.Web.UI.Page {
		#region Declarations.
		...
		protected System.Web.UI.WebControls.TextBox txtBeneficeryQuestion;
		protected System.Web.UI.WebControls.TextBox txtBeneficeryAnswer;
		protected System.Web.UI.WebControls.TextBox txtBeneficeryMessage;
		...
		protected System.Web.UI.WebControls.TextBox txtMessageToAgent;
		protected System.Web.UI.WebControls.Panel pnlMessageToAgent;
...
*/
		...
		private void butInitiateTransfer_Click(object sender, System.EventArgs e) {
			 ...
			 * 
			 * */
			//System.Data.SqlClient.SqlTransaction trans = new System.Data.SqlClient.SqlTransaction(
			...
			if(aopaymentModeList.Col_FinalEntity.Value=="Bank" || aopaymentModeList.Col_FinalEntity.Value=="FixedBank" || aopaymentModeList.Col_ChannelThrough.Value=="Bank") {
				...
				query+=",NULL";
							...
							'"+ txtBeneficeryQuestion.Text +@"',
							'"+ txtBeneficeryAnswer.Text +@"',
							'"+ m2b.Replace("'","''") +@"',
							'"+ m2a.Replace("'","''") +@"',
		...
		private bool ValidateTransaction() {
			...
			tvr = TransactionManager.ValidateGlobalThreshold(payinAmount+commissionAmount, agentRate.AgencyRate.BankRate.PayInUnitExchangeRate.Value);
		...
		private void BindBeneficerySelection(string strBeneficeryID) 
		{
			...
			ddlBeneficerySelection.Items.Clear();
					...
					DataSet ds = SqlHelper.ExecuteDataset(ConfigHelper.ConStr,
						...
						//Select Id [ID1], FirstName+','+LastName Display From CustomerList Where Id = '" + strBeneficeryID + "'");
					ddlBeneficerySelection.DataSource = ds;
					ddlBeneficerySelection.DataBind();
			...
			//DataSet dsBen = SqlHelper.ExecuteDataset(ConfigHelper.ConStr,
			//	CommandType.Text,
			//	"Select Id [ID1], FirstName+','+LastName Display From CustomerList Where Id = '" + strBeneficeryID + "'");

			//ddlBeneficerySelection.SelectedIndex = ddlBeneficerySelection.Items.IndexOf(ddlBeneficerySelection.Items.FindByText(dsDest.Tables[0].Rows[0]["BenID"].ToString().Trim()));
			if(ddlBeneficerySelection.Items.Count>1)  
			{
				ddlBeneficerySelection.SelectedIndex=1;
			}
