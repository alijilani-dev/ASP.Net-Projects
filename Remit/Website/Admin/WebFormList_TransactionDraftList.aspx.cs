...
{
	/// <summary>
	/// Summary description for WebFormList_TransactionDraftList.
	/// </summary>
	public class WebFormList_TransactionDraftList: System.Web.UI.Page
	{
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		public WebFormList_TransactionDraftList() {
		...
		/// [To be supplied.]
		/// </summary>
		protected Evernet.MoneyExchange.Web.Repeaters.WebRepeaterCustom_spS_TransactionDraftList_SelectDisplay repeater_TransactionDraftList_SelectDisplay;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.LinkButton Label_DraftNumber;
		...
		private void Page_Load(object sender, System.EventArgs e) {
			...
			if (!Page.IsPostBack) {
				...
				if (ViewState["WebFormList_TransactionDraftList_CurrentSort"] == null) {

					ViewState.Add("WebFormList_TransactionDraftList_CurrentSort", sortColumn);
				}
				else {

					ViewState["WebFormList_TransactionDraftList_CurrentSort"] = sortColumn;
				}
			...
			repeater_TransactionDraftList_SelectDisplay.EnableViewState = true;
		...
		private void InitializeComponent() {
			...
			this.Label_DraftNumber.Click += new System.EventHandler(this.Label_DraftNumber_Click);
		...
		private void RefreshList() {
			...
			repeater_TransactionDraftList_SelectDisplay.Initialize(ConnectionString, System.Data.SqlTypes.SqlGuid.Null, TransactionId);
			try {

				repeater_TransactionDraftList_SelectDisplay.RefreshData();
			}
			catch (Evernet.MoneyExchange.DataClasses.CustomException customException) {

				if (customException.Parameter.SqlException != null) {

					throw new Exception(String.Format("An exception has been thrown in the underlying DataClass that is used by the 'WebRepeater_TransactionDraftList' class. Exception message is: {0}", customException.Parameter.SqlException.Message), customException);
				}
				else if (customException.Parameter.OtherException != null) {

					throw new Exception(String.Format("An exception has been thrown in the underlying DataClass that is used by the 'WebRepeater_TransactionDraftList' class. Exception message is: {0}", customException.Parameter.OtherException.Message), customException);
				}
				else {
			...
			System.Data.DataView dataView = (System.Data.DataView)repeater_TransactionDraftList_SelectDisplay.DataSource;

			string SortDirective = String.Empty;
			switch ((CurrentSortEnum)ViewState["WebFormList_TransactionDraftList_CurrentSort"]) {

				case CurrentSortEnum.SortBy_Id:
					SortDirective = spS_TransactionDraftList.Resultset1.Fields.Column_Id.ColumnName;
					break;

				case CurrentSortEnum.SortBy_TransactionId:
					SortDirective = spS_TransactionDraftList_SelectDisplay.Resultset1.Fields.Column_TransactionId_Display.ColumnName;
					break;

				case CurrentSortEnum.SortBy_DraftNumber:
					SortDirective = spS_TransactionDraftList.Resultset1.Fields.Column_DraftNumber.ColumnName;
					break;
			...
			repeater_TransactionDraftList_SelectDisplay.DataBind();
		}

		private void Label_Id_Click(object sender, System.EventArgs e) {

			if ((CurrentSortEnum)ViewState["WebFormList_TransactionDraftList_CurrentSort"] == CurrentSortEnum.SortBy_Id) {
				...
				ViewState["WebFormList_TransactionDraftList_CurrentSort"] = CurrentSortEnum.SortBy_Id;
			}
		...
		private void Label_TransactionId_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_TransactionDraftList_CurrentSort"] == CurrentSortEnum.SortBy_TransactionId) {
				...
				ViewState["WebFormList_TransactionDraftList_CurrentSort"] = CurrentSortEnum.SortBy_TransactionId;
			}

			RefreshList();
		}

		private void Label_DraftNumber_Click(object sender, System.EventArgs e) {

			if ((CurrentSortEnum)ViewState["WebFormList_TransactionDraftList_CurrentSort"] == CurrentSortEnum.SortBy_DraftNumber) {
				...
				ViewState["WebFormList_TransactionDraftList_CurrentSort"] = CurrentSortEnum.SortBy_DraftNumber;
			}
