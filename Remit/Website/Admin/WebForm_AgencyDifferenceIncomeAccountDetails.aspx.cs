...
namespace Evernet.MoneyExchange.Web.Forms {
	...
	/// <summary>
	/// Summary description for WebForm_AgencyDifferenceIncomeAccountDetails.
	/// </summary>
	public class WebForm_AgencyDifferenceIncomeAccountDetails : System.Web.UI.Page {
		...
		/// [To be supplied.]
		/// </summary>
		public WebForm_AgencyDifferenceIncomeAccountDetails() {
		...
		private void RefreshRecord() {
			...
			Evernet.MoneyExchange.AbstractClasses.Abstract_AgencyDifferenceIncomeAccountDetails oAbstract_AgencyDifferenceIncomeAccountDetails = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgencyDifferenceIncomeAccountDetails(ConnectionString);

			if (!oAbstract_AgencyDifferenceIncomeAccountDetails.Refresh(CurrentID)) {
			...
			if (!oAbstract_AgencyDifferenceIncomeAccountDetails.Col_Id.IsNull) {

				txt_Id.Text = oAbstract_AgencyDifferenceIncomeAccountDetails.Col_Id.Value.ToString();
			}
			else {
			...
			if (!oAbstract_AgencyDifferenceIncomeAccountDetails.Col_CreditDateTime.IsNull) {

				txt_CreditDateTime.Text = oAbstract_AgencyDifferenceIncomeAccountDetails.Col_CreditDateTime.Value.ToString();
			}
			else {
			...
			if (!oAbstract_AgencyDifferenceIncomeAccountDetails.Col_DebitDateTime.IsNull) {

				txt_DebitDateTime.Text = oAbstract_AgencyDifferenceIncomeAccountDetails.Col_DebitDateTime.Value.ToString();
			}
			else {
			...
			com_TransactionId.Items.FindByValue(Convert.ToString(oAbstract_AgencyDifferenceIncomeAccountDetails.Col_TransactionId)).Selected = true;

			if (!oAbstract_AgencyDifferenceIncomeAccountDetails.Col_CreditLC.IsNull) {

				txt_CreditLC.Text = oAbstract_AgencyDifferenceIncomeAccountDetails.Col_CreditLC.Value.ToString();
			}
			else {
			...
			if (!oAbstract_AgencyDifferenceIncomeAccountDetails.Col_CreditUSD.IsNull) {

				txt_CreditUSD.Text = oAbstract_AgencyDifferenceIncomeAccountDetails.Col_CreditUSD.Value.ToString();
			}
			else {
			...
			if (!oAbstract_AgencyDifferenceIncomeAccountDetails.Col_DebitLC.IsNull) {

				txt_DebitLC.Text = oAbstract_AgencyDifferenceIncomeAccountDetails.Col_DebitLC.Value.ToString();
			}
			else {
			...
			if (!oAbstract_AgencyDifferenceIncomeAccountDetails.Col_DebitUSD.IsNull) {

				txt_DebitUSD.Text = oAbstract_AgencyDifferenceIncomeAccountDetails.Col_DebitUSD.Value.ToString();
			}
			else {
		...
		private void cmdAdd_Click(object sender, System.EventArgs e) {
			...
			if (ReturnURL.Visible) {
				...
				Response.Redirect(String.Format("WebForm_AgencyDifferenceIncomeAccountDetails.aspx?Action=Add&ReturnToUrl={0}&ReturnToDisplay={1}", ReturnURL.NavigateUrl, ReturnURL.Text));
			}
			else {

				Response.Redirect("WebForm_AgencyDifferenceIncomeAccountDetails.aspx?Action=Add");
			}
		}
		...
		private void cmdUpdate_Click(object sender, System.EventArgs e) {
			...
			if (Action == ActionEnum.Edit) {
				...
				Params.spU_AgencyDifferenceIncomeAccountDetails Param = null;
				SPs.spU_AgencyDifferenceIncomeAccountDetails SP = null;

				Param = new Params.spU_AgencyDifferenceIncomeAccountDetails();
				...
				SP = new SPs.spU_AgencyDifferenceIncomeAccountDetails();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_AgencyDifferenceIncomeAccountDetails.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", CurrentID.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_AgencyDifferenceIncomeAccountDetails.aspx?Action=Edit&ID={0}", CurrentID.ToString()));
					}
					return;
				}
				else {
				...
				Params.spI_AgencyDifferenceIncomeAccountDetails Param = null;
				SPs.spI_AgencyDifferenceIncomeAccountDetails SP = null;

				Param = new Params.spI_AgencyDifferenceIncomeAccountDetails();
				...
				SP = new SPs.spI_AgencyDifferenceIncomeAccountDetails();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_AgencyDifferenceIncomeAccountDetails.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", Param.Param_Id.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_AgencyDifferenceIncomeAccountDetails.aspx?Action=Edit&ID={0}", Param.Param_Id.ToString()));
					}
					return;
				}
				else {
		...
		private void cmdDelete_Click(object sender, System.EventArgs e) {
			...
			Params.spD_AgencyDifferenceIncomeAccountDetails Param = null;
			SPs.spD_AgencyDifferenceIncomeAccountDetails SP = null;

			Param = new Params.spD_AgencyDifferenceIncomeAccountDetails();

			Param.SetUpConnection(ConnectionString);

			Param.Param_Id = CurrentID;

			SP = new SPs.spD_AgencyDifferenceIncomeAccountDetails();
