<%@ Page language="c#" Codebehind="WebForm_PaymentModeBaseTypeList.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_PaymentModeBaseTypeList" %>
...
<html>
	...
	<body class="FormStyle">
		...
		<asp:panel id="MainDisplay" runat="server">
			<form id="WebForm_PaymentModeBaseTypeList" method="post" runat="server">
