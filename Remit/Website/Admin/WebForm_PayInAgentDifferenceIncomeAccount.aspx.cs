...
namespace Evernet.MoneyExchange.Web.Forms {
	...
	/// <summary>
	/// Summary description for WebForm_PayInAgentDifferenceIncomeAccount.
	/// </summary>
	public class WebForm_PayInAgentDifferenceIncomeAccount : System.Web.UI.Page {
		...
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label lab_TranasctionId;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		/// [To be supplied.]
		/// </summary>
		public WebForm_PayInAgentDifferenceIncomeAccount() {
		...
		private void RefreshForeignTables() {
			...
			try {
				...
				com_TranasctionId.RefreshData(System.Data.SqlTypes.SqlGuid.Null);
			}
			catch (Evernet.MoneyExchange.DataClasses.CustomException customException) {
		...
		private void RefreshRecord() {
			...
			Evernet.MoneyExchange.AbstractClasses.Abstract_PayInAgentDifferenceIncomeAccount oAbstract_PayInAgentDifferenceIncomeAccount = new Evernet.MoneyExchange.AbstractClasses.Abstract_PayInAgentDifferenceIncomeAccount(ConnectionString);

			if (!oAbstract_PayInAgentDifferenceIncomeAccount.Refresh(CurrentID)) {
			...
			if (!oAbstract_PayInAgentDifferenceIncomeAccount.Col_Id.IsNull) {

				txt_Id.Text = oAbstract_PayInAgentDifferenceIncomeAccount.Col_Id.Value.ToString();
			}
			else {
			...
			if (!oAbstract_PayInAgentDifferenceIncomeAccount.Col_CreditDateTime.IsNull) {

				txt_CreditDateTime.Text = oAbstract_PayInAgentDifferenceIncomeAccount.Col_CreditDateTime.Value.ToString();
			}
			else {
			...
			if (!oAbstract_PayInAgentDifferenceIncomeAccount.Col_DebitDateTime.IsNull) {

				txt_DebitDateTime.Text = oAbstract_PayInAgentDifferenceIncomeAccount.Col_DebitDateTime.Value.ToString();
			}
			else {
			...
			com_AgentAccountId.Items.FindByValue(Convert.ToString(oAbstract_PayInAgentDifferenceIncomeAccount.Col_AgentAccountId)).Selected = true;

			com_TranasctionId.Items.FindByValue(Convert.ToString(oAbstract_PayInAgentDifferenceIncomeAccount.Col_TranasctionId)).Selected = true;

			if (!oAbstract_PayInAgentDifferenceIncomeAccount.Col_CreditLC.IsNull) {

				txt_CreditLC.Text = oAbstract_PayInAgentDifferenceIncomeAccount.Col_CreditLC.Value.ToString();
			}
			else {
			...
			if (!oAbstract_PayInAgentDifferenceIncomeAccount.Col_CreditUSD.IsNull) {

				txt_CreditUSD.Text = oAbstract_PayInAgentDifferenceIncomeAccount.Col_CreditUSD.Value.ToString();
			}
			else {
			...
			if (!oAbstract_PayInAgentDifferenceIncomeAccount.Col_DebitLC.IsNull) {

				txt_DebitLC.Text = oAbstract_PayInAgentDifferenceIncomeAccount.Col_DebitLC.Value.ToString();
			}
			else {
			...
			if (!oAbstract_PayInAgentDifferenceIncomeAccount.Col_DebitUSD.IsNull) {

				txt_DebitUSD.Text = oAbstract_PayInAgentDifferenceIncomeAccount.Col_DebitUSD.Value.ToString();
			}
			else {
		...
		private void EmptyControls() {
			...
			com_TranasctionId.SelectedIndex = 0;
			txt_CreditLC.Text = String.Empty;
			txt_CreditUSD.Text = String.Empty;
			txt_DebitLC.Text = String.Empty;
			txt_DebitUSD.Text = String.Empty;
		...
		private void cmdAdd_Click(object sender, System.EventArgs e) {
			...
			if (ReturnURL.Visible) {
				...
				Response.Redirect(String.Format("WebForm_PayInAgentDifferenceIncomeAccount.aspx?Action=Add&ReturnToUrl={0}&ReturnToDisplay={1}", ReturnURL.NavigateUrl, ReturnURL.Text));
			}
			else {

				Response.Redirect("WebForm_PayInAgentDifferenceIncomeAccount.aspx?Action=Add");
			}
		}
		...
		private void cmdUpdate_Click(object sender, System.EventArgs e) {
			...
			if (Action == ActionEnum.Edit) {
				...
				Params.spU_PayInAgentDifferenceIncomeAccount Param = null;
				SPs.spU_PayInAgentDifferenceIncomeAccount SP = null;

				Param = new Params.spU_PayInAgentDifferenceIncomeAccount();
				...
				Param.Param_TranasctionId = new Guid(com_TranasctionId.SelectedItem.Value);

				if (txt_CreditLC.Text.Trim() != String.Empty) {

					Param.Param_CreditLC = new System.Data.SqlTypes.SqlMoney(System.Convert.ToDecimal(txt_CreditLC.Text));
				}

				if (txt_CreditUSD.Text.Trim() != String.Empty) {

					Param.Param_CreditUSD = new System.Data.SqlTypes.SqlMoney(System.Convert.ToDecimal(txt_CreditUSD.Text));
				}

				if (txt_DebitLC.Text.Trim() != String.Empty) {

					Param.Param_DebitLC = new System.Data.SqlTypes.SqlMoney(System.Convert.ToDecimal(txt_DebitLC.Text));
				}

				if (txt_DebitUSD.Text.Trim() != String.Empty) {

					Param.Param_DebitUSD = new System.Data.SqlTypes.SqlMoney(System.Convert.ToDecimal(txt_DebitUSD.Text));
				}

				SP = new SPs.spU_PayInAgentDifferenceIncomeAccount();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_PayInAgentDifferenceIncomeAccount.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", CurrentID.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_PayInAgentDifferenceIncomeAccount.aspx?Action=Edit&ID={0}", CurrentID.ToString()));
					}
					return;
				}
				else {
				...
				Params.spI_PayInAgentDifferenceIncomeAccount Param = null;
				SPs.spI_PayInAgentDifferenceIncomeAccount SP = null;

				Param = new Params.spI_PayInAgentDifferenceIncomeAccount();
				...
				SP = new SPs.spI_PayInAgentDifferenceIncomeAccount();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_PayInAgentDifferenceIncomeAccount.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", Param.Param_Id.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_PayInAgentDifferenceIncomeAccount.aspx?Action=Edit&ID={0}", Param.Param_Id.ToString()));
					}
					return;
				}
				else {
		...
		private void cmdDelete_Click(object sender, System.EventArgs e) {
			...
			Params.spD_PayInAgentDifferenceIncomeAccount Param = null;
			SPs.spD_PayInAgentDifferenceIncomeAccount SP = null;

			Param = new Params.spD_PayInAgentDifferenceIncomeAccount();

			Param.SetUpConnection(ConnectionString);

			Param.Param_Id = CurrentID;

			SP = new SPs.spD_PayInAgentDifferenceIncomeAccount();
		...
		private bool CheckValues() {
			...
			try {
				...
				System.Data.SqlTypes.SqlMoney value = new System.Data.SqlTypes.SqlMoney(System.Convert.ToDecimal(txt_CreditLC.Text));
			}
			...
			try {
				...
				System.Data.SqlTypes.SqlMoney value = new System.Data.SqlTypes.SqlMoney(System.Convert.ToDecimal(txt_CreditUSD.Text));
			}
			...
			try {
				...
				System.Data.SqlTypes.SqlMoney value = new System.Data.SqlTypes.SqlMoney(System.Convert.ToDecimal(txt_DebitLC.Text));
			}
			...
			try {
				...
				System.Data.SqlTypes.SqlMoney value = new System.Data.SqlTypes.SqlMoney(System.Convert.ToDecimal(txt_DebitUSD.Text));
			}
