...
namespace Evernet.MoneyExchange.Web.Forms {
	...
	/// <summary>
	/// Summary description for WebForm_TransactionSettlementHistory.
	/// </summary>
	public class WebForm_TransactionSettlementHistory : System.Web.UI.Page {
		...
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label lab_SettlementAmount;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.TextBox txt_SettlementAmount;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label labError_SettlementAmount;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		/// [To be supplied.]
		/// </summary>
		public WebForm_TransactionSettlementHistory() {
		...
		private void Page_Load(object sender, System.EventArgs e) {
			...
			*/
			...
			labError_SettlementAmount.Visible = false;
		...
		private void RefreshForeignTables() {
			...
			try {
				...
				com_PaymentId.RefreshData(System.Data.SqlTypes.SqlGuid.Null);
			}
		...
		private void RefreshRecord() {
			...
			Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionSettlementHistory oAbstract_TransactionSettlementHistory = new Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionSettlementHistory(ConnectionString);

			if (!oAbstract_TransactionSettlementHistory.Refresh(CurrentID)) {
			...
			if (!oAbstract_TransactionSettlementHistory.Col_Id.IsNull) {

				txt_Id.Text = oAbstract_TransactionSettlementHistory.Col_Id.Value.ToString();
			}
			else {
			...
			com_PaymentId.Items.FindByValue(Convert.ToString(oAbstract_TransactionSettlementHistory.Col_PaymentId)).Selected = true;

			com_TransactionId.Items.FindByValue(Convert.ToString(oAbstract_TransactionSettlementHistory.Col_TransactionId)).Selected = true;

			if (!oAbstract_TransactionSettlementHistory.Col_SettlementAmount.IsNull) {

				txt_SettlementAmount.Text = oAbstract_TransactionSettlementHistory.Col_SettlementAmount.Value.ToString();
			}
			else {

				txt_SettlementAmount.Text = String.Empty;
			}
		...
		private void cmdAdd_Click(object sender, System.EventArgs e) {
			...
			if (ReturnURL.Visible) {
				...
				Response.Redirect(String.Format("WebForm_TransactionSettlementHistory.aspx?Action=Add&ReturnToUrl={0}&ReturnToDisplay={1}", ReturnURL.NavigateUrl, ReturnURL.Text));
			}
			else {

				Response.Redirect("WebForm_TransactionSettlementHistory.aspx?Action=Add");
			}
		}
		...
		private void cmdUpdate_Click(object sender, System.EventArgs e) {
			...
			if (Action == ActionEnum.Edit) {
				...
				Params.spU_TransactionSettlementHistory Param = null;
				SPs.spU_TransactionSettlementHistory SP = null;

				Param = new Params.spU_TransactionSettlementHistory();
				...
				Param.Param_PaymentId = new Guid(com_PaymentId.SelectedItem.Value);

				Param.Param_TransactionId = new Guid(com_TransactionId.SelectedItem.Value);

				if (txt_SettlementAmount.Text.Trim() != String.Empty) {

					Param.Param_SettlementAmount = new System.Data.SqlTypes.SqlDecimal(System.Convert.ToDecimal(txt_SettlementAmount.Text));
				}

				SP = new SPs.spU_TransactionSettlementHistory();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_TransactionSettlementHistory.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", CurrentID.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_TransactionSettlementHistory.aspx?Action=Edit&ID={0}", CurrentID.ToString()));
					}
					return;
				}
				else {
				...
				Params.spI_TransactionSettlementHistory Param = null;
				SPs.spI_TransactionSettlementHistory SP = null;

				Param = new Params.spI_TransactionSettlementHistory();
				...
				SP = new SPs.spI_TransactionSettlementHistory();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_TransactionSettlementHistory.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", Param.Param_Id.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_TransactionSettlementHistory.aspx?Action=Edit&ID={0}", Param.Param_Id.ToString()));
					}
					return;
				}
				else {
		...
		private void cmdDelete_Click(object sender, System.EventArgs e) {
			...
			Params.spD_TransactionSettlementHistory Param = null;
			SPs.spD_TransactionSettlementHistory SP = null;

			Param = new Params.spD_TransactionSettlementHistory();

			Param.SetUpConnection(ConnectionString);

			Param.Param_Id = CurrentID;

			SP = new SPs.spD_TransactionSettlementHistory();
		...
		private bool CheckValues() {
			...
			try {
				...
				System.Data.SqlTypes.SqlDecimal value = new System.Data.SqlTypes.SqlDecimal(System.Convert.ToDecimal(txt_SettlementAmount.Text));
			}

			catch {

				labError_SettlementAmount.Text = "INVALID";
				labError_SettlementAmount.Visible = true;
				status = false;
			}
