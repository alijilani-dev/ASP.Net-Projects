...
namespace Evernet.MoneyExchange.Web.Forms {
	...
	/// <summary>
	/// Summary description for WebForm_TransactionStatusList.
	/// </summary>
	public class WebForm_TransactionStatusList : System.Web.UI.Page {
		...
		/// [To be supplied.]
		/// </summary>
		public WebForm_TransactionStatusList() {
		...
		private void RefreshRecord() {
			...
			Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionStatusList oAbstract_TransactionStatusList = new Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionStatusList(ConnectionString);

			if (!oAbstract_TransactionStatusList.Refresh(CurrentID)) {
			...
			if (!oAbstract_TransactionStatusList.Col_Name.IsNull) {

				txt_Name.Text = oAbstract_TransactionStatusList.Col_Name.Value.ToString();
			}
			else {
			...
			if (!oAbstract_TransactionStatusList.Col_Value.IsNull) {

				txt_Value.Text = oAbstract_TransactionStatusList.Col_Value.Value.ToString();
			}
			else {
		...
		private void cmdAdd_Click(object sender, System.EventArgs e) {
			...
			if (ReturnURL.Visible) {
				...
				Response.Redirect(String.Format("WebForm_TransactionStatusList.aspx?Action=Add&ReturnToUrl={0}&ReturnToDisplay={1}", ReturnURL.NavigateUrl, ReturnURL.Text));
			}
			else {

				Response.Redirect("WebForm_TransactionStatusList.aspx?Action=Add");
			}
		}
		...
		private void cmdUpdate_Click(object sender, System.EventArgs e) {
			...
			if (Action == ActionEnum.Edit) {
				...
				Params.spU_TransactionStatusList Param = null;
				SPs.spU_TransactionStatusList SP = null;

				Param = new Params.spU_TransactionStatusList();
				...
				SP = new SPs.spU_TransactionStatusList();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_TransactionStatusList.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", CurrentID.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_TransactionStatusList.aspx?Action=Edit&ID={0}", CurrentID.ToString()));
					}
					return;
				}
				else {
				...
				Params.spI_TransactionStatusList Param = null;
				SPs.spI_TransactionStatusList SP = null;

				Param = new Params.spI_TransactionStatusList();
				...
				SP = new SPs.spI_TransactionStatusList();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_TransactionStatusList.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", Param.Param_Value.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_TransactionStatusList.aspx?Action=Edit&ID={0}", Param.Param_Value.ToString()));
					}
					return;
				}
				else {
		...
		private void cmdDelete_Click(object sender, System.EventArgs e) {
			...
			Params.spD_TransactionStatusList Param = null;
			SPs.spD_TransactionStatusList SP = null;

			Param = new Params.spD_TransactionStatusList();

			Param.SetUpConnection(ConnectionString);

			Param.Param_Value = CurrentID;

			SP = new SPs.spD_TransactionStatusList();
