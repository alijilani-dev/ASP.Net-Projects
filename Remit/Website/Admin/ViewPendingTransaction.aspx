...
<%@ Page language="c#" Codebehind="ViewPendingTransaction.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Admin.ViewPendingTransaction_Updated" %>
<HTML>
	<HEAD>
																			...
																			<tr>
																				<td>
																					<asp:DataGrid id="dgrdPayIn" runat="server" AutoGenerateColumns="False" BorderColor="Tan" BorderWidth="1px"
																						...
																						<FooterStyle BackColor="Tan"></FooterStyle>
																						<Columns>
																							<asp:TemplateColumn SortExpression="approval">
																								<ItemTemplate>
																									<asp:CheckBox id="chkapprove" runat="server" EnableViewState="False" Visible="true" Checked="False"></asp:CheckBox>
																								</ItemTemplate>
																							</asp:TemplateColumn>
																							<asp:BoundColumn DataField="CustomerId_FirstName" HeaderText="Sender Name"></asp:BoundColumn>
																							<asp:BoundColumn DataField="BeneficeryId_FirstName" HeaderText="Ben. Name"></asp:BoundColumn>
																							<asp:BoundColumn DataField="TransactionNumber" HeaderText="SRTR No"></asp:BoundColumn>
																					...
																					<asp:Button id="btnApprove" runat="server" Text="Approve Selected Transactions"></asp:Button>
																				</td>
																			</tr>
																		</table>
																	</td>
