...
namespace Evernet.MoneyExchange.Web.Forms {
	...
	/// <summary>
	/// Summary description for WebForm_TransactionSettlementStatusList.
	/// </summary>
	public class WebForm_TransactionSettlementStatusList : System.Web.UI.Page {
		...
		/// [To be supplied.]
		/// </summary>
		public WebForm_TransactionSettlementStatusList() {
		...
		private void RefreshRecord() {
			...
			Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionSettlementStatusList oAbstract_TransactionSettlementStatusList = new Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionSettlementStatusList(ConnectionString);

			if (!oAbstract_TransactionSettlementStatusList.Refresh(CurrentID)) {
			...
			if (!oAbstract_TransactionSettlementStatusList.Col_Name.IsNull) {

				txt_Name.Text = oAbstract_TransactionSettlementStatusList.Col_Name.Value.ToString();
			}
			else {
			...
			if (!oAbstract_TransactionSettlementStatusList.Col_Value.IsNull) {

				txt_Value.Text = oAbstract_TransactionSettlementStatusList.Col_Value.Value.ToString();
			}
			else {
		...
		private void cmdAdd_Click(object sender, System.EventArgs e) {
			...
			if (ReturnURL.Visible) {
				...
				Response.Redirect(String.Format("WebForm_TransactionSettlementStatusList.aspx?Action=Add&ReturnToUrl={0}&ReturnToDisplay={1}", ReturnURL.NavigateUrl, ReturnURL.Text));
			}
			else {

				Response.Redirect("WebForm_TransactionSettlementStatusList.aspx?Action=Add");
			}
		}
		...
		private void cmdUpdate_Click(object sender, System.EventArgs e) {
			...
			if (Action == ActionEnum.Edit) {
				...
				Params.spU_TransactionSettlementStatusList Param = null;
				SPs.spU_TransactionSettlementStatusList SP = null;

				Param = new Params.spU_TransactionSettlementStatusList();
				...
				SP = new SPs.spU_TransactionSettlementStatusList();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_TransactionSettlementStatusList.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", CurrentID.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_TransactionSettlementStatusList.aspx?Action=Edit&ID={0}", CurrentID.ToString()));
					}
					return;
				}
				else {
				...
				Params.spI_TransactionSettlementStatusList Param = null;
				SPs.spI_TransactionSettlementStatusList SP = null;

				Param = new Params.spI_TransactionSettlementStatusList();
				...
				SP = new SPs.spI_TransactionSettlementStatusList();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_TransactionSettlementStatusList.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", Param.Param_Value.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_TransactionSettlementStatusList.aspx?Action=Edit&ID={0}", Param.Param_Value.ToString()));
					}
					return;
				}
				else {
		...
		private void cmdDelete_Click(object sender, System.EventArgs e) {
			...
			Params.spD_TransactionSettlementStatusList Param = null;
			SPs.spD_TransactionSettlementStatusList SP = null;

			Param = new Params.spD_TransactionSettlementStatusList();

			Param.SetUpConnection(ConnectionString);

			Param.Param_Value = CurrentID;

			SP = new SPs.spD_TransactionSettlementStatusList();
