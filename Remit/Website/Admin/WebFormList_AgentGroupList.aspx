                  ...
                  <td align="center" valign="top"><!-- InstanceBeginEditable name="MainContent" --> 
                    <table rules="all" style="border-collapse:collapse;" cellSpacing="0" cellPadding="5" border="1">
                      ...
                      <tr class="TableHeader" align="middle">
                        <td><asp:HyperLink id="Add" runat="server" CssClass="EditHyperLink" EnableViewState="false" NavigateUrl="WebForm_AgentGroupList.aspx?Action=Add&ReturnToUrl=WebFormList_AgentGroupList.aspx&ReturnToDisplay=Back to the list"> Add </asp:HyperLink>
                        </td>
                        ...
                        <td><asp:linkbutton id="Label_PrefixCode" runat="server" CssClass="TableHeader" EnableViewState="false"> PrefixCode </asp:linkbutton>
                        </td>
                      </tr>
                      <Repeaters:WebRepeaterCustom_spS_AgentGroupList_SelectDisplay id="repeater_AgentGroupList_SelectDisplay" runat="server">
                      <ItemTemplate>
                        <tr class="TableRow" align="center">
                          <td><asp:HyperLink id="Edit" runat="server" CssClass="EditHyperLink" EnableViewState="false" NavigateUrl='<%# String.Format("WebForm_AgentGroupList.aspx?Action=Edit&ID={0}&ReturnToUrl=WebFormList_AgentGroupList.aspx&ReturnToDisplay=Back to the list", DataBinder.Eval(Container.DataItem, "Id") ) %>'> Edit </asp:HyperLink>
                              <br>
                              <asp:HyperLink Visible="false" id="Delete" runat="server" CssClass="EditHyperLink" EnableViewState="false" NavigateUrl='<%# String.Format("WebForm_AgentGroupList.aspx?Action=Delete&ID={0}&ReturnToUrl=WebFormList_AgentGroupList.aspx&ReturnToDisplay=Back to the list", DataBinder.Eval(Container.DataItem, "Id") ) %>'> Delete </asp:HyperLink>
                          </td>
                          <td><%# DataBinder.Eval(Container.DataItem, "AgentAccountId_Display") %> </td>
                          <td><%# DataBinder.Eval(Container.DataItem, "Name") %> </td>
                          <td><%# DataBinder.Eval(Container.DataItem, "PrefixCode") %> </td>
                        </tr>
                      </ItemTemplate>
