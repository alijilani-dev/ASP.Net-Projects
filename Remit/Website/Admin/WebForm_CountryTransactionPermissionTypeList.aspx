<%@ Page language="c#" Codebehind="WebForm_CountryTransactionPermissionTypeList.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_CountryTransactionPermissionTypeList" %>
...
<html>
	...
	<body class="FormStyle">
		...
		<asp:panel id="MainDisplay" runat="server">
			<form id="WebForm_CountryTransactionPermissionTypeList" method="post" runat="server">
