...
namespace Evernet.MoneyExchange.Web.Forms {
	...
	/// <summary>
	/// Summary description for WebForm_PaymentModeBaseTypeList.
	/// </summary>
	public class WebForm_PaymentModeBaseTypeList : System.Web.UI.Page {
		...
		/// [To be supplied.]
		/// </summary>
		public WebForm_PaymentModeBaseTypeList() {
		...
		private void RefreshRecord() {
			...
			Evernet.MoneyExchange.AbstractClasses.Abstract_PaymentModeBaseTypeList oAbstract_PaymentModeBaseTypeList = new Evernet.MoneyExchange.AbstractClasses.Abstract_PaymentModeBaseTypeList(ConnectionString);

			if (!oAbstract_PaymentModeBaseTypeList.Refresh(CurrentID)) {
			...
			if (!oAbstract_PaymentModeBaseTypeList.Col_Name.IsNull) {

				txt_Name.Text = oAbstract_PaymentModeBaseTypeList.Col_Name.Value.ToString();
			}
			else {
			...
			if (!oAbstract_PaymentModeBaseTypeList.Col_Value.IsNull) {

				txt_Value.Text = oAbstract_PaymentModeBaseTypeList.Col_Value.Value.ToString();
			}
			else {
		...
		private void cmdAdd_Click(object sender, System.EventArgs e) {
			...
			if (ReturnURL.Visible) {
				...
				Response.Redirect(String.Format("WebForm_PaymentModeBaseTypeList.aspx?Action=Add&ReturnToUrl={0}&ReturnToDisplay={1}", ReturnURL.NavigateUrl, ReturnURL.Text));
			}
			else {

				Response.Redirect("WebForm_PaymentModeBaseTypeList.aspx?Action=Add");
			}
		}
		...
		private void cmdUpdate_Click(object sender, System.EventArgs e) {
			...
			if (Action == ActionEnum.Edit) {
				...
				Params.spU_PaymentModeBaseTypeList Param = null;
				SPs.spU_PaymentModeBaseTypeList SP = null;

				Param = new Params.spU_PaymentModeBaseTypeList();
				...
				SP = new SPs.spU_PaymentModeBaseTypeList();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_PaymentModeBaseTypeList.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", CurrentID.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_PaymentModeBaseTypeList.aspx?Action=Edit&ID={0}", CurrentID.ToString()));
					}
					return;
				}
				else {
				...
				Params.spI_PaymentModeBaseTypeList Param = null;
				SPs.spI_PaymentModeBaseTypeList SP = null;

				Param = new Params.spI_PaymentModeBaseTypeList();
				...
				SP = new SPs.spI_PaymentModeBaseTypeList();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_PaymentModeBaseTypeList.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", Param.Param_Value.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_PaymentModeBaseTypeList.aspx?Action=Edit&ID={0}", Param.Param_Value.ToString()));
					}
					return;
				}
				else {
		...
		private void cmdDelete_Click(object sender, System.EventArgs e) {
			...
			Params.spD_PaymentModeBaseTypeList Param = null;
			SPs.spD_PaymentModeBaseTypeList SP = null;

			Param = new Params.spD_PaymentModeBaseTypeList();

			Param.SetUpConnection(ConnectionString);

			Param.Param_Value = CurrentID;

			SP = new SPs.spD_PaymentModeBaseTypeList();
