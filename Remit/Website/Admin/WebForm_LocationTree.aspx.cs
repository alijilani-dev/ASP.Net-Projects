...
namespace Evernet.MoneyExchange.Web.Forms {
	...
	/// <summary>
	/// Summary description for WebForm_LocationTree.
	/// </summary>
	public class WebForm_LocationTree : System.Web.UI.Page {
		...
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.TextBox txt_LocationId;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label labError_LocationId;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label lab_ParentLocationId;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.TextBox txt_ParentLocationId;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label labError_ParentLocationId;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		private void Page_Load(object sender, System.EventArgs e) {
			...
			*/
			...
			labError_LocationId.Visible = false;
			labError_ParentLocationId.Visible = false;
		...
		private void RefreshRecord() {
			...
			Evernet.MoneyExchange.AbstractClasses.Abstract_LocationTree oAbstract_LocationTree = new Evernet.MoneyExchange.AbstractClasses.Abstract_LocationTree(ConnectionString);

			if (!oAbstract_LocationTree.Refresh(CurrentID)) {
			...
			if (!oAbstract_LocationTree.Col_Id.IsNull) {

				txt_Id.Text = oAbstract_LocationTree.Col_Id.Value.ToString();
			}
			else {
			...
			if (!oAbstract_LocationTree.Col_LocationId.IsNull) {

				txt_LocationId.Text = oAbstract_LocationTree.Col_LocationId.Value.ToString();
			}
			else {

				txt_LocationId.Text = String.Empty;
			}

			if (!oAbstract_LocationTree.Col_ParentLocationId.IsNull) {

				txt_ParentLocationId.Text = oAbstract_LocationTree.Col_ParentLocationId.Value.ToString();
			}
			else {

				txt_ParentLocationId.Text = String.Empty;
			}

			if (!oAbstract_LocationTree.Col_Level.IsNull) {

				txt_Level.Text = oAbstract_LocationTree.Col_Level.Value.ToString();
			}
			else {
		...
		private void cmdAdd_Click(object sender, System.EventArgs e) {
			...
			if (ReturnURL.Visible) {
				...
				Response.Redirect(String.Format("WebForm_LocationTree.aspx?Action=Add&ReturnToUrl={0}&ReturnToDisplay={1}", ReturnURL.NavigateUrl, ReturnURL.Text));
			}
			else {

				Response.Redirect("WebForm_LocationTree.aspx?Action=Add");
			}
		}
		...
		private void cmdUpdate_Click(object sender, System.EventArgs e) {
			...
			if (Action == ActionEnum.Edit) {
				...
				Params.spU_LocationTree Param = null;
				SPs.spU_LocationTree SP = null;

				Param = new Params.spU_LocationTree();
				...
				if (txt_LocationId.Text.Trim() != String.Empty) {

					Param.Param_LocationId = new System.Data.SqlTypes.SqlGuid(new System.Guid(txt_LocationId.Text));
				}

				if (txt_ParentLocationId.Text.Trim() != String.Empty) {

					Param.Param_ParentLocationId = new System.Data.SqlTypes.SqlGuid(new System.Guid(txt_ParentLocationId.Text));
				}
				...
				SP = new SPs.spU_LocationTree();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_LocationTree.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", CurrentID.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_LocationTree.aspx?Action=Edit&ID={0}", CurrentID.ToString()));
					}
					return;
				}
				else {
				...
				Params.spI_LocationTree Param = null;
				SPs.spI_LocationTree SP = null;

				Param = new Params.spI_LocationTree();
				...
				SP = new SPs.spI_LocationTree();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_LocationTree.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", Param.Param_Id.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_LocationTree.aspx?Action=Edit&ID={0}", Param.Param_Id.ToString()));
					}
					return;
				}
				else {
		...
		private void cmdDelete_Click(object sender, System.EventArgs e) {
			...
			Params.spD_LocationTree Param = null;
			SPs.spD_LocationTree SP = null;

			Param = new Params.spD_LocationTree();

			Param.SetUpConnection(ConnectionString);

			Param.Param_Id = CurrentID;

			SP = new SPs.spD_LocationTree();
		...
		private bool CheckValues() {
			...
			try {
				...
				System.Data.SqlTypes.SqlGuid value = new System.Data.SqlTypes.SqlGuid(new System.Guid(txt_LocationId.Text));
			}

			catch {

				labError_LocationId.Text = "INVALID";
				labError_LocationId.Visible = true;
				status = false;
			}

			try {

				System.Data.SqlTypes.SqlGuid value = new System.Data.SqlTypes.SqlGuid(new System.Guid(txt_ParentLocationId.Text));
			}

			catch {

				labError_ParentLocationId.Text = "INVALID";
				labError_ParentLocationId.Visible = true;
				status = false;
			}
