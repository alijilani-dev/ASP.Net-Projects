...
namespace Evernet.MoneyExchange.Web.Forms {
	...
	/// <summary>
	/// Summary description for WebForm_UserAuditList.
	/// </summary>
	public class WebForm_UserAuditList : System.Web.UI.Page {
		...
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label lab_MainModule;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.TextBox txt_MainModule;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label labError_MainModule;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label lab_SubModule;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.TextBox txt_SubModule;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label labError_SubModule;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label labError_Action;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label lab_AdditionalMessage;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.TextBox txt_AdditionalMessage;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label labError_AdditionalMessage;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		private void RefreshRecord() {
			...
			Evernet.MoneyExchange.AbstractClasses.Abstract_UserAuditList oAbstract_UserAuditList = new Evernet.MoneyExchange.AbstractClasses.Abstract_UserAuditList(ConnectionString);

			if (!oAbstract_UserAuditList.Refresh(CurrentID)) {
			...
			if (!oAbstract_UserAuditList.Col_Id.IsNull) {

				txt_Id.Text = oAbstract_UserAuditList.Col_Id.Value.ToString();
			}
			else {
			...
			com_UserId.Items.FindByValue(Convert.ToString(oAbstract_UserAuditList.Col_UserId)).Selected = true;

			if (!oAbstract_UserAuditList.Col_Date.IsNull) {

				txt_Date.Text = oAbstract_UserAuditList.Col_Date.Value.ToString();
			}
			else {
			...
			if (!oAbstract_UserAuditList.Col_MainModule.IsNull) {

				txt_MainModule.Text = oAbstract_UserAuditList.Col_MainModule.Value.ToString();
			}
			else {

				txt_MainModule.Text = String.Empty;
			}

			if (!oAbstract_UserAuditList.Col_SubModule.IsNull) {

				txt_SubModule.Text = oAbstract_UserAuditList.Col_SubModule.Value.ToString();
			}
			else {

				txt_SubModule.Text = String.Empty;
			}

			if (!oAbstract_UserAuditList.Col_Action.IsNull) {

				txt_Action.Text = oAbstract_UserAuditList.Col_Action.Value.ToString();
			}
			else {
			...
			if (!oAbstract_UserAuditList.Col_AdditionalMessage.IsNull) {

				txt_AdditionalMessage.Text = oAbstract_UserAuditList.Col_AdditionalMessage.Value.ToString();
			}
			else {

				txt_AdditionalMessage.Text = String.Empty;
			}
		...
		private void cmdAdd_Click(object sender, System.EventArgs e) {
			...
			if (ReturnURL.Visible) {
				...
				Response.Redirect(String.Format("WebForm_UserAuditList.aspx?Action=Add&ReturnToUrl={0}&ReturnToDisplay={1}", ReturnURL.NavigateUrl, ReturnURL.Text));
			}
			else {

				Response.Redirect("WebForm_UserAuditList.aspx?Action=Add");
			}
		}
		...
		private void cmdUpdate_Click(object sender, System.EventArgs e) {
			...
			if (Action == ActionEnum.Edit) {
				...
				Params.spU_UserAuditList Param = null;
				SPs.spU_UserAuditList SP = null;

				Param = new Params.spU_UserAuditList();
				...
				if (txt_MainModule.Text.Trim() != String.Empty) {

					Param.Param_MainModule = new System.Data.SqlTypes.SqlString(txt_MainModule.Text);
				}

				if (txt_SubModule.Text.Trim() != String.Empty) {

					Param.Param_SubModule = new System.Data.SqlTypes.SqlString(txt_SubModule.Text);
				}

				if (txt_Action.Text.Trim() != String.Empty) {

					Param.Param_Action = new System.Data.SqlTypes.SqlString(txt_Action.Text);
				}

				if (txt_AdditionalMessage.Text.Trim() != String.Empty) {

					Param.Param_AdditionalMessage = new System.Data.SqlTypes.SqlString(txt_AdditionalMessage.Text);
				}

				SP = new SPs.spU_UserAuditList();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_UserAuditList.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", CurrentID.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_UserAuditList.aspx?Action=Edit&ID={0}", CurrentID.ToString()));
					}
					return;
				}
				else {
				...
				Params.spI_UserAuditList Param = null;
				SPs.spI_UserAuditList SP = null;

				Param = new Params.spI_UserAuditList();
				...
				SP = new SPs.spI_UserAuditList();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_UserAuditList.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", Param.Param_Id.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_UserAuditList.aspx?Action=Edit&ID={0}", Param.Param_Id.ToString()));
					}
					return;
				}
				else {
		...
		private void cmdDelete_Click(object sender, System.EventArgs e) {
			...
			Params.spD_UserAuditList Param = null;
			SPs.spD_UserAuditList SP = null;

			Param = new Params.spD_UserAuditList();

			Param.SetUpConnection(ConnectionString);

			Param.Param_Id = CurrentID;

			SP = new SPs.spD_UserAuditList();
