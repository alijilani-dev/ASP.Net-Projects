        ...
        <tr>
          <td valign="top" bgcolor="#CFCFCF"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center"><font size="4" face="Arial, Helvetica, sans-serif"><!-- InstanceBeginEditable name="Heading" --> &nbsp;Customer Card Management <!-- InstanceEndEditable --></font></td>
                  </tr>
              </table></td>
            </tr>
            <tr>
                  ...
                  <td align="center" valign="top"><!-- InstanceBeginEditable name="MainContent" --> 
                    <table rules="all" style="border-collapse:collapse;" cellSpacing="0" cellPadding="5" border="1">
                      <tr class="TableFilter" align="middle">
                        ...
                        <td><DropDownLists:WebDropDownList_CustomerCardStatusList id="com_Status" runat="server" AutoPostBack="True" CssClass="Filter"> </DropDownLists:WebDropDownList_CustomerCardStatusList> </td>
                      </tr>
                      <tr class="TableHeader" align="middle">
                        <td><asp:HyperLink Visible="false" id="Add" runat="server" CssClass="EditHyperLink" EnableViewState="false" NavigateUrl="WebForm_CustomerCardList.aspx?Action=Add&ReturnToUrl=WebFormList_CustomerCardList.aspx&ReturnToDisplay=Back to the list"> Add </asp:HyperLink>
                        </td>
                        <td><asp:linkbutton id="Label_Code" runat="server" CssClass="TableHeader" EnableViewState="false"> Code </asp:linkbutton>
                        </td>
                        <td><asp:linkbutton id="Label_AgentId" runat="server" CssClass="TableHeader" EnableViewState="false"> AgentId </asp:linkbutton>
                        </td>
                        <td><asp:linkbutton id="Label_Status" runat="server" CssClass="TableHeader" EnableViewState="false"> Status </asp:linkbutton>
                        </td>
                      </tr>
                      ...
                      <ItemTemplate>
                        <tr class="TableRow" align="center">
                          <td><asp:HyperLink id="Edit" runat="server" CssClass="EditHyperLink" EnableViewState="false" NavigateUrl='<%# String.Format("WebForm_CustomerCardList.aspx?Action=Edit&ID={0}&ReturnToUrl=WebFormList_CustomerCardList.aspx&ReturnToDisplay=Back to the list", DataBinder.Eval(Container.DataItem, "Id") ) %>'> Edit </asp:HyperLink>
                              <br>
                              <asp:HyperLink Visible="false" id="Delete" runat="server" CssClass="EditHyperLink" EnableViewState="false" NavigateUrl='<%# String.Format("WebForm_CustomerCardList.aspx?Action=Delete&ID={0}&ReturnToUrl=WebFormList_CustomerCardList.aspx&ReturnToDisplay=Back to the list", DataBinder.Eval(Container.DataItem, "Id") ) %>'> Delete </asp:HyperLink>
                          </td>
                          <td><%# DataBinder.Eval(Container.DataItem, "Code") %> </td>
                          <td><%# DataBinder.Eval(Container.DataItem, "AgentId_Display") %> </td>
                          <td><%# DataBinder.Eval(Container.DataItem, "Status_Display") %> </td>
                        </tr>
                      </ItemTemplate>
