...
<%@ Page language="c#" Codebehind="WebFormList_AgencyCommissionIncomeAccountDetails.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebFormList_AgencyCommissionIncomeAccountDetails" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>AgencyCommissionIncomeAccountDetails table content management</title>
	...
	<body>
		<form id="WebFormList_AgencyCommissionIncomeAccountDetails" method="post" runat="server">
			<table rules="all" style="border-collapse:collapse;" cellSpacing="0" cellPadding="5" border="1">
				...
				<tr class="TableHeader" align="middle">
					<td>
						<asp:HyperLink id="Add" runat="server" CssClass="EditHyperLink" EnableViewState="false" NavigateUrl="WebForm_AgencyCommissionIncomeAccountDetails.aspx?Action=Add&ReturnToUrl=WebFormList_AgencyCommissionIncomeAccountDetails.aspx&ReturnToDisplay=Back to the list">
							Add
						</asp:HyperLink>
					</td>
					<td>
				...
				<Repeaters:WebRepeaterCustom_spS_AgencyCommissionIncomeAccountDetails_SelectDisplay id="repeater_AgencyCommissionIncomeAccountDetails_SelectDisplay" runat="server">
					<ItemTemplate>
						<tr class="TableRow" align="center">
							<td>
								<asp:HyperLink id="Edit" runat="server" CssClass="EditHyperLink" EnableViewState="false" NavigateUrl='<%# String.Format("WebForm_AgencyCommissionIncomeAccountDetails.aspx?Action=Edit&ID={0}&ReturnToUrl=WebFormList_AgencyCommissionIncomeAccountDetails.aspx&ReturnToDisplay=Back to the list", DataBinder.Eval(Container.DataItem, "Id") ) %>'>
									Edit
								</asp:HyperLink>
								<br>
								<asp:HyperLink id="Delete" runat="server" CssClass="EditHyperLink" EnableViewState="false" NavigateUrl='<%# String.Format("WebForm_AgencyCommissionIncomeAccountDetails.aspx?Action=Delete&ID={0}&ReturnToUrl=WebFormList_AgencyCommissionIncomeAccountDetails.aspx&ReturnToDisplay=Back to the list", DataBinder.Eval(Container.DataItem, "Id") ) %>'>
									Delete
								</asp:HyperLink>
							</td>
							<td>
				...
				</Repeaters:WebRepeaterCustom_spS_AgencyCommissionIncomeAccountDetails_SelectDisplay>
			</table>
		</form>
	</body>
</HTML>
