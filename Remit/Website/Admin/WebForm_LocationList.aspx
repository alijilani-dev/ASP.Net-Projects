<%@ Page language="c#" Codebehind="WebForm_LocationList.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_LocationList" %>
                    ...
                    <asp:panel id="MainDisplay" runat="server">
                      <table border="0" cellspacing="10" cellpadding="5">
                        ...
                        <tr>
                          ...
                          <td><DropDownLists:WebDropDownList_CountryList id="com_CountryId" runat="server" CssClass="MandatoryComboBoxStyle" tabIndex="2"> </DropDownLists:WebDropDownList_CountryList> </td>
                        </tr>
                        <tr> </tr>
                        <tr>
                          <td></td>
