<%@ Page language="c#" Codebehind="WebForm_AgentExchangeRateList.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_AgentExchangeRateList" %>
        ...
        <tr>
          <td valign="top" bgcolor="#CFCFCF"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center"><font size="4" face="Arial, Helvetica, sans-serif"><!-- InstanceBeginEditable name="Heading" --> &nbsp;Agent Exchange Margin Management <!-- InstanceEndEditable --></font></td>
                  </tr>
              </table></td>
            </tr>
            <tr>
                  ...
                  <td align="center" valign="top"><!-- InstanceBeginEditable name="MainContent" --> 
                    ...
                    <asp:panel id="MainDisplay" runat="server">
                      <table border="0" cellspacing="10" cellpadding="5">
                        ...
                        <tr>
                          <td align="Right" class="MandatoryLabelStyle"> AgencyExchangeRate </td>
                          <td><DropDownLists:WebDropDownList_AgencyExchangeRateList id="com_AgencyExchangeRateId" runat="server" CssClass="MandatoryComboBoxStyle" tabIndex="2"> </DropDownLists:WebDropDownList_AgencyExchangeRateList> </td>
                        </tr>
                        <tr>
                          <td align="Right" class="MandatoryLabelStyle"> MarginPercent </td>
                          <td><asp:TextBox id="txt_MarginPercent" runat="server" CssClass="MandatoryTextBoxStyle" tabIndex="3" ></asp:TextBox>
                          </td>
                          <td><asp:Label EnableViewState="False" Visible="False" runat="Server" id="labError_MarginPercent" CssClass="ErrorStyle"></asp:Label>
                          </td>
                        </tr>
                        <tr> </tr>
                        <tr>
