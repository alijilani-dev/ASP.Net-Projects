<%@ Page language="c#" Codebehind="WebForm_PurposeOfTransferList.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_PurposeOfTransferList" %>
                ...
                <tr>
                  ...
                  <asp:panel id="MainDisplay" runat="server">
                    <table border="0" cellspacing="10" cellpadding="5">
                      ...
                      <tr>
                        <td align="Right" class="MandatoryLabelStyle"> Value </td>
                        <td><asp:TextBox id="txt_Value" runat="server" CssClass="MandatoryTextBoxStyle" tabIndex="2" ></asp:TextBox>
                        </td>
                        <td><asp:Label EnableViewState="False" Visible="False" runat="Server" id="labError_Value" CssClass="ErrorStyle"></asp:Label>
                        </td>
                      </tr>
                      <tr>
                        <td align="Right" class="MandatoryLabelStyle"> PaymentModeBaseType </td>
                        <td><DropDownLists:WebDropDownList_PaymentModeBaseTypeList id="com_PaymentModeBaseType" runat="server" CssClass="MandatoryComboBoxStyle" tabIndex="3"> </DropDownLists:WebDropDownList_PaymentModeBaseTypeList> </td>
                      </tr>
                      <tr> </tr>
                      <tr>
                        <td></td>
