...
namespace Evernet.MoneyExchange.Web.Forms {
	...
	/// <summary>
	/// Summary description for WebForm_AgencyCommissionIncomeAccountDetails.
	/// </summary>
	public class WebForm_AgencyCommissionIncomeAccountDetails : System.Web.UI.Page {
		...
		/// [To be supplied.]
		/// </summary>
		public WebForm_AgencyCommissionIncomeAccountDetails() {
		...
		private void RefreshRecord() {
			...
			Evernet.MoneyExchange.AbstractClasses.Abstract_AgencyCommissionIncomeAccountDetails oAbstract_AgencyCommissionIncomeAccountDetails = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgencyCommissionIncomeAccountDetails(ConnectionString);

			if (!oAbstract_AgencyCommissionIncomeAccountDetails.Refresh(CurrentID)) {
			...
			if (!oAbstract_AgencyCommissionIncomeAccountDetails.Col_Id.IsNull) {

				txt_Id.Text = oAbstract_AgencyCommissionIncomeAccountDetails.Col_Id.Value.ToString();
			}
			else {
			...
			if (!oAbstract_AgencyCommissionIncomeAccountDetails.Col_Date.IsNull) {

				txt_Date.Text = oAbstract_AgencyCommissionIncomeAccountDetails.Col_Date.Value.ToString();
			}
			else {
			...
			com_TransactionId.Items.FindByValue(Convert.ToString(oAbstract_AgencyCommissionIncomeAccountDetails.Col_TransactionId)).Selected = true;

			if (!oAbstract_AgencyCommissionIncomeAccountDetails.Col_CreditLC.IsNull) {

				txt_CreditLC.Text = oAbstract_AgencyCommissionIncomeAccountDetails.Col_CreditLC.Value.ToString();
			}
			else {
			...
			if (!oAbstract_AgencyCommissionIncomeAccountDetails.Col_CreditUSD.IsNull) {

				txt_CreditUSD.Text = oAbstract_AgencyCommissionIncomeAccountDetails.Col_CreditUSD.Value.ToString();
			}
			else {
			...
			if (!oAbstract_AgencyCommissionIncomeAccountDetails.Col_DebitLC.IsNull) {

				txt_DebitLC.Text = oAbstract_AgencyCommissionIncomeAccountDetails.Col_DebitLC.Value.ToString();
			}
			else {
			...
			if (!oAbstract_AgencyCommissionIncomeAccountDetails.Col_DebitUSD.IsNull) {

				txt_DebitUSD.Text = oAbstract_AgencyCommissionIncomeAccountDetails.Col_DebitUSD.Value.ToString();
			}
			else {
		...
		private void cmdAdd_Click(object sender, System.EventArgs e) {
			...
			if (ReturnURL.Visible) {
				...
				Response.Redirect(String.Format("WebForm_AgencyCommissionIncomeAccountDetails.aspx?Action=Add&ReturnToUrl={0}&ReturnToDisplay={1}", ReturnURL.NavigateUrl, ReturnURL.Text));
			}
			else {

				Response.Redirect("WebForm_AgencyCommissionIncomeAccountDetails.aspx?Action=Add");
			}
		}
		...
		private void cmdUpdate_Click(object sender, System.EventArgs e) {
			...
			if (Action == ActionEnum.Edit) {
				...
				Params.spU_AgencyCommissionIncomeAccountDetails Param = null;
				SPs.spU_AgencyCommissionIncomeAccountDetails SP = null;

				Param = new Params.spU_AgencyCommissionIncomeAccountDetails();
				...
				SP = new SPs.spU_AgencyCommissionIncomeAccountDetails();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_AgencyCommissionIncomeAccountDetails.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", CurrentID.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_AgencyCommissionIncomeAccountDetails.aspx?Action=Edit&ID={0}", CurrentID.ToString()));
					}
					return;
				}
				else {
				...
				Params.spI_AgencyCommissionIncomeAccountDetails Param = null;
				SPs.spI_AgencyCommissionIncomeAccountDetails SP = null;

				Param = new Params.spI_AgencyCommissionIncomeAccountDetails();
				...
				SP = new SPs.spI_AgencyCommissionIncomeAccountDetails();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_AgencyCommissionIncomeAccountDetails.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", Param.Param_Id.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_AgencyCommissionIncomeAccountDetails.aspx?Action=Edit&ID={0}", Param.Param_Id.ToString()));
					}
					return;
				}
				else {
		...
		private void cmdDelete_Click(object sender, System.EventArgs e) {
			...
			Params.spD_AgencyCommissionIncomeAccountDetails Param = null;
			SPs.spD_AgencyCommissionIncomeAccountDetails SP = null;

			Param = new Params.spD_AgencyCommissionIncomeAccountDetails();

			Param.SetUpConnection(ConnectionString);

			Param.Param_Id = CurrentID;

			SP = new SPs.spD_AgencyCommissionIncomeAccountDetails();
