<%@ Page language="c#" Codebehind="WebForm_CommissionCurrencyType.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_CommissionCurrencyType" %>
...
<html>
	...
	<body class="FormStyle">
		...
		<asp:panel id="MainDisplay" runat="server">
			<form id="WebForm_CommissionCurrencyType" method="post" runat="server">
