<%@ Page language="c#" Codebehind="WebForm_TransactionSettlementStatusList.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_TransactionSettlementStatusList" %>
...
<html>
	...
	<body class="FormStyle">
		...
		<asp:panel id="MainDisplay" runat="server">
			<form id="WebForm_TransactionSettlementStatusList" method="post" runat="server">
