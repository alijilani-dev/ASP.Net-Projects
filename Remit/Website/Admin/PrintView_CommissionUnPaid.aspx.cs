...
{
	/// <summary>
	/// Summary description for PrintView_CommissionUnPaid.
	/// </summary>
	public class PrintView_CommissionUnPaid : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(Request["CurrencyId"]==null
				...
				Response.Redirect("ViewReport_CommissionUnPaid.aspx");
				return;
			}
			BindAccountDetails();
		}
		...
		private void BindAccountDetails() {
			...
			if(true) {
				...
				query = "Select * From fn_getUnPaidCommissionAccountDetailsForCurrency('"+ Request["CurrencyId"] +"') Where FinalDate < '"+ startDate.AddDays(1).ToString() +"'";
				...
				query = "Select * From fn_getUnPaidCommissionAccountDetailsForCurrency('"+ Request["CurrencyId"] +"') Where FinalDate Between '"+ startDate.ToString() +"' And '"+ endDate.ToString() +"'";
