...
{
	/// <summary>
	/// Summary description for WebFormList_CountryAvailablePaymentModeList.
	/// </summary>
	public class WebFormList_CountryAvailablePaymentModeList: System.Web.UI.Page
	{
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		public WebFormList_CountryAvailablePaymentModeList() {
		...
		/// [To be supplied.]
		/// </summary>
		protected Evernet.MoneyExchange.Web.Repeaters.WebRepeaterCustom_spS_CountryAvailablePaymentModeList_SelectDisplay repeater_CountryAvailablePaymentModeList_SelectDisplay;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		private void Page_Load(object sender, System.EventArgs e) {
			...
			if (!Page.IsPostBack) {
				...
				if (ViewState["WebFormList_CountryAvailablePaymentModeList_CurrentSort"] == null) {

					ViewState.Add("WebFormList_CountryAvailablePaymentModeList_CurrentSort", sortColumn);
				}
				else {

					ViewState["WebFormList_CountryAvailablePaymentModeList_CurrentSort"] = sortColumn;
				}
			...
			repeater_CountryAvailablePaymentModeList_SelectDisplay.EnableViewState = true;
		...
		private void RefreshList() {
			...
			repeater_CountryAvailablePaymentModeList_SelectDisplay.Initialize(ConnectionString, System.Data.SqlTypes.SqlGuid.Null, CountryId, PaymentMode);
			try {

				repeater_CountryAvailablePaymentModeList_SelectDisplay.RefreshData();
			}
			catch (Evernet.MoneyExchange.DataClasses.CustomException customException) {

				if (customException.Parameter.SqlException != null) {

					throw new Exception(String.Format("An exception has been thrown in the underlying DataClass that is used by the 'WebRepeater_CountryAvailablePaymentModeList' class. Exception message is: {0}", customException.Parameter.SqlException.Message), customException);
				}
				else if (customException.Parameter.OtherException != null) {

					throw new Exception(String.Format("An exception has been thrown in the underlying DataClass that is used by the 'WebRepeater_CountryAvailablePaymentModeList' class. Exception message is: {0}", customException.Parameter.OtherException.Message), customException);
				}
				else {
			...
			System.Data.DataView dataView = (System.Data.DataView)repeater_CountryAvailablePaymentModeList_SelectDisplay.DataSource;

			string SortDirective = String.Empty;
			switch ((CurrentSortEnum)ViewState["WebFormList_CountryAvailablePaymentModeList_CurrentSort"]) {

				case CurrentSortEnum.SortBy_CountryId:
					SortDirective = spS_CountryAvailablePaymentModeList_SelectDisplay.Resultset1.Fields.Column_CountryId_Display.ColumnName;
					break;

				case CurrentSortEnum.SortBy_PaymentMode:
					SortDirective = spS_CountryAvailablePaymentModeList_SelectDisplay.Resultset1.Fields.Column_PaymentMode_Display.ColumnName;
					break;
			...
			repeater_CountryAvailablePaymentModeList_SelectDisplay.DataBind();
		}

		private void Label_CountryId_Click(object sender, System.EventArgs e) {

			if ((CurrentSortEnum)ViewState["WebFormList_CountryAvailablePaymentModeList_CurrentSort"] == CurrentSortEnum.SortBy_CountryId) {
				...
				ViewState["WebFormList_CountryAvailablePaymentModeList_CurrentSort"] = CurrentSortEnum.SortBy_CountryId;
			}
		...
		private void Label_PaymentMode_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_CountryAvailablePaymentModeList_CurrentSort"] == CurrentSortEnum.SortBy_PaymentMode) {
				...
				ViewState["WebFormList_CountryAvailablePaymentModeList_CurrentSort"] = CurrentSortEnum.SortBy_PaymentMode;
			}
