<%@ Page language="c#" Codebehind="WebForm_TransactionStatusList.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_TransactionStatusList" %>
...
<html>
	...
	<body class="FormStyle">
		...
		<asp:panel id="MainDisplay" runat="server">
			<form id="WebForm_TransactionStatusList" method="post" runat="server">
