<%@ Page language="c#" Codebehind="WebForm_AgentGroupList.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_AgentGroupList" %>
...
<title>ARY Speed Remit :: Agent Group List Management</title>
<!-- InstanceEndEditable -->
        ...
        <tr>
          <td valign="top" bgcolor="#CFCFCF"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center"><font size="4" face="Arial, Helvetica, sans-serif"><!-- InstanceBeginEditable name="Heading" --> &nbsp;Agent Group List<!-- InstanceEndEditable --></font></td>
                  </tr>
              </table></td>
            </tr>
            <tr>
              <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center" valign="top"><!-- InstanceBeginEditable name="MainContent" -->		          <asp:panel id="ErrorDisplay" runat="server" visible="false">
                  ...
                  <asp:panel id="MainDisplay" runat="server">
                    <table border="0" cellspacing="10" cellpadding="5">
                      <tr>
                        <td align="Right" class="MandatoryLabelStyle"> AgentAccount </td>
                        <td><DropDownLists:WebDropDownList_AgentMaster id="com_AgentAccountId" runat="server" CssClass="MandatoryComboBoxStyle" tabIndex="1"> </DropDownLists:WebDropDownList_AgentMaster> </td>
                      </tr>
                      <tr>
                        <td align="Right" class="MandatoryLabelStyle"> Name </td>
                        <td><asp:TextBox id="txt_Name" runat="server" CssClass="MandatoryTextBoxStyle" tabIndex="2" ></asp:TextBox>
                        </td>
                        <td><asp:Label EnableViewState="False" Visible="False" runat="Server" id="labError_Name" CssClass="ErrorStyle"></asp:Label>
                        </td>
                      </tr>
                      <tr>
                        <td align="Right" class="MandatoryLabelStyle"> PrefixCode </td>
                        <td><asp:TextBox id="txt_PrefixCode" runat="server" CssClass="MandatoryTextBoxStyle" tabIndex="3" ></asp:TextBox>
                        </td>
                        <td><asp:Label EnableViewState="False" Visible="False" runat="Server" id="labError_PrefixCode" CssClass="ErrorStyle"></asp:Label>
                        </td>
                      </tr>
                      <tr> </tr>
                      <tr>
