...
namespace Evernet.MoneyExchange.Web.Forms {
	...
	/// <summary>
	/// Summary description for WebForm_AgentCommissionIncomeAccount.
	/// </summary>
	public class WebForm_AgentCommissionIncomeAccount : System.Web.UI.Page {
		...
		/// [To be supplied.]
		/// </summary>
		public WebForm_AgentCommissionIncomeAccount() {
		...
		private void RefreshRecord() {
			...
			Evernet.MoneyExchange.AbstractClasses.Abstract_AgentCommissionIncomeAccount oAbstract_AgentCommissionIncomeAccount = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgentCommissionIncomeAccount(ConnectionString);

			if (!oAbstract_AgentCommissionIncomeAccount.Refresh(CurrentID)) {
			...
			if (!oAbstract_AgentCommissionIncomeAccount.Col_Id.IsNull) {

				txt_Id.Text = oAbstract_AgentCommissionIncomeAccount.Col_Id.Value.ToString();
			}
			else {
			...
			if (!oAbstract_AgentCommissionIncomeAccount.Col_CreditDateTime.IsNull) {

				txt_CreditDateTime.Text = oAbstract_AgentCommissionIncomeAccount.Col_CreditDateTime.Value.ToString();
			}
			else {
			...
			if (!oAbstract_AgentCommissionIncomeAccount.Col_DebitDateTime.IsNull) {

				txt_DebitDateTime.Text = oAbstract_AgentCommissionIncomeAccount.Col_DebitDateTime.Value.ToString();
			}
			else {
			...
			com_AgentAccountId.Items.FindByValue(Convert.ToString(oAbstract_AgentCommissionIncomeAccount.Col_AgentAccountId)).Selected = true;

			com_TransactionId.Items.FindByValue(Convert.ToString(oAbstract_AgentCommissionIncomeAccount.Col_TransactionId)).Selected = true;

			if (!oAbstract_AgentCommissionIncomeAccount.Col_CommissionCreditLC.IsNull) {

				txt_CommissionCreditLC.Text = oAbstract_AgentCommissionIncomeAccount.Col_CommissionCreditLC.Value.ToString();
			}
			else {
			...
			if (!oAbstract_AgentCommissionIncomeAccount.Col_CommissionCreditUSD.IsNull) {

				txt_CommissionCreditUSD.Text = oAbstract_AgentCommissionIncomeAccount.Col_CommissionCreditUSD.Value.ToString();
			}
			else {
			...
			if (!oAbstract_AgentCommissionIncomeAccount.Col_CommissionDebitLC.IsNull) {

				txt_CommissionDebitLC.Text = oAbstract_AgentCommissionIncomeAccount.Col_CommissionDebitLC.Value.ToString();
			}
			else {
			...
			if (!oAbstract_AgentCommissionIncomeAccount.Col_CommissionDebitUSD.IsNull) {

				txt_CommissionDebitUSD.Text = oAbstract_AgentCommissionIncomeAccount.Col_CommissionDebitUSD.Value.ToString();
			}
			else {
		...
		private void cmdAdd_Click(object sender, System.EventArgs e) {
			...
			if (ReturnURL.Visible) {
				...
				Response.Redirect(String.Format("WebForm_AgentCommissionIncomeAccount.aspx?Action=Add&ReturnToUrl={0}&ReturnToDisplay={1}", ReturnURL.NavigateUrl, ReturnURL.Text));
			}
			else {

				Response.Redirect("WebForm_AgentCommissionIncomeAccount.aspx?Action=Add");
			}
		}
		...
		private void cmdUpdate_Click(object sender, System.EventArgs e) {
			...
			if (Action == ActionEnum.Edit) {
				...
				Params.spU_AgentCommissionIncomeAccount Param = null;
				SPs.spU_AgentCommissionIncomeAccount SP = null;

				Param = new Params.spU_AgentCommissionIncomeAccount();
				...
				SP = new SPs.spU_AgentCommissionIncomeAccount();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_AgentCommissionIncomeAccount.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", CurrentID.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_AgentCommissionIncomeAccount.aspx?Action=Edit&ID={0}", CurrentID.ToString()));
					}
					return;
				}
				else {
				...
				Params.spI_AgentCommissionIncomeAccount Param = null;
				SPs.spI_AgentCommissionIncomeAccount SP = null;

				Param = new Params.spI_AgentCommissionIncomeAccount();
				...
				SP = new SPs.spI_AgentCommissionIncomeAccount();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_AgentCommissionIncomeAccount.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", Param.Param_Id.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_AgentCommissionIncomeAccount.aspx?Action=Edit&ID={0}", Param.Param_Id.ToString()));
					}
					return;
				}
				else {
		...
		private void cmdDelete_Click(object sender, System.EventArgs e) {
			...
			Params.spD_AgentCommissionIncomeAccount Param = null;
			SPs.spD_AgentCommissionIncomeAccount SP = null;

			Param = new Params.spD_AgentCommissionIncomeAccount();

			Param.SetUpConnection(ConnectionString);

			Param.Param_Id = CurrentID;

			SP = new SPs.spD_AgentCommissionIncomeAccount();
