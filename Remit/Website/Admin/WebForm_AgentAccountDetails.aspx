<%@ Page language="c#" Codebehind="WebForm_AgentAccountDetails.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_AgentAccountDetails" %>
...
<html>
	...
	<body class="FormStyle">
		...
		<asp:panel id="MainDisplay" runat="server">
			<form id="WebForm_AgentAccountDetails" method="post" runat="server">
