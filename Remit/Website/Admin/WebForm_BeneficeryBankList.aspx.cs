...
namespace Evernet.MoneyExchange.Web.Forms {
	...
	/// <summary>
	/// Summary description for WebForm_BeneficeryBankList.
	/// </summary>
	public class WebForm_BeneficeryBankList : System.Web.UI.Page {
		...
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label lab_AccountNumber;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.TextBox txt_AccountNumber;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label labError_AccountNumber;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		/// [To be supplied.]
		/// </summary>
		public WebForm_BeneficeryBankList() {
		...
		private void RefreshRecord() {
			...
			Evernet.MoneyExchange.AbstractClasses.Abstract_BeneficeryBankList oAbstract_BeneficeryBankList = new Evernet.MoneyExchange.AbstractClasses.Abstract_BeneficeryBankList(ConnectionString);

			if (!oAbstract_BeneficeryBankList.Refresh(CurrentID)) {
			...
			com_CustomerId.Items.FindByValue(Convert.ToString(oAbstract_BeneficeryBankList.Col_CustomerId)).Selected = true;

			if (!oAbstract_BeneficeryBankList.Col_AccountNumber.IsNull) {

				txt_AccountNumber.Text = oAbstract_BeneficeryBankList.Col_AccountNumber.Value.ToString();
			}
			else {
			...
			if (!oAbstract_BeneficeryBankList.Col_Name.IsNull) {

				txt_Name.Text = oAbstract_BeneficeryBankList.Col_Name.Value.ToString();
			}
			else {
			...
			if (!oAbstract_BeneficeryBankList.Col_BranchName.IsNull) {

				txt_BranchName.Text = oAbstract_BeneficeryBankList.Col_BranchName.Value.ToString();
			}
			else {
			...
			if (!oAbstract_BeneficeryBankList.Col_Address.IsNull) {

				txt_Address.Text = oAbstract_BeneficeryBankList.Col_Address.Value.ToString();
			}
			else {
			...
			if (!oAbstract_BeneficeryBankList.Col_ZipCode.IsNull) {

				txt_ZipCode.Text = oAbstract_BeneficeryBankList.Col_ZipCode.Value.ToString();
			}
			else {
			...
			com_CountryId.Items.FindByValue(Convert.ToString(oAbstract_BeneficeryBankList.Col_CountryId)).Selected = true;
		...
		private void cmdAdd_Click(object sender, System.EventArgs e) {
			...
			if (ReturnURL.Visible) {
				...
				Response.Redirect(String.Format("WebForm_BeneficeryBankList.aspx?Action=Add&ReturnToUrl={0}&ReturnToDisplay={1}", ReturnURL.NavigateUrl, ReturnURL.Text));
			}
			else {

				Response.Redirect("WebForm_BeneficeryBankList.aspx?Action=Add");
			}
		}
		...
		private void cmdUpdate_Click(object sender, System.EventArgs e) {
			...
			if (Action == ActionEnum.Edit) {
				...
				Params.spU_BeneficeryBankList Param = null;
				SPs.spU_BeneficeryBankList SP = null;

				Param = new Params.spU_BeneficeryBankList();
				...
				if (txt_AccountNumber.Text.Trim() != String.Empty) {

					Param.Param_AccountNumber = new System.Data.SqlTypes.SqlString(txt_AccountNumber.Text);
				}
				...
				SP = new SPs.spU_BeneficeryBankList();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_BeneficeryBankList.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", CurrentID.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_BeneficeryBankList.aspx?Action=Edit&ID={0}", CurrentID.ToString()));
					}
					return;
				}
				else {
				...
				Params.spI_BeneficeryBankList Param = null;
				SPs.spI_BeneficeryBankList SP = null;

				Param = new Params.spI_BeneficeryBankList();
				...
				SP = new SPs.spI_BeneficeryBankList();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_BeneficeryBankList.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", Param.Param_Id.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_BeneficeryBankList.aspx?Action=Edit&ID={0}", Param.Param_Id.ToString()));
					}
					return;
				}
				else {
		...
		private void cmdDelete_Click(object sender, System.EventArgs e) {
			...
			Params.spD_BeneficeryBankList Param = null;
			SPs.spD_BeneficeryBankList SP = null;

			Param = new Params.spD_BeneficeryBankList();

			Param.SetUpConnection(ConnectionString);

			Param.Param_Id = CurrentID;

			SP = new SPs.spD_BeneficeryBankList();
