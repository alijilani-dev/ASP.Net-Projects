...
<%@ Page language="c#" Codebehind="InitiateTransfer2.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Admin.InitiateTransfer2" %>
<HTML>
	<HEAD>
																...
																<TR>
																	<TD align="center">
																		<TABLE id="Table5" cellPadding="0" width="100%" border="0">
																			<TR>
																				<TD></TD>
																				<TD align="center"><asp:checkbox id="chbxCreateNewCustomer" runat="server" AutoPostBack="True" Text="Create new customer"
																		...
																		</asp:panel><asp:panel id="Panel1" runat="server" Visible="False">
																			<TABLE id="Table32" cellSpacing="1" cellPadding="1" width="80%" border="0">
																				<TR>
																					<TD align="center">Customer Card No:
																				...
																				<TR>
																					<TD align="center">
																						<asp:Button id="Button1" runat="server" Text="Update Customer Record From Database for the Given Card Number"
																							CausesValidation="False"></asp:Button></TD>
																				</TR>
																			</TABLE>
																		</asp:panel></TD>
																								...
																								<TR>
																									<TD>
																										<TABLE id="Table8" cellPadding="0" width="100%" border="0">
																											<TR>
																												<TD align="right" width="35%" height="13">Country :
																												</TD>
																												<TD height="13">
																...
																<tr>
																	<td align="center"><asp:panel id="pnlBottomPart" dir="ltr" runat="server" Visible="False">
																			<TABLE id="Table43" cellSpacing="0" cellPadding="0" width="100%" border="0">
																				...
																				<TR>
																					<TD align="center">
																						<asp:Button id="butInitiateTransfer" runat="server" Width="40%" Text="Initiate Transfer" Font-Size="Medium"
																							Height="30px" Font-Names="Verdana"></asp:Button></TD>
																				</TR>
																				<TR>
																					<TD align="center">
																						<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
