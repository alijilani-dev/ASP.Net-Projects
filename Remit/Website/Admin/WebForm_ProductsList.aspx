<%@ Page language="c#" Codebehind="WebForm_ProductsList.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_ProductsList" %>
...
<html>
	...
	<body class="FormStyle">
		...
		<asp:panel id="MainDisplay" runat="server">
			<form id="WebForm_ProductsList" method="post" runat="server">
				<table border="0" cellspacing="10" cellpadding="5">
					...
					<tr>
						...
						<td>
							<asp:TextBox id="txt_Name" runat="server" CssClass="MandatoryTextBoxStyle" tabIndex="2" ></asp:TextBox>
						</td>
						<td>
