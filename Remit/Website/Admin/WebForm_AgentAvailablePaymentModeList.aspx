<%@ Page language="c#" Codebehind="WebForm_AgentAvailablePaymentModeList.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_AgentAvailablePaymentModeList" %>
                ...
                <tr>
                  ...
                  <asp:panel id="MainDisplay" runat="server">
                    <table border="0" cellspacing="10" cellpadding="5">
                      <tr>
                        <td align="Right" class="MandatoryLabelStyle"> Agent </td>
                        <td><DropDownLists:WebDropDownList_AgentLocationList id="com_AgentId" runat="server" CssClass="MandatoryComboBoxStyle" tabIndex="1"> </DropDownLists:WebDropDownList_AgentLocationList> </td>
                      </tr>
                      <tr>
                        <td align="Right" class="MandatoryLabelStyle"> PaymentMode </td>
                        <td><DropDownLists:WebDropDownList_PaymentModeList id="com_PaymentMode" runat="server" CssClass="MandatoryComboBoxStyle" tabIndex="2"> </DropDownLists:WebDropDownList_PaymentModeList> </td>
                      </tr>
                      <tr> </tr>
                      <tr>
                        <td></td>
                        <td align="center"><table border="0" cellspacing="10" cellpadding="5">
                            <tr align="center">
                              <td><asp:Button id="cmdRefresh" runat="server" Text="Refresh" CssClass="ButtonStyle" tabIndex="3"></asp:Button>
                              </td>
                              <td><asp:Button id="cmdDelete" runat="server" Text="Delete" CssClass="ButtonStyle" tabIndex="4"></asp:Button>
                              </td>
                              <td><asp:Button id="cmdUpdate" runat="server" Text="Update" CssClass="ButtonStyle" tabIndex="5"></asp:Button>
                              </td>
                            </tr>
                        </table></td>
                      </tr>
