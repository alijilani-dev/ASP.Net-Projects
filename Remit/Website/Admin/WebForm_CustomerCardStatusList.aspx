<%@ Page language="c#" Codebehind="WebForm_CustomerCardStatusList.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_CustomerCardStatusList" %>
...
<html>
	...
	<body class="FormStyle">
		...
		<asp:panel id="MainDisplay" runat="server">
			<form id="WebForm_CustomerCardStatusList" method="post" runat="server">
