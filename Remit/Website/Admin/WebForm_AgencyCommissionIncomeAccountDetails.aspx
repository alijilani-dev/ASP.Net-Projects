<%@ Page language="c#" Codebehind="WebForm_AgencyCommissionIncomeAccountDetails.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_AgencyCommissionIncomeAccountDetails" %>
...
<html>
	...
	<body class="FormStyle">
		...
		<asp:panel id="MainDisplay" runat="server">
			<form id="WebForm_AgencyCommissionIncomeAccountDetails" method="post" runat="server">
				<table border="0" cellspacing="10" cellpadding="5">
					...
					<tr>
						...
						<td>
							<asp:TextBox id="txt_CreditLC" runat="server" CssClass="OptionalTextBoxStyle" tabIndex="4" ></asp:TextBox>
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<asp:TextBox id="txt_CreditUSD" runat="server" CssClass="OptionalTextBoxStyle" tabIndex="5" ></asp:TextBox>
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<asp:TextBox id="txt_DebitLC" runat="server" CssClass="OptionalTextBoxStyle" tabIndex="6" ></asp:TextBox>
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<asp:TextBox id="txt_DebitUSD" runat="server" CssClass="OptionalTextBoxStyle" tabIndex="7" ></asp:TextBox>
						</td>
						<td>
