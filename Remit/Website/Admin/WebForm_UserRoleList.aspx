<%@ Page language="c#" Codebehind="WebForm_UserRoleList.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_UserRoleList" %>
...
<html>
	...
	<body class="FormStyle">
		...
		<asp:panel id="MainDisplay" runat="server">
			<form id="WebForm_UserRoleList" method="post" runat="server">
				<table border="0" cellspacing="10" cellpadding="5">
					...
					<tr>
						...
						<td>
							<DropDownLists:WebDropDownList_MasterModuleList id="com_Module" runat="server" CssClass="OptionalComboBoxStyle" tabIndex="3">
					...
					<tr>
						...
						<td>
							<DropDownLists:WebDropDownList_UserRoleTypeList id="com_Type" runat="server" CssClass="MandatoryComboBoxStyle" tabIndex="4">
