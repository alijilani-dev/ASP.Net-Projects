...
{
	/// <summary>
	/// Summary description for WebFormList_TransitionAccountDetails.
	/// </summary>
	public class WebFormList_TransitionAccountDetails: System.Web.UI.Page
	{
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		public WebFormList_TransitionAccountDetails() {
		...
		/// [To be supplied.]
		/// </summary>
		protected Evernet.MoneyExchange.Web.Repeaters.WebRepeaterCustom_spS_TransitionAccountDetails_SelectDisplay repeater_TransitionAccountDetails_SelectDisplay;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		private void Page_Load(object sender, System.EventArgs e) {
			...
			if (!Page.IsPostBack) {
				...
				CurrentSortEnum sortColumn = CurrentSortEnum.SortBy_CreditDateTime;
				...
				if (ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] == null) {

					ViewState.Add("WebFormList_TransitionAccountDetails_CurrentSort", sortColumn);
				}
				else {

					ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] = sortColumn;
				}
			...
			repeater_TransitionAccountDetails_SelectDisplay.EnableViewState = true;
		...
		private void RefreshList() {
			...
			repeater_TransitionAccountDetails_SelectDisplay.Initialize(ConnectionString, System.Data.SqlTypes.SqlGuid.Null, TransactionId);
			try {

				repeater_TransitionAccountDetails_SelectDisplay.RefreshData();
			}
			catch (Evernet.MoneyExchange.DataClasses.CustomException customException) {

				if (customException.Parameter.SqlException != null) {

					throw new Exception(String.Format("An exception has been thrown in the underlying DataClass that is used by the 'WebRepeater_TransitionAccountDetails' class. Exception message is: {0}", customException.Parameter.SqlException.Message), customException);
				}
				else if (customException.Parameter.OtherException != null) {

					throw new Exception(String.Format("An exception has been thrown in the underlying DataClass that is used by the 'WebRepeater_TransitionAccountDetails' class. Exception message is: {0}", customException.Parameter.OtherException.Message), customException);
				}
				else {
			...
			System.Data.DataView dataView = (System.Data.DataView)repeater_TransitionAccountDetails_SelectDisplay.DataSource;

			string SortDirective = String.Empty;
			switch ((CurrentSortEnum)ViewState["WebFormList_TransitionAccountDetails_CurrentSort"]) {

				case CurrentSortEnum.SortBy_CreditDateTime:
					SortDirective = spS_TransitionAccountDetails.Resultset1.Fields.Column_CreditDateTime.ColumnName;
					break;

				case CurrentSortEnum.SortBy_DebitDateTime:
					SortDirective = spS_TransitionAccountDetails.Resultset1.Fields.Column_DebitDateTime.ColumnName;
					break;

				case CurrentSortEnum.SortBy_TransactionId:
					SortDirective = spS_TransitionAccountDetails_SelectDisplay.Resultset1.Fields.Column_TransactionId_Display.ColumnName;
					break;

				case CurrentSortEnum.SortBy_CreditLC:
					SortDirective = spS_TransitionAccountDetails.Resultset1.Fields.Column_CreditLC.ColumnName;
					break;

				case CurrentSortEnum.SortBy_CreditUSD:
					SortDirective = spS_TransitionAccountDetails.Resultset1.Fields.Column_CreditUSD.ColumnName;
					break;

				case CurrentSortEnum.SortBy_DebitLC:
					SortDirective = spS_TransitionAccountDetails.Resultset1.Fields.Column_DebitLC.ColumnName;
					break;

				case CurrentSortEnum.SortBy_DebitUSD:
					SortDirective = spS_TransitionAccountDetails.Resultset1.Fields.Column_DebitUSD.ColumnName;
					break;

				case CurrentSortEnum.SortBy_CommissionCreditLC:
					SortDirective = spS_TransitionAccountDetails.Resultset1.Fields.Column_CommissionCreditLC.ColumnName;
					break;

				case CurrentSortEnum.SortBy_CommissionCreditUSD:
					SortDirective = spS_TransitionAccountDetails.Resultset1.Fields.Column_CommissionCreditUSD.ColumnName;
					break;

				case CurrentSortEnum.SortBy_CommissionDebitLC:
					SortDirective = spS_TransitionAccountDetails.Resultset1.Fields.Column_CommissionDebitLC.ColumnName;
					break;

				case CurrentSortEnum.SortBy_CommissionDebitUSD:
					SortDirective = spS_TransitionAccountDetails.Resultset1.Fields.Column_CommissionDebitUSD.ColumnName;
					break;
			...
			repeater_TransitionAccountDetails_SelectDisplay.DataBind();
		}

		private void Label_CreditDateTime_Click(object sender, System.EventArgs e) {

			if ((CurrentSortEnum)ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] == CurrentSortEnum.SortBy_CreditDateTime) {
				...
				ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] = CurrentSortEnum.SortBy_CreditDateTime;
			}
		...
		private void Label_DebitDateTime_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] == CurrentSortEnum.SortBy_DebitDateTime) {
				...
				ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] = CurrentSortEnum.SortBy_DebitDateTime;
			}
		...
		private void Label_TransactionId_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] == CurrentSortEnum.SortBy_TransactionId) {
				...
				ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] = CurrentSortEnum.SortBy_TransactionId;
			}
		...
		private void Label_CreditLC_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] == CurrentSortEnum.SortBy_CreditLC) {
				...
				ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] = CurrentSortEnum.SortBy_CreditLC;
			}
		...
		private void Label_CreditUSD_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] == CurrentSortEnum.SortBy_CreditUSD) {
				...
				ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] = CurrentSortEnum.SortBy_CreditUSD;
			}
		...
		private void Label_DebitLC_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] == CurrentSortEnum.SortBy_DebitLC) {
				...
				ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] = CurrentSortEnum.SortBy_DebitLC;
			}
		...
		private void Label_DebitUSD_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] == CurrentSortEnum.SortBy_DebitUSD) {
				...
				ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] = CurrentSortEnum.SortBy_DebitUSD;
			}
		...
		private void Label_CommissionCreditLC_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] == CurrentSortEnum.SortBy_CommissionCreditLC) {
				...
				ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] = CurrentSortEnum.SortBy_CommissionCreditLC;
			}
		...
		private void Label_CommissionCreditUSD_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] == CurrentSortEnum.SortBy_CommissionCreditUSD) {
				...
				ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] = CurrentSortEnum.SortBy_CommissionCreditUSD;
			}
		...
		private void Label_CommissionDebitLC_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] == CurrentSortEnum.SortBy_CommissionDebitLC) {
				...
				ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] = CurrentSortEnum.SortBy_CommissionDebitLC;
			}
		...
		private void Label_CommissionDebitUSD_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] == CurrentSortEnum.SortBy_CommissionDebitUSD) {
				...
				ViewState["WebFormList_TransitionAccountDetails_CurrentSort"] = CurrentSortEnum.SortBy_CommissionDebitUSD;
			}
