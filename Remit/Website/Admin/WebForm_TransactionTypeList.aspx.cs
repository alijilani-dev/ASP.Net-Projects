...
namespace Evernet.MoneyExchange.Web.Forms {
	...
	/// <summary>
	/// Summary description for WebForm_TransactionTypeList.
	/// </summary>
	public class WebForm_TransactionTypeList : System.Web.UI.Page {
		...
		/// [To be supplied.]
		/// </summary>
		public WebForm_TransactionTypeList() {
		...
		private void RefreshRecord() {
			...
			Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionTypeList oAbstract_TransactionTypeList = new Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionTypeList(ConnectionString);

			if (!oAbstract_TransactionTypeList.Refresh(CurrentID)) {
			...
			if (!oAbstract_TransactionTypeList.Col_Name.IsNull) {

				txt_Name.Text = oAbstract_TransactionTypeList.Col_Name.Value.ToString();
			}
			else {
			...
			if (!oAbstract_TransactionTypeList.Col_Value.IsNull) {

				txt_Value.Text = oAbstract_TransactionTypeList.Col_Value.Value.ToString();
			}
			else {
		...
		private void cmdAdd_Click(object sender, System.EventArgs e) {
			...
			if (ReturnURL.Visible) {
				...
				Response.Redirect(String.Format("WebForm_TransactionTypeList.aspx?Action=Add&ReturnToUrl={0}&ReturnToDisplay={1}", ReturnURL.NavigateUrl, ReturnURL.Text));
			}
			else {

				Response.Redirect("WebForm_TransactionTypeList.aspx?Action=Add");
			}
		}
		...
		private void cmdUpdate_Click(object sender, System.EventArgs e) {
			...
			if (Action == ActionEnum.Edit) {
				...
				Params.spU_TransactionTypeList Param = null;
				SPs.spU_TransactionTypeList SP = null;

				Param = new Params.spU_TransactionTypeList();
				...
				SP = new SPs.spU_TransactionTypeList();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_TransactionTypeList.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", CurrentID.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_TransactionTypeList.aspx?Action=Edit&ID={0}", CurrentID.ToString()));
					}
					return;
				}
				else {
				...
				Params.spI_TransactionTypeList Param = null;
				SPs.spI_TransactionTypeList SP = null;

				Param = new Params.spI_TransactionTypeList();
				...
				SP = new SPs.spI_TransactionTypeList();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_TransactionTypeList.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", Param.Param_Value.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_TransactionTypeList.aspx?Action=Edit&ID={0}", Param.Param_Value.ToString()));
					}
					return;
				}
				else {
		...
		private void cmdDelete_Click(object sender, System.EventArgs e) {
			...
			Params.spD_TransactionTypeList Param = null;
			SPs.spD_TransactionTypeList SP = null;

			Param = new Params.spD_TransactionTypeList();

			Param.SetUpConnection(ConnectionString);

			Param.Param_Value = CurrentID;

			SP = new SPs.spD_TransactionTypeList();
