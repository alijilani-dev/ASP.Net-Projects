<%@ Page language="c#" Codebehind="WebForm_UserRoleAssignmentList.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_UserRoleAssignmentList" %>
...
<title>ARY Speed Remit :: User Role Management</title>
<!-- InstanceEndEditable -->
        ...
        <tr>
          <td valign="top" bgcolor="#CFCFCF"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center"><font size="4" face="Arial, Helvetica, sans-serif"><!-- InstanceBeginEditable name="Heading" --> &nbsp;User Role Management <!-- InstanceEndEditable --></font></td>
                  </tr>
              </table></td>
            </tr>
            <tr>
                  ...
                  <td align="center" valign="top"><!-- InstanceBeginEditable name="MainContent" --> 
                    ...
                    <asp:panel id="MainDisplay" runat="server">
                      <table border="0" cellspacing="10" cellpadding="5">
                        <tr>
                          <td align="Right" class="MandatoryLabelStyle"> User </td>
                          <td><DropDownLists:WebDropDownList_UserList id="com_UserId" runat="server" CssClass="MandatoryComboBoxStyle" tabIndex="1"> </DropDownLists:WebDropDownList_UserList> </td>
                        </tr>
                        <tr>
                          <td align="Right" class="MandatoryLabelStyle"> Role </td>
                          <td><DropDownLists:WebDropDownList_UserRoleList id="com_Role" runat="server" CssClass="MandatoryComboBoxStyle" tabIndex="2"> </DropDownLists:WebDropDownList_UserRoleList> </td>
                        </tr>
                        <tr> </tr>
                        <tr>
                          <td></td>
