<%@ Page language="c#" Codebehind="WebForm_CommissionSplitTypeList.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_CommissionSplitTypeList" %>
...
<html>
	...
	<body class="FormStyle">
		...
		<asp:panel id="MainDisplay" runat="server">
			<form id="WebForm_CommissionSplitTypeList" method="post" runat="server">
