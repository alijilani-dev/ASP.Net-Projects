<%@ Page language="c#" Codebehind="WebForm_BankExchangeRateList.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_BankExchangeRateList" %>
        ...
        <tr>
          <td valign="top" bgcolor="#CFCFCF"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center"><font size="4" face="Arial, Helvetica, sans-serif"><!-- InstanceBeginEditable name="Heading" --> &nbsp;Bank Exchange Rate Management <!-- InstanceEndEditable --></font></td>
                  </tr>
              </table></td>
            </tr>
            <tr>
                  ...
                  <td align="center" valign="top"><!-- InstanceBeginEditable name="MainContent" --> 
                    ...
                    <asp:panel id="MainDisplay" runat="server">
                      <table border="0" cellspacing="10" cellpadding="5">
                        <tr>
                          <td align="Right" class="MandatoryLabelStyle"> Currency </td>
                          <td><DropDownLists:WebDropDownList_CurrencyList id="com_CurrencyId" runat="server" CssClass="MandatoryComboBoxStyle" tabIndex="1"> </DropDownLists:WebDropDownList_CurrencyList> </td>
                        </tr>
                        <tr>
                          <td align="Right" class="MandatoryLabelStyle"> ExchangeType </td>
                          <td><DropDownLists:WebDropDownList_CurrencyExchangeType id="com_ExchangeType" runat="server" CssClass="MandatoryComboBoxStyle" tabIndex="2"> </DropDownLists:WebDropDownList_CurrencyExchangeType> </td>
                        </tr>
                        <tr>
                          <td align="Right" class="OptionalLabelStyle"> BidRate </td>
                          <td><asp:TextBox id="txt_BidRate" runat="server" CssClass="OptionalTextBoxStyle" tabIndex="3" ></asp:TextBox>
                          </td>
                          <td><asp:Label EnableViewState="False" Visible="False" runat="Server" id="labError_BidRate" CssClass="ErrorStyle"></asp:Label>
                          </td>
                        </tr>
                        <tr>
                          <td align="Right" class="MandatoryLabelStyle"> OfferRate </td>
                          <td><asp:TextBox id="txt_OfferRate" runat="server" CssClass="MandatoryTextBoxStyle" tabIndex="4" ></asp:TextBox>
                          </td>
                          <td><asp:Label EnableViewState="False" Visible="False" runat="Server" id="labError_OfferRate" CssClass="ErrorStyle"></asp:Label>
                          </td>
                        </tr>
                        <tr> </tr>
                        <tr>
                          ...
                          <td align="center"><table border="0" cellspacing="10" cellpadding="5">
                              <tr align="center">
                                <td><asp:Button id="cmdRefresh" runat="server" Text="Refresh" CssClass="ButtonStyle" tabIndex="5"></asp:Button>
                                </td>
                                <td><asp:Button id="cmdDelete" runat="server" Text="Delete" CssClass="ButtonStyle" tabIndex="6"></asp:Button>
                                </td>
                                <td><asp:Button id="cmdUpdate" runat="server" Text="Update" CssClass="ButtonStyle" tabIndex="7"></asp:Button>
                                </td>
                              </tr>
                          </table></td>
                        </tr>
