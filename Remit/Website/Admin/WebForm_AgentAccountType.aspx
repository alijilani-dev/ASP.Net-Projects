<%@ Page language="c#" Codebehind="WebForm_AgentAccountType.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_AgentAccountType" %>
...
<html>
	...
	<body class="FormStyle">
		...
		<asp:panel id="MainDisplay" runat="server">
			<form id="WebForm_AgentAccountType" method="post" runat="server">
