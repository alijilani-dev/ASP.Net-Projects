...
namespace Evernet.MoneyExchange.Web.Forms {
	...
	/// <summary>
	/// Summary description for WebForm_TransactionDraftList.
	/// </summary>
	public class WebForm_TransactionDraftList : System.Web.UI.Page {
		...
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label lab_DraftNumber;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.TextBox txt_DraftNumber;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label labError_DraftNumber;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		/// [To be supplied.]
		/// </summary>
		public WebForm_TransactionDraftList() {
		...
		private void RefreshRecord() {
			...
			Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionDraftList oAbstract_TransactionDraftList = new Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionDraftList(ConnectionString);

			if (!oAbstract_TransactionDraftList.Refresh(CurrentID)) {
			...
			if (!oAbstract_TransactionDraftList.Col_Id.IsNull) {

				txt_Id.Text = oAbstract_TransactionDraftList.Col_Id.Value.ToString();
			}
			else {
			...
			com_TransactionId.Items.FindByValue(Convert.ToString(oAbstract_TransactionDraftList.Col_TransactionId)).Selected = true;

			if (!oAbstract_TransactionDraftList.Col_DraftNumber.IsNull) {

				txt_DraftNumber.Text = oAbstract_TransactionDraftList.Col_DraftNumber.Value.ToString();
			}
			else {

				txt_DraftNumber.Text = String.Empty;
			}
		...
		private void cmdAdd_Click(object sender, System.EventArgs e) {
			...
			if (ReturnURL.Visible) {
				...
				Response.Redirect(String.Format("WebForm_TransactionDraftList.aspx?Action=Add&ReturnToUrl={0}&ReturnToDisplay={1}", ReturnURL.NavigateUrl, ReturnURL.Text));
			}
			else {

				Response.Redirect("WebForm_TransactionDraftList.aspx?Action=Add");
			}
		}
		...
		private void cmdUpdate_Click(object sender, System.EventArgs e) {
			...
			if (Action == ActionEnum.Edit) {
				...
				Params.spU_TransactionDraftList Param = null;
				SPs.spU_TransactionDraftList SP = null;

				Param = new Params.spU_TransactionDraftList();
				...
				if (txt_DraftNumber.Text.Trim() != String.Empty) {

					Param.Param_DraftNumber = new System.Data.SqlTypes.SqlString(txt_DraftNumber.Text);
				}

				SP = new SPs.spU_TransactionDraftList();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_TransactionDraftList.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", CurrentID.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_TransactionDraftList.aspx?Action=Edit&ID={0}", CurrentID.ToString()));
					}
					return;
				}
				else {
				...
				Params.spI_TransactionDraftList Param = null;
				SPs.spI_TransactionDraftList SP = null;

				Param = new Params.spI_TransactionDraftList();
				...
				SP = new SPs.spI_TransactionDraftList();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_TransactionDraftList.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", Param.Param_Id.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_TransactionDraftList.aspx?Action=Edit&ID={0}", Param.Param_Id.ToString()));
					}
					return;
				}
				else {
		...
		private void cmdDelete_Click(object sender, System.EventArgs e) {
			...
			Params.spD_TransactionDraftList Param = null;
			SPs.spD_TransactionDraftList SP = null;

			Param = new Params.spD_TransactionDraftList();

			Param.SetUpConnection(ConnectionString);

			Param.Param_Id = CurrentID;

			SP = new SPs.spD_TransactionDraftList();
