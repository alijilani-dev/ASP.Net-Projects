<%@ Page language="c#" Codebehind="WebForm_MasterModuleList.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_MasterModuleList" %>
...
<html>
	...
	<body class="FormStyle">
		...
		<asp:panel id="MainDisplay" runat="server">
			<form id="WebForm_MasterModuleList" method="post" runat="server">
