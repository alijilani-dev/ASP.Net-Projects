...
{
	/// <summary>
	/// Summary description for WebFormList_LocationList.
	/// </summary>
	public class WebFormList_LocationList: System.Web.UI.Page
	{
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		public WebFormList_LocationList() {
		...
		/// [To be supplied.]
		/// </summary>
		protected Evernet.MoneyExchange.Web.Repeaters.WebRepeaterCustom_spS_LocationList_SelectDisplay repeater_LocationList_SelectDisplay;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_LocationList com_ParentId;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
...
//				com_ParentId.Items.Insert(0, "Show all");
				...
				if (ViewState["WebFormList_LocationList_CurrentSort"] == null) {

					ViewState.Add("WebFormList_LocationList_CurrentSort", sortColumn);
				}
				else {

					ViewState["WebFormList_LocationList_CurrentSort"] = sortColumn;
				}
			...
			repeater_LocationList_SelectDisplay.EnableViewState = true;
...
//			}
			...
			repeater_LocationList_SelectDisplay.Initialize(ConnectionString, System.Data.SqlTypes.SqlGuid.Null, ParentId, CountryId);
			try {

				repeater_LocationList_SelectDisplay.RefreshData();
			}
			catch (Evernet.MoneyExchange.DataClasses.CustomException customException) {

				if (customException.Parameter.SqlException != null) {

					throw new Exception(String.Format("An exception has been thrown in the underlying DataClass that is used by the 'WebRepeater_LocationList' class. Exception message is: {0}", customException.Parameter.SqlException.Message), customException);
				}
				else if (customException.Parameter.OtherException != null) {

					throw new Exception(String.Format("An exception has been thrown in the underlying DataClass that is used by the 'WebRepeater_LocationList' class. Exception message is: {0}", customException.Parameter.OtherException.Message), customException);
				}
				else {
			...
			System.Data.DataView dataView = (System.Data.DataView)repeater_LocationList_SelectDisplay.DataSource;

			string SortDirective = String.Empty;
			switch ((CurrentSortEnum)ViewState["WebFormList_LocationList_CurrentSort"]) {

				case CurrentSortEnum.SortBy_Name:
					SortDirective = spS_LocationList.Resultset1.Fields.Column_Name.ColumnName;
					break;

				case CurrentSortEnum.SortBy_CountryId:
					SortDirective = spS_LocationList_SelectDisplay.Resultset1.Fields.Column_CountryId_Display.ColumnName;
					break;
			...
			repeater_LocationList_SelectDisplay.DataBind();
		}

		private void Label_Name_Click(object sender, System.EventArgs e) {

			if ((CurrentSortEnum)ViewState["WebFormList_LocationList_CurrentSort"] == CurrentSortEnum.SortBy_Name) {
				...
				ViewState["WebFormList_LocationList_CurrentSort"] = CurrentSortEnum.SortBy_Name;
			}
		...
		private void Label_CountryId_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_LocationList_CurrentSort"] == CurrentSortEnum.SortBy_CountryId) {
				...
				ViewState["WebFormList_LocationList_CurrentSort"] = CurrentSortEnum.SortBy_CountryId;
			}
