...
namespace Evernet.MoneyExchange.Web.Forms {
	...
	/// <summary>
	/// Summary description for WebForm_PaymentModeList.
	/// </summary>
	public class WebForm_PaymentModeList : System.Web.UI.Page {
		...
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label lab_BaseType;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label lab_ChannelThrough;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label lab_FinalEntity;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label lab_Prefix;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.TextBox txt_Prefix;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label labError_Prefix;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		/// [To be supplied.]
		/// </summary>
		public WebForm_PaymentModeList() {
		...
		private void RefreshForeignTables() {
			...
			try {
				...
				com_BaseType.RefreshData(System.Data.SqlTypes.SqlString.Null);
			}
			...
			try {
				...
				com_ChannelThrough.RefreshData(System.Data.SqlTypes.SqlString.Null);
			}
			catch (Evernet.MoneyExchange.DataClasses.CustomException customException) {
			...
			try {
				...
				com_FinalEntity.RefreshData(System.Data.SqlTypes.SqlString.Null);
			}
			catch (Evernet.MoneyExchange.DataClasses.CustomException customException) {
		...
		private void RefreshRecord() {
			...
			Evernet.MoneyExchange.AbstractClasses.Abstract_PaymentModeList oAbstract_PaymentModeList = new Evernet.MoneyExchange.AbstractClasses.Abstract_PaymentModeList(ConnectionString);

			if (!oAbstract_PaymentModeList.Refresh(CurrentID)) {
			...
			if (!oAbstract_PaymentModeList.Col_Name.IsNull) {

				txt_Name.Text = oAbstract_PaymentModeList.Col_Name.Value.ToString();
			}
			else {
			...
			if (!oAbstract_PaymentModeList.Col_Value.IsNull) {

				txt_Value.Text = oAbstract_PaymentModeList.Col_Value.Value.ToString();
			}
			else {
			...
			com_BaseType.Items.FindByValue(Convert.ToString(oAbstract_PaymentModeList.Col_BaseType)).Selected = true;

			com_ChannelThrough.Items.FindByValue(Convert.ToString(oAbstract_PaymentModeList.Col_ChannelThrough)).Selected = true;

			com_FinalEntity.Items.FindByValue(Convert.ToString(oAbstract_PaymentModeList.Col_FinalEntity)).Selected = true;

			if (!oAbstract_PaymentModeList.Col_Prefix.IsNull) {

				txt_Prefix.Text = oAbstract_PaymentModeList.Col_Prefix.Value.ToString();
			}
			else {

				txt_Prefix.Text = String.Empty;
			}
		...
		private void EmptyControls() {
			...
			txt_Name.Text = String.Empty;
			txt_Value.Text = String.Empty;
			com_BaseType.SelectedIndex = 0;
			com_ChannelThrough.SelectedIndex = 0;
			com_FinalEntity.SelectedIndex = 0;
			txt_Prefix.Text = String.Empty;
		}
		...
		private void cmdAdd_Click(object sender, System.EventArgs e) {
			...
			if (ReturnURL.Visible) {
				...
				Response.Redirect(String.Format("WebForm_PaymentModeList.aspx?Action=Add&ReturnToUrl={0}&ReturnToDisplay={1}", ReturnURL.NavigateUrl, ReturnURL.Text));
			}
			else {

				Response.Redirect("WebForm_PaymentModeList.aspx?Action=Add");
			}
		}
		...
		private void cmdUpdate_Click(object sender, System.EventArgs e) {
			...
			if (Action == ActionEnum.Edit) {
				...
				Params.spU_PaymentModeList Param = null;
				SPs.spU_PaymentModeList SP = null;

				Param = new Params.spU_PaymentModeList();
				...
				Param.Param_BaseType = Convert.ToString(com_BaseType.SelectedItem.Value);

				Param.Param_ChannelThrough = Convert.ToString(com_ChannelThrough.SelectedItem.Value);

				Param.Param_FinalEntity = Convert.ToString(com_FinalEntity.SelectedItem.Value);

				if (txt_Prefix.Text.Trim() != String.Empty) {

					Param.Param_Prefix = new System.Data.SqlTypes.SqlString(txt_Prefix.Text);
				}

				SP = new SPs.spU_PaymentModeList();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_PaymentModeList.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", CurrentID.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_PaymentModeList.aspx?Action=Edit&ID={0}", CurrentID.ToString()));
					}
					return;
				}
				else {
				...
				Params.spI_PaymentModeList Param = null;
				SPs.spI_PaymentModeList SP = null;

				Param = new Params.spI_PaymentModeList();
				...
				SP = new SPs.spI_PaymentModeList();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_PaymentModeList.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", Param.Param_Value.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_PaymentModeList.aspx?Action=Edit&ID={0}", Param.Param_Value.ToString()));
					}
					return;
				}
				else {
		...
		private void cmdDelete_Click(object sender, System.EventArgs e) {
			...
			Params.spD_PaymentModeList Param = null;
			SPs.spD_PaymentModeList SP = null;

			Param = new Params.spD_PaymentModeList();

			Param.SetUpConnection(ConnectionString);

			Param.Param_Value = CurrentID;

			SP = new SPs.spD_PaymentModeList();
