<%@ Page language="c#" Codebehind="WebForm_CustomerLoyaltyPointsAccumulationHistory.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_CustomerLoyaltyPointsAccumulationHistory" %>
...
<html>
	...
	<body class="FormStyle">
		...
		<asp:panel id="MainDisplay" runat="server">
			<form id="WebForm_CustomerLoyaltyPointsAccumulationHistory" method="post" runat="server">
				<table border="0" cellspacing="10" cellpadding="5">
					...
					<tr>
						...
						<td>
							<DropDownLists:WebDropDownList_TransactionDetails id="com_TransactionId" runat="server" CssClass="MandatoryComboBoxStyle" tabIndex="2">
					...
					<tr>
						...
						<td>
							<asp:TextBox id="txt_Points" runat="server" CssClass="MandatoryTextBoxStyle" tabIndex="3" ></asp:TextBox>
						</td>
						<td>
