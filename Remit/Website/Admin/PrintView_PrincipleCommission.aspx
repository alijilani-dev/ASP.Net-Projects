<%@ Page language="c#" Codebehind="PrintView_PrincipleCommission.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Admin.PrintView_PrincipleCommission" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>PrintView_PrincipleCommission</title>
	...
	<body leftmargin="0" topmargin="0" MS_POSITIONING="FlowLayout">
		<form id="Form1" method="post" runat="server">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align="center">
						<asp:Label id="lblTitle" runat="server">Principle Commission Account Report</asp:Label>
						&nbsp;
					</td>
				</tr>
				<tr>
					<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="120" align="right">Agent Account :
											</td>
											<td>
												<asp:Label id="lblAgentAccount" runat="server"></asp:Label>
											</td>
										</tr>
										<tr>
											...
											<td>
												<asp:Label id="lblAccountCurrency" runat="server"></asp:Label>
											</td>
										</tr>
									</table>
								</td>
				...
				<tr>
					<td align="center">
						<asp:DataGrid id="dgrdAccountReport" runat="server" AutoGenerateColumns="False" BackColor="White"
							BorderColor="Black">
