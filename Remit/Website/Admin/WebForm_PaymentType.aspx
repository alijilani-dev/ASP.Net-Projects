<%@ Page language="c#" Codebehind="WebForm_PaymentType.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_PaymentType" %>
...
<html>
	...
	<body class="FormStyle">
		...
		<asp:panel id="MainDisplay" runat="server">
			<form id="WebForm_PaymentType" method="post" runat="server">
