<%@ Page language="c#" Codebehind="WebForm_MasterCountryList.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_MasterCountryList" %>
...
<html>
	...
	<body class="FormStyle">
		...
		<asp:panel id="MainDisplay" runat="server">
			<form id="WebForm_MasterCountryList" method="post" runat="server">
				<table border="0" cellspacing="10" cellpadding="5">
					...
					<tr>
						...
						<td>
							<asp:TextBox id="txt_Code" runat="server" CssClass="MandatoryTextBoxStyle" tabIndex="2" ></asp:TextBox>
						</td>
						<td>
							<asp:Label EnableViewState="False" Visible="False" runat="Server" id="labError_Code" CssClass="ErrorStyle"></asp:Label>
						</td>
					</tr>
					<tr>
					</tr>
