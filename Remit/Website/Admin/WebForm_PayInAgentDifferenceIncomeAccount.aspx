<%@ Page language="c#" Codebehind="WebForm_PayInAgentDifferenceIncomeAccount.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_PayInAgentDifferenceIncomeAccount" %>
...
<html>
	...
	<body class="FormStyle">
		...
		<asp:panel id="MainDisplay" runat="server">
			<form id="WebForm_PayInAgentDifferenceIncomeAccount" method="post" runat="server">
				<table border="0" cellspacing="10" cellpadding="5">
					...
					<tr>
						...
						<td>
							<DropDownLists:WebDropDownList_TransactionDetails id="com_TranasctionId" runat="server" CssClass="MandatoryComboBoxStyle" tabIndex="5">
					...
					<tr>
						...
						<td>
							<asp:TextBox id="txt_CreditLC" runat="server" CssClass="MandatoryTextBoxStyle" tabIndex="6" ></asp:TextBox>
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<asp:TextBox id="txt_CreditUSD" runat="server" CssClass="MandatoryTextBoxStyle" tabIndex="7" ></asp:TextBox>
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<asp:TextBox id="txt_DebitLC" runat="server" CssClass="MandatoryTextBoxStyle" tabIndex="8" ></asp:TextBox>
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<asp:TextBox id="txt_DebitUSD" runat="server" CssClass="MandatoryTextBoxStyle" tabIndex="9" ></asp:TextBox>
						</td>
						<td>
