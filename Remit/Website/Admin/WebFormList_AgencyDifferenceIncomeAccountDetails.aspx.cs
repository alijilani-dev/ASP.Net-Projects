...
{
	/// <summary>
	/// Summary description for WebFormList_AgencyDifferenceIncomeAccountDetails.
	/// </summary>
	public class WebFormList_AgencyDifferenceIncomeAccountDetails: System.Web.UI.Page
	{
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		public WebFormList_AgencyDifferenceIncomeAccountDetails() {
		...
		/// [To be supplied.]
		/// </summary>
		protected Evernet.MoneyExchange.Web.Repeaters.WebRepeaterCustom_spS_AgencyDifferenceIncomeAccountDetails_SelectDisplay repeater_AgencyDifferenceIncomeAccountDetails_SelectDisplay;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		private void Page_Load(object sender, System.EventArgs e) {
			...
			if (!Page.IsPostBack) {
				...
				if (ViewState["WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort"] == null) {

					ViewState.Add("WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort", sortColumn);
				}
				else {

					ViewState["WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort"] = sortColumn;
				}
			...
			repeater_AgencyDifferenceIncomeAccountDetails_SelectDisplay.EnableViewState = true;
		...
		private void RefreshList() {
			...
			repeater_AgencyDifferenceIncomeAccountDetails_SelectDisplay.Initialize(ConnectionString, System.Data.SqlTypes.SqlGuid.Null, TransactionId);
			try {

				repeater_AgencyDifferenceIncomeAccountDetails_SelectDisplay.RefreshData();
			}
			catch (Evernet.MoneyExchange.DataClasses.CustomException customException) {

				if (customException.Parameter.SqlException != null) {

					throw new Exception(String.Format("An exception has been thrown in the underlying DataClass that is used by the 'WebRepeater_AgencyDifferenceIncomeAccountDetails' class. Exception message is: {0}", customException.Parameter.SqlException.Message), customException);
				}
				else if (customException.Parameter.OtherException != null) {

					throw new Exception(String.Format("An exception has been thrown in the underlying DataClass that is used by the 'WebRepeater_AgencyDifferenceIncomeAccountDetails' class. Exception message is: {0}", customException.Parameter.OtherException.Message), customException);
				}
				else {
			...
			System.Data.DataView dataView = (System.Data.DataView)repeater_AgencyDifferenceIncomeAccountDetails_SelectDisplay.DataSource;

			string SortDirective = String.Empty;
			switch ((CurrentSortEnum)ViewState["WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort"]) {

				case CurrentSortEnum.SortBy_Id:
					SortDirective = spS_AgencyDifferenceIncomeAccountDetails.Resultset1.Fields.Column_Id.ColumnName;
					break;

				case CurrentSortEnum.SortBy_CreditDateTime:
					SortDirective = spS_AgencyDifferenceIncomeAccountDetails.Resultset1.Fields.Column_CreditDateTime.ColumnName;
					break;

				case CurrentSortEnum.SortBy_DebitDateTime:
					SortDirective = spS_AgencyDifferenceIncomeAccountDetails.Resultset1.Fields.Column_DebitDateTime.ColumnName;
					break;

				case CurrentSortEnum.SortBy_TransactionId:
					SortDirective = spS_AgencyDifferenceIncomeAccountDetails_SelectDisplay.Resultset1.Fields.Column_TransactionId_Display.ColumnName;
					break;

				case CurrentSortEnum.SortBy_CreditLC:
					SortDirective = spS_AgencyDifferenceIncomeAccountDetails.Resultset1.Fields.Column_CreditLC.ColumnName;
					break;

				case CurrentSortEnum.SortBy_CreditUSD:
					SortDirective = spS_AgencyDifferenceIncomeAccountDetails.Resultset1.Fields.Column_CreditUSD.ColumnName;
					break;

				case CurrentSortEnum.SortBy_DebitLC:
					SortDirective = spS_AgencyDifferenceIncomeAccountDetails.Resultset1.Fields.Column_DebitLC.ColumnName;
					break;

				case CurrentSortEnum.SortBy_DebitUSD:
					SortDirective = spS_AgencyDifferenceIncomeAccountDetails.Resultset1.Fields.Column_DebitUSD.ColumnName;
					break;
			...
			repeater_AgencyDifferenceIncomeAccountDetails_SelectDisplay.DataBind();
		}

		private void Label_Id_Click(object sender, System.EventArgs e) {

			if ((CurrentSortEnum)ViewState["WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort"] == CurrentSortEnum.SortBy_Id) {
				...
				ViewState["WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort"] = CurrentSortEnum.SortBy_Id;
			}
		...
		private void Label_CreditDateTime_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort"] == CurrentSortEnum.SortBy_CreditDateTime) {
				...
				ViewState["WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort"] = CurrentSortEnum.SortBy_CreditDateTime;
			}
		...
		private void Label_DebitDateTime_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort"] == CurrentSortEnum.SortBy_DebitDateTime) {
				...
				ViewState["WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort"] = CurrentSortEnum.SortBy_DebitDateTime;
			}
		...
		private void Label_TransactionId_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort"] == CurrentSortEnum.SortBy_TransactionId) {
				...
				ViewState["WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort"] = CurrentSortEnum.SortBy_TransactionId;
			}
		...
		private void Label_CreditLC_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort"] == CurrentSortEnum.SortBy_CreditLC) {
				...
				ViewState["WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort"] = CurrentSortEnum.SortBy_CreditLC;
			}
		...
		private void Label_CreditUSD_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort"] == CurrentSortEnum.SortBy_CreditUSD) {
				...
				ViewState["WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort"] = CurrentSortEnum.SortBy_CreditUSD;
			}
		...
		private void Label_DebitLC_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort"] == CurrentSortEnum.SortBy_DebitLC) {
				...
				ViewState["WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort"] = CurrentSortEnum.SortBy_DebitLC;
			}
		...
		private void Label_DebitUSD_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort"] == CurrentSortEnum.SortBy_DebitUSD) {
				...
				ViewState["WebFormList_AgencyDifferenceIncomeAccountDetails_CurrentSort"] = CurrentSortEnum.SortBy_DebitUSD;
			}
