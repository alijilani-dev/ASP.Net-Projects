...
namespace Evernet.MoneyExchange.Web.Forms {
	...
	/// <summary>
	/// Summary description for WebForm_CountryTransactionPermissionList.
	/// </summary>
	public class WebForm_CountryTransactionPermissionList : System.Web.UI.Page {

		/// <summary>
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label lab_BaseCountryId;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label lab_TargetCountryId;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.Label lab_PermissionType;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		/// [To be supplied.]
		/// </summary>
		public WebForm_CountryTransactionPermissionList() {
		...
		private void RefreshForeignTables() {
			...
			try {
				...
				com_BaseCountryId.RefreshData(System.Data.SqlTypes.SqlGuid.Null);
			}
			...
			try {
				...
				com_TargetCountryId.RefreshData(System.Data.SqlTypes.SqlGuid.Null);
			}
			catch (Evernet.MoneyExchange.DataClasses.CustomException customException) {
			...
			try {
				...
				com_PermissionType.RefreshData(System.Data.SqlTypes.SqlString.Null);
			}
			catch (Evernet.MoneyExchange.DataClasses.CustomException customException) {
		...
		private void RefreshRecord() {
			...
			Evernet.MoneyExchange.AbstractClasses.Abstract_CountryTransactionPermissionList oAbstract_CountryTransactionPermissionList = new Evernet.MoneyExchange.AbstractClasses.Abstract_CountryTransactionPermissionList(ConnectionString);

			if (!oAbstract_CountryTransactionPermissionList.Refresh(CurrentID)) {
			...
			com_BaseCountryId.Items.FindByValue(Convert.ToString(oAbstract_CountryTransactionPermissionList.Col_BaseCountryId)).Selected = true;

			com_TargetCountryId.Items.FindByValue(Convert.ToString(oAbstract_CountryTransactionPermissionList.Col_TargetCountryId)).Selected = true;

			com_PermissionType.Items.FindByValue(Convert.ToString(oAbstract_CountryTransactionPermissionList.Col_PermissionType)).Selected = true;

		}

		private void EmptyControls() {

			com_BaseCountryId.SelectedIndex = 0;
			com_TargetCountryId.SelectedIndex = 0;
		...
		private void cmdAdd_Click(object sender, System.EventArgs e) {
			...
			if (ReturnURL.Visible) {
				...
				Response.Redirect(String.Format("WebForm_CountryTransactionPermissionList.aspx?Action=Add&ReturnToUrl={0}&ReturnToDisplay={1}", ReturnURL.NavigateUrl, ReturnURL.Text));
			}
			else {

				Response.Redirect("WebForm_CountryTransactionPermissionList.aspx?Action=Add");
			}
		}
		...
		private void cmdUpdate_Click(object sender, System.EventArgs e) {
			...
			if (Action == ActionEnum.Edit) {
				...
				Params.spU_CountryTransactionPermissionList Param = null;
				SPs.spU_CountryTransactionPermissionList SP = null;

				Param = new Params.spU_CountryTransactionPermissionList();

				Param.SetUpConnection(ConnectionString);

				Param.Param_Id = CurrentID;

				Param.Param_BaseCountryId = new Guid(com_BaseCountryId.SelectedItem.Value);

				Param.Param_TargetCountryId = new Guid(com_TargetCountryId.SelectedItem.Value);

				Param.Param_PermissionType = Convert.ToString(com_PermissionType.SelectedItem.Value);

				SP = new SPs.spU_CountryTransactionPermissionList();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_CountryTransactionPermissionList.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", CurrentID.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_CountryTransactionPermissionList.aspx?Action=Edit&ID={0}", CurrentID.ToString()));
					}
					return;
				}
				else {
				...
				Params.spI_CountryTransactionPermissionList Param = null;
				SPs.spI_CountryTransactionPermissionList SP = null;

				Param = new Params.spI_CountryTransactionPermissionList();
				...
				SP = new SPs.spI_CountryTransactionPermissionList();

				if (SP.Execute(ref Param)) {

					if (ReturnURL.Visible) {

						Response.Redirect(String.Format("WebForm_CountryTransactionPermissionList.aspx?Action=Edit&ID={0}&ReturnToUrl={1}&ReturnToDisplay={2}", Param.Param_Id.ToString(), ReturnURL.NavigateUrl, ReturnURL.Text));
					}
					else {

						Response.Redirect(String.Format("WebForm_CountryTransactionPermissionList.aspx?Action=Edit&ID={0}", Param.Param_Id.ToString()));
					}
					return;
				}
				else {
		...
		private void cmdDelete_Click(object sender, System.EventArgs e) {
			...
			Params.spD_CountryTransactionPermissionList Param = null;
			SPs.spD_CountryTransactionPermissionList SP = null;

			Param = new Params.spD_CountryTransactionPermissionList();

			Param.SetUpConnection(ConnectionString);

			Param.Param_Id = CurrentID;

			SP = new SPs.spD_CountryTransactionPermissionList();
