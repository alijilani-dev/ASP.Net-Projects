<%@ Page language="c#" Codebehind="WebForm_UserRoleTypeList.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_UserRoleTypeList" %>
...
<html>
	...
	<body class="FormStyle">
		...
		<asp:panel id="MainDisplay" runat="server">
			<form id="WebForm_UserRoleTypeList" method="post" runat="server">
