...
namespace Evernet.MoneyExchange.Admin {
	public class InitiateTransfer2 : System.Web.UI.Page {
		#region Declarations.
...
//					butUpdateCustomerRecord.Visible=false;
			...
			//////////////////////////////////////////////////////////////
			//if(ddlDestinationModeOfPayment)
			
			//Modified Added below lines.
			//visibilityBasedOnModeOfPaymentExecuted = true;
			//UpdateVisibilityBasedOnModeOfPayment();
			//Modified Added above lines.
			//Modified Commented below line.
//			pnlMessageToAgent.Visible=true;
			//Modified Commented above line.
			//pnlBottomPart.Visible=true;
		}
		...
		private void butCalculate_Click(object sender, System.EventArgs e) {
			...
			if(User.IsInRole(UserRoles.ExchangeRateChangerDuringTransaction.ToString())) 
			{
				...
				{
					lblMessage.Text = "Please enter an exchange rate within the specified range.1";
				}
			}
			else
			{
