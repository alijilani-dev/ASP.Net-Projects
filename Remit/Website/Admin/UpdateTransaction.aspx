...
<%@ Page language="c#" Codebehind="UpdateTransaction.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Admin.UpdateTransaction" %>
<HTML>
	<HEAD>
												...
												<table cellSpacing="0" cellPadding="0" width="100%" border="0">
													<tr>
														<td align="center"><font face="Arial, Helvetica, sans-serif" size="4"><!-- InstanceBeginEditable name="Heading" --> 
																&nbsp;Transaction Updation&nbsp;Screen <!-- InstanceEndEditable --></font></td>
													</tr>
													<TR>
														<TD align="center"></TD>
													</TR>
													<TR>
														<TD align="center">
															<asp:Label id="lblSRTRNo" runat="server">Transaction Number :</asp:Label>
															<asp:TextBox id="txtSRTRNo" runat="server"></asp:TextBox></TD>
													</TR>
													<TR>
														<TD align="center"></TD>
													</TR>
													<TR>
														<TD align="center">
															<asp:Button id="btnGetInfo" runat="server" Text="Get Information"></asp:Button></TD>
													</TR>
													<TR>
														<TD align="center">
															<asp:Panel id="Panel1" runat="server" Height="64px">Panel</asp:Panel></TD>
													</TR>
												</table>
											</td>
										</tr>
													...
													<tr>
														<td vAlign="top"><!-- InstanceBeginEditable name="MainContent" -->
															<table cellPadding="0" width="100%" border="0">
																					...
																					<TD vAlign="top" align="center" width="50%">
																						<TABLE id="Table1" cellPadding="0" width="100%" border="0">
																							<TR>
																								...
																								<TD>
																									<asp:DropDownList id="ddlOriginCountry" runat="server" DataTextField="Display" DataValueField="ID1"
																							...
																							<TR>
																								...
																								<TD>
																									<asp:DropDownList id="ddlOriginLocation" runat="server" DataTextField="Display" DataValueField="ID1"
																										AutoPostBack="True"></asp:DropDownList></TD>
																							</TR>
																							<TR>
																								...
																								<TD>
																									<asp:DropDownList id="ddlOriginAgent" runat="server" DataTextField="Display" DataValueField="ID1"
																										AutoPostBack="True"></asp:DropDownList></TD>
																							</TR>
																							<TR>
																								...
																								<TD>
																									<asp:DropDownList id="ddlOriginUser" runat="server" DataTextField="Display" DataValueField="ID1" AutoPostBack="True"></asp:DropDownList></TD>
																							</TR>
																							<TR>
																								...
																								<TR>
																									<TD>
																										<TABLE id="Table8" cellPadding="0" width="100%" border="0">
																											<TR>
																												<TD align="right" width="35%">Country :
																												</TD>
																												<TD>
																													<asp:DropDownList id="ddlDestinationCountry" runat="server" DataTextField="Display" DataValueField="ID1"
																														AutoPostBack="True"></asp:DropDownList></TD>
																											</TR>
																											<TR>
																												...
																												<TD>
																													<asp:DropDownList id="ddlDestinationModeOfPayment" runat="server" DataTextField="Display" DataValueField="ID1"
																														AutoPostBack="True"></asp:DropDownList></TD>
																											</TR>
																											<TR>
																												...
																												<TD height="12">
																													<asp:DropDownList id="ddlDestinationLocation" runat="server" DataTextField="Display" DataValueField="ID1"
																														AutoPostBack="True"></asp:DropDownList></TD>
																											</TR>
																											<TR>
																...
																<tr>
																	<td align="center"><asp:label id="lblMessage" runat="server" ForeColor="OrangeRed" Font-Bold="True" Width="100%"></asp:label></td>
																</tr>
																<tr>
																	<td align="center"><asp:validationsummary id="ValidationSummary1" runat="server" ForeColor="OrangeRed" Font-Bold="True" Width="100%"></asp:validationsummary></td>
																</tr>
																<tr>
																												...
																												<TD>
																													<TABLE id="Table17" cellPadding="0" width="100%" border="0">
																														...
																														<TR>
																															...
																															<TD height="23">
																																<asp:DropDownList id="ddlPayOutCurrency" runat="server" DataTextField="Display" DataValueField="ID1"
																																	AutoPostBack="True"></asp:DropDownList></TD>
																														</TR>
																														<TR>
																				...
																				<TR>
																					<TD align="center">
																						<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
																							...
																							<TR>
																								<TD align="center">
																									<asp:Label id="lblCustomerCardMessage" runat="server" Width="100%"></asp:Label></TD>
																							</TR>
																							<TR>
																								<TD align="center">
																									<TABLE id="Table5" cellPadding="0" width="100%" border="0">
																										<TR>
																											<TD></TD>
																											<TD align="center">
																												<asp:CheckBox id="chbxCreateNewCustomer" runat="server" Text="Create new customer" AutoPostBack="True"
																													Font-Bold="True" Checked="True"></asp:CheckBox>&nbsp;
																											</TD>
																										</TR>
																									</TABLE>
																									<asp:Panel id="pnlExistingCustomer" runat="server" Visible="False">
																										<TABLE id="Table24" cellSpacing="1" cellPadding="1" width="80%" border="0">
																											<TR>
																												<TD align="center">Customer Card No:
																													<asp:TextBox id="txtCustomerCardNumber" runat="server"></asp:TextBox>&nbsp;&nbsp;</TD>
																											</TR>
																											<TR>
																												<TD align="center">
																													<asp:Button id="butCheckCustomerCard" runat="server" Text="Update Customer Record From Database for the Given Card Number"
																								...
																								<TR vAlign="top">
																									<TD width="50%"><!-- Customer Details Start-->
																										<TABLE id="Table21" cellSpacing="0" cellPadding="0" width="100%" border="0">
																															...
																															<TD>
																																<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
																																	...
																																	<TR align="center">
																																		...
																																		<TD>
																																			<asp:DropDownList id="ddlCustomerNationality" runat="server" DataTextField="Display" DataValueField="ID1"
																											...
																											<TR>
																												<TD align="right">
																													<asp:Button id="butUpdateCustomerRecord" runat="server" Text="Update Sender Record" CausesValidation="False"
																									...
																									<TD width="50%">
																										<asp:Panel id="pnlBeneficeryDetails" runat="server"> <!-- Start -->
																											<TABLE id="Table28" cellPadding="0" width="100%" border="0">
																																...
																																<TD width="50%">
																																	<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
																																		<TR>
																																			<TD>Beneficiary</TD>
																																			<TD>
																																				<asp:DropDownList id="ddlBeneficerySelection" runat="server" DataTextField="Display" DataValueField="ID1"
																																					AutoPostBack="True">
																													...
																													<TD>
																														<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
																															...
																															<TR align="center">
																																...
																																<TD>
																																	<asp:DropDownList id="ddlBeneficeryNationality" runat="server" DataTextField="Display" DataValueField="ID1"
																																		Width="180px"></asp:DropDownList></TD>
																															</TR>
																														</TABLE>
																													</TD>
																												...
																												<TR>
																													<TD align="right">
																														<asp:Button id="butUpdateBeneficeryRecord" runat="server" Text="Update Beneficiary Record" CausesValidation="False"
																															Visible="False"></asp:Button></TD>
																												</TR>
																											</TABLE> <!-- End --></asp:Panel></TD>
																								</TR>
																												...
																												<TD>
																													<TABLE id="Table38" cellSpacing="0" cellPadding="0" width="100%" border="0">
																														<TR>
																															...
																															<TD>
																																<asp:DropDownList id="ddlBeneficeryBankSelection" runat="server" DataTextField="Display" DataValueField="ID1"
																																	AutoPostBack="True">
																																	<asp:ListItem Value="New...">New...</asp:ListItem>
																																</asp:DropDownList></TD>
																														</TR>
																...
																<tr>
																	<td align="center"><asp:panel id="pnlBottomPart" dir="ltr" runat="server" Visible="False">
																			<TABLE id="Table43" cellSpacing="0" cellPadding="0" width="100%" border="0">
																				...
																				<TR>
																					<TD align="center">
																						<asp:Button id="butInitiateTransfer" runat="server" Text="Initiate Transfer" Height="30px" Width="40%"
