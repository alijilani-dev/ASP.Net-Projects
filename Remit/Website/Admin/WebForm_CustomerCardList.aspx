<%@ Page language="c#" Codebehind="WebForm_CustomerCardList.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Web.Forms.WebForm_CustomerCardList" %>
...
<title>ARY Speed Remit :: Customer Card List</title>
<!-- InstanceEndEditable -->
        ...
        <tr>
          <td valign="top" bgcolor="#CFCFCF"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center"><font size="4" face="Arial, Helvetica, sans-serif"><!-- InstanceBeginEditable name="Heading" --> &nbsp;Customer Card List <!-- InstanceEndEditable --></font></td>
                  </tr>
              </table></td>
            </tr>
            <tr>
                  ...
                  <td align="center" valign="top"><!-- InstanceBeginEditable name="MainContent" -->&nbsp;
                    ...
                    <asp:panel id="MainDisplay" runat="server">
                      <table border="0" cellspacing="10" cellpadding="5">
                        <tr>
                          <td align="Right" class="MandatoryLabelStyle"> Code </td>
                          <td><asp:TextBox id="txt_Code" runat="server" CssClass="MandatoryTextBoxStyle" tabIndex="1" ></asp:TextBox>
                          </td>
                          <td><asp:Label EnableViewState="False" Visible="False" runat="Server" id="labError_Code" CssClass="ErrorStyle"></asp:Label>
                          </td>
                        </tr>
                        <tr>
                          <td align="Right" class="OptionalLabelStyle"> AgentId </td>
                          <td><DropDownLists:WebDropDownList_AgentLocationList id="com_AgentId" runat="server" CssClass="OptionalComboBoxStyle" tabIndex="2"> </DropDownLists:WebDropDownList_AgentLocationList> </td>
                        </tr>
                        <tr>
                          <td align="Right" class="MandatoryLabelStyle"> Status </td>
                          <td><DropDownLists:WebDropDownList_CustomerCardStatusList id="com_Status" runat="server" CssClass="MandatoryComboBoxStyle" tabIndex="3"> </DropDownLists:WebDropDownList_CustomerCardStatusList> </td>
                        </tr>
                        <tr> </tr>
                        <tr>
                          <td></td>
