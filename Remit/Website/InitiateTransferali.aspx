<%@ Page language="c#" Codebehind="InitiateTransferali.aspx.cs" AutoEventWireup="false" Inherits="Evernet.MoneyExchange.Admin.InitiateTransferali" %>
													...
													<tr>
														<td vAlign="top" bgColor="#000000">
															<table cellSpacing="0" cellPadding="0" width="100%" border="0">
																...
																<tr>
																	<td><font face="Verdana, Arial, Helvetica, sans-serif" color="#ffffff" size="3">We 
												...
												<table cellSpacing="0" cellPadding="0" width="100%" border="0">
													<tr>
														<td align="center"><font face="Arial, Helvetica, sans-serif" size="4"><!-- InstanceBeginEditable name="Heading" --> 
																&nbsp;Initiate Transfer <!-- InstanceEndEditable --></font></td>
													</tr>
												</table>
													...
													<tr>
														<td vAlign="top"><!-- InstanceBeginEditable name="MainContent" -->
															<table cellPadding="0" width="100%" border="0">
																								...
																								<TR>
																									<TD>
																										<TABLE id="Table8" cellPadding="0" width="100%" border="0">
																											<TR>
																												<TD align="right" width="35%" height="12">Country :
																												</TD>
																												<TD height="12">
																...
																<tr>
																	<td align="center"><asp:validationsummary id="ValidationSummary1" runat="server" Width="100%" Font-Bold="True" ForeColor="OrangeRed"></asp:validationsummary></td>
																</tr>
																<tr>
																				...
																				<TR>
																					<TD align="center">
																						<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
																							<TR vAlign="top">
																								<TD>
																									<asp:Panel id="pnlBeneficeryBankDetails" runat="server" DESIGNTIMEDRAGDROP="1664"> <!-- Start -->
																								...
																								<TD width="40%"><!-- Start -->
																									<asp:Panel id="pnlMessageToAgent" runat="server">
																										<TABLE id="Table41" cellSpacing="0" cellPadding="0" width="100%" border="0">
																											<TR>
																												<TD>
																													<TABLE id="Table42" cellPadding="0" width="100%" border="0">
																														<TR>
																															<TD width="80">
																																<HR noShade>
																															</TD>
																															<TD noWrap align="center" width="140"><STRONG>Messages</STRONG></TD>
																															<TD>
																																<HR noShade>
																															</TD>
																														</TR>
																											...
																											<TR>
																												<TD>
																													<TABLE id="Table35" cellSpacing="0" cellPadding="0" width="100%" border="0">
																														<TR>
																															<TD align="right" width="40%">Question :
																															</TD>
																															<TD>
																																<asp:TextBox id="txtBeneficeryQuestion" runat="server" Rows="1" Columns="50" MaxLength="200"></asp:TextBox></TD>
																														</TR>
																														<TR>
																															<TD align="right">Expected Answer :
																															</TD>
																															<TD>
																																<asp:TextBox id="txtBeneficeryAnswer" runat="server" Rows="1" Columns="50" MaxLength="200"></asp:TextBox></TD>
																														</TR>
																														<TR>
																															<TD align="right">Message to Beneficiary:
																															</TD>
																															<TD>
																																<asp:TextBox id="txtBeneficeryMessage" runat="server" Rows="1" Columns="50" MaxLength="300"></asp:TextBox></TD>
																														</TR>
																													</TABLE>
																												</TD>
																											</TR>
																											<TR>
																												<TD>Message to receiving agent :
																												</TD>
																											</TR>
																											<TR>
																												<TD>
																													<asp:TextBox id="txtMessageToAgent" runat="server" Rows="1" Columns="50" MaxLength="300"></asp:TextBox></TD>
																											</TR>
																										</TABLE> <!-- End --></asp:Panel></TD>
																							</TR>
																						</TABLE>
																				...
																				<TR>
																					<TD>
																						<TABLE id="Table45" cellSpacing="0" cellPadding="0" width="100%" border="0">
																							<TR>
																								<TD align="right" width="45%">Transaction Password :(<FONT color="#ff0000">**</FONT>)
																								</TD>
																								<TD>
