...
{
	/// <summary>
	/// Summary description for WebFormList_AgentGroupList.
	/// </summary>
	public class WebFormList_AgentGroupList: System.Web.UI.Page
	{
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		public WebFormList_AgentGroupList() {
		...
		/// [To be supplied.]
		/// </summary>
		protected Evernet.MoneyExchange.Web.Repeaters.WebRepeaterCustom_spS_AgentGroupList_SelectDisplay repeater_AgentGroupList_SelectDisplay;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		/// [To be supplied.]
		/// </summary>
		protected System.Web.UI.WebControls.LinkButton Label_PrefixCode;
		...
		private void Page_Load(object sender, System.EventArgs e) {
			...
			if (!Page.IsPostBack) {
				...
				if (ViewState["WebFormList_AgentGroupList_CurrentSort"] == null) {

					ViewState.Add("WebFormList_AgentGroupList_CurrentSort", sortColumn);
				}
				else {

					ViewState["WebFormList_AgentGroupList_CurrentSort"] = sortColumn;
				}
			...
			repeater_AgentGroupList_SelectDisplay.EnableViewState = true;
		...
		private void InitializeComponent() {
			...
			this.Label_PrefixCode.Click += new System.EventHandler(this.Label_PrefixCode_Click);
		...
		private void RefreshList() {
			...
			repeater_AgentGroupList_SelectDisplay.Initialize(ConnectionString, System.Data.SqlTypes.SqlGuid.Null, AgentAccountId);
			try {

				repeater_AgentGroupList_SelectDisplay.RefreshData();
			}
			catch (Evernet.MoneyExchange.DataClasses.CustomException customException) {

				if (customException.Parameter.SqlException != null) {

					throw new Exception(String.Format("An exception has been thrown in the underlying DataClass that is used by the 'WebRepeater_AgentGroupList' class. Exception message is: {0}", customException.Parameter.SqlException.Message), customException);
				}
				else if (customException.Parameter.OtherException != null) {

					throw new Exception(String.Format("An exception has been thrown in the underlying DataClass that is used by the 'WebRepeater_AgentGroupList' class. Exception message is: {0}", customException.Parameter.OtherException.Message), customException);
				}
				else {
			...
			System.Data.DataView dataView = (System.Data.DataView)repeater_AgentGroupList_SelectDisplay.DataSource;

			string SortDirective = String.Empty;
			switch ((CurrentSortEnum)ViewState["WebFormList_AgentGroupList_CurrentSort"]) {

				case CurrentSortEnum.SortBy_AgentAccountId:
					SortDirective = spS_AgentGroupList_SelectDisplay.Resultset1.Fields.Column_AgentAccountId_Display.ColumnName;
					break;

				case CurrentSortEnum.SortBy_Name:
					SortDirective = spS_AgentGroupList.Resultset1.Fields.Column_Name.ColumnName;
					break;

				case CurrentSortEnum.SortBy_PrefixCode:
					SortDirective = spS_AgentGroupList.Resultset1.Fields.Column_PrefixCode.ColumnName;
					break;
			...
			repeater_AgentGroupList_SelectDisplay.DataBind();
		}

		private void Label_AgentAccountId_Click(object sender, System.EventArgs e) {

			if ((CurrentSortEnum)ViewState["WebFormList_AgentGroupList_CurrentSort"] == CurrentSortEnum.SortBy_AgentAccountId) {
				...
				ViewState["WebFormList_AgentGroupList_CurrentSort"] = CurrentSortEnum.SortBy_AgentAccountId;
			}
		...
		private void Label_Name_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_AgentGroupList_CurrentSort"] == CurrentSortEnum.SortBy_Name) {
				...
				ViewState["WebFormList_AgentGroupList_CurrentSort"] = CurrentSortEnum.SortBy_Name;
			}

			RefreshList();
		}

		private void Label_PrefixCode_Click(object sender, System.EventArgs e) {

			if ((CurrentSortEnum)ViewState["WebFormList_AgentGroupList_CurrentSort"] == CurrentSortEnum.SortBy_PrefixCode) {
				...
				ViewState["WebFormList_AgentGroupList_CurrentSort"] = CurrentSortEnum.SortBy_PrefixCode;
			}
