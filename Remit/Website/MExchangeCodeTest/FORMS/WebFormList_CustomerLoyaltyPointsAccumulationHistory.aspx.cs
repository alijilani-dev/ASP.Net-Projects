...
{
	/// <summary>
	/// Summary description for WebFormList_CustomerLoyaltyPointsAccumulationHistory.
	/// </summary>
	public class WebFormList_CustomerLoyaltyPointsAccumulationHistory: System.Web.UI.Page
	{
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		public WebFormList_CustomerLoyaltyPointsAccumulationHistory() {
		...
		/// [To be supplied.]
		/// </summary>
		protected Evernet.MoneyExchange.Web.Repeaters.WebRepeaterCustom_spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay repeater_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay;
		/// <summary>
		/// [To be supplied.]
		/// </summary>
		...
		private void Page_Load(object sender, System.EventArgs e) {
			...
			if (!Page.IsPostBack) {
				...
				if (ViewState["WebFormList_CustomerLoyaltyPointsAccumulationHistory_CurrentSort"] == null) {

					ViewState.Add("WebFormList_CustomerLoyaltyPointsAccumulationHistory_CurrentSort", sortColumn);
				}
				else {

					ViewState["WebFormList_CustomerLoyaltyPointsAccumulationHistory_CurrentSort"] = sortColumn;
				}
			...
			repeater_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay.EnableViewState = true;
		...
		private void RefreshList() {
			...
			repeater_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay.Initialize(ConnectionString, System.Data.SqlTypes.SqlGuid.Null, CustomerId, TransactionId);
			try {

				repeater_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay.RefreshData();
			}
			catch (Evernet.MoneyExchange.DataClasses.CustomException customException) {

				if (customException.Parameter.SqlException != null) {

					throw new Exception(String.Format("An exception has been thrown in the underlying DataClass that is used by the 'WebRepeater_CustomerLoyaltyPointsAccumulationHistory' class. Exception message is: {0}", customException.Parameter.SqlException.Message), customException);
				}
				else if (customException.Parameter.OtherException != null) {

					throw new Exception(String.Format("An exception has been thrown in the underlying DataClass that is used by the 'WebRepeater_CustomerLoyaltyPointsAccumulationHistory' class. Exception message is: {0}", customException.Parameter.OtherException.Message), customException);
				}
				else {
			...
			System.Data.DataView dataView = (System.Data.DataView)repeater_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay.DataSource;

			string SortDirective = String.Empty;
			switch ((CurrentSortEnum)ViewState["WebFormList_CustomerLoyaltyPointsAccumulationHistory_CurrentSort"]) {

				case CurrentSortEnum.SortBy_CustomerId:
					SortDirective = spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay.Resultset1.Fields.Column_CustomerId_Display.ColumnName;
					break;

				case CurrentSortEnum.SortBy_TransactionId:
					SortDirective = spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay.Resultset1.Fields.Column_TransactionId_Display.ColumnName;
					break;

				case CurrentSortEnum.SortBy_Points:
					SortDirective = spS_CustomerLoyaltyPointsAccumulationHistory.Resultset1.Fields.Column_Points.ColumnName;
					break;
			...
			repeater_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay.DataBind();
		}

		private void Label_CustomerId_Click(object sender, System.EventArgs e) {

			if ((CurrentSortEnum)ViewState["WebFormList_CustomerLoyaltyPointsAccumulationHistory_CurrentSort"] == CurrentSortEnum.SortBy_CustomerId) {
				...
				ViewState["WebFormList_CustomerLoyaltyPointsAccumulationHistory_CurrentSort"] = CurrentSortEnum.SortBy_CustomerId;
			}
		...
		private void Label_TransactionId_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_CustomerLoyaltyPointsAccumulationHistory_CurrentSort"] == CurrentSortEnum.SortBy_TransactionId) {
				...
				ViewState["WebFormList_CustomerLoyaltyPointsAccumulationHistory_CurrentSort"] = CurrentSortEnum.SortBy_TransactionId;
			}
		...
		private void Label_Points_Click(object sender, System.EventArgs e) {
			...
			if ((CurrentSortEnum)ViewState["WebFormList_CustomerLoyaltyPointsAccumulationHistory_CurrentSort"] == CurrentSortEnum.SortBy_Points) {
				...
				ViewState["WebFormList_CustomerLoyaltyPointsAccumulationHistory_CurrentSort"] = CurrentSortEnum.SortBy_Points;
			}
