...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [AgentCommissionSplitList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="AgentCommissionSplitList", SqlObjectDependancyRevision=544)]
#endif
	public class SqlDataAdapter_AgentCommissionSplitList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_AgentCommissionSplitList class.
		...
		public SqlDataAdapter_AgentCommissionSplitList(string connectionString) {
		...
		public SqlDataAdapter_AgentCommissionSplitList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_AgentCommissionSplitList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_AgentCommissionSplitList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_CurrentAccountId">Value for this foreign key.</param>
		/// <param name="FK_EndNodeAccountId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_AgentCommissionSplitList(string connectionString, System.Data.SqlTypes.SqlGuid FK_CurrentAccountId, System.Data.SqlTypes.SqlGuid FK_EndNodeAccountId, string tableName) : this(connectionString) {

			this.Configure(FK_CurrentAccountId, FK_EndNodeAccountId, tableName);
		}
		...
		/// <param name="FK_EndNodeAccountId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_AgentCommissionSplitList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CurrentAccountId, System.Data.SqlTypes.SqlGuid FK_EndNodeAccountId, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_EndNodeAccountId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_AgentCommissionSplitList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_CurrentAccountId, System.Data.SqlTypes.SqlGuid FK_EndNodeAccountId, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_AgentCommissionSplitList class.
		/// The table name in the DataSet will be: AgentCommissionSplitList
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_CurrentAccountId">Value for this foreign key.</param>
		/// <param name="FK_EndNodeAccountId">Value for this foreign key.</param>
		public SqlDataAdapter_AgentCommissionSplitList(string connectionString, System.Data.SqlTypes.SqlGuid FK_CurrentAccountId, System.Data.SqlTypes.SqlGuid FK_EndNodeAccountId) : this(connectionString) {

			this.Configure(FK_CurrentAccountId, FK_EndNodeAccountId, "AgentCommissionSplitList");
		}
		...
		/// <param name="FK_CurrentAccountId">Value for this foreign key.</param>
		/// <param name="FK_EndNodeAccountId">Value for this foreign key.</param>
		public SqlDataAdapter_AgentCommissionSplitList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CurrentAccountId, System.Data.SqlTypes.SqlGuid FK_EndNodeAccountId) : this(sqlConnection) {
		...
		/// <param name="FK_CurrentAccountId">Value for this foreign key.</param>
		/// <param name="FK_EndNodeAccountId">Value for this foreign key.</param>
		public SqlDataAdapter_AgentCommissionSplitList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_CurrentAccountId, System.Data.SqlTypes.SqlGuid FK_EndNodeAccountId) : this(sqlTransaction) {
		...
		/// <param name="FK_CurrentAccountId">Value for this foreign key.</param>
		/// <param name="FK_EndNodeAccountId">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_CurrentAccountId, System.Data.SqlTypes.SqlGuid FK_EndNodeAccountId) {
		...
		/// <param name="FK_EndNodeAccountId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_CurrentAccountId, System.Data.SqlTypes.SqlGuid FK_EndNodeAccountId, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_AgentCommissionSplitList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_AgentCommissionSplitList";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_CurrentAccountId.IsNull) {

				sqlParameter.Value = FK_CurrentAccountId;
			}
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_EndNodeAccountId.IsNull) {

				sqlParameter.Value = FK_EndNodeAccountId;
			}
			...
			sqlInsertCommand.CommandText = "spI_AgentCommissionSplitList";
			...
			sqlUpdateCommand.CommandText = "spU_AgentCommissionSplitList";
			...
			sqlDeleteCommand.CommandText = "spD_AgentCommissionSplitList";
			...
			this.sqlDataAdapter.TableMappings.AddRange (
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						 "AgentCommissionSplitList"
						,tableName
						,new System.Data.Common.DataColumnMapping[] {
							 new System.Data.Common.DataColumnMapping("Id", "Id")
							,new System.Data.Common.DataColumnMapping("CurrentAccountId", "CurrentAccountId")
							,new System.Data.Common.DataColumnMapping("EndNodeAccountId", "EndNodeAccountId")
							,new System.Data.Common.DataColumnMapping("PayInCommission", "PayInCommission")
							,new System.Data.Common.DataColumnMapping("PayOutCommission", "PayOutCommission")
		...
		///the populated table name in the DataSet will be: AgentCommissionSplitList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "AgentCommissionSplitList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "AgentCommissionSplitList", startRecord, maxRecords);
		}
