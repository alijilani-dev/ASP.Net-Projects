...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [AgencyExchangeRateList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:32", SqlObjectDependancyName="AgencyExchangeRateList", SqlObjectDependancyRevision=960)]
#endif
	public class SqlDataAdapter_AgencyExchangeRateList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_AgencyExchangeRateList class.
		...
		public SqlDataAdapter_AgencyExchangeRateList(string connectionString) {
		...
		public SqlDataAdapter_AgencyExchangeRateList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_AgencyExchangeRateList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_AgencyExchangeRateList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_AgencyExchangeRateList(string connectionString, System.Data.SqlTypes.SqlGuid FK_PayInCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCurrencyId, string tableName) : this(connectionString) {

			this.Configure(FK_PayInCountryId, FK_PayOutCountryId, FK_PayOutCurrencyId, tableName);
		}
		...
		/// <param name="FK_PayOutCurrencyId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_AgencyExchangeRateList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_PayInCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCurrencyId, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_PayOutCurrencyId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_AgencyExchangeRateList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_PayInCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCurrencyId, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_AgencyExchangeRateList class.
		/// The table name in the DataSet will be: AgencyExchangeRateList
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_PayInCountryId">Value for this foreign key.</param>
		/// <param name="FK_PayOutCountryId">Value for this foreign key.</param>
		/// <param name="FK_PayOutCurrencyId">Value for this foreign key.</param>
		public SqlDataAdapter_AgencyExchangeRateList(string connectionString, System.Data.SqlTypes.SqlGuid FK_PayInCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCurrencyId) : this(connectionString) {

			this.Configure(FK_PayInCountryId, FK_PayOutCountryId, FK_PayOutCurrencyId, "AgencyExchangeRateList");
		}
		...
		/// <param name="FK_PayOutCountryId">Value for this foreign key.</param>
		/// <param name="FK_PayOutCurrencyId">Value for this foreign key.</param>
		public SqlDataAdapter_AgencyExchangeRateList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_PayInCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCurrencyId) : this(sqlConnection) {
		...
		/// <param name="FK_PayOutCountryId">Value for this foreign key.</param>
		/// <param name="FK_PayOutCurrencyId">Value for this foreign key.</param>
		public SqlDataAdapter_AgencyExchangeRateList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_PayInCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCurrencyId) : this(sqlTransaction) {
		...
		/// <param name="FK_PayOutCountryId">Value for this foreign key.</param>
		/// <param name="FK_PayOutCurrencyId">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_PayInCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCurrencyId) {
		...
		/// <param name="FK_PayOutCurrencyId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_PayInCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCurrencyId, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_AgencyExchangeRateList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_AgencyExchangeRateList";
			...
			sqlInsertCommand.CommandText = "spI_AgencyExchangeRateList";
			...
			sqlUpdateCommand.CommandText = "spU_AgencyExchangeRateList";
			...
			sqlDeleteCommand.CommandText = "spD_AgencyExchangeRateList";
			...
			this.sqlDataAdapter.TableMappings.AddRange (
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						 "AgencyExchangeRateList"
						,tableName
						,new System.Data.Common.DataColumnMapping[] {
							 new System.Data.Common.DataColumnMapping("Id", "Id")
							,new System.Data.Common.DataColumnMapping("ExchangeSetName", "ExchangeSetName")
							...
							,new System.Data.Common.DataColumnMapping("MarginPercent", "MarginPercent")
							,new System.Data.Common.DataColumnMapping("MaximumAgentMargin", "MaximumAgentMargin")
							,new System.Data.Common.DataColumnMapping("MinimumAgentMargin", "MinimumAgentMargin")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: AgencyExchangeRateList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "AgencyExchangeRateList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "AgencyExchangeRateList", startRecord, maxRecords);
		}
