...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [PayInAgentDifferenceIncomeAccount] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="PayInAgentDifferenceIncomeAccount", SqlObjectDependancyRevision=736)]
#endif
	public class SqlDataAdapter_PayInAgentDifferenceIncomeAccount {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_PayInAgentDifferenceIncomeAccount class.
		...
		public SqlDataAdapter_PayInAgentDifferenceIncomeAccount(string connectionString) {
		...
		public SqlDataAdapter_PayInAgentDifferenceIncomeAccount(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_PayInAgentDifferenceIncomeAccount(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_PayInAgentDifferenceIncomeAccount class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_PayInAgentDifferenceIncomeAccount(string connectionString, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_TranasctionId, string tableName) : this(connectionString) {

			this.Configure(FK_AgentAccountId, FK_TranasctionId, tableName);
		}
		...
		/// <param name="FK_TranasctionId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_PayInAgentDifferenceIncomeAccount(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_TranasctionId, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_TranasctionId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_PayInAgentDifferenceIncomeAccount(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_TranasctionId, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_PayInAgentDifferenceIncomeAccount class.
		/// The table name in the DataSet will be: PayInAgentDifferenceIncomeAccount
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_AgentAccountId">Value for this foreign key.</param>
		/// <param name="FK_TranasctionId">Value for this foreign key.</param>
		public SqlDataAdapter_PayInAgentDifferenceIncomeAccount(string connectionString, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_TranasctionId) : this(connectionString) {

			this.Configure(FK_AgentAccountId, FK_TranasctionId, "PayInAgentDifferenceIncomeAccount");
		}
		...
		/// <param name="FK_AgentAccountId">Value for this foreign key.</param>
		/// <param name="FK_TranasctionId">Value for this foreign key.</param>
		public SqlDataAdapter_PayInAgentDifferenceIncomeAccount(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_TranasctionId) : this(sqlConnection) {
		...
		/// <param name="FK_AgentAccountId">Value for this foreign key.</param>
		/// <param name="FK_TranasctionId">Value for this foreign key.</param>
		public SqlDataAdapter_PayInAgentDifferenceIncomeAccount(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_TranasctionId) : this(sqlTransaction) {
		...
		/// <param name="FK_AgentAccountId">Value for this foreign key.</param>
		/// <param name="FK_TranasctionId">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_TranasctionId) {
		...
		/// <param name="FK_TranasctionId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_TranasctionId, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_PayInAgentDifferenceIncomeAccount)");
					}
			...
			sqlSelectCommand.CommandText = "spS_PayInAgentDifferenceIncomeAccount";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_TranasctionId.IsNull) {

				sqlParameter.Value = FK_TranasctionId;
			}
			...
			sqlInsertCommand.CommandText = "spI_PayInAgentDifferenceIncomeAccount";
			...
			sqlUpdateCommand.CommandText = "spU_PayInAgentDifferenceIncomeAccount";
			...
			sqlDeleteCommand.CommandText = "spD_PayInAgentDifferenceIncomeAccount";
			...
			this.sqlDataAdapter.TableMappings.AddRange (
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						 "PayInAgentDifferenceIncomeAccount"
						,tableName
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("TranasctionId", "TranasctionId")
		...
		///the populated table name in the DataSet will be: PayInAgentDifferenceIncomeAccount.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "PayInAgentDifferenceIncomeAccount", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "PayInAgentDifferenceIncomeAccount", startRecord, maxRecords);
		}
