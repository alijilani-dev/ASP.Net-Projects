...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [CustomerLoyaltyPointsRedeemHistory] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="CustomerLoyaltyPointsRedeemHistory", SqlObjectDependancyRevision=480)]
#endif
	public class SqlDataAdapter_CustomerLoyaltyPointsRedeemHistory {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_CustomerLoyaltyPointsRedeemHistory class.
		...
		public SqlDataAdapter_CustomerLoyaltyPointsRedeemHistory(string connectionString) {
		...
		public SqlDataAdapter_CustomerLoyaltyPointsRedeemHistory(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_CustomerLoyaltyPointsRedeemHistory(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_CustomerLoyaltyPointsRedeemHistory class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		/// <param name="FK_ProductsId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_CustomerLoyaltyPointsRedeemHistory(string connectionString, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_ProductsId, string tableName) : this(connectionString) {

			this.Configure(FK_CustomerId, FK_ProductsId, tableName);
		}
		...
		/// <param name="FK_ProductsId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_CustomerLoyaltyPointsRedeemHistory(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_ProductsId, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_ProductsId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_CustomerLoyaltyPointsRedeemHistory(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_ProductsId, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_CustomerLoyaltyPointsRedeemHistory class.
		/// The table name in the DataSet will be: CustomerLoyaltyPointsRedeemHistory
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		/// <param name="FK_ProductsId">Value for this foreign key.</param>
		public SqlDataAdapter_CustomerLoyaltyPointsRedeemHistory(string connectionString, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_ProductsId) : this(connectionString) {

			this.Configure(FK_CustomerId, FK_ProductsId, "CustomerLoyaltyPointsRedeemHistory");
		}
		...
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		/// <param name="FK_ProductsId">Value for this foreign key.</param>
		public SqlDataAdapter_CustomerLoyaltyPointsRedeemHistory(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_ProductsId) : this(sqlConnection) {
		...
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		/// <param name="FK_ProductsId">Value for this foreign key.</param>
		public SqlDataAdapter_CustomerLoyaltyPointsRedeemHistory(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_ProductsId) : this(sqlTransaction) {
		...
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		/// <param name="FK_ProductsId">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_ProductsId) {
		...
		/// <param name="FK_ProductsId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_ProductsId, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_CustomerLoyaltyPointsRedeemHistory)");
					}
			...
			sqlSelectCommand.CommandText = "spS_CustomerLoyaltyPointsRedeemHistory";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_ProductsId.IsNull) {

				sqlParameter.Value = FK_ProductsId;
			}
			...
			sqlInsertCommand.CommandText = "spI_CustomerLoyaltyPointsRedeemHistory";
			...
			sqlUpdateCommand.CommandText = "spU_CustomerLoyaltyPointsRedeemHistory";
			...
			sqlDeleteCommand.CommandText = "spD_CustomerLoyaltyPointsRedeemHistory";
			...
			this.sqlDataAdapter.TableMappings.AddRange (
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						 "CustomerLoyaltyPointsRedeemHistory"
						,tableName
						,new System.Data.Common.DataColumnMapping[] {
							 new System.Data.Common.DataColumnMapping("Id", "Id")
							,new System.Data.Common.DataColumnMapping("Date", "Date")
							,new System.Data.Common.DataColumnMapping("CustomerId", "CustomerId")
							,new System.Data.Common.DataColumnMapping("ProductsId", "ProductsId")
		...
		///the populated table name in the DataSet will be: CustomerLoyaltyPointsRedeemHistory.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "CustomerLoyaltyPointsRedeemHistory", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "CustomerLoyaltyPointsRedeemHistory", startRecord, maxRecords);
		}
