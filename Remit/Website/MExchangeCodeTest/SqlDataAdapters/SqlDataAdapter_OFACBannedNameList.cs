...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [OFACBannedNameList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="OFACBannedNameList", SqlObjectDependancyRevision=352)]
#endif
	public class SqlDataAdapter_OFACBannedNameList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_OFACBannedNameList class.
		/// This constructor will automatically pre-configure the SqlDataAdapter.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public SqlDataAdapter_OFACBannedNameList(string connectionString) {
			...
			this.Configure("OFACBannedNameList");
		}
		...
		public SqlDataAdapter_OFACBannedNameList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_OFACBannedNameList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_OFACBannedNameList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_OFACBannedNameList(string connectionString, string tableName) : this(connectionString) {
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_OFACBannedNameList(System.Data.SqlClient.SqlConnection sqlConnection, string tableName) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_OFACBannedNameList(System.Data.SqlClient.SqlTransaction sqlTransaction, string tableName) : this(sqlTransaction) {
		...
		/// The table name in the DataSet will be: OFACBannedNameList
		/// </summary>
		...
		public void Configure(string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_OFACBannedNameList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_OFACBannedNameList";
			...
			sqlInsertCommand.CommandText = "spI_OFACBannedNameList";
			...
			sqlUpdateCommand.CommandText = "spU_OFACBannedNameList";
			...
			sqlDeleteCommand.CommandText = "spD_OFACBannedNameList";
		...
		///the populated table name in the DataSet will be: OFACBannedNameList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "OFACBannedNameList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "OFACBannedNameList", startRecord, maxRecords);
		}
