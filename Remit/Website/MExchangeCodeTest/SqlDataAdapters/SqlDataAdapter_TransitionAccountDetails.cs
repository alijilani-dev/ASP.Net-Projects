...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [TransitionAccountDetails] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="TransitionAccountDetails", SqlObjectDependancyRevision=1264)]
#endif
	public class SqlDataAdapter_TransitionAccountDetails {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_TransitionAccountDetails class.
		...
		public SqlDataAdapter_TransitionAccountDetails(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'TransitionAccountDetails'";
		...
		public SqlDataAdapter_TransitionAccountDetails(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_TransitionAccountDetails(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_TransitionAccountDetails class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_TransitionAccountDetails(string connectionString, System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) : this(connectionString) {

			this.Configure(FK_TransactionId, tableName);
		}
		...
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_TransitionAccountDetails(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_TransitionAccountDetails(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_TransitionAccountDetails class.
		/// The table name in the DataSet will be: TransitionAccountDetails
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public SqlDataAdapter_TransitionAccountDetails(string connectionString, System.Data.SqlTypes.SqlGuid FK_TransactionId) : this(connectionString) {

			this.Configure(FK_TransactionId, "TransitionAccountDetails");
		}
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public SqlDataAdapter_TransitionAccountDetails(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_TransactionId) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public SqlDataAdapter_TransitionAccountDetails(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_TransactionId) : this(sqlTransaction) {
		...
		/// </summary>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_TransactionId) {
		...
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_TransitionAccountDetails)");
					}
			...
			sqlSelectCommand.CommandText = "spS_TransitionAccountDetails";
			...
			sqlInsertCommand.CommandText = "spI_TransitionAccountDetails";
			...
			sqlUpdateCommand.CommandText = "spU_TransitionAccountDetails";
			...
			sqlDeleteCommand.CommandText = "spD_TransitionAccountDetails";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("CreditLC", "CreditLC")
							,new System.Data.Common.DataColumnMapping("CreditUSD", "CreditUSD")
							,new System.Data.Common.DataColumnMapping("DebitLC", "DebitLC")
							,new System.Data.Common.DataColumnMapping("DebitUSD", "DebitUSD")
		...
		///the populated table name in the DataSet will be: TransitionAccountDetails.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "TransitionAccountDetails", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "TransitionAccountDetails", startRecord, maxRecords);
		}
