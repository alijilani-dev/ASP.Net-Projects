...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [BeneficeryBankList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="BeneficeryBankList", SqlObjectDependancyRevision=1008)]
#endif
	public class SqlDataAdapter_BeneficeryBankList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_BeneficeryBankList class.
		...
		public SqlDataAdapter_BeneficeryBankList(string connectionString) {
		...
		public SqlDataAdapter_BeneficeryBankList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_BeneficeryBankList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_BeneficeryBankList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_BeneficeryBankList(string connectionString, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_CountryId, string tableName) : this(connectionString) {

			this.Configure(FK_CustomerId, FK_CountryId, tableName);
		}
		...
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_BeneficeryBankList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_CountryId, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_BeneficeryBankList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_CountryId, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_BeneficeryBankList class.
		/// The table name in the DataSet will be: BeneficeryBankList
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		public SqlDataAdapter_BeneficeryBankList(string connectionString, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_CountryId) : this(connectionString) {

			this.Configure(FK_CustomerId, FK_CountryId, "BeneficeryBankList");
		}
		...
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		public SqlDataAdapter_BeneficeryBankList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_CountryId) : this(sqlConnection) {
		...
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		public SqlDataAdapter_BeneficeryBankList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_CountryId) : this(sqlTransaction) {
		...
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_CountryId) {
		...
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_CountryId, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_BeneficeryBankList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_BeneficeryBankList";
			...
			sqlInsertCommand.CommandText = "spI_BeneficeryBankList";
			...
			sqlUpdateCommand.CommandText = "spU_BeneficeryBankList";
			...
			sqlDeleteCommand.CommandText = "spD_BeneficeryBankList";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("RegistrationDateTime", "RegistrationDateTime")
		...
		///the populated table name in the DataSet will be: BeneficeryBankList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "BeneficeryBankList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "BeneficeryBankList", startRecord, maxRecords);
		}
