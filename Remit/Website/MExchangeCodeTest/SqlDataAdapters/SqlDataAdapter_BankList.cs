...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [BankList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="BankList", SqlObjectDependancyRevision=1280)]
#endif
	public class SqlDataAdapter_BankList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_BankList class.
		...
		public SqlDataAdapter_BankList(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'BankList'";
		...
		public SqlDataAdapter_BankList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_BankList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_BankList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_AccountId">Value for this foreign key.</param>
		/// <param name="FK_LocationId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_BankList(string connectionString, System.Data.SqlTypes.SqlGuid FK_AccountId, System.Data.SqlTypes.SqlGuid FK_LocationId, string tableName) : this(connectionString) {

			this.Configure(FK_AccountId, FK_LocationId, tableName);
		}
		...
		/// <param name="FK_LocationId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_BankList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_AccountId, System.Data.SqlTypes.SqlGuid FK_LocationId, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_LocationId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_BankList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_AccountId, System.Data.SqlTypes.SqlGuid FK_LocationId, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_BankList class.
		/// The table name in the DataSet will be: BankList
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_AccountId">Value for this foreign key.</param>
		/// <param name="FK_LocationId">Value for this foreign key.</param>
		public SqlDataAdapter_BankList(string connectionString, System.Data.SqlTypes.SqlGuid FK_AccountId, System.Data.SqlTypes.SqlGuid FK_LocationId) : this(connectionString) {

			this.Configure(FK_AccountId, FK_LocationId, "BankList");
		}
		...
		/// <param name="FK_AccountId">Value for this foreign key.</param>
		/// <param name="FK_LocationId">Value for this foreign key.</param>
		public SqlDataAdapter_BankList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_AccountId, System.Data.SqlTypes.SqlGuid FK_LocationId) : this(sqlConnection) {
		...
		/// <param name="FK_AccountId">Value for this foreign key.</param>
		/// <param name="FK_LocationId">Value for this foreign key.</param>
		public SqlDataAdapter_BankList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_AccountId, System.Data.SqlTypes.SqlGuid FK_LocationId) : this(sqlTransaction) {
		...
		/// <param name="FK_AccountId">Value for this foreign key.</param>
		/// <param name="FK_LocationId">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_AccountId, System.Data.SqlTypes.SqlGuid FK_LocationId) {
		...
		/// <param name="FK_LocationId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_AccountId, System.Data.SqlTypes.SqlGuid FK_LocationId, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_BankList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_BankList";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_AccountId.IsNull) {

				sqlParameter.Value = FK_AccountId;
			}
			...
			sqlInsertCommand.CommandText = "spI_BankList";
			...
			sqlUpdateCommand.CommandText = "spU_BankList";
			...
			sqlDeleteCommand.CommandText = "spD_BankList";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("InternalCode", "InternalCode")
							,new System.Data.Common.DataColumnMapping("ExternalCode", "ExternalCode")
		...
		///the populated table name in the DataSet will be: BankList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "BankList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "BankList", startRecord, maxRecords);
		}
