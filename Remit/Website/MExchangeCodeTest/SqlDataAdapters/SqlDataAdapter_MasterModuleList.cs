...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [MasterModuleList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="MasterModuleList", SqlObjectDependancyRevision=208)]
#endif
	public class SqlDataAdapter_MasterModuleList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_MasterModuleList class.
		/// This constructor will automatically pre-configure the SqlDataAdapter.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public SqlDataAdapter_MasterModuleList(string connectionString) {
			...
			this.Configure("MasterModuleList");
		}
		...
		public SqlDataAdapter_MasterModuleList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_MasterModuleList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_MasterModuleList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_MasterModuleList(string connectionString, string tableName) : this(connectionString) {
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_MasterModuleList(System.Data.SqlClient.SqlConnection sqlConnection, string tableName) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_MasterModuleList(System.Data.SqlClient.SqlTransaction sqlTransaction, string tableName) : this(sqlTransaction) {
		...
		/// The table name in the DataSet will be: MasterModuleList
		/// </summary>
		...
		public void Configure(string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_MasterModuleList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_MasterModuleList";
			...
			sqlInsertCommand.CommandText = "spI_MasterModuleList";
			...
			sqlUpdateCommand.CommandText = "spU_MasterModuleList";
			...
			sqlDeleteCommand.CommandText = "spD_MasterModuleList";
		...
		///the populated table name in the DataSet will be: MasterModuleList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "MasterModuleList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "MasterModuleList", startRecord, maxRecords);
		}
