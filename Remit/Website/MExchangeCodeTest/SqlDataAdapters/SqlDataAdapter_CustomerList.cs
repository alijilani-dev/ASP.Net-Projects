...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [CustomerList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="CustomerList", SqlObjectDependancyRevision=1984)]
#endif
	public class SqlDataAdapter_CustomerList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_CustomerList class.
		...
		public SqlDataAdapter_CustomerList(string connectionString) {
		...
		public SqlDataAdapter_CustomerList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_CustomerList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_CustomerList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_CardId">Value for this foreign key.</param>
		/// <param name="FK_Nationality">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_CustomerList(string connectionString, System.Data.SqlTypes.SqlGuid FK_CardId, System.Data.SqlTypes.SqlString FK_Nationality, string tableName) : this(connectionString) {

			this.Configure(FK_CardId, FK_Nationality, tableName);
		}
		...
		/// <param name="FK_Nationality">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_CustomerList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CardId, System.Data.SqlTypes.SqlString FK_Nationality, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_Nationality">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_CustomerList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_CardId, System.Data.SqlTypes.SqlString FK_Nationality, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_CustomerList class.
		/// The table name in the DataSet will be: CustomerList
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_CardId">Value for this foreign key.</param>
		/// <param name="FK_Nationality">Value for this foreign key.</param>
		public SqlDataAdapter_CustomerList(string connectionString, System.Data.SqlTypes.SqlGuid FK_CardId, System.Data.SqlTypes.SqlString FK_Nationality) : this(connectionString) {

			this.Configure(FK_CardId, FK_Nationality, "CustomerList");
		}
		...
		/// <param name="FK_CardId">Value for this foreign key.</param>
		/// <param name="FK_Nationality">Value for this foreign key.</param>
		public SqlDataAdapter_CustomerList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CardId, System.Data.SqlTypes.SqlString FK_Nationality) : this(sqlConnection) {
		...
		/// <param name="FK_CardId">Value for this foreign key.</param>
		/// <param name="FK_Nationality">Value for this foreign key.</param>
		public SqlDataAdapter_CustomerList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_CardId, System.Data.SqlTypes.SqlString FK_Nationality) : this(sqlTransaction) {
		...
		/// <param name="FK_CardId">Value for this foreign key.</param>
		/// <param name="FK_Nationality">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_CardId, System.Data.SqlTypes.SqlString FK_Nationality) {
		...
		/// <param name="FK_Nationality">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_CardId, System.Data.SqlTypes.SqlString FK_Nationality, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_CustomerList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_CustomerList";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_Nationality.IsNull) {

				sqlParameter.Value = FK_Nationality;
			}
			...
			sqlInsertCommand.CommandText = "spI_CustomerList";
			...
			sqlUpdateCommand.CommandText = "spU_CustomerList";
			...
			sqlDeleteCommand.CommandText = "spD_CustomerList";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("IDDetails", "IDDetails")
							,new System.Data.Common.DataColumnMapping("IDExpirationDate", "IDExpirationDate")
							,new System.Data.Common.DataColumnMapping("Nationality", "Nationality")
							,new System.Data.Common.DataColumnMapping("Active", "Active")
							,new System.Data.Common.DataColumnMapping("AccountActivated", "AccountActivated")
							,new System.Data.Common.DataColumnMapping("CardIssued", "CardIssued")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: CustomerList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "CustomerList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "CustomerList", startRecord, maxRecords);
		}
