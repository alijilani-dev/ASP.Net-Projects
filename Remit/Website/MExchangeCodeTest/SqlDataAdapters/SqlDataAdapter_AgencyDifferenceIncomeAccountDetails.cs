...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [AgencyDifferenceIncomeAccountDetails] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:32", SqlObjectDependancyName="AgencyDifferenceIncomeAccountDetails", SqlObjectDependancyRevision=640)]
#endif
	public class SqlDataAdapter_AgencyDifferenceIncomeAccountDetails {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_AgencyDifferenceIncomeAccountDetails class.
		...
		public SqlDataAdapter_AgencyDifferenceIncomeAccountDetails(string connectionString) {
		...
		public SqlDataAdapter_AgencyDifferenceIncomeAccountDetails(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_AgencyDifferenceIncomeAccountDetails(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_AgencyDifferenceIncomeAccountDetails class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_AgencyDifferenceIncomeAccountDetails(string connectionString, System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) : this(connectionString) {
		...
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_AgencyDifferenceIncomeAccountDetails(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_AgencyDifferenceIncomeAccountDetails(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_AgencyDifferenceIncomeAccountDetails class.
		/// The table name in the DataSet will be: AgencyDifferenceIncomeAccountDetails
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public SqlDataAdapter_AgencyDifferenceIncomeAccountDetails(string connectionString, System.Data.SqlTypes.SqlGuid FK_TransactionId) : this(connectionString) {

			this.Configure(FK_TransactionId, "AgencyDifferenceIncomeAccountDetails");
		}
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public SqlDataAdapter_AgencyDifferenceIncomeAccountDetails(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_TransactionId) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public SqlDataAdapter_AgencyDifferenceIncomeAccountDetails(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_TransactionId) : this(sqlTransaction) {
		...
		public void Configure(System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_AgencyDifferenceIncomeAccountDetails)");
					}
			...
			sqlSelectCommand.CommandText = "spS_AgencyDifferenceIncomeAccountDetails";
			...
			sqlInsertCommand.CommandText = "spI_AgencyDifferenceIncomeAccountDetails";
			...
			sqlUpdateCommand.CommandText = "spU_AgencyDifferenceIncomeAccountDetails";
			...
			sqlDeleteCommand.CommandText = "spD_AgencyDifferenceIncomeAccountDetails";
			...
			this.sqlDataAdapter.TableMappings.AddRange (
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						 "AgencyDifferenceIncomeAccountDetails"
						,tableName
		...
		///the populated table name in the DataSet will be: AgencyDifferenceIncomeAccountDetails.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "AgencyDifferenceIncomeAccountDetails", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "AgencyDifferenceIncomeAccountDetails", startRecord, maxRecords);
		}
