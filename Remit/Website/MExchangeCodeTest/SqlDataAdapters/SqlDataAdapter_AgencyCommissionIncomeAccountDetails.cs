...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [AgencyCommissionIncomeAccountDetails] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:32", SqlObjectDependancyName="AgencyCommissionIncomeAccountDetails", SqlObjectDependancyRevision=576)]
#endif
	public class SqlDataAdapter_AgencyCommissionIncomeAccountDetails {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_AgencyCommissionIncomeAccountDetails class.
		...
		public SqlDataAdapter_AgencyCommissionIncomeAccountDetails(string connectionString) {
		...
		public SqlDataAdapter_AgencyCommissionIncomeAccountDetails(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_AgencyCommissionIncomeAccountDetails(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_AgencyCommissionIncomeAccountDetails class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_AgencyCommissionIncomeAccountDetails(string connectionString, System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) : this(connectionString) {
		...
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_AgencyCommissionIncomeAccountDetails(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_AgencyCommissionIncomeAccountDetails(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_AgencyCommissionIncomeAccountDetails class.
		/// The table name in the DataSet will be: AgencyCommissionIncomeAccountDetails
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public SqlDataAdapter_AgencyCommissionIncomeAccountDetails(string connectionString, System.Data.SqlTypes.SqlGuid FK_TransactionId) : this(connectionString) {

			this.Configure(FK_TransactionId, "AgencyCommissionIncomeAccountDetails");
		}
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public SqlDataAdapter_AgencyCommissionIncomeAccountDetails(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_TransactionId) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public SqlDataAdapter_AgencyCommissionIncomeAccountDetails(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_TransactionId) : this(sqlTransaction) {
		...
		public void Configure(System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_AgencyCommissionIncomeAccountDetails)");
					}
			...
			sqlSelectCommand.CommandText = "spS_AgencyCommissionIncomeAccountDetails";
			...
			sqlInsertCommand.CommandText = "spI_AgencyCommissionIncomeAccountDetails";
			...
			sqlUpdateCommand.CommandText = "spU_AgencyCommissionIncomeAccountDetails";
			...
			sqlDeleteCommand.CommandText = "spD_AgencyCommissionIncomeAccountDetails";
			...
			this.sqlDataAdapter.TableMappings.AddRange (
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						 "AgencyCommissionIncomeAccountDetails"
						,tableName
		...
		///the populated table name in the DataSet will be: AgencyCommissionIncomeAccountDetails.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "AgencyCommissionIncomeAccountDetails", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "AgencyCommissionIncomeAccountDetails", startRecord, maxRecords);
		}
