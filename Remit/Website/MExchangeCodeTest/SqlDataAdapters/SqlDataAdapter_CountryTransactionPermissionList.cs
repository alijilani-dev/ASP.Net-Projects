...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [CountryTransactionPermissionList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="CountryTransactionPermissionList", SqlObjectDependancyRevision=560)]
#endif
	public class SqlDataAdapter_CountryTransactionPermissionList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_CountryTransactionPermissionList class.
		...
		public SqlDataAdapter_CountryTransactionPermissionList(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'CountryTransactionPermissionList'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "CountryTransactionPermissionList", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		public SqlDataAdapter_CountryTransactionPermissionList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_CountryTransactionPermissionList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_CountryTransactionPermissionList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_BaseCountryId">Value for this foreign key.</param>
		/// <param name="FK_TargetCountryId">Value for this foreign key.</param>
		/// <param name="FK_PermissionType">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_CountryTransactionPermissionList(string connectionString, System.Data.SqlTypes.SqlGuid FK_BaseCountryId, System.Data.SqlTypes.SqlGuid FK_TargetCountryId, System.Data.SqlTypes.SqlString FK_PermissionType, string tableName) : this(connectionString) {

			this.Configure(FK_BaseCountryId, FK_TargetCountryId, FK_PermissionType, tableName);
		}
		...
		/// <param name="FK_PermissionType">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_CountryTransactionPermissionList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_BaseCountryId, System.Data.SqlTypes.SqlGuid FK_TargetCountryId, System.Data.SqlTypes.SqlString FK_PermissionType, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_PermissionType">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_CountryTransactionPermissionList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_BaseCountryId, System.Data.SqlTypes.SqlGuid FK_TargetCountryId, System.Data.SqlTypes.SqlString FK_PermissionType, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_CountryTransactionPermissionList class.
		/// The table name in the DataSet will be: CountryTransactionPermissionList
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_BaseCountryId">Value for this foreign key.</param>
		/// <param name="FK_TargetCountryId">Value for this foreign key.</param>
		/// <param name="FK_PermissionType">Value for this foreign key.</param>
		public SqlDataAdapter_CountryTransactionPermissionList(string connectionString, System.Data.SqlTypes.SqlGuid FK_BaseCountryId, System.Data.SqlTypes.SqlGuid FK_TargetCountryId, System.Data.SqlTypes.SqlString FK_PermissionType) : this(connectionString) {

			this.Configure(FK_BaseCountryId, FK_TargetCountryId, FK_PermissionType, "CountryTransactionPermissionList");
		}
		...
		/// <param name="FK_TargetCountryId">Value for this foreign key.</param>
		/// <param name="FK_PermissionType">Value for this foreign key.</param>
		public SqlDataAdapter_CountryTransactionPermissionList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_BaseCountryId, System.Data.SqlTypes.SqlGuid FK_TargetCountryId, System.Data.SqlTypes.SqlString FK_PermissionType) : this(sqlConnection) {
		...
		/// <param name="FK_TargetCountryId">Value for this foreign key.</param>
		/// <param name="FK_PermissionType">Value for this foreign key.</param>
		public SqlDataAdapter_CountryTransactionPermissionList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_BaseCountryId, System.Data.SqlTypes.SqlGuid FK_TargetCountryId, System.Data.SqlTypes.SqlString FK_PermissionType) : this(sqlTransaction) {
		...
		/// <param name="FK_TargetCountryId">Value for this foreign key.</param>
		/// <param name="FK_PermissionType">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_BaseCountryId, System.Data.SqlTypes.SqlGuid FK_TargetCountryId, System.Data.SqlTypes.SqlString FK_PermissionType) {
		...
		/// <param name="FK_PermissionType">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_BaseCountryId, System.Data.SqlTypes.SqlGuid FK_TargetCountryId, System.Data.SqlTypes.SqlString FK_PermissionType, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_CountryTransactionPermissionList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_CountryTransactionPermissionList";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_BaseCountryId.IsNull) {

				sqlParameter.Value = FK_BaseCountryId;
			}
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_TargetCountryId.IsNull) {

				sqlParameter.Value = FK_TargetCountryId;
			}
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_PermissionType.IsNull) {

				sqlParameter.Value = FK_PermissionType;
			}
			...
			sqlInsertCommand.CommandText = "spI_CountryTransactionPermissionList";
			...
			sqlUpdateCommand.CommandText = "spU_CountryTransactionPermissionList";
			...
			sqlDeleteCommand.CommandText = "spD_CountryTransactionPermissionList";
			...
			this.sqlDataAdapter.TableMappings.AddRange (
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						 "CountryTransactionPermissionList"
						,tableName
						,new System.Data.Common.DataColumnMapping[] {
							 new System.Data.Common.DataColumnMapping("Id", "Id")
							,new System.Data.Common.DataColumnMapping("BaseCountryId", "BaseCountryId")
							,new System.Data.Common.DataColumnMapping("TargetCountryId", "TargetCountryId")
							,new System.Data.Common.DataColumnMapping("PermissionType", "PermissionType")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: CountryTransactionPermissionList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "CountryTransactionPermissionList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "CountryTransactionPermissionList", startRecord, maxRecords);
		}
