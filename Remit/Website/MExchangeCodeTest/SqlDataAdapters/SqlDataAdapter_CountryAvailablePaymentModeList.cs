...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [CountryAvailablePaymentModeList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="CountryAvailablePaymentModeList", SqlObjectDependancyRevision=432)]
#endif
	public class SqlDataAdapter_CountryAvailablePaymentModeList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_CountryAvailablePaymentModeList class.
		...
		public SqlDataAdapter_CountryAvailablePaymentModeList(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'CountryAvailablePaymentModeList'";
		...
		public SqlDataAdapter_CountryAvailablePaymentModeList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_CountryAvailablePaymentModeList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_CountryAvailablePaymentModeList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_CountryAvailablePaymentModeList(string connectionString, System.Data.SqlTypes.SqlGuid FK_CountryId, System.Data.SqlTypes.SqlString FK_PaymentMode, string tableName) : this(connectionString) {

			this.Configure(FK_CountryId, FK_PaymentMode, tableName);
		}
		...
		/// <param name="FK_PaymentMode">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_CountryAvailablePaymentModeList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CountryId, System.Data.SqlTypes.SqlString FK_PaymentMode, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_PaymentMode">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_CountryAvailablePaymentModeList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_CountryId, System.Data.SqlTypes.SqlString FK_PaymentMode, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_CountryAvailablePaymentModeList class.
		/// The table name in the DataSet will be: CountryAvailablePaymentModeList
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		/// <param name="FK_PaymentMode">Value for this foreign key.</param>
		public SqlDataAdapter_CountryAvailablePaymentModeList(string connectionString, System.Data.SqlTypes.SqlGuid FK_CountryId, System.Data.SqlTypes.SqlString FK_PaymentMode) : this(connectionString) {

			this.Configure(FK_CountryId, FK_PaymentMode, "CountryAvailablePaymentModeList");
		}
		...
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		/// <param name="FK_PaymentMode">Value for this foreign key.</param>
		public SqlDataAdapter_CountryAvailablePaymentModeList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CountryId, System.Data.SqlTypes.SqlString FK_PaymentMode) : this(sqlConnection) {
		...
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		/// <param name="FK_PaymentMode">Value for this foreign key.</param>
		public SqlDataAdapter_CountryAvailablePaymentModeList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_CountryId, System.Data.SqlTypes.SqlString FK_PaymentMode) : this(sqlTransaction) {
		...
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		/// <param name="FK_PaymentMode">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_CountryId, System.Data.SqlTypes.SqlString FK_PaymentMode) {
		...
		/// <param name="FK_PaymentMode">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_CountryId, System.Data.SqlTypes.SqlString FK_PaymentMode, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_CountryAvailablePaymentModeList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_CountryAvailablePaymentModeList";
			...
			sqlInsertCommand.CommandText = "spI_CountryAvailablePaymentModeList";
			...
			sqlUpdateCommand.CommandText = "spU_CountryAvailablePaymentModeList";
			...
			sqlDeleteCommand.CommandText = "spD_CountryAvailablePaymentModeList";
			...
			this.sqlDataAdapter.TableMappings.AddRange (
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						 "CountryAvailablePaymentModeList"
						,tableName
		...
		///the populated table name in the DataSet will be: CountryAvailablePaymentModeList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "CountryAvailablePaymentModeList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "CountryAvailablePaymentModeList", startRecord, maxRecords);
		}
