...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [LocationList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="LocationList", SqlObjectDependancyRevision=1056)]
#endif
	public class SqlDataAdapter_LocationList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_LocationList class.
		...
		public SqlDataAdapter_LocationList(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'LocationList'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "LocationList", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		public SqlDataAdapter_LocationList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_LocationList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_LocationList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_LocationList(string connectionString, System.Data.SqlTypes.SqlGuid FK_ParentId, System.Data.SqlTypes.SqlGuid FK_CountryId, string tableName) : this(connectionString) {
		...
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_LocationList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_ParentId, System.Data.SqlTypes.SqlGuid FK_CountryId, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_LocationList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_ParentId, System.Data.SqlTypes.SqlGuid FK_CountryId, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_LocationList class.
		/// The table name in the DataSet will be: LocationList
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_ParentId">Value for this foreign key.</param>
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		public SqlDataAdapter_LocationList(string connectionString, System.Data.SqlTypes.SqlGuid FK_ParentId, System.Data.SqlTypes.SqlGuid FK_CountryId) : this(connectionString) {

			this.Configure(FK_ParentId, FK_CountryId, "LocationList");
		}
		...
		/// <param name="FK_ParentId">Value for this foreign key.</param>
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		public SqlDataAdapter_LocationList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_ParentId, System.Data.SqlTypes.SqlGuid FK_CountryId) : this(sqlConnection) {
		...
		/// <param name="FK_ParentId">Value for this foreign key.</param>
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		public SqlDataAdapter_LocationList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_ParentId, System.Data.SqlTypes.SqlGuid FK_CountryId) : this(sqlTransaction) {
		...
		public void Configure(System.Data.SqlTypes.SqlGuid FK_ParentId, System.Data.SqlTypes.SqlGuid FK_CountryId, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_LocationList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_LocationList";
			...
			sqlInsertCommand.CommandText = "spI_LocationList";
			...
			sqlUpdateCommand.CommandText = "spU_LocationList";
			...
			sqlDeleteCommand.CommandText = "spD_LocationList";
		...
		///the populated table name in the DataSet will be: LocationList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "LocationList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "LocationList", startRecord, maxRecords);
		}
