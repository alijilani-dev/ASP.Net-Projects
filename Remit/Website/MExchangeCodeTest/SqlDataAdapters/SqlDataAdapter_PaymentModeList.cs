...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [PaymentModeList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="PaymentModeList", SqlObjectDependancyRevision=816)]
#endif
	public class SqlDataAdapter_PaymentModeList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_PaymentModeList class.
		...
		public SqlDataAdapter_PaymentModeList(string connectionString) {
		...
		public SqlDataAdapter_PaymentModeList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_PaymentModeList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_PaymentModeList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_BaseType">Value for this foreign key.</param>
		/// <param name="FK_ChannelThrough">Value for this foreign key.</param>
		/// <param name="FK_FinalEntity">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_PaymentModeList(string connectionString, System.Data.SqlTypes.SqlString FK_BaseType, System.Data.SqlTypes.SqlString FK_ChannelThrough, System.Data.SqlTypes.SqlString FK_FinalEntity, string tableName) : this(connectionString) {

			this.Configure(FK_BaseType, FK_ChannelThrough, FK_FinalEntity, tableName);
		}
		...
		/// <param name="FK_FinalEntity">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_PaymentModeList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_BaseType, System.Data.SqlTypes.SqlString FK_ChannelThrough, System.Data.SqlTypes.SqlString FK_FinalEntity, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_FinalEntity">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_PaymentModeList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_BaseType, System.Data.SqlTypes.SqlString FK_ChannelThrough, System.Data.SqlTypes.SqlString FK_FinalEntity, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_PaymentModeList class.
		/// The table name in the DataSet will be: PaymentModeList
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_BaseType">Value for this foreign key.</param>
		/// <param name="FK_ChannelThrough">Value for this foreign key.</param>
		/// <param name="FK_FinalEntity">Value for this foreign key.</param>
		public SqlDataAdapter_PaymentModeList(string connectionString, System.Data.SqlTypes.SqlString FK_BaseType, System.Data.SqlTypes.SqlString FK_ChannelThrough, System.Data.SqlTypes.SqlString FK_FinalEntity) : this(connectionString) {

			this.Configure(FK_BaseType, FK_ChannelThrough, FK_FinalEntity, "PaymentModeList");
		}
		...
		/// <param name="FK_ChannelThrough">Value for this foreign key.</param>
		/// <param name="FK_FinalEntity">Value for this foreign key.</param>
		public SqlDataAdapter_PaymentModeList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_BaseType, System.Data.SqlTypes.SqlString FK_ChannelThrough, System.Data.SqlTypes.SqlString FK_FinalEntity) : this(sqlConnection) {
		...
		/// <param name="FK_ChannelThrough">Value for this foreign key.</param>
		/// <param name="FK_FinalEntity">Value for this foreign key.</param>
		public SqlDataAdapter_PaymentModeList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_BaseType, System.Data.SqlTypes.SqlString FK_ChannelThrough, System.Data.SqlTypes.SqlString FK_FinalEntity) : this(sqlTransaction) {
		...
		/// <param name="FK_ChannelThrough">Value for this foreign key.</param>
		/// <param name="FK_FinalEntity">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_BaseType, System.Data.SqlTypes.SqlString FK_ChannelThrough, System.Data.SqlTypes.SqlString FK_FinalEntity) {
		...
		/// <param name="FK_FinalEntity">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_BaseType, System.Data.SqlTypes.SqlString FK_ChannelThrough, System.Data.SqlTypes.SqlString FK_FinalEntity, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_PaymentModeList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_PaymentModeList";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_BaseType.IsNull) {

				sqlParameter.Value = FK_BaseType;
			}
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_ChannelThrough.IsNull) {

				sqlParameter.Value = FK_ChannelThrough;
			}
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_FinalEntity.IsNull) {

				sqlParameter.Value = FK_FinalEntity;
			}
			...
			sqlInsertCommand.CommandText = "spI_PaymentModeList";
			...
			sqlUpdateCommand.CommandText = "spU_PaymentModeList";
			...
			sqlDeleteCommand.CommandText = "spD_PaymentModeList";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("BaseType", "BaseType")
							,new System.Data.Common.DataColumnMapping("ChannelThrough", "ChannelThrough")
							,new System.Data.Common.DataColumnMapping("FinalEntity", "FinalEntity")
		...
		///the populated table name in the DataSet will be: PaymentModeList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "PaymentModeList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "PaymentModeList", startRecord, maxRecords);
		}
