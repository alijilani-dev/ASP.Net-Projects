...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [PaymentHistory] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="PaymentHistory", SqlObjectDependancyRevision=688)]
#endif
	public class SqlDataAdapter_PaymentHistory {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_PaymentHistory class.
		...
		public SqlDataAdapter_PaymentHistory(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'PaymentHistory'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "PaymentHistory", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		public SqlDataAdapter_PaymentHistory(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_PaymentHistory(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_PaymentHistory class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_PaymentCurrencyId">Value for this foreign key.</param>
		/// <param name="FK_Type">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_PaymentHistory(string connectionString, System.Data.SqlTypes.SqlGuid FK_PaymentCurrencyId, System.Data.SqlTypes.SqlString FK_Type, string tableName) : this(connectionString) {

			this.Configure(FK_PaymentCurrencyId, FK_Type, tableName);
		}
		...
		/// <param name="FK_Type">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_PaymentHistory(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_PaymentCurrencyId, System.Data.SqlTypes.SqlString FK_Type, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_Type">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_PaymentHistory(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_PaymentCurrencyId, System.Data.SqlTypes.SqlString FK_Type, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_PaymentHistory class.
		/// The table name in the DataSet will be: PaymentHistory
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_PaymentCurrencyId">Value for this foreign key.</param>
		/// <param name="FK_Type">Value for this foreign key.</param>
		public SqlDataAdapter_PaymentHistory(string connectionString, System.Data.SqlTypes.SqlGuid FK_PaymentCurrencyId, System.Data.SqlTypes.SqlString FK_Type) : this(connectionString) {

			this.Configure(FK_PaymentCurrencyId, FK_Type, "PaymentHistory");
		}
		...
		/// <param name="FK_PaymentCurrencyId">Value for this foreign key.</param>
		/// <param name="FK_Type">Value for this foreign key.</param>
		public SqlDataAdapter_PaymentHistory(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_PaymentCurrencyId, System.Data.SqlTypes.SqlString FK_Type) : this(sqlConnection) {
		...
		/// <param name="FK_PaymentCurrencyId">Value for this foreign key.</param>
		/// <param name="FK_Type">Value for this foreign key.</param>
		public SqlDataAdapter_PaymentHistory(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_PaymentCurrencyId, System.Data.SqlTypes.SqlString FK_Type) : this(sqlTransaction) {
		...
		/// <param name="FK_PaymentCurrencyId">Value for this foreign key.</param>
		/// <param name="FK_Type">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_PaymentCurrencyId, System.Data.SqlTypes.SqlString FK_Type) {
		...
		/// <param name="FK_Type">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_PaymentCurrencyId, System.Data.SqlTypes.SqlString FK_Type, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_PaymentHistory)");
					}
			...
			sqlSelectCommand.CommandText = "spS_PaymentHistory";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_PaymentCurrencyId.IsNull) {

				sqlParameter.Value = FK_PaymentCurrencyId;
			}
			...
			sqlInsertCommand.CommandText = "spI_PaymentHistory";
			...
			sqlUpdateCommand.CommandText = "spU_PaymentHistory";
			...
			sqlDeleteCommand.CommandText = "spD_PaymentHistory";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("EntryDateTime", "EntryDateTime")
							,new System.Data.Common.DataColumnMapping("PaymentDateTime", "PaymentDateTime")
							,new System.Data.Common.DataColumnMapping("PaymentCurrencyId", "PaymentCurrencyId")
							,new System.Data.Common.DataColumnMapping("Debit", "Debit")
							,new System.Data.Common.DataColumnMapping("Credit", "Credit")
							,new System.Data.Common.DataColumnMapping("Type", "Type")
							,new System.Data.Common.DataColumnMapping("Particulars", "Particulars")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: PaymentHistory.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "PaymentHistory", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "PaymentHistory", startRecord, maxRecords);
		}
