...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [TransactionStatusList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="TransactionStatusList", SqlObjectDependancyRevision=208)]
#endif
	public class SqlDataAdapter_TransactionStatusList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_TransactionStatusList class.
		/// This constructor will automatically pre-configure the SqlDataAdapter.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public SqlDataAdapter_TransactionStatusList(string connectionString) {
			...
			this.Configure("TransactionStatusList");
		}
		...
		public SqlDataAdapter_TransactionStatusList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_TransactionStatusList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_TransactionStatusList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_TransactionStatusList(string connectionString, string tableName) : this(connectionString) {
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_TransactionStatusList(System.Data.SqlClient.SqlConnection sqlConnection, string tableName) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_TransactionStatusList(System.Data.SqlClient.SqlTransaction sqlTransaction, string tableName) : this(sqlTransaction) {
		...
		/// The table name in the DataSet will be: TransactionStatusList
		/// </summary>
		...
		public void Configure(string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_TransactionStatusList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_TransactionStatusList";
			...
			sqlInsertCommand.CommandText = "spI_TransactionStatusList";
			...
			sqlUpdateCommand.CommandText = "spU_TransactionStatusList";
			...
			sqlDeleteCommand.CommandText = "spD_TransactionStatusList";
		...
		///the populated table name in the DataSet will be: TransactionStatusList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "TransactionStatusList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "TransactionStatusList", startRecord, maxRecords);
		}
