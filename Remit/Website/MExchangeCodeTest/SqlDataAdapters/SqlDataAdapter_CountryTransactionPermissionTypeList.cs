...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [CountryTransactionPermissionTypeList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="CountryTransactionPermissionTypeList", SqlObjectDependancyRevision=208)]
#endif
	public class SqlDataAdapter_CountryTransactionPermissionTypeList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_CountryTransactionPermissionTypeList class.
		/// This constructor will automatically pre-configure the SqlDataAdapter.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public SqlDataAdapter_CountryTransactionPermissionTypeList(string connectionString) {
			...
			this.Configure("CountryTransactionPermissionTypeList");
		}
		...
		public SqlDataAdapter_CountryTransactionPermissionTypeList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_CountryTransactionPermissionTypeList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_CountryTransactionPermissionTypeList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_CountryTransactionPermissionTypeList(string connectionString, string tableName) : this(connectionString) {
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_CountryTransactionPermissionTypeList(System.Data.SqlClient.SqlConnection sqlConnection, string tableName) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_CountryTransactionPermissionTypeList(System.Data.SqlClient.SqlTransaction sqlTransaction, string tableName) : this(sqlTransaction) {
		...
		/// The table name in the DataSet will be: CountryTransactionPermissionTypeList
		/// </summary>
		...
		public void Configure(string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_CountryTransactionPermissionTypeList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_CountryTransactionPermissionTypeList";
			...
			sqlInsertCommand.CommandText = "spI_CountryTransactionPermissionTypeList";
			...
			sqlUpdateCommand.CommandText = "spU_CountryTransactionPermissionTypeList";
			...
			sqlDeleteCommand.CommandText = "spD_CountryTransactionPermissionTypeList";
			...
			this.sqlDataAdapter.TableMappings.AddRange (
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						 "CountryTransactionPermissionTypeList"
						,tableName
		...
		///the populated table name in the DataSet will be: CountryTransactionPermissionTypeList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "CountryTransactionPermissionTypeList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "CountryTransactionPermissionTypeList", startRecord, maxRecords);
		}
