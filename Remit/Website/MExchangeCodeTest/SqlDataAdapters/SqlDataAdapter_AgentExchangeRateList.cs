...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [AgentExchangeRateList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="AgentExchangeRateList", SqlObjectDependancyRevision=528)]
#endif
	public class SqlDataAdapter_AgentExchangeRateList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_AgentExchangeRateList class.
		...
		public SqlDataAdapter_AgentExchangeRateList(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'AgentExchangeRateList'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "AgentExchangeRateList", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		public SqlDataAdapter_AgentExchangeRateList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_AgentExchangeRateList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_AgentExchangeRateList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_AgentAccountId">Value for this foreign key.</param>
		/// <param name="FK_AgencyExchangeRateId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_AgentExchangeRateList(string connectionString, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_AgencyExchangeRateId, string tableName) : this(connectionString) {

			this.Configure(FK_AgentAccountId, FK_AgencyExchangeRateId, tableName);
		}
		...
		/// <param name="FK_AgencyExchangeRateId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_AgentExchangeRateList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_AgencyExchangeRateId, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_AgencyExchangeRateId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_AgentExchangeRateList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_AgencyExchangeRateId, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_AgentExchangeRateList class.
		/// The table name in the DataSet will be: AgentExchangeRateList
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_AgentAccountId">Value for this foreign key.</param>
		/// <param name="FK_AgencyExchangeRateId">Value for this foreign key.</param>
		public SqlDataAdapter_AgentExchangeRateList(string connectionString, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_AgencyExchangeRateId) : this(connectionString) {

			this.Configure(FK_AgentAccountId, FK_AgencyExchangeRateId, "AgentExchangeRateList");
		}
		...
		/// <param name="FK_AgentAccountId">Value for this foreign key.</param>
		/// <param name="FK_AgencyExchangeRateId">Value for this foreign key.</param>
		public SqlDataAdapter_AgentExchangeRateList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_AgencyExchangeRateId) : this(sqlConnection) {
		...
		/// <param name="FK_AgentAccountId">Value for this foreign key.</param>
		/// <param name="FK_AgencyExchangeRateId">Value for this foreign key.</param>
		public SqlDataAdapter_AgentExchangeRateList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_AgencyExchangeRateId) : this(sqlTransaction) {
		...
		/// <param name="FK_AgentAccountId">Value for this foreign key.</param>
		/// <param name="FK_AgencyExchangeRateId">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_AgencyExchangeRateId) {
		...
		/// <param name="FK_AgencyExchangeRateId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_AgencyExchangeRateId, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_AgentExchangeRateList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_AgentExchangeRateList";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_AgencyExchangeRateId.IsNull) {

				sqlParameter.Value = FK_AgencyExchangeRateId;
			}
			...
			sqlInsertCommand.CommandText = "spI_AgentExchangeRateList";
			...
			sqlUpdateCommand.CommandText = "spU_AgentExchangeRateList";
			...
			sqlDeleteCommand.CommandText = "spD_AgentExchangeRateList";
			...
			this.sqlDataAdapter.TableMappings.AddRange (
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						 "AgentExchangeRateList"
						,tableName
						,new System.Data.Common.DataColumnMapping[] {
							 new System.Data.Common.DataColumnMapping("Id", "Id")
							,new System.Data.Common.DataColumnMapping("AgentAccountId", "AgentAccountId")
							,new System.Data.Common.DataColumnMapping("AgencyExchangeRateId", "AgencyExchangeRateId")
		...
		///the populated table name in the DataSet will be: AgentExchangeRateList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "AgentExchangeRateList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "AgentExchangeRateList", startRecord, maxRecords);
		}
