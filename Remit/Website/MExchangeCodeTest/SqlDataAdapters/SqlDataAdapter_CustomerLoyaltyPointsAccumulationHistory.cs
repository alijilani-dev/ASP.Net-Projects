...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [CustomerLoyaltyPointsAccumulationHistory] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="CustomerLoyaltyPointsAccumulationHistory", SqlObjectDependancyRevision=640)]
#endif
	public class SqlDataAdapter_CustomerLoyaltyPointsAccumulationHistory {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_CustomerLoyaltyPointsAccumulationHistory class.
		...
		public SqlDataAdapter_CustomerLoyaltyPointsAccumulationHistory(string connectionString) {
		...
		public SqlDataAdapter_CustomerLoyaltyPointsAccumulationHistory(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_CustomerLoyaltyPointsAccumulationHistory(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_CustomerLoyaltyPointsAccumulationHistory class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_CustomerLoyaltyPointsAccumulationHistory(string connectionString, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) : this(connectionString) {

			this.Configure(FK_CustomerId, FK_TransactionId, tableName);
		}
		...
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_CustomerLoyaltyPointsAccumulationHistory(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_CustomerLoyaltyPointsAccumulationHistory(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_CustomerLoyaltyPointsAccumulationHistory class.
		/// The table name in the DataSet will be: CustomerLoyaltyPointsAccumulationHistory
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public SqlDataAdapter_CustomerLoyaltyPointsAccumulationHistory(string connectionString, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_TransactionId) : this(connectionString) {

			this.Configure(FK_CustomerId, FK_TransactionId, "CustomerLoyaltyPointsAccumulationHistory");
		}
		...
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public SqlDataAdapter_CustomerLoyaltyPointsAccumulationHistory(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_TransactionId) : this(sqlConnection) {
		...
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public SqlDataAdapter_CustomerLoyaltyPointsAccumulationHistory(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_TransactionId) : this(sqlTransaction) {
		...
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_TransactionId) {
		...
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_CustomerLoyaltyPointsAccumulationHistory)");
					}
			...
			sqlSelectCommand.CommandText = "spS_CustomerLoyaltyPointsAccumulationHistory";
			...
			sqlInsertCommand.CommandText = "spI_CustomerLoyaltyPointsAccumulationHistory";
			...
			sqlUpdateCommand.CommandText = "spU_CustomerLoyaltyPointsAccumulationHistory";
			...
			sqlDeleteCommand.CommandText = "spD_CustomerLoyaltyPointsAccumulationHistory";
			...
			this.sqlDataAdapter.TableMappings.AddRange (
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						 "CustomerLoyaltyPointsAccumulationHistory"
						,tableName
		...
		///the populated table name in the DataSet will be: CustomerLoyaltyPointsAccumulationHistory.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "CustomerLoyaltyPointsAccumulationHistory", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "CustomerLoyaltyPointsAccumulationHistory", startRecord, maxRecords);
		}
