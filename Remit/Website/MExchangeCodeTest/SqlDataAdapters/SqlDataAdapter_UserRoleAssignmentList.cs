...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [UserRoleAssignmentList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="UserRoleAssignmentList", SqlObjectDependancyRevision=432)]
#endif
	public class SqlDataAdapter_UserRoleAssignmentList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_UserRoleAssignmentList class.
		...
		public SqlDataAdapter_UserRoleAssignmentList(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'UserRoleAssignmentList'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "UserRoleAssignmentList", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		public SqlDataAdapter_UserRoleAssignmentList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_UserRoleAssignmentList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_UserRoleAssignmentList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_UserId">Value for this foreign key.</param>
		/// <param name="FK_Role">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_UserRoleAssignmentList(string connectionString, System.Data.SqlTypes.SqlGuid FK_UserId, System.Data.SqlTypes.SqlString FK_Role, string tableName) : this(connectionString) {

			this.Configure(FK_UserId, FK_Role, tableName);
		}
		...
		/// <param name="FK_Role">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_UserRoleAssignmentList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_UserId, System.Data.SqlTypes.SqlString FK_Role, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_Role">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_UserRoleAssignmentList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_UserId, System.Data.SqlTypes.SqlString FK_Role, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_UserRoleAssignmentList class.
		/// The table name in the DataSet will be: UserRoleAssignmentList
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_UserId">Value for this foreign key.</param>
		/// <param name="FK_Role">Value for this foreign key.</param>
		public SqlDataAdapter_UserRoleAssignmentList(string connectionString, System.Data.SqlTypes.SqlGuid FK_UserId, System.Data.SqlTypes.SqlString FK_Role) : this(connectionString) {

			this.Configure(FK_UserId, FK_Role, "UserRoleAssignmentList");
		}
		...
		/// <param name="FK_UserId">Value for this foreign key.</param>
		/// <param name="FK_Role">Value for this foreign key.</param>
		public SqlDataAdapter_UserRoleAssignmentList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_UserId, System.Data.SqlTypes.SqlString FK_Role) : this(sqlConnection) {
		...
		/// <param name="FK_UserId">Value for this foreign key.</param>
		/// <param name="FK_Role">Value for this foreign key.</param>
		public SqlDataAdapter_UserRoleAssignmentList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_UserId, System.Data.SqlTypes.SqlString FK_Role) : this(sqlTransaction) {
		...
		/// <param name="FK_UserId">Value for this foreign key.</param>
		/// <param name="FK_Role">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_UserId, System.Data.SqlTypes.SqlString FK_Role) {
		...
		/// <param name="FK_Role">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_UserId, System.Data.SqlTypes.SqlString FK_Role, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_UserRoleAssignmentList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_UserRoleAssignmentList";
			...
			sqlInsertCommand.CommandText = "spI_UserRoleAssignmentList";
			...
			sqlUpdateCommand.CommandText = "spU_UserRoleAssignmentList";
			...
			sqlDeleteCommand.CommandText = "spD_UserRoleAssignmentList";
		...
		///the populated table name in the DataSet will be: UserRoleAssignmentList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "UserRoleAssignmentList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "UserRoleAssignmentList", startRecord, maxRecords);
		}
