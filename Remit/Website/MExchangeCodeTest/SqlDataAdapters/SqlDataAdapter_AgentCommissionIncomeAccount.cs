...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [AgentCommissionIncomeAccount] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="AgentCommissionIncomeAccount", SqlObjectDependancyRevision=864)]
#endif
	public class SqlDataAdapter_AgentCommissionIncomeAccount {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_AgentCommissionIncomeAccount class.
		...
		public SqlDataAdapter_AgentCommissionIncomeAccount(string connectionString) {
		...
		public SqlDataAdapter_AgentCommissionIncomeAccount(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_AgentCommissionIncomeAccount(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_AgentCommissionIncomeAccount class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_AgentCommissionIncomeAccount(string connectionString, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) : this(connectionString) {

			this.Configure(FK_AgentAccountId, FK_TransactionId, tableName);
		}
		...
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_AgentCommissionIncomeAccount(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_AgentCommissionIncomeAccount(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_AgentCommissionIncomeAccount class.
		/// The table name in the DataSet will be: AgentCommissionIncomeAccount
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_AgentAccountId">Value for this foreign key.</param>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public SqlDataAdapter_AgentCommissionIncomeAccount(string connectionString, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_TransactionId) : this(connectionString) {

			this.Configure(FK_AgentAccountId, FK_TransactionId, "AgentCommissionIncomeAccount");
		}
		...
		/// <param name="FK_AgentAccountId">Value for this foreign key.</param>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public SqlDataAdapter_AgentCommissionIncomeAccount(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_TransactionId) : this(sqlConnection) {
		...
		/// <param name="FK_AgentAccountId">Value for this foreign key.</param>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public SqlDataAdapter_AgentCommissionIncomeAccount(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_TransactionId) : this(sqlTransaction) {
		...
		/// <param name="FK_AgentAccountId">Value for this foreign key.</param>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_TransactionId) {
		...
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_TransactionId, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_AgentCommissionIncomeAccount)");
					}
			...
			sqlSelectCommand.CommandText = "spS_AgentCommissionIncomeAccount";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_TransactionId.IsNull) {

				sqlParameter.Value = FK_TransactionId;
			}
			...
			sqlInsertCommand.CommandText = "spI_AgentCommissionIncomeAccount";
			...
			sqlUpdateCommand.CommandText = "spU_AgentCommissionIncomeAccount";
			...
			sqlDeleteCommand.CommandText = "spD_AgentCommissionIncomeAccount";
			...
			this.sqlDataAdapter.TableMappings.AddRange (
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						 "AgentCommissionIncomeAccount"
						,tableName
						,new System.Data.Common.DataColumnMapping[] {
							 new System.Data.Common.DataColumnMapping("Id", "Id")
							,new System.Data.Common.DataColumnMapping("CreditDateTime", "CreditDateTime")
							,new System.Data.Common.DataColumnMapping("DebitDateTime", "DebitDateTime")
							...
							,new System.Data.Common.DataColumnMapping("CommissionCreditLC", "CommissionCreditLC")
							,new System.Data.Common.DataColumnMapping("CommissionCreditUSD", "CommissionCreditUSD")
							,new System.Data.Common.DataColumnMapping("CommissionDebitLC", "CommissionDebitLC")
							,new System.Data.Common.DataColumnMapping("CommissionDebitUSD", "CommissionDebitUSD")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: AgentCommissionIncomeAccount.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "AgentCommissionIncomeAccount", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "AgentCommissionIncomeAccount", startRecord, maxRecords);
		}
