...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [CountryList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="CountryList", SqlObjectDependancyRevision=1776)]
#endif
	public class SqlDataAdapter_CountryList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_CountryList class.
		...
		public SqlDataAdapter_CountryList(string connectionString) {
		...
		public SqlDataAdapter_CountryList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_CountryList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_CountryList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_BaseCurrency">Value for this foreign key.</param>
		...
		public SqlDataAdapter_CountryList(string connectionString, System.Data.SqlTypes.SqlGuid FK_BaseCurrency, System.Data.SqlTypes.SqlString FK_AllowedInternationalTransactionType, System.Data.SqlTypes.SqlString FK_AllowedDomesticTransactionType, string tableName) : this(connectionString) {

			this.Configure(FK_BaseCurrency, FK_AllowedInternationalTransactionType, FK_AllowedDomesticTransactionType, tableName);
		}
		...
		/// <param name="FK_AllowedDomesticTransactionType">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_CountryList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_BaseCurrency, System.Data.SqlTypes.SqlString FK_AllowedInternationalTransactionType, System.Data.SqlTypes.SqlString FK_AllowedDomesticTransactionType, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_AllowedDomesticTransactionType">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_CountryList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_BaseCurrency, System.Data.SqlTypes.SqlString FK_AllowedInternationalTransactionType, System.Data.SqlTypes.SqlString FK_AllowedDomesticTransactionType, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_CountryList class.
		/// The table name in the DataSet will be: CountryList
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_BaseCurrency">Value for this foreign key.</param>
		/// <param name="FK_AllowedInternationalTransactionType">Value for this foreign key.</param>
		/// <param name="FK_AllowedDomesticTransactionType">Value for this foreign key.</param>
		public SqlDataAdapter_CountryList(string connectionString, System.Data.SqlTypes.SqlGuid FK_BaseCurrency, System.Data.SqlTypes.SqlString FK_AllowedInternationalTransactionType, System.Data.SqlTypes.SqlString FK_AllowedDomesticTransactionType) : this(connectionString) {

			this.Configure(FK_BaseCurrency, FK_AllowedInternationalTransactionType, FK_AllowedDomesticTransactionType, "CountryList");
		}
		...
		/// <param name="FK_AllowedInternationalTransactionType">Value for this foreign key.</param>
		/// <param name="FK_AllowedDomesticTransactionType">Value for this foreign key.</param>
		public SqlDataAdapter_CountryList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_BaseCurrency, System.Data.SqlTypes.SqlString FK_AllowedInternationalTransactionType, System.Data.SqlTypes.SqlString FK_AllowedDomesticTransactionType) : this(sqlConnection) {
		...
		/// <param name="FK_AllowedInternationalTransactionType">Value for this foreign key.</param>
		/// <param name="FK_AllowedDomesticTransactionType">Value for this foreign key.</param>
		public SqlDataAdapter_CountryList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_BaseCurrency, System.Data.SqlTypes.SqlString FK_AllowedInternationalTransactionType, System.Data.SqlTypes.SqlString FK_AllowedDomesticTransactionType) : this(sqlTransaction) {
		...
		/// <param name="FK_AllowedInternationalTransactionType">Value for this foreign key.</param>
		/// <param name="FK_AllowedDomesticTransactionType">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_BaseCurrency, System.Data.SqlTypes.SqlString FK_AllowedInternationalTransactionType, System.Data.SqlTypes.SqlString FK_AllowedDomesticTransactionType) {
		...
		/// <param name="FK_AllowedDomesticTransactionType">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_BaseCurrency, System.Data.SqlTypes.SqlString FK_AllowedInternationalTransactionType, System.Data.SqlTypes.SqlString FK_AllowedDomesticTransactionType, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_CountryList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_CountryList";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_BaseCurrency.IsNull) {

				sqlParameter.Value = FK_BaseCurrency;
			}
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_AllowedInternationalTransactionType.IsNull) {

				sqlParameter.Value = FK_AllowedInternationalTransactionType;
			}
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_AllowedDomesticTransactionType.IsNull) {

				sqlParameter.Value = FK_AllowedDomesticTransactionType;
			}
			...
			sqlInsertCommand.CommandText = "spI_CountryList";
			...
			sqlUpdateCommand.CommandText = "spU_CountryList";
			...
			sqlDeleteCommand.CommandText = "spD_CountryList";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("BaseCurrency", "BaseCurrency")
							,new System.Data.Common.DataColumnMapping("AllowedInternationalTransactionType", "AllowedInternationalTransactionType")
							,new System.Data.Common.DataColumnMapping("AllowedDomesticTransactionType", "AllowedDomesticTransactionType")
							,new System.Data.Common.DataColumnMapping("TotalInboundThresholdPerYearPerPerson", "TotalInboundThresholdPerYearPerPerson")
							,new System.Data.Common.DataColumnMapping("MaximumTransactionsPerYearPerPersonToOneBeneficery", "MaximumTransactionsPerYearPerPersonToOneBeneficery")
							,new System.Data.Common.DataColumnMapping("TransactionYearStartDate", "TransactionYearStartDate")
							,new System.Data.Common.DataColumnMapping("TransactionYearEndDate", "TransactionYearEndDate")
							,new System.Data.Common.DataColumnMapping("OutboundIDRequirementThreshold", "OutboundIDRequirementThreshold")
							,new System.Data.Common.DataColumnMapping("OutboundThresholdPerTransaction", "OutboundThresholdPerTransaction")
							,new System.Data.Common.DataColumnMapping("CanPayOutUSD", "CanPayOutUSD")
		...
		///the populated table name in the DataSet will be: CountryList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "CountryList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "CountryList", startRecord, maxRecords);
		}
