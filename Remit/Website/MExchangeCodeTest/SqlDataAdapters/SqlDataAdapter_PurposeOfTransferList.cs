...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [PurposeOfTransferList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="PurposeOfTransferList", SqlObjectDependancyRevision=416)]
#endif
	public class SqlDataAdapter_PurposeOfTransferList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_PurposeOfTransferList class.
		...
		public SqlDataAdapter_PurposeOfTransferList(string connectionString) {
		...
		public SqlDataAdapter_PurposeOfTransferList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_PurposeOfTransferList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_PurposeOfTransferList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		...
		public SqlDataAdapter_PurposeOfTransferList(string connectionString, System.Data.SqlTypes.SqlString FK_PaymentModeBaseType, string tableName) : this(connectionString) {

			this.Configure(FK_PaymentModeBaseType, tableName);
		}
		...
		/// <param name="FK_PaymentModeBaseType">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_PurposeOfTransferList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_PaymentModeBaseType, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_PaymentModeBaseType">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_PurposeOfTransferList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_PaymentModeBaseType, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_PurposeOfTransferList class.
		/// The table name in the DataSet will be: PurposeOfTransferList
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_PaymentModeBaseType">Value for this foreign key.</param>
		public SqlDataAdapter_PurposeOfTransferList(string connectionString, System.Data.SqlTypes.SqlString FK_PaymentModeBaseType) : this(connectionString) {

			this.Configure(FK_PaymentModeBaseType, "PurposeOfTransferList");
		}
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="FK_PaymentModeBaseType">Value for this foreign key.</param>
		public SqlDataAdapter_PurposeOfTransferList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_PaymentModeBaseType) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="FK_PaymentModeBaseType">Value for this foreign key.</param>
		public SqlDataAdapter_PurposeOfTransferList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlString FK_PaymentModeBaseType) : this(sqlTransaction) {
		...
		/// </summary>
		/// <param name="FK_PaymentModeBaseType">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_PaymentModeBaseType) {
		...
		/// <param name="FK_PaymentModeBaseType">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlString FK_PaymentModeBaseType, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_PurposeOfTransferList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_PurposeOfTransferList";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_PaymentModeBaseType.IsNull) {

				sqlParameter.Value = FK_PaymentModeBaseType;
			}
			...
			sqlInsertCommand.CommandText = "spI_PurposeOfTransferList";
			...
			sqlUpdateCommand.CommandText = "spU_PurposeOfTransferList";
			...
			sqlDeleteCommand.CommandText = "spD_PurposeOfTransferList";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("PaymentModeBaseType", "PaymentModeBaseType")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: PurposeOfTransferList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "PurposeOfTransferList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "PurposeOfTransferList", startRecord, maxRecords);
		}
