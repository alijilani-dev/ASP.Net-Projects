...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [TransactionModificationMessageList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="TransactionModificationMessageList", SqlObjectDependancyRevision=448)]
#endif
	public class SqlDataAdapter_TransactionModificationMessageList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_TransactionModificationMessageList class.
		...
		public SqlDataAdapter_TransactionModificationMessageList(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'TransactionModificationMessageList'";
		...
		public SqlDataAdapter_TransactionModificationMessageList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_TransactionModificationMessageList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_TransactionModificationMessageList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_UserId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_TransactionModificationMessageList(string connectionString, System.Data.SqlTypes.SqlGuid FK_UserId, string tableName) : this(connectionString) {
		...
		/// <param name="FK_UserId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_TransactionModificationMessageList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_UserId, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_UserId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_TransactionModificationMessageList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_UserId, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_TransactionModificationMessageList class.
		/// The table name in the DataSet will be: TransactionModificationMessageList
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_UserId">Value for this foreign key.</param>
		public SqlDataAdapter_TransactionModificationMessageList(string connectionString, System.Data.SqlTypes.SqlGuid FK_UserId) : this(connectionString) {

			this.Configure(FK_UserId, "TransactionModificationMessageList");
		}
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="FK_UserId">Value for this foreign key.</param>
		public SqlDataAdapter_TransactionModificationMessageList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_UserId) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="FK_UserId">Value for this foreign key.</param>
		public SqlDataAdapter_TransactionModificationMessageList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_UserId) : this(sqlTransaction) {
		...
		public void Configure(System.Data.SqlTypes.SqlGuid FK_UserId, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_TransactionModificationMessageList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_TransactionModificationMessageList";
			...
			sqlInsertCommand.CommandText = "spI_TransactionModificationMessageList";
			...
			sqlUpdateCommand.CommandText = "spU_TransactionModificationMessageList";
			...
			sqlDeleteCommand.CommandText = "spD_TransactionModificationMessageList";
			...
			this.sqlDataAdapter.TableMappings.AddRange (
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						 "TransactionModificationMessageList"
						,tableName
		...
		///the populated table name in the DataSet will be: TransactionModificationMessageList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "TransactionModificationMessageList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "TransactionModificationMessageList", startRecord, maxRecords);
		}
