...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [BankExchangeRateList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="BankExchangeRateList", SqlObjectDependancyRevision=624)]
#endif
	public class SqlDataAdapter_BankExchangeRateList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_BankExchangeRateList class.
		...
		public SqlDataAdapter_BankExchangeRateList(string connectionString) {
		...
		public SqlDataAdapter_BankExchangeRateList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_BankExchangeRateList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_BankExchangeRateList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_CurrencyId">Value for this foreign key.</param>
		/// <param name="FK_ExchangeType">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_BankExchangeRateList(string connectionString, System.Data.SqlTypes.SqlGuid FK_CurrencyId, System.Data.SqlTypes.SqlString FK_ExchangeType, string tableName) : this(connectionString) {

			this.Configure(FK_CurrencyId, FK_ExchangeType, tableName);
		}
		...
		/// <param name="FK_ExchangeType">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_BankExchangeRateList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CurrencyId, System.Data.SqlTypes.SqlString FK_ExchangeType, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_ExchangeType">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_BankExchangeRateList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_CurrencyId, System.Data.SqlTypes.SqlString FK_ExchangeType, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_BankExchangeRateList class.
		/// The table name in the DataSet will be: BankExchangeRateList
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_CurrencyId">Value for this foreign key.</param>
		/// <param name="FK_ExchangeType">Value for this foreign key.</param>
		public SqlDataAdapter_BankExchangeRateList(string connectionString, System.Data.SqlTypes.SqlGuid FK_CurrencyId, System.Data.SqlTypes.SqlString FK_ExchangeType) : this(connectionString) {

			this.Configure(FK_CurrencyId, FK_ExchangeType, "BankExchangeRateList");
		}
		...
		/// <param name="FK_CurrencyId">Value for this foreign key.</param>
		/// <param name="FK_ExchangeType">Value for this foreign key.</param>
		public SqlDataAdapter_BankExchangeRateList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CurrencyId, System.Data.SqlTypes.SqlString FK_ExchangeType) : this(sqlConnection) {
		...
		/// <param name="FK_CurrencyId">Value for this foreign key.</param>
		/// <param name="FK_ExchangeType">Value for this foreign key.</param>
		public SqlDataAdapter_BankExchangeRateList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_CurrencyId, System.Data.SqlTypes.SqlString FK_ExchangeType) : this(sqlTransaction) {
		...
		/// <param name="FK_CurrencyId">Value for this foreign key.</param>
		/// <param name="FK_ExchangeType">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_CurrencyId, System.Data.SqlTypes.SqlString FK_ExchangeType) {
		...
		/// <param name="FK_ExchangeType">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_CurrencyId, System.Data.SqlTypes.SqlString FK_ExchangeType, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_BankExchangeRateList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_BankExchangeRateList";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_CurrencyId.IsNull) {

				sqlParameter.Value = FK_CurrencyId;
			}
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_ExchangeType.IsNull) {

				sqlParameter.Value = FK_ExchangeType;
			}
			...
			sqlInsertCommand.CommandText = "spI_BankExchangeRateList";
			...
			sqlUpdateCommand.CommandText = "spU_BankExchangeRateList";
			...
			sqlDeleteCommand.CommandText = "spD_BankExchangeRateList";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("ExchangeType", "ExchangeType")
							,new System.Data.Common.DataColumnMapping("BidRate", "BidRate")
							,new System.Data.Common.DataColumnMapping("OfferRate", "OfferRate")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: BankExchangeRateList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "BankExchangeRateList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "BankExchangeRateList", startRecord, maxRecords);
		}
