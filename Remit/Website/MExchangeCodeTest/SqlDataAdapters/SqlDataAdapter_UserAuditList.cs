...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [UserAuditList] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="UserAuditList", SqlObjectDependancyRevision=592)]
#endif
	public class SqlDataAdapter_UserAuditList {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_UserAuditList class.
		...
		public SqlDataAdapter_UserAuditList(string connectionString) {
		...
		public SqlDataAdapter_UserAuditList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_UserAuditList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_UserAuditList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_UserId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_UserAuditList(string connectionString, System.Data.SqlTypes.SqlGuid FK_UserId, string tableName) : this(connectionString) {

			this.Configure(FK_UserId, tableName);
		}
		...
		/// <param name="FK_UserId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_UserAuditList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_UserId, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_UserId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_UserAuditList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_UserId, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_UserAuditList class.
		/// The table name in the DataSet will be: UserAuditList
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_UserId">Value for this foreign key.</param>
		public SqlDataAdapter_UserAuditList(string connectionString, System.Data.SqlTypes.SqlGuid FK_UserId) : this(connectionString) {

			this.Configure(FK_UserId, "UserAuditList");
		}
		...
		/// <param name="sqlConnection">A valid System.Data.SqlClient.SqlConnection to the database.</param>
		/// <param name="FK_UserId">Value for this foreign key.</param>
		public SqlDataAdapter_UserAuditList(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_UserId) : this(sqlConnection) {
		...
		/// <param name="sqlTransaction">A valid System.Data.SqlClient.SqlTransaction to the database.</param>
		/// <param name="FK_UserId">Value for this foreign key.</param>
		public SqlDataAdapter_UserAuditList(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_UserId) : this(sqlTransaction) {
		...
		/// </summary>
		/// <param name="FK_UserId">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_UserId) {
		...
		/// <param name="FK_UserId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_UserId, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_UserAuditList)");
					}
			...
			sqlSelectCommand.CommandText = "spS_UserAuditList";
			...
			sqlInsertCommand.CommandText = "spI_UserAuditList";
			...
			sqlUpdateCommand.CommandText = "spU_UserAuditList";
			...
			sqlDeleteCommand.CommandText = "spD_UserAuditList";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("MainModule", "MainModule")
							,new System.Data.Common.DataColumnMapping("SubModule", "SubModule")
							,new System.Data.Common.DataColumnMapping("Action", "Action")
							,new System.Data.Common.DataColumnMapping("AdditionalMessage", "AdditionalMessage")
						}
					)
				}
			);
		...
		///the populated table name in the DataSet will be: UserAuditList.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "UserAuditList", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "UserAuditList", startRecord, maxRecords);
		}
