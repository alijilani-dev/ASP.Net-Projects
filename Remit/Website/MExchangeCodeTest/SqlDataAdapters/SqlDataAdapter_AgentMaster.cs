...
namespace Evernet.MoneyExchange.SqlDataAdapters {
	...
	/// used against the [AgentMaster] table. The four basics operations are supported: Insert, Update, Delete and Select.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:33", SqlObjectDependancyName="AgentMaster", SqlObjectDependancyRevision=1520)]
#endif
	public class SqlDataAdapter_AgentMaster {
		...
		/// <summary>
		/// Creates a new instance of the SqlDataAdapter_AgentMaster class.
		...
		public SqlDataAdapter_AgentMaster(string connectionString) {
		...
		public SqlDataAdapter_AgentMaster(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public SqlDataAdapter_AgentMaster(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_AgentMaster class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_ParentId">Value for this foreign key.</param>
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_AgentMaster(string connectionString, System.Data.SqlTypes.SqlGuid FK_ParentId, System.Data.SqlTypes.SqlGuid FK_CountryId, string tableName) : this(connectionString) {

			this.Configure(FK_ParentId, FK_CountryId, tableName);
		}
		...
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_AgentMaster(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_ParentId, System.Data.SqlTypes.SqlGuid FK_CountryId, string tableName) : this(sqlConnection) {
		...
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public SqlDataAdapter_AgentMaster(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_ParentId, System.Data.SqlTypes.SqlGuid FK_CountryId, string tableName) : this(sqlTransaction) {
		...
		/// <summary>
		/// Creates and configures a new instance of the SqlDataAdapter_AgentMaster class.
		/// The table name in the DataSet will be: AgentMaster
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		/// <param name="FK_ParentId">Value for this foreign key.</param>
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		public SqlDataAdapter_AgentMaster(string connectionString, System.Data.SqlTypes.SqlGuid FK_ParentId, System.Data.SqlTypes.SqlGuid FK_CountryId) : this(connectionString) {

			this.Configure(FK_ParentId, FK_CountryId, "AgentMaster");
		}
		...
		/// <param name="FK_ParentId">Value for this foreign key.</param>
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		public SqlDataAdapter_AgentMaster(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_ParentId, System.Data.SqlTypes.SqlGuid FK_CountryId) : this(sqlConnection) {
		...
		/// <param name="FK_ParentId">Value for this foreign key.</param>
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		public SqlDataAdapter_AgentMaster(System.Data.SqlClient.SqlTransaction sqlTransaction, System.Data.SqlTypes.SqlGuid FK_ParentId, System.Data.SqlTypes.SqlGuid FK_CountryId) : this(sqlTransaction) {
		...
		/// <param name="FK_ParentId">Value for this foreign key.</param>
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_ParentId, System.Data.SqlTypes.SqlGuid FK_CountryId) {
		...
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		/// <param name="tableName">Table name to be use in the DataSet.</param>
		public void Configure(System.Data.SqlTypes.SqlGuid FK_ParentId, System.Data.SqlTypes.SqlGuid FK_CountryId, string tableName) {
			...
			switch (this.lastKnownConnectionType) {
				...
				case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
					...
					if (connectionString.Length == 0) {
						...
						throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.SqlDataAdapters.SqlDataAdapter_AgentMaster)");
					}
			...
			sqlSelectCommand.CommandText = "spS_AgentMaster";
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_ParentId.IsNull) {

				sqlParameter.Value = FK_ParentId;
			}
			...
			sqlParameter.Direction = System.Data.ParameterDirection.Input;
			if (!FK_CountryId.IsNull) {

				sqlParameter.Value = FK_CountryId;
			}
			...
			sqlInsertCommand.CommandText = "spI_AgentMaster";
			...
			sqlUpdateCommand.CommandText = "spU_AgentMaster";
			...
			sqlDeleteCommand.CommandText = "spD_AgentMaster";
				...
				new System.Data.Common.DataTableMapping[] {
					...
					new System.Data.Common.DataTableMapping (
						...
						,new System.Data.Common.DataColumnMapping[] {
							...
							,new System.Data.Common.DataColumnMapping("PayInThreshold", "PayInThreshold")
							,new System.Data.Common.DataColumnMapping("BankSwiftCode", "BankSwiftCode")
							,new System.Data.Common.DataColumnMapping("DraftStatusUrl", "DraftStatusUrl")
							,new System.Data.Common.DataColumnMapping("DraftStatusVariable", "DraftStatusVariable")
		...
		///the populated table name in the DataSet will be: AgentMaster.
		/// </summary>
		...
		public void FillDataSet(ref System.Data.DataSet dataSet) {
			...
			this.FillDataSet(ref dataSet, "AgentMaster", -1, -1);
		}
		...
		public void FillDataSet(ref System.Data.DataSet dataSet, int startRecord, int maxRecords) {
			...
			this.FillDataSet(ref dataSet, "AgentMaster", startRecord, maxRecords);
		}
