...
namespace Evernet.MoneyExchange.Web.ListBoxes {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:37", SqlObjectDependancyName="spS_CommissionSplitTypeList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebListBoxCustom_spS_CommissionSplitTypeList), "WebListBox.bmp")]
	public class WebListBoxCustom_spS_CommissionSplitTypeList : System.Web.UI.WebControls.ListBox {
		...
		/// <summary>
		/// Create a new instance of the WebListBoxCustom_spS_CommissionSplitTypeList class.
		/// </summary>
		public WebListBoxCustom_spS_CommissionSplitTypeList() : base() {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebListBoxCustom_spS_CommissionSplitTypeList", "RefreshData");
			}
