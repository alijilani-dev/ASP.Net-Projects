...
namespace Evernet.MoneyExchange.Web.ListBoxes {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.ListBox class and was built to display the 'CountryAllowedOutboundCurrencyList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:46", SqlObjectDependancyName="CountryAllowedOutboundCurrencyList", SqlObjectDependancyRevision=272)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebListBox_CountryAllowedOutboundCurrencyList), "WebListBox.bmp")]
	public class WebListBox_CountryAllowedOutboundCurrencyList : System.Web.UI.WebControls.ListBox {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.ListBoxes.WebListBox_CountryAllowedOutboundCurrencyList class.
		/// </summary>
		public WebListBox_CountryAllowedOutboundCurrencyList() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebListBox_CountryAllowedOutboundCurrencyList : System.Web.UI.WebControls.ListBox", "RefreshData");
			}
