...
namespace Evernet.MoneyExchange.Web.ListBoxes {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.ListBox class and was built to display the 'AgentMaster' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:45", SqlObjectDependancyName="AgentMaster", SqlObjectDependancyRevision=1520)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebListBox_AgentMaster), "WebListBox.bmp")]
	public class WebListBox_AgentMaster : System.Web.UI.WebControls.ListBox {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.ListBoxes.WebListBox_AgentMaster class.
		/// </summary>
		public WebListBox_AgentMaster() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebListBox_AgentMaster : System.Web.UI.WebControls.ListBox", "RefreshData");
			}
