...
namespace Evernet.MoneyExchange.Web.ListBoxes {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:36", SqlObjectDependancyName="spS_BankExchangeRateList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebListBoxCustom_spS_BankExchangeRateList), "WebListBox.bmp")]
	public class WebListBoxCustom_spS_BankExchangeRateList : System.Web.UI.WebControls.ListBox {
		...
		/// <summary>
		/// Create a new instance of the WebListBoxCustom_spS_BankExchangeRateList class.
		/// </summary>
		public WebListBoxCustom_spS_BankExchangeRateList() : base() {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebListBoxCustom_spS_BankExchangeRateList", "RefreshData");
			}
