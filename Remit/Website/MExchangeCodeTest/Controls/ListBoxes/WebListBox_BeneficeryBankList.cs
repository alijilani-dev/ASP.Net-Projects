...
namespace Evernet.MoneyExchange.Web.ListBoxes {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.ListBox class and was built to display the 'BeneficeryBankList' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebListBox_BeneficeryBankList), "WebListBox.bmp")]
	public class WebListBox_BeneficeryBankList : System.Web.UI.WebControls.ListBox {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.ListBoxes.WebListBox_BeneficeryBankList class.
		/// </summary>
		public WebListBox_BeneficeryBankList() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebListBox_BeneficeryBankList : System.Web.UI.WebControls.ListBox", "RefreshData");
			}
