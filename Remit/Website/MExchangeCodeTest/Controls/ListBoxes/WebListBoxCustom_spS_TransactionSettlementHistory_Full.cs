...
namespace Evernet.MoneyExchange.Web.ListBoxes {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:39", SqlObjectDependancyName="spS_TransactionSettlementHistory_Full", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebListBoxCustom_spS_TransactionSettlementHistory_Full), "WebListBox.bmp")]
	public class WebListBoxCustom_spS_TransactionSettlementHistory_Full : System.Web.UI.WebControls.ListBox {
		...
		/// <summary>
		/// Create a new instance of the WebListBoxCustom_spS_TransactionSettlementHistory_Full class.
		/// </summary>
		public WebListBoxCustom_spS_TransactionSettlementHistory_Full() : base() {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebListBoxCustom_spS_TransactionSettlementHistory_Full", "RefreshData");
			}
