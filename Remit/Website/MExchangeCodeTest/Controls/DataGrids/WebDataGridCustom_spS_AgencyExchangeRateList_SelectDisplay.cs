/*
	This C# source code was automatically generated using:
		...
		SQL Server Centric .NET Code Generator
			...
			Generation Date: 11/30/2004 11:49:02 PM
...
namespace Evernet.MoneyExchange.Web.DataGrids {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:49:02", SqlObjectDependancyName="spS_AgencyExchangeRateList_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataGridCustom_spS_AgencyExchangeRateList_SelectDisplay), "WebDataGrid.bmp")]
	public class WebDataGridCustom_spS_AgencyExchangeRateList_SelectDisplay : System.Web.UI.WebControls.DataGrid {
		...
		/// WebDataGridCustom_spS_AgencyExchangeRateList_SelectDisplay class.
		/// </summary>
		public WebDataGridCustom_spS_AgencyExchangeRateList_SelectDisplay() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataGridCustom_spS_AgencyExchangeRateList_SelectDisplay", "RefreshData");
			}
		}
	}
}
