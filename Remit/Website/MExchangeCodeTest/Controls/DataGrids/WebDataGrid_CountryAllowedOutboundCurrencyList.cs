...
namespace Evernet.MoneyExchange.Web.DataGrids {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataGrid class and was built to display the 'CountryAllowedOutboundCurrencyList' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataGrid_CountryAllowedOutboundCurrencyList), "WebDataGrid.bmp")]
	public class WebDataGrid_CountryAllowedOutboundCurrencyList : System.Web.UI.WebControls.DataGrid {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DataGrids.WebDataGrid_CountryAllowedOutboundCurrencyList class.
		/// </summary>
		public WebDataGrid_CountryAllowedOutboundCurrencyList() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataGrid_CountryAllowedOutboundCurrencyList : System.Web.UI.WebControls.DataGrid", "RefreshData");
			}
		}
	}
}
