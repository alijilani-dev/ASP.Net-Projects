/*
	This C# source code was automatically generated using:
		...
		SQL Server Centric .NET Code Generator
			...
			Generation Date: 11/30/2004 11:49:05 PM
...
namespace Evernet.MoneyExchange.Web.DataGrids {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:49:06", SqlObjectDependancyName="spS_PayInAgentDifferenceIncomeAccount_Full", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataGridCustom_spS_PayInAgentDifferenceIncomeAccount_Full), "WebDataGrid.bmp")]
	public class WebDataGridCustom_spS_PayInAgentDifferenceIncomeAccount_Full : System.Web.UI.WebControls.DataGrid {
		...
		/// WebDataGridCustom_spS_PayInAgentDifferenceIncomeAccount_Full class.
		/// </summary>
		public WebDataGridCustom_spS_PayInAgentDifferenceIncomeAccount_Full() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataGridCustom_spS_PayInAgentDifferenceIncomeAccount_Full", "RefreshData");
			}
		}
	}
}
