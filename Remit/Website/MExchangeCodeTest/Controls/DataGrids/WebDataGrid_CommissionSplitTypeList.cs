...
namespace Evernet.MoneyExchange.Web.DataGrids {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataGrid class and was built to display the 'CommissionSplitTypeList' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataGrid_CommissionSplitTypeList), "WebDataGrid.bmp")]
	public class WebDataGrid_CommissionSplitTypeList : System.Web.UI.WebControls.DataGrid {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DataGrids.WebDataGrid_CommissionSplitTypeList class.
		/// </summary>
		public WebDataGrid_CommissionSplitTypeList() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataGrid_CommissionSplitTypeList : System.Web.UI.WebControls.DataGrid", "RefreshData");
			}
		}
	}
}
