/*
	This C# source code was automatically generated using:
		...
		SQL Server Centric .NET Code Generator
			...
			Generation Date: 11/30/2004 11:47:48 PM
...
namespace Evernet.MoneyExchange.Web.DataGrids {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataGrid class and was built to display the 'CommissionSlabMaster' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:48", SqlObjectDependancyName="CommissionSlabMaster", SqlObjectDependancyRevision=1520)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataGrid_CommissionSlabMaster), "WebDataGrid.bmp")]
	public class WebDataGrid_CommissionSlabMaster : System.Web.UI.WebControls.DataGrid {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DataGrids.WebDataGrid_CommissionSlabMaster class.
		/// </summary>
		public WebDataGrid_CommissionSlabMaster() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataGrid_CommissionSlabMaster : System.Web.UI.WebControls.DataGrid", "RefreshData");
			}
		}
	}
}
