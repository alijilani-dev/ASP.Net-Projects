...
namespace Evernet.MoneyExchange.Web.DataGrids {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataGrid class and was built to display the 'LocationTree' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:48", SqlObjectDependancyName="LocationTree", SqlObjectDependancyRevision=336)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataGrid_LocationTree), "WebDataGrid.bmp")]
	public class WebDataGrid_LocationTree : System.Web.UI.WebControls.DataGrid {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DataGrids.WebDataGrid_LocationTree class.
		/// </summary>
		public WebDataGrid_LocationTree() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataGrid_LocationTree : System.Web.UI.WebControls.DataGrid", "RefreshData");
			}
		}
	}
}
