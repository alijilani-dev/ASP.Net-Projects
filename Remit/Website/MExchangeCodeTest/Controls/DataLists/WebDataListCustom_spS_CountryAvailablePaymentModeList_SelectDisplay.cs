...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// 'spS_CountryAvailablePaymentModeList_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:49:15", SqlObjectDependancyName="spS_CountryAvailablePaymentModeList_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataListCustom_spS_CountryAvailablePaymentModeList_SelectDisplay), "WebDataList.bmp")]
	public class WebDataListCustom_spS_CountryAvailablePaymentModeList_SelectDisplay : System.Web.UI.WebControls.DataList {

		private string tableName;
		private Params.spS_CountryAvailablePaymentModeList_SelectDisplay param;
		...
		/// </summary>
		public Params.spS_CountryAvailablePaymentModeList_SelectDisplay SP_Parameter {
		...
		/// WebDataListCustom_spS_CountryAvailablePaymentModeList_SelectDisplay class.
		/// </summary>
		public WebDataListCustom_spS_CountryAvailablePaymentModeList_SelectDisplay() : base() {
		...
		/// You also need to supply the spS_CountryAvailablePaymentModeList_SelectDisplay stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CountryId, System.Data.SqlTypes.SqlString param_PaymentMode) {
		...
		/// <param name="param_CountryId">Value for the parameter @CountryId.</param>
		/// <param name="param_PaymentMode">Value for the parameter @PaymentMode.</param>
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CountryId, System.Data.SqlTypes.SqlString param_PaymentMode) {
			...
			this.connectionString = connectionString;
			this.LastKnownConnectionType = Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString;
			this.tableName = "spS_CountryAvailablePaymentModeList_SelectDisplay";
		...
		/// <param name="param_CountryId">Value for the parameter @CountryId.</param>
		/// <param name="param_PaymentMode">Value for the parameter @PaymentMode.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CountryId, System.Data.SqlTypes.SqlString param_PaymentMode) {
		...
		/// <param name="param_CountryId">Value for the parameter @CountryId.</param>
		/// <param name="param_PaymentMode">Value for the parameter @PaymentMode.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CountryId, System.Data.SqlTypes.SqlString param_PaymentMode) {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CountryAvailablePaymentModeList_SelectDisplay();
			...
			SPs.spS_CountryAvailablePaymentModeList_SelectDisplay SP = new SPs.spS_CountryAvailablePaymentModeList_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataListCustom_spS_CountryAvailablePaymentModeList_SelectDisplay", "RefreshData");
			}
		}
	}
}
