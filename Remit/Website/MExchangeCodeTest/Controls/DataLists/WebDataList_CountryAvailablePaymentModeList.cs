...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'CountryAvailablePaymentModeList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:50", SqlObjectDependancyName="CountryAvailablePaymentModeList", SqlObjectDependancyRevision=432)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_CountryAvailablePaymentModeList), "WebDataList.bmp")]
	public class WebDataList_CountryAvailablePaymentModeList : System.Web.UI.WebControls.DataList {

		private Params.spS_CountryAvailablePaymentModeList param;
		...
		/// <summary>
		/// Returns the Evernet.MoneyExchange.DataClasses.Parameters.spS_CountryAvailablePaymentModeList class that was used to populate this control.
		/// </summary>
		public Params.spS_CountryAvailablePaymentModeList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DataLists.WebDataList_CountryAvailablePaymentModeList class.
		/// </summary>
		public WebDataList_CountryAvailablePaymentModeList() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CountryAvailablePaymentModeList(true);
			...
			SPs.spS_CountryAvailablePaymentModeList SP = new SPs.spS_CountryAvailablePaymentModeList(false);
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_CountryAvailablePaymentModeList"].DefaultView;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataList_CountryAvailablePaymentModeList : System.Web.UI.WebControls.DataList", "RefreshData");
			}
		}
	}
}
