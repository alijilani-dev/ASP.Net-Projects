...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:49:14", SqlObjectDependancyName="spS_AgentAvailablePaymentModeList_Full", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataListCustom_spS_AgentAvailablePaymentModeList_Full), "WebDataList.bmp")]
	public class WebDataListCustom_spS_AgentAvailablePaymentModeList_Full : System.Web.UI.WebControls.DataList {
		...
		/// WebDataListCustom_spS_AgentAvailablePaymentModeList_Full class.
		/// </summary>
		public WebDataListCustom_spS_AgentAvailablePaymentModeList_Full() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataListCustom_spS_AgentAvailablePaymentModeList_Full", "RefreshData");
			}
		}
	}
}
