...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'PaymentModeBaseTypeList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:50", SqlObjectDependancyName="PaymentModeBaseTypeList", SqlObjectDependancyRevision=224)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_PaymentModeBaseTypeList), "WebDataList.bmp")]
	public class WebDataList_PaymentModeBaseTypeList : System.Web.UI.WebControls.DataList {
		...
		/// <summary>
		/// Returns the Evernet.MoneyExchange.DataClasses.Parameters.spS_PaymentModeBaseTypeList class that was used to populate this control.
		/// </summary>
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DataLists.WebDataList_PaymentModeBaseTypeList class.
		/// </summary>
		public WebDataList_PaymentModeBaseTypeList() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_PaymentModeBaseTypeList(true);
			...
			SPs.spS_PaymentModeBaseTypeList SP = new SPs.spS_PaymentModeBaseTypeList(false);
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_PaymentModeBaseTypeList"].DefaultView;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataList_PaymentModeBaseTypeList : System.Web.UI.WebControls.DataList", "RefreshData");
			}
		}
	}
}
