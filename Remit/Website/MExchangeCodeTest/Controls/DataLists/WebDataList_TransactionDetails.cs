...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'TransactionDetails' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:50", SqlObjectDependancyName="TransactionDetails", SqlObjectDependancyRevision=3344)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_TransactionDetails), "WebDataList.bmp")]
	public class WebDataList_TransactionDetails : System.Web.UI.WebControls.DataList {

		private Params.spS_TransactionDetails param;
		...
		/// <summary>
		/// Returns the Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionDetails class that was used to populate this control.
		/// </summary>
		public Params.spS_TransactionDetails SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DataLists.WebDataList_TransactionDetails class.
		/// </summary>
		public WebDataList_TransactionDetails() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (!this.FK_BeneficeryId.IsNull) {

				this.param.Param_BeneficeryId = this.FK_BeneficeryId;
			}

			if (!this.FK_BeneficeryBankId.IsNull) {
			...
			if (!this.FK_PurposeOfTransfer.IsNull) {

				this.param.Param_PurposeOfTransfer = this.FK_PurposeOfTransfer;
			}

			if (!this.FK_PayInCurrencyId.IsNull) {
			...
			if (!this.FK_SettlementStatus.IsNull) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				this.DataSource = DS.Tables["spS_TransactionDetails"].DefaultView;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataList_TransactionDetails : System.Web.UI.WebControls.DataList", "RefreshData");
			}
		}
	}
}
