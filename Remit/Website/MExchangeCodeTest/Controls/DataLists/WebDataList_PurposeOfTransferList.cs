...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'PurposeOfTransferList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:50", SqlObjectDependancyName="PurposeOfTransferList", SqlObjectDependancyRevision=416)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_PurposeOfTransferList), "WebDataList.bmp")]
	public class WebDataList_PurposeOfTransferList : System.Web.UI.WebControls.DataList {
		...
		/// <summary>
		/// Returns the Evernet.MoneyExchange.DataClasses.Parameters.spS_PurposeOfTransferList class that was used to populate this control.
		/// </summary>
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DataLists.WebDataList_PurposeOfTransferList class.
		/// </summary>
		public WebDataList_PurposeOfTransferList() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_PurposeOfTransferList(true);
			...
			if (!this.FK_PaymentModeBaseType.IsNull) {
			...
			SPs.spS_PurposeOfTransferList SP = new SPs.spS_PurposeOfTransferList(false);
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_PurposeOfTransferList"].DefaultView;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataList_PurposeOfTransferList : System.Web.UI.WebControls.DataList", "RefreshData");
			}
		}
	}
}
