...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'AgentAvailablePaymentModeList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:49", SqlObjectDependancyName="AgentAvailablePaymentModeList", SqlObjectDependancyRevision=496)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_AgentAvailablePaymentModeList), "WebDataList.bmp")]
	public class WebDataList_AgentAvailablePaymentModeList : System.Web.UI.WebControls.DataList {
		...
		/// <summary>
		/// Returns the Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentAvailablePaymentModeList class that was used to populate this control.
		/// </summary>
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DataLists.WebDataList_AgentAvailablePaymentModeList class.
		/// </summary>
		public WebDataList_AgentAvailablePaymentModeList() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgentAvailablePaymentModeList(true);
			...
			SPs.spS_AgentAvailablePaymentModeList SP = new SPs.spS_AgentAvailablePaymentModeList(false);
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_AgentAvailablePaymentModeList"].DefaultView;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataList_AgentAvailablePaymentModeList : System.Web.UI.WebControls.DataList", "RefreshData");
			}
		}
	}
}
