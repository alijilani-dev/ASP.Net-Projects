...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:49:16", SqlObjectDependancyName="spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataListCustom_spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay), "WebDataList.bmp")]
	public class WebDataListCustom_spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay : System.Web.UI.WebControls.DataList {
		...
		/// WebDataListCustom_spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay class.
		/// </summary>
		public WebDataListCustom_spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay() : base() {
		...
		public void Initialize(string connectionString, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CustomerId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
		...
		/// <param name="param_CustomerId">Value for the parameter @CustomerId.</param>
		/// <param name="param_TransactionId">Value for the parameter @TransactionId.</param>
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CustomerId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
		...
		/// <param name="param_CustomerId">Value for the parameter @CustomerId.</param>
		/// <param name="param_TransactionId">Value for the parameter @TransactionId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CustomerId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
		...
		/// <param name="param_CustomerId">Value for the parameter @CustomerId.</param>
		/// <param name="param_TransactionId">Value for the parameter @TransactionId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CustomerId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataListCustom_spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay", "RefreshData");
			}
		}
	}
}
