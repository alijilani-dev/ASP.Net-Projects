...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:49:18", SqlObjectDependancyName="spS_PurposeOfTransferList_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataListCustom_spS_PurposeOfTransferList_SelectDisplay), "WebDataList.bmp")]
	public class WebDataListCustom_spS_PurposeOfTransferList_SelectDisplay : System.Web.UI.WebControls.DataList {
		...
		/// WebDataListCustom_spS_PurposeOfTransferList_SelectDisplay class.
		/// </summary>
		public WebDataListCustom_spS_PurposeOfTransferList_SelectDisplay() : base() {
		...
		public void Initialize(string connectionString, string tableName, System.Data.SqlTypes.SqlString param_Value, System.Data.SqlTypes.SqlString param_PaymentModeBaseType) {
		...
		/// <param name="param_Value">Value for the parameter @Value.</param>
		/// <param name="param_PaymentModeBaseType">Value for the parameter @PaymentModeBaseType.</param>
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlString param_Value, System.Data.SqlTypes.SqlString param_PaymentModeBaseType) {
		...
		/// <param name="param_Value">Value for the parameter @Value.</param>
		/// <param name="param_PaymentModeBaseType">Value for the parameter @PaymentModeBaseType.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string tableName, System.Data.SqlTypes.SqlString param_Value, System.Data.SqlTypes.SqlString param_PaymentModeBaseType) {
		...
		/// <param name="param_Value">Value for the parameter @Value.</param>
		/// <param name="param_PaymentModeBaseType">Value for the parameter @PaymentModeBaseType.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString param_Value, System.Data.SqlTypes.SqlString param_PaymentModeBaseType) {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataListCustom_spS_PurposeOfTransferList_SelectDisplay", "RefreshData");
			}
		}
	}
}
