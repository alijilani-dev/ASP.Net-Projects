...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'AgentAccountType' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:49", SqlObjectDependancyName="AgentAccountType", SqlObjectDependancyRevision=192)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_AgentAccountType), "WebDataList.bmp")]
	public class WebDataList_AgentAccountType : System.Web.UI.WebControls.DataList {
		...
		/// <summary>
		/// Returns the Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentAccountType class that was used to populate this control.
		/// </summary>
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DataLists.WebDataList_AgentAccountType class.
		/// </summary>
		public WebDataList_AgentAccountType() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgentAccountType(true);
			...
			SPs.spS_AgentAccountType SP = new SPs.spS_AgentAccountType(false);
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_AgentAccountType"].DefaultView;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataList_AgentAccountType : System.Web.UI.WebControls.DataList", "RefreshData");
			}
		}
	}
}
