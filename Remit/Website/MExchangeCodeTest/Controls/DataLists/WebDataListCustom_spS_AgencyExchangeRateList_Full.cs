...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// 'spS_AgencyExchangeRateList_Full' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:49:13", SqlObjectDependancyName="spS_AgencyExchangeRateList_Full", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataListCustom_spS_AgencyExchangeRateList_Full), "WebDataList.bmp")]
	public class WebDataListCustom_spS_AgencyExchangeRateList_Full : System.Web.UI.WebControls.DataList {

		private string tableName;
		private Params.spS_AgencyExchangeRateList_Full param;
		...
		/// </summary>
		public Params.spS_AgencyExchangeRateList_Full SP_Parameter {
		...
		/// WebDataListCustom_spS_AgencyExchangeRateList_Full class.
		/// </summary>
		public WebDataListCustom_spS_AgencyExchangeRateList_Full() : base() {
		...
		/// You also need to supply the spS_AgencyExchangeRateList_Full stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PayInCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCurrencyId) {
			...
			this.connectionString = connectionString;
			this.LastKnownConnectionType = Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString;
			this.tableName = "spS_AgencyExchangeRateList_Full";
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgencyExchangeRateList_Full();
			...
			SPs.spS_AgencyExchangeRateList_Full SP = new SPs.spS_AgencyExchangeRateList_Full();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataListCustom_spS_AgencyExchangeRateList_Full", "RefreshData");
			}
		}
	}
}
