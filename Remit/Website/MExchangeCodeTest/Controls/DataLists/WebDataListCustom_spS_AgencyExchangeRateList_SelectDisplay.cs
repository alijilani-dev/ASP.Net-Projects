/*
	This C# source code was automatically generated using:
		...
		SQL Server Centric .NET Code Generator
			...
			Generation Date: 11/30/2004 11:49:13 PM
...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// 'spS_AgencyExchangeRateList_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:49:13", SqlObjectDependancyName="spS_AgencyExchangeRateList_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataListCustom_spS_AgencyExchangeRateList_SelectDisplay), "WebDataList.bmp")]
	public class WebDataListCustom_spS_AgencyExchangeRateList_SelectDisplay : System.Web.UI.WebControls.DataList {

		private string tableName;
		private Params.spS_AgencyExchangeRateList_SelectDisplay param;
		...
		/// </summary>
		public Params.spS_AgencyExchangeRateList_SelectDisplay SP_Parameter {
		...
		/// WebDataListCustom_spS_AgencyExchangeRateList_SelectDisplay class.
		/// </summary>
		public WebDataListCustom_spS_AgencyExchangeRateList_SelectDisplay() : base() {
		...
		/// You also need to supply the spS_AgencyExchangeRateList_SelectDisplay stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PayInCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCurrencyId) {
		...
		/// <param name="param_PayOutCountryId">Value for the parameter @PayOutCountryId.</param>
		/// <param name="param_PayOutCurrencyId">Value for the parameter @PayOutCurrencyId.</param>
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PayInCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCurrencyId) {
			...
			this.connectionString = connectionString;
			this.LastKnownConnectionType = Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString;
			this.tableName = "spS_AgencyExchangeRateList_SelectDisplay";
		...
		/// <param name="param_PayOutCountryId">Value for the parameter @PayOutCountryId.</param>
		/// <param name="param_PayOutCurrencyId">Value for the parameter @PayOutCurrencyId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PayInCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCurrencyId) {
		...
		/// <param name="param_PayOutCountryId">Value for the parameter @PayOutCountryId.</param>
		/// <param name="param_PayOutCurrencyId">Value for the parameter @PayOutCurrencyId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PayInCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCurrencyId) {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgencyExchangeRateList_SelectDisplay();
			...
			SPs.spS_AgencyExchangeRateList_SelectDisplay SP = new SPs.spS_AgencyExchangeRateList_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataListCustom_spS_AgencyExchangeRateList_SelectDisplay", "RefreshData");
			}
		}
	}
}
