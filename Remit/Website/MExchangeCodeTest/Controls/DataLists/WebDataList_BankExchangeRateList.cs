...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'BankExchangeRateList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:49", SqlObjectDependancyName="BankExchangeRateList", SqlObjectDependancyRevision=624)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_BankExchangeRateList), "WebDataList.bmp")]
	public class WebDataList_BankExchangeRateList : System.Web.UI.WebControls.DataList {
		...
		/// <summary>
		/// Returns the Evernet.MoneyExchange.DataClasses.Parameters.spS_BankExchangeRateList class that was used to populate this control.
		/// </summary>
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DataLists.WebDataList_BankExchangeRateList class.
		/// </summary>
		public WebDataList_BankExchangeRateList() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (!this.FK_CurrencyId.IsNull) {

				this.param.Param_CurrencyId = this.FK_CurrencyId;
			}

			if (!this.FK_ExchangeType.IsNull) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				this.DataSource = DS.Tables["spS_BankExchangeRateList"].DefaultView;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataList_BankExchangeRateList : System.Web.UI.WebControls.DataList", "RefreshData");
			}
		}
	}
}
