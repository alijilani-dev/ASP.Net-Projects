...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// 'spS_BankExchangeRateList_Full' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:49:15", SqlObjectDependancyName="spS_BankExchangeRateList_Full", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataListCustom_spS_BankExchangeRateList_Full), "WebDataList.bmp")]
	public class WebDataListCustom_spS_BankExchangeRateList_Full : System.Web.UI.WebControls.DataList {

		private string tableName;
		private Params.spS_BankExchangeRateList_Full param;
		...
		/// </summary>
		public Params.spS_BankExchangeRateList_Full SP_Parameter {
		...
		/// WebDataListCustom_spS_BankExchangeRateList_Full class.
		/// </summary>
		public WebDataListCustom_spS_BankExchangeRateList_Full() : base() {
		...
		/// You also need to supply the spS_BankExchangeRateList_Full stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CurrencyId, System.Data.SqlTypes.SqlString param_ExchangeType) {
			...
			this.connectionString = connectionString;
			this.LastKnownConnectionType = Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString;
			this.tableName = "spS_BankExchangeRateList_Full";
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_BankExchangeRateList_Full();
			...
			SPs.spS_BankExchangeRateList_Full SP = new SPs.spS_BankExchangeRateList_Full();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataListCustom_spS_BankExchangeRateList_Full", "RefreshData");
			}
		}
	}
}
