...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:49:15", SqlObjectDependancyName="spS_BankList_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataListCustom_spS_BankList_SelectDisplay), "WebDataList.bmp")]
	public class WebDataListCustom_spS_BankList_SelectDisplay : System.Web.UI.WebControls.DataList {
		...
		/// WebDataListCustom_spS_BankList_SelectDisplay class.
		/// </summary>
		public WebDataListCustom_spS_BankList_SelectDisplay() : base() {
		...
		public void Initialize(string connectionString, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AccountId, System.Data.SqlTypes.SqlGuid param_LocationId) {
		...
		/// <param name="param_AccountId">Value for the parameter @AccountId.</param>
		/// <param name="param_LocationId">Value for the parameter @LocationId.</param>
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AccountId, System.Data.SqlTypes.SqlGuid param_LocationId) {
		...
		/// <param name="param_AccountId">Value for the parameter @AccountId.</param>
		/// <param name="param_LocationId">Value for the parameter @LocationId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AccountId, System.Data.SqlTypes.SqlGuid param_LocationId) {
		...
		/// <param name="param_AccountId">Value for the parameter @AccountId.</param>
		/// <param name="param_LocationId">Value for the parameter @LocationId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AccountId, System.Data.SqlTypes.SqlGuid param_LocationId) {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataListCustom_spS_BankList_SelectDisplay", "RefreshData");
			}
		}
	}
}
