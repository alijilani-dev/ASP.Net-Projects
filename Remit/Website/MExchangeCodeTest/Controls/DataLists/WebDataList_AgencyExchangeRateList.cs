...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'AgencyExchangeRateList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:49", SqlObjectDependancyName="AgencyExchangeRateList", SqlObjectDependancyRevision=960)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_AgencyExchangeRateList), "WebDataList.bmp")]
	public class WebDataList_AgencyExchangeRateList : System.Web.UI.WebControls.DataList {
		...
		/// <summary>
		/// Returns the Evernet.MoneyExchange.DataClasses.Parameters.spS_AgencyExchangeRateList class that was used to populate this control.
		/// </summary>
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DataLists.WebDataList_AgencyExchangeRateList class.
		/// </summary>
		public WebDataList_AgencyExchangeRateList() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (!this.FK_PayOutCurrencyId.IsNull) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				this.DataSource = DS.Tables["spS_AgencyExchangeRateList"].DefaultView;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataList_AgencyExchangeRateList : System.Web.UI.WebControls.DataList", "RefreshData");
			}
		}
	}
}
