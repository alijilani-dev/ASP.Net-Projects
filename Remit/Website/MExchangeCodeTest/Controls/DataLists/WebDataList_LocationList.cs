...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'LocationList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:50", SqlObjectDependancyName="LocationList", SqlObjectDependancyRevision=1056)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_LocationList), "WebDataList.bmp")]
	public class WebDataList_LocationList : System.Web.UI.WebControls.DataList {
		...
		/// <summary>
		/// Returns the Evernet.MoneyExchange.DataClasses.Parameters.spS_LocationList class that was used to populate this control.
		/// </summary>
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DataLists.WebDataList_LocationList class.
		/// </summary>
		public WebDataList_LocationList() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_LocationList(true);
			...
			if (!this.FK_ParentId.IsNull) {

				this.param.Param_ParentId = this.FK_ParentId;
			}

			if (!this.FK_CountryId.IsNull) {
			...
			SPs.spS_LocationList SP = new SPs.spS_LocationList(false);
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_LocationList"].DefaultView;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataList_LocationList : System.Web.UI.WebControls.DataList", "RefreshData");
			}
		}
	}
}
