...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:49:17", SqlObjectDependancyName="spS_PayInAgentDifferenceIncomeAccount_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataListCustom_spS_PayInAgentDifferenceIncomeAccount_SelectDisplay), "WebDataList.bmp")]
	public class WebDataListCustom_spS_PayInAgentDifferenceIncomeAccount_SelectDisplay : System.Web.UI.WebControls.DataList {
		...
		/// WebDataListCustom_spS_PayInAgentDifferenceIncomeAccount_SelectDisplay class.
		/// </summary>
		public WebDataListCustom_spS_PayInAgentDifferenceIncomeAccount_SelectDisplay() : base() {
		...
		public void Initialize(string connectionString, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_TranasctionId) {
		...
		/// <param name="param_AgentAccountId">Value for the parameter @AgentAccountId.</param>
		/// <param name="param_TranasctionId">Value for the parameter @TranasctionId.</param>
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_TranasctionId) {
		...
		/// <param name="param_AgentAccountId">Value for the parameter @AgentAccountId.</param>
		/// <param name="param_TranasctionId">Value for the parameter @TranasctionId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_TranasctionId) {
		...
		/// <param name="param_AgentAccountId">Value for the parameter @AgentAccountId.</param>
		/// <param name="param_TranasctionId">Value for the parameter @TranasctionId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_TranasctionId) {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataListCustom_spS_PayInAgentDifferenceIncomeAccount_SelectDisplay", "RefreshData");
			}
		}
	}
}
