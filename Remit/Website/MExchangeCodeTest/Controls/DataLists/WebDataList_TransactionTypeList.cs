...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'TransactionTypeList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:50", SqlObjectDependancyName="TransactionTypeList", SqlObjectDependancyRevision=368)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_TransactionTypeList), "WebDataList.bmp")]
	public class WebDataList_TransactionTypeList : System.Web.UI.WebControls.DataList {
		...
		/// <summary>
		/// Returns the Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionTypeList class that was used to populate this control.
		/// </summary>
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DataLists.WebDataList_TransactionTypeList class.
		/// </summary>
		public WebDataList_TransactionTypeList() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_TransactionTypeList(true);
			...
			SPs.spS_TransactionTypeList SP = new SPs.spS_TransactionTypeList(false);
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_TransactionTypeList"].DefaultView;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataList_TransactionTypeList : System.Web.UI.WebControls.DataList", "RefreshData");
			}
		}
	}
}
