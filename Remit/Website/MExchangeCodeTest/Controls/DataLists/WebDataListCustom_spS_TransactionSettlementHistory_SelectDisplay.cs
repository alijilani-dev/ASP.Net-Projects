/*
	This C# source code was automatically generated using:
		...
		SQL Server Centric .NET Code Generator
			...
			Generation Date: 11/30/2004 11:49:18 PM
...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:49:18", SqlObjectDependancyName="spS_TransactionSettlementHistory_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataListCustom_spS_TransactionSettlementHistory_SelectDisplay), "WebDataList.bmp")]
	public class WebDataListCustom_spS_TransactionSettlementHistory_SelectDisplay : System.Web.UI.WebControls.DataList {
		...
		/// WebDataListCustom_spS_TransactionSettlementHistory_SelectDisplay class.
		/// </summary>
		public WebDataListCustom_spS_TransactionSettlementHistory_SelectDisplay() : base() {
		...
		public void Initialize(string connectionString, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PaymentId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
		...
		/// <param name="param_PaymentId">Value for the parameter @PaymentId.</param>
		/// <param name="param_TransactionId">Value for the parameter @TransactionId.</param>
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PaymentId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
		...
		/// <param name="param_PaymentId">Value for the parameter @PaymentId.</param>
		/// <param name="param_TransactionId">Value for the parameter @TransactionId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PaymentId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
		...
		/// <param name="param_PaymentId">Value for the parameter @PaymentId.</param>
		/// <param name="param_TransactionId">Value for the parameter @TransactionId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PaymentId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataListCustom_spS_TransactionSettlementHistory_SelectDisplay", "RefreshData");
			}
		}
	}
}
