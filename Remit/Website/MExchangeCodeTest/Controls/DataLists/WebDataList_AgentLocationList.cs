...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'AgentLocationList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:49", SqlObjectDependancyName="AgentLocationList", SqlObjectDependancyRevision=2096)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_AgentLocationList), "WebDataList.bmp")]
	public class WebDataList_AgentLocationList : System.Web.UI.WebControls.DataList {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DataLists.WebDataList_AgentLocationList class.
		/// </summary>
		public WebDataList_AgentLocationList() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataList_AgentLocationList : System.Web.UI.WebControls.DataList", "RefreshData");
			}
		}
	}
}
