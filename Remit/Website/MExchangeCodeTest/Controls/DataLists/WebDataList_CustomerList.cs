...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'CustomerList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:50", SqlObjectDependancyName="CustomerList", SqlObjectDependancyRevision=1984)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_CustomerList), "WebDataList.bmp")]
	public class WebDataList_CustomerList : System.Web.UI.WebControls.DataList {
		...
		/// <summary>
		/// Returns the Evernet.MoneyExchange.DataClasses.Parameters.spS_CustomerList class that was used to populate this control.
		/// </summary>
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DataLists.WebDataList_CustomerList class.
		/// </summary>
		public WebDataList_CustomerList() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (!this.FK_CardId.IsNull) {

				this.param.Param_CardId = this.FK_CardId;
			}

			if (!this.FK_Nationality.IsNull) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				this.DataSource = DS.Tables["spS_CustomerList"].DefaultView;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataList_CustomerList : System.Web.UI.WebControls.DataList", "RefreshData");
			}
		}
	}
}
