...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'AgencyCommissionIncomeAccountDetails' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:49", SqlObjectDependancyName="AgencyCommissionIncomeAccountDetails", SqlObjectDependancyRevision=576)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_AgencyCommissionIncomeAccountDetails), "WebDataList.bmp")]
	public class WebDataList_AgencyCommissionIncomeAccountDetails : System.Web.UI.WebControls.DataList {
		...
		/// <summary>
		/// Returns the Evernet.MoneyExchange.DataClasses.Parameters.spS_AgencyCommissionIncomeAccountDetails class that was used to populate this control.
		/// </summary>
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DataLists.WebDataList_AgencyCommissionIncomeAccountDetails class.
		/// </summary>
		public WebDataList_AgencyCommissionIncomeAccountDetails() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				this.DataSource = DS.Tables["spS_AgencyCommissionIncomeAccountDetails"].DefaultView;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataList_AgencyCommissionIncomeAccountDetails : System.Web.UI.WebControls.DataList", "RefreshData");
			}
		}
	}
}
