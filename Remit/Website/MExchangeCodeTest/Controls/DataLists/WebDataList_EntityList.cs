...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'EntityList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:50", SqlObjectDependancyName="EntityList", SqlObjectDependancyRevision=224)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_EntityList), "WebDataList.bmp")]
	public class WebDataList_EntityList : System.Web.UI.WebControls.DataList {
		...
		/// <summary>
		/// Returns the Evernet.MoneyExchange.DataClasses.Parameters.spS_EntityList class that was used to populate this control.
		/// </summary>
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DataLists.WebDataList_EntityList class.
		/// </summary>
		public WebDataList_EntityList() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_EntityList(true);
			...
			SPs.spS_EntityList SP = new SPs.spS_EntityList(false);
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_EntityList"].DefaultView;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataList_EntityList : System.Web.UI.WebControls.DataList", "RefreshData");
			}
		}
	}
}
