...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.DataList class and was built to display the 'AgentCommissionSplitList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:49", SqlObjectDependancyName="AgentCommissionSplitList", SqlObjectDependancyRevision=544)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataList_AgentCommissionSplitList), "WebDataList.bmp")]
	public class WebDataList_AgentCommissionSplitList : System.Web.UI.WebControls.DataList {
		...
		/// <summary>
		/// Returns the Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentCommissionSplitList class that was used to populate this control.
		/// </summary>
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DataLists.WebDataList_AgentCommissionSplitList class.
		/// </summary>
		public WebDataList_AgentCommissionSplitList() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (!this.FK_CurrentAccountId.IsNull) {

				this.param.Param_CurrentAccountId = this.FK_CurrentAccountId;
			}

			if (!this.FK_EndNodeAccountId.IsNull) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				this.DataSource = DS.Tables["spS_AgentCommissionSplitList"].DefaultView;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataList_AgentCommissionSplitList : System.Web.UI.WebControls.DataList", "RefreshData");
			}
		}
	}
}
