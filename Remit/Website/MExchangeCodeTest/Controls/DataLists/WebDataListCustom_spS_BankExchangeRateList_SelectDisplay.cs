...
namespace Evernet.MoneyExchange.Web.DataLists {
	...
	/// 'spS_BankExchangeRateList_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:49:15", SqlObjectDependancyName="spS_BankExchangeRateList_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDataListCustom_spS_BankExchangeRateList_SelectDisplay), "WebDataList.bmp")]
	public class WebDataListCustom_spS_BankExchangeRateList_SelectDisplay : System.Web.UI.WebControls.DataList {

		private string tableName;
		private Params.spS_BankExchangeRateList_SelectDisplay param;
		...
		/// </summary>
		public Params.spS_BankExchangeRateList_SelectDisplay SP_Parameter {
		...
		/// WebDataListCustom_spS_BankExchangeRateList_SelectDisplay class.
		/// </summary>
		public WebDataListCustom_spS_BankExchangeRateList_SelectDisplay() : base() {
		...
		/// You also need to supply the spS_BankExchangeRateList_SelectDisplay stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CurrencyId, System.Data.SqlTypes.SqlString param_ExchangeType) {
		...
		/// <param name="param_CurrencyId">Value for the parameter @CurrencyId.</param>
		/// <param name="param_ExchangeType">Value for the parameter @ExchangeType.</param>
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CurrencyId, System.Data.SqlTypes.SqlString param_ExchangeType) {
			...
			this.connectionString = connectionString;
			this.LastKnownConnectionType = Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString;
			this.tableName = "spS_BankExchangeRateList_SelectDisplay";
		...
		/// <param name="param_CurrencyId">Value for the parameter @CurrencyId.</param>
		/// <param name="param_ExchangeType">Value for the parameter @ExchangeType.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CurrencyId, System.Data.SqlTypes.SqlString param_ExchangeType) {
		...
		/// <param name="param_CurrencyId">Value for the parameter @CurrencyId.</param>
		/// <param name="param_ExchangeType">Value for the parameter @ExchangeType.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CurrencyId, System.Data.SqlTypes.SqlString param_ExchangeType) {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_BankExchangeRateList_SelectDisplay();
			...
			SPs.spS_BankExchangeRateList_SelectDisplay SP = new SPs.spS_BankExchangeRateList_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDataListCustom_spS_BankExchangeRateList_SelectDisplay", "RefreshData");
			}
		}
	}
}
