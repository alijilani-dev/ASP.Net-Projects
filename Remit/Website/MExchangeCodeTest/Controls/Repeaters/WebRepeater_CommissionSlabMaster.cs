...
namespace Evernet.MoneyExchange.Web.Repeaters {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.Repeater class and was built to display the 'CommissionSlabMaster' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebRepeater_CommissionSlabMaster), "WebRepeater.bmp")]
	public class WebRepeater_CommissionSlabMaster : System.Web.UI.WebControls.Repeater {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.Repeaters.WebRepeater_CommissionSlabMaster class.
		/// </summary>
		public WebRepeater_CommissionSlabMaster() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebRepeater_CommissionSlabMaster : System.Web.UI.WebControls.Repeater", "RefreshData");
			}
		}
	}
}
