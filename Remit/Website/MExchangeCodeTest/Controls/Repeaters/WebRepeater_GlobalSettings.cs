...
namespace Evernet.MoneyExchange.Web.Repeaters {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.Repeater class and was built to display the 'GlobalSettings' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:49", SqlObjectDependancyName="GlobalSettings", SqlObjectDependancyRevision=832)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebRepeater_GlobalSettings), "WebRepeater.bmp")]
	public class WebRepeater_GlobalSettings : System.Web.UI.WebControls.Repeater {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.Repeaters.WebRepeater_GlobalSettings class.
		/// </summary>
		public WebRepeater_GlobalSettings() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebRepeater_GlobalSettings : System.Web.UI.WebControls.Repeater", "RefreshData");
			}
		}
	}
}
