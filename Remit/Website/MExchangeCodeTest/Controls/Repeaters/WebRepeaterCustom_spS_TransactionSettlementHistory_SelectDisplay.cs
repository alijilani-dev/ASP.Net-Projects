/*
	This C# source code was automatically generated using:
		...
		SQL Server Centric .NET Code Generator
			...
			Generation Date: 11/30/2004 11:48:57 PM
...
namespace Evernet.MoneyExchange.Web.Repeaters {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:57", SqlObjectDependancyName="spS_TransactionSettlementHistory_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebRepeaterCustom_spS_TransactionSettlementHistory_SelectDisplay), "WebRepeater.bmp")]
	public class WebRepeaterCustom_spS_TransactionSettlementHistory_SelectDisplay : System.Web.UI.WebControls.Repeater {
		...
		/// WebRepeaterCustom_spS_TransactionSettlementHistory_SelectDisplay class.
		/// </summary>
		public WebRepeaterCustom_spS_TransactionSettlementHistory_SelectDisplay() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebRepeaterCustom_spS_TransactionSettlementHistory_SelectDisplay", "RefreshData");
			}
		}
	}
}
