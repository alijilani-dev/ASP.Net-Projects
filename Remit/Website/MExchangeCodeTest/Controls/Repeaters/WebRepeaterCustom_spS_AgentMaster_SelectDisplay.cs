...
namespace Evernet.MoneyExchange.Web.Repeaters {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:54", SqlObjectDependancyName="spS_AgentMaster_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebRepeaterCustom_spS_AgentMaster_SelectDisplay), "WebRepeater.bmp")]
	public class WebRepeaterCustom_spS_AgentMaster_SelectDisplay : System.Web.UI.WebControls.Repeater {
		...
		/// WebRepeaterCustom_spS_AgentMaster_SelectDisplay class.
		/// </summary>
		public WebRepeaterCustom_spS_AgentMaster_SelectDisplay() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebRepeaterCustom_spS_AgentMaster_SelectDisplay", "RefreshData");
			}
		}
	}
}
