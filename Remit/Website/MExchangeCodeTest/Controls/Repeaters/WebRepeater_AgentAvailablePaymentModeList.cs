...
namespace Evernet.MoneyExchange.Web.Repeaters {
	...
	/// <summary>
	/// This class is based on a System.Web.UI.WebControls.Repeater class and was built to display the 'AgentAvailablePaymentModeList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:48", SqlObjectDependancyName="AgentAvailablePaymentModeList", SqlObjectDependancyRevision=496)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebRepeater_AgentAvailablePaymentModeList), "WebRepeater.bmp")]
	public class WebRepeater_AgentAvailablePaymentModeList : System.Web.UI.WebControls.Repeater {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.Repeaters.WebRepeater_AgentAvailablePaymentModeList class.
		/// </summary>
		public WebRepeater_AgentAvailablePaymentModeList() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebRepeater_AgentAvailablePaymentModeList : System.Web.UI.WebControls.Repeater", "RefreshData");
			}
		}
	}
}
