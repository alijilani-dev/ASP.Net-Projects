...
namespace Evernet.MoneyExchange.Web.Repeaters {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:53", SqlObjectDependancyName="spS_AgencyDifferenceIncomeAccountDetails_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebRepeaterCustom_spS_AgencyDifferenceIncomeAccountDetails_SelectDisplay), "WebRepeater.bmp")]
	public class WebRepeaterCustom_spS_AgencyDifferenceIncomeAccountDetails_SelectDisplay : System.Web.UI.WebControls.Repeater {
		...
		/// WebRepeaterCustom_spS_AgencyDifferenceIncomeAccountDetails_SelectDisplay class.
		/// </summary>
		public WebRepeaterCustom_spS_AgencyDifferenceIncomeAccountDetails_SelectDisplay() : base() {
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebRepeaterCustom_spS_AgencyDifferenceIncomeAccountDetails_SelectDisplay", "RefreshData");
			}
		}
	}
}
