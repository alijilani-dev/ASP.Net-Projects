...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_UserRoleList_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:32", SqlObjectDependancyName="spS_UserRoleList_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_UserRoleList_SelectDisplay), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_UserRoleList_SelectDisplay : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_UserRoleList_SelectDisplay param;
		private System.Data.SqlTypes.SqlString param_Value = System.Data.SqlTypes.SqlString.Null;
		private System.Data.SqlTypes.SqlString param_Module = System.Data.SqlTypes.SqlString.Null;
		private System.Data.SqlTypes.SqlString param_Type = System.Data.SqlTypes.SqlString.Null;
		...
		/// </summary>
		public Params.spS_UserRoleList_SelectDisplay SP_Parameter {
		...
		public override void Dispose() {
			...
			this.param_Module = System.Data.SqlTypes.SqlString.Null;
			this.param_Type = System.Data.SqlTypes.SqlString.Null;
			if (this.param != null) {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_UserRoleList_SelectDisplay class.
		/// </summary>
		public WebDropDownListCustom_spS_UserRoleList_SelectDisplay() : base() {
		...
		/// You also need to supply the 'spS_UserRoleList_SelectDisplay' stored procedure parameters.
		/// </summary>
		...
		/// <param name="param_Module">Value for the parameter @Module.</param>
		/// <param name="param_Type">Value for the parameter @Type.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlString param_Value, System.Data.SqlTypes.SqlString param_Module, System.Data.SqlTypes.SqlString param_Type) {
		...
		/// <param name="param_Module">Value for the parameter @Module.</param>
		/// <param name="param_Type">Value for the parameter @Type.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_Value, System.Data.SqlTypes.SqlString param_Module, System.Data.SqlTypes.SqlString param_Type) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_UserRoleList_SelectDisplay";
		...
		/// <param name="param_Module">Value for the parameter @Module.</param>
		/// <param name="param_Type">Value for the parameter @Type.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlString param_Value, System.Data.SqlTypes.SqlString param_Module, System.Data.SqlTypes.SqlString param_Type) {
		...
		/// <param name="param_Module">Value for the parameter @Module.</param>
		/// <param name="param_Type">Value for the parameter @Type.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_Value, System.Data.SqlTypes.SqlString param_Module, System.Data.SqlTypes.SqlString param_Type) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_UserRoleList_SelectDisplay();
			...
			if (!this.param_Module.IsNull) {

				this.param.Param_Module = this.param_Module;
			}


			if (!this.param_Type.IsNull) {

				this.param.Param_Type = this.param_Type;
			}


			System.Data.DataSet DS = null;
			
			SPs.spS_UserRoleList_SelectDisplay SP = new SPs.spS_UserRoleList_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_UserRoleList_SelectDisplay", "RefreshData");
			}
