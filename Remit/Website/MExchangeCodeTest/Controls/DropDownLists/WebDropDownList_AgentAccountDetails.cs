...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'AgentAccountDetails' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:37", SqlObjectDependancyName="AgentAccountDetails", SqlObjectDependancyRevision=736)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_AgentAccountDetails), "WebDropDownList.bmp")]
	public class WebDropDownList_AgentAccountDetails : System.Web.UI.WebControls.DropDownList {

		private Params.spS_AgentAccountDetails_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_AgentAccountDetails oAbstract_AgentAccountDetails;
		...
		/// </summary>
		public Params.spS_AgentAccountDetails_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'AgentAccountDetails' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_AgentAccountDetails Abstract_AgentAccountDetails {

			get {

				return(this.oAbstract_AgentAccountDetails);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_AgentAccountDetails = null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_AgentAccountDetails class.
		/// </summary>
		public WebDropDownList_AgentAccountDetails() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_TransactionId) {
		...
		/// <param name="FK_AgentAccountId">Value for this foreign key.</param>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_TransactionId) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgentAccountDetails_Display(true);
			...
			SPs.spS_AgentAccountDetails_Display SP = new SPs.spS_AgentAccountDetails_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_AgentAccountDetails_Display"].DefaultView;
				this.DataValueField = SPs.spS_AgentAccountDetails_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_AgentAccountDetails_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_AgentAccountDetails : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the AgentAccountDetails abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_AgentAccountDetails != null) {

					oAbstract_AgentAccountDetails.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_AgentAccountDetails == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_AgentAccountDetails = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgentAccountDetails(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_AgentAccountDetails = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgentAccountDetails(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_AgentAccountDetails.Refresh(PK_Id));
		}
	}
}
