...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_CountryTransactionPermissionTypeList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:30", SqlObjectDependancyName="spS_CountryTransactionPermissionTypeList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_CountryTransactionPermissionTypeList), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_CountryTransactionPermissionTypeList : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_CountryTransactionPermissionTypeList param;
		...
		/// </summary>
		public Params.spS_CountryTransactionPermissionTypeList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_CountryTransactionPermissionTypeList class.
		/// </summary>
		public WebDropDownListCustom_spS_CountryTransactionPermissionTypeList() : base() {
		...
		/// You also need to supply the 'spS_CountryTransactionPermissionTypeList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlString param_Value) {
		...
		/// <param name="displayMember">name of the field to be used for the content display.</param>
		/// <param name="param_Value">Value for the parameter @Value.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_Value) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_CountryTransactionPermissionTypeList";
		...
		/// <param name="tableName">name of the table to use to populate the control.</param>
		/// <param name="param_Value">Value for the parameter @Value.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlString param_Value) {
		...
		/// <param name="displayMember">name of the field to be used for the content display.</param>
		/// <param name="param_Value">Value for the parameter @Value.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_Value) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CountryTransactionPermissionTypeList();
			...
			SPs.spS_CountryTransactionPermissionTypeList SP = new SPs.spS_CountryTransactionPermissionTypeList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_CountryTransactionPermissionTypeList", "RefreshData");
			}
