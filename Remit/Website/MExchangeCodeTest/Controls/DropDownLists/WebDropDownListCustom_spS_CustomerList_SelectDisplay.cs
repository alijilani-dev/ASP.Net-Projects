...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_CustomerList_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:30", SqlObjectDependancyName="spS_CustomerList_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_CustomerList_SelectDisplay), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_CustomerList_SelectDisplay : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_CustomerList_SelectDisplay param;
		private System.Data.SqlTypes.SqlGuid param_Id = System.Data.SqlTypes.SqlGuid.Null;
		private System.Data.SqlTypes.SqlGuid param_CardId = System.Data.SqlTypes.SqlGuid.Null;
		private System.Data.SqlTypes.SqlString param_Nationality = System.Data.SqlTypes.SqlString.Null;
		...
		/// </summary>
		public Params.spS_CustomerList_SelectDisplay SP_Parameter {
		...
		public override void Dispose() {
			...
			this.param_CardId = System.Data.SqlTypes.SqlGuid.Null;
			this.param_Nationality = System.Data.SqlTypes.SqlString.Null;
			if (this.param != null) {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_CustomerList_SelectDisplay class.
		/// </summary>
		public WebDropDownListCustom_spS_CustomerList_SelectDisplay() : base() {
		...
		/// You also need to supply the 'spS_CustomerList_SelectDisplay' stored procedure parameters.
		/// </summary>
		...
		/// <param name="param_CardId">Value for the parameter @CardId.</param>
		/// <param name="param_Nationality">Value for the parameter @Nationality.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CardId, System.Data.SqlTypes.SqlString param_Nationality) {
			...
			this.param_CardId = param_CardId;
			this.param_Nationality = param_Nationality;
		}
		...
		/// <param name="param_CardId">Value for the parameter @CardId.</param>
		/// <param name="param_Nationality">Value for the parameter @Nationality.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CardId, System.Data.SqlTypes.SqlString param_Nationality) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_CustomerList_SelectDisplay";
		...
		/// <param name="param_CardId">Value for the parameter @CardId.</param>
		/// <param name="param_Nationality">Value for the parameter @Nationality.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CardId, System.Data.SqlTypes.SqlString param_Nationality) {
		...
		/// <param name="param_CardId">Value for the parameter @CardId.</param>
		/// <param name="param_Nationality">Value for the parameter @Nationality.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CardId, System.Data.SqlTypes.SqlString param_Nationality) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CustomerList_SelectDisplay();
			...
			if (!this.param_CardId.IsNull) {

				this.param.Param_CardId = this.param_CardId;
			}


			if (!this.param_Nationality.IsNull) {

				this.param.Param_Nationality = this.param_Nationality;
			}


			System.Data.DataSet DS = null;
			
			SPs.spS_CustomerList_SelectDisplay SP = new SPs.spS_CustomerList_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_CustomerList_SelectDisplay", "RefreshData");
			}
