...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_TransitionAccountDetails_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:32", SqlObjectDependancyName="spS_TransitionAccountDetails_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_TransitionAccountDetails_SelectDisplay), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_TransitionAccountDetails_SelectDisplay : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_TransitionAccountDetails_SelectDisplay param;
		...
		/// </summary>
		public Params.spS_TransitionAccountDetails_SelectDisplay SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_TransitionAccountDetails_SelectDisplay class.
		/// </summary>
		public WebDropDownListCustom_spS_TransitionAccountDetails_SelectDisplay() : base() {
		...
		/// You also need to supply the 'spS_TransitionAccountDetails_SelectDisplay' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_TransactionId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_TransitionAccountDetails_SelectDisplay";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_TransitionAccountDetails_SelectDisplay();
			...
			SPs.spS_TransitionAccountDetails_SelectDisplay SP = new SPs.spS_TransitionAccountDetails_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_TransitionAccountDetails_SelectDisplay", "RefreshData");
			}
