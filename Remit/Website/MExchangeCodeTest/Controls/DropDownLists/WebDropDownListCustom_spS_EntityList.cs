...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_EntityList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:30", SqlObjectDependancyName="spS_EntityList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_EntityList), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_EntityList : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_EntityList param;
		...
		/// </summary>
		public Params.spS_EntityList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_EntityList class.
		/// </summary>
		public WebDropDownListCustom_spS_EntityList() : base() {
		...
		/// You also need to supply the 'spS_EntityList' stored procedure parameters.
		/// </summary>
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_EntityList();
			...
			SPs.spS_EntityList SP = new SPs.spS_EntityList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_EntityList", "RefreshData");
			}
