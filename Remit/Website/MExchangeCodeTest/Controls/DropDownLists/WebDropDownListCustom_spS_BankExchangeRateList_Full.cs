...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:29", SqlObjectDependancyName="spS_BankExchangeRateList_Full", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_BankExchangeRateList_Full), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_BankExchangeRateList_Full : System.Web.UI.WebControls.DropDownList {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_BankExchangeRateList_Full class.
		/// </summary>
		public WebDropDownListCustom_spS_BankExchangeRateList_Full() : base() {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_BankExchangeRateList_Full", "RefreshData");
			}
