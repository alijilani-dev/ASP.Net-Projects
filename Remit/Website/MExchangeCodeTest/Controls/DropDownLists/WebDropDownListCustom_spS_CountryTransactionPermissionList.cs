...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_CountryTransactionPermissionList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:30", SqlObjectDependancyName="spS_CountryTransactionPermissionList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_CountryTransactionPermissionList), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_CountryTransactionPermissionList : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_CountryTransactionPermissionList param;
		...
		/// </summary>
		public Params.spS_CountryTransactionPermissionList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_CountryTransactionPermissionList class.
		/// </summary>
		public WebDropDownListCustom_spS_CountryTransactionPermissionList() : base() {
		...
		/// You also need to supply the 'spS_CountryTransactionPermissionList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_BaseCountryId, System.Data.SqlTypes.SqlGuid param_TargetCountryId, System.Data.SqlTypes.SqlString param_PermissionType) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_CountryTransactionPermissionList";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CountryTransactionPermissionList();
			...
			SPs.spS_CountryTransactionPermissionList SP = new SPs.spS_CountryTransactionPermissionList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_CountryTransactionPermissionList", "RefreshData");
			}
