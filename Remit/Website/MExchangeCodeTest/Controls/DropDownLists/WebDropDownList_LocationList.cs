...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'LocationList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="LocationList", SqlObjectDependancyRevision=1056)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_LocationList), "WebDropDownList.bmp")]
	public class WebDropDownList_LocationList : System.Web.UI.WebControls.DropDownList {

		private Params.spS_LocationList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_LocationList oAbstract_LocationList;
		private System.Data.SqlTypes.SqlGuid FK_ParentId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_LocationList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'LocationList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_LocationList Abstract_LocationList {

			get {

				return(this.oAbstract_LocationList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_LocationList = null;

			this.FK_ParentId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_LocationList class.
		/// </summary>
		public WebDropDownList_LocationList() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_ParentId, System.Data.SqlTypes.SqlGuid FK_CountryId) {
		...
		/// <param name="FK_ParentId">Value for this foreign key.</param>
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_ParentId, System.Data.SqlTypes.SqlGuid FK_CountryId) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_LocationList_Display(true);
			...
			this.param.Param_ParentId = this.FK_ParentId;
			this.param.Param_CountryId = this.FK_CountryId;

			System.Data.DataSet DS = null;
			
			SPs.spS_LocationList_Display SP = new SPs.spS_LocationList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_LocationList_Display"].DefaultView;
				this.DataValueField = SPs.spS_LocationList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_LocationList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_LocationList : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the LocationList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_LocationList != null) {

					oAbstract_LocationList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_LocationList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_LocationList = new Evernet.MoneyExchange.AbstractClasses.Abstract_LocationList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_LocationList = new Evernet.MoneyExchange.AbstractClasses.Abstract_LocationList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_LocationList.Refresh(PK_Id));
		}
	}
}
