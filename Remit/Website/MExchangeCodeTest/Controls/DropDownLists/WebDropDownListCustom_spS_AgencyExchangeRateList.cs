...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_AgencyExchangeRateList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:28", SqlObjectDependancyName="spS_AgencyExchangeRateList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_AgencyExchangeRateList), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_AgencyExchangeRateList : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_AgencyExchangeRateList param;
		...
		/// </summary>
		public Params.spS_AgencyExchangeRateList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_AgencyExchangeRateList class.
		/// </summary>
		public WebDropDownListCustom_spS_AgencyExchangeRateList() : base() {
		...
		/// You also need to supply the 'spS_AgencyExchangeRateList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PayInCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCurrencyId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_AgencyExchangeRateList";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgencyExchangeRateList();
			...
			SPs.spS_AgencyExchangeRateList SP = new SPs.spS_AgencyExchangeRateList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_AgencyExchangeRateList", "RefreshData");
			}
