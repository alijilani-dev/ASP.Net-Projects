...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'BeneficeryBankList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="BeneficeryBankList", SqlObjectDependancyRevision=1008)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_BeneficeryBankList), "WebDropDownList.bmp")]
	public class WebDropDownList_BeneficeryBankList : System.Web.UI.WebControls.DropDownList {

		private Params.spS_BeneficeryBankList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_BeneficeryBankList oAbstract_BeneficeryBankList;
		...
		/// </summary>
		public Params.spS_BeneficeryBankList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'BeneficeryBankList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_BeneficeryBankList Abstract_BeneficeryBankList {

			get {

				return(this.oAbstract_BeneficeryBankList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_BeneficeryBankList = null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_BeneficeryBankList class.
		/// </summary>
		public WebDropDownList_BeneficeryBankList() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_CountryId) {
		...
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_CountryId) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_BeneficeryBankList_Display(true);
			...
			SPs.spS_BeneficeryBankList_Display SP = new SPs.spS_BeneficeryBankList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_BeneficeryBankList_Display"].DefaultView;
				this.DataValueField = SPs.spS_BeneficeryBankList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_BeneficeryBankList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_BeneficeryBankList : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the BeneficeryBankList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_BeneficeryBankList != null) {

					oAbstract_BeneficeryBankList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_BeneficeryBankList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_BeneficeryBankList = new Evernet.MoneyExchange.AbstractClasses.Abstract_BeneficeryBankList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_BeneficeryBankList = new Evernet.MoneyExchange.AbstractClasses.Abstract_BeneficeryBankList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_BeneficeryBankList.Refresh(PK_Id));
		}
	}
}
