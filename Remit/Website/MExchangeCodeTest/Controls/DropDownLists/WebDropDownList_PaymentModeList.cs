...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'PaymentModeList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="PaymentModeList", SqlObjectDependancyRevision=816)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_PaymentModeList), "WebDropDownList.bmp")]
	public class WebDropDownList_PaymentModeList : System.Web.UI.WebControls.DropDownList {

		private Params.spS_PaymentModeList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_PaymentModeList oAbstract_PaymentModeList;
		private System.Data.SqlTypes.SqlString FK_BaseType = System.Data.SqlTypes.SqlString.Null;
		private System.Data.SqlTypes.SqlString FK_ChannelThrough = System.Data.SqlTypes.SqlString.Null;
		private System.Data.SqlTypes.SqlString FK_FinalEntity = System.Data.SqlTypes.SqlString.Null;
		...
		/// </summary>
		public Params.spS_PaymentModeList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'PaymentModeList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_PaymentModeList Abstract_PaymentModeList {

			get {

				return(this.oAbstract_PaymentModeList);
			}
		}
		...
		/// </summary>
		public System.Data.SqlTypes.SqlString SelectedRecordID {

			get {

				return(Convert.ToString(this.SelectedItem.Value));
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_PaymentModeList = null;

			this.FK_BaseType = System.Data.SqlTypes.SqlString.Null;
			this.FK_ChannelThrough = System.Data.SqlTypes.SqlString.Null;
			this.FK_FinalEntity = System.Data.SqlTypes.SqlString.Null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_PaymentModeList class.
		/// </summary>
		public WebDropDownList_PaymentModeList() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlString FK_BaseType, System.Data.SqlTypes.SqlString FK_ChannelThrough, System.Data.SqlTypes.SqlString FK_FinalEntity) {
			...
			this.FK_BaseType = FK_BaseType;
			this.FK_ChannelThrough = FK_ChannelThrough;
			this.FK_FinalEntity = FK_FinalEntity;
		}
		...
		/// <param name="FK_ChannelThrough">Value for this foreign key.</param>
		/// <param name="FK_FinalEntity">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_BaseType, System.Data.SqlTypes.SqlString FK_ChannelThrough, System.Data.SqlTypes.SqlString FK_FinalEntity) {
		...
		public void RefreshData() {
			...
			this.RefreshData(System.Data.SqlTypes.SqlString.Null, -1, -1);
		}
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.RefreshData(System.Data.SqlTypes.SqlString.Null, startRecord, maxRecords);
		}
		...
		/// </summary>
		/// <param name="PK_Value">Primary key of the record you want to be selected by default.</param>
		public void RefreshData(System.Data.SqlTypes.SqlString PK_Value) {

			this.RefreshData(PK_Value, -1, -1);
		}
		...
		/// <param name="startRecord">The zero-based record number to start with.</param>
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		public void RefreshData(System.Data.SqlTypes.SqlString PK_Value, int startRecord, int maxRecords) {

			this.param = new Params.spS_PaymentModeList_Display(true);
			...
			this.param.Param_BaseType = this.FK_BaseType;
			this.param.Param_ChannelThrough = this.FK_ChannelThrough;
			this.param.Param_FinalEntity = this.FK_FinalEntity;

			System.Data.DataSet DS = null;
			
			SPs.spS_PaymentModeList_Display SP = new SPs.spS_PaymentModeList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_PaymentModeList_Display"].DefaultView;
				this.DataValueField = SPs.spS_PaymentModeList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_PaymentModeList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_PaymentModeList : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the PaymentModeList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_PaymentModeList != null) {

					oAbstract_PaymentModeList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_PaymentModeList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_PaymentModeList = new Evernet.MoneyExchange.AbstractClasses.Abstract_PaymentModeList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_PaymentModeList = new Evernet.MoneyExchange.AbstractClasses.Abstract_PaymentModeList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_PaymentModeList.Refresh(PK_Value));
		}
	}
}
