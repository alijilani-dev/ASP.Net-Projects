...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'CustomerLoyaltyPointsRedeemHistory' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="CustomerLoyaltyPointsRedeemHistory", SqlObjectDependancyRevision=480)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_CustomerLoyaltyPointsRedeemHistory), "WebDropDownList.bmp")]
	public class WebDropDownList_CustomerLoyaltyPointsRedeemHistory : System.Web.UI.WebControls.DropDownList {

		private Params.spS_CustomerLoyaltyPointsRedeemHistory_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_CustomerLoyaltyPointsRedeemHistory oAbstract_CustomerLoyaltyPointsRedeemHistory;
		private System.Data.SqlTypes.SqlGuid FK_CustomerId = System.Data.SqlTypes.SqlGuid.Null;
		private System.Data.SqlTypes.SqlGuid FK_ProductsId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_CustomerLoyaltyPointsRedeemHistory_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'CustomerLoyaltyPointsRedeemHistory' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_CustomerLoyaltyPointsRedeemHistory Abstract_CustomerLoyaltyPointsRedeemHistory {

			get {

				return(this.oAbstract_CustomerLoyaltyPointsRedeemHistory);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_CustomerLoyaltyPointsRedeemHistory = null;

			this.FK_CustomerId = System.Data.SqlTypes.SqlGuid.Null;
			this.FK_ProductsId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_CustomerLoyaltyPointsRedeemHistory class.
		/// </summary>
		public WebDropDownList_CustomerLoyaltyPointsRedeemHistory() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_ProductsId) {
			...
			this.FK_ProductsId = FK_ProductsId;
		}
		...
		/// <param name="FK_CustomerId">Value for this foreign key.</param>
		/// <param name="FK_ProductsId">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CustomerId, System.Data.SqlTypes.SqlGuid FK_ProductsId) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CustomerLoyaltyPointsRedeemHistory_Display(true);
			...
			this.param.Param_ProductsId = this.FK_ProductsId;

			System.Data.DataSet DS = null;
			
			SPs.spS_CustomerLoyaltyPointsRedeemHistory_Display SP = new SPs.spS_CustomerLoyaltyPointsRedeemHistory_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_CustomerLoyaltyPointsRedeemHistory_Display"].DefaultView;
				this.DataValueField = SPs.spS_CustomerLoyaltyPointsRedeemHistory_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_CustomerLoyaltyPointsRedeemHistory_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_CustomerLoyaltyPointsRedeemHistory : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the CustomerLoyaltyPointsRedeemHistory abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_CustomerLoyaltyPointsRedeemHistory != null) {

					oAbstract_CustomerLoyaltyPointsRedeemHistory.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_CustomerLoyaltyPointsRedeemHistory == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_CustomerLoyaltyPointsRedeemHistory = new Evernet.MoneyExchange.AbstractClasses.Abstract_CustomerLoyaltyPointsRedeemHistory(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_CustomerLoyaltyPointsRedeemHistory = new Evernet.MoneyExchange.AbstractClasses.Abstract_CustomerLoyaltyPointsRedeemHistory(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_CustomerLoyaltyPointsRedeemHistory.Refresh(PK_Id));
		}
	}
}
