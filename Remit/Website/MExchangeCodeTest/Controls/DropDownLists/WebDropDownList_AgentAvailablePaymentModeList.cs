...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'AgentAvailablePaymentModeList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="AgentAvailablePaymentModeList", SqlObjectDependancyRevision=496)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_AgentAvailablePaymentModeList), "WebDropDownList.bmp")]
	public class WebDropDownList_AgentAvailablePaymentModeList : System.Web.UI.WebControls.DropDownList {

		private Params.spS_AgentAvailablePaymentModeList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_AgentAvailablePaymentModeList oAbstract_AgentAvailablePaymentModeList;
		private System.Data.SqlTypes.SqlGuid FK_AgentId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_AgentAvailablePaymentModeList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'AgentAvailablePaymentModeList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_AgentAvailablePaymentModeList Abstract_AgentAvailablePaymentModeList {

			get {

				return(this.oAbstract_AgentAvailablePaymentModeList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_AgentAvailablePaymentModeList = null;

			this.FK_AgentId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_AgentAvailablePaymentModeList class.
		/// </summary>
		public WebDropDownList_AgentAvailablePaymentModeList() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_AgentId, System.Data.SqlTypes.SqlString FK_PaymentMode) {
		...
		/// <param name="FK_AgentId">Value for this foreign key.</param>
		/// <param name="FK_PaymentMode">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_AgentId, System.Data.SqlTypes.SqlString FK_PaymentMode) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgentAvailablePaymentModeList_Display(true);
			...
			this.param.Param_AgentId = this.FK_AgentId;
			this.param.Param_PaymentMode = this.FK_PaymentMode;

			System.Data.DataSet DS = null;
			
			SPs.spS_AgentAvailablePaymentModeList_Display SP = new SPs.spS_AgentAvailablePaymentModeList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_AgentAvailablePaymentModeList_Display"].DefaultView;
				this.DataValueField = SPs.spS_AgentAvailablePaymentModeList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_AgentAvailablePaymentModeList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_AgentAvailablePaymentModeList : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the AgentAvailablePaymentModeList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_AgentAvailablePaymentModeList != null) {

					oAbstract_AgentAvailablePaymentModeList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_AgentAvailablePaymentModeList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_AgentAvailablePaymentModeList = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgentAvailablePaymentModeList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_AgentAvailablePaymentModeList = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgentAvailablePaymentModeList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_AgentAvailablePaymentModeList.Refresh(PK_Id));
		}
	}
}
