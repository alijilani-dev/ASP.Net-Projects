/*
	This C# source code was automatically generated using:
		...
		SQL Server Centric .NET Code Generator
			...
			Generation Date: 11/30/2004 11:47:37 PM
...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'AgencyExchangeRateList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:37", SqlObjectDependancyName="AgencyExchangeRateList", SqlObjectDependancyRevision=960)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_AgencyExchangeRateList), "WebDropDownList.bmp")]
	public class WebDropDownList_AgencyExchangeRateList : System.Web.UI.WebControls.DropDownList {

		private Params.spS_AgencyExchangeRateList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_AgencyExchangeRateList oAbstract_AgencyExchangeRateList;
		...
		/// </summary>
		public Params.spS_AgencyExchangeRateList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'AgencyExchangeRateList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_AgencyExchangeRateList Abstract_AgencyExchangeRateList {

			get {

				return(this.oAbstract_AgencyExchangeRateList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_AgencyExchangeRateList = null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_AgencyExchangeRateList class.
		/// </summary>
		public WebDropDownList_AgencyExchangeRateList() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_PayInCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCurrencyId) {
		...
		/// <param name="FK_PayOutCountryId">Value for this foreign key.</param>
		/// <param name="FK_PayOutCurrencyId">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_PayInCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCurrencyId) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgencyExchangeRateList_Display(true);
			...
			SPs.spS_AgencyExchangeRateList_Display SP = new SPs.spS_AgencyExchangeRateList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_AgencyExchangeRateList_Display"].DefaultView;
				this.DataValueField = SPs.spS_AgencyExchangeRateList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_AgencyExchangeRateList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_AgencyExchangeRateList : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the AgencyExchangeRateList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_AgencyExchangeRateList != null) {

					oAbstract_AgencyExchangeRateList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_AgencyExchangeRateList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_AgencyExchangeRateList = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgencyExchangeRateList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_AgencyExchangeRateList = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgencyExchangeRateList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_AgencyExchangeRateList.Refresh(PK_Id));
		}
	}
}
