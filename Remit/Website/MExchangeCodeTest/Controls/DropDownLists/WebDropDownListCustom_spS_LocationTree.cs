...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_LocationTree' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:31", SqlObjectDependancyName="spS_LocationTree", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_LocationTree), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_LocationTree : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_LocationTree param;
		...
		/// </summary>
		public Params.spS_LocationTree SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_LocationTree class.
		/// </summary>
		public WebDropDownListCustom_spS_LocationTree() : base() {
		...
		/// You also need to supply the 'spS_LocationTree' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_LocationTree";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_LocationTree();
			...
			SPs.spS_LocationTree SP = new SPs.spS_LocationTree();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_LocationTree", "RefreshData");
			}
