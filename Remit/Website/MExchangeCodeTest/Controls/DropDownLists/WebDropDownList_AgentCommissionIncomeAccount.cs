...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'AgentCommissionIncomeAccount' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="AgentCommissionIncomeAccount", SqlObjectDependancyRevision=864)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_AgentCommissionIncomeAccount), "WebDropDownList.bmp")]
	public class WebDropDownList_AgentCommissionIncomeAccount : System.Web.UI.WebControls.DropDownList {

		private Params.spS_AgentCommissionIncomeAccount_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_AgentCommissionIncomeAccount oAbstract_AgentCommissionIncomeAccount;
		...
		/// </summary>
		public Params.spS_AgentCommissionIncomeAccount_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'AgentCommissionIncomeAccount' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_AgentCommissionIncomeAccount Abstract_AgentCommissionIncomeAccount {

			get {

				return(this.oAbstract_AgentCommissionIncomeAccount);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_AgentCommissionIncomeAccount = null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_AgentCommissionIncomeAccount class.
		/// </summary>
		public WebDropDownList_AgentCommissionIncomeAccount() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgentCommissionIncomeAccount_Display(true);
			...
			SPs.spS_AgentCommissionIncomeAccount_Display SP = new SPs.spS_AgentCommissionIncomeAccount_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_AgentCommissionIncomeAccount_Display"].DefaultView;
				this.DataValueField = SPs.spS_AgentCommissionIncomeAccount_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_AgentCommissionIncomeAccount_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_AgentCommissionIncomeAccount : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the AgentCommissionIncomeAccount abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_AgentCommissionIncomeAccount != null) {

					oAbstract_AgentCommissionIncomeAccount.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_AgentCommissionIncomeAccount == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_AgentCommissionIncomeAccount = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgentCommissionIncomeAccount(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_AgentCommissionIncomeAccount = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgentCommissionIncomeAccount(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_AgentCommissionIncomeAccount.Refresh(PK_Id));
		}
	}
}
