...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'TransactionDraftList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="TransactionDraftList", SqlObjectDependancyRevision=320)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_TransactionDraftList), "WebDropDownList.bmp")]
	public class WebDropDownList_TransactionDraftList : System.Web.UI.WebControls.DropDownList {

		private Params.spS_TransactionDraftList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionDraftList oAbstract_TransactionDraftList;
		...
		/// </summary>
		public Params.spS_TransactionDraftList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'TransactionDraftList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionDraftList Abstract_TransactionDraftList {

			get {

				return(this.oAbstract_TransactionDraftList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_TransactionDraftList = null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_TransactionDraftList class.
		/// </summary>
		public WebDropDownList_TransactionDraftList() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_TransactionDraftList_Display(true);
			...
			SPs.spS_TransactionDraftList_Display SP = new SPs.spS_TransactionDraftList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_TransactionDraftList_Display"].DefaultView;
				this.DataValueField = SPs.spS_TransactionDraftList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_TransactionDraftList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_TransactionDraftList : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the TransactionDraftList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_TransactionDraftList != null) {

					oAbstract_TransactionDraftList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_TransactionDraftList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_TransactionDraftList = new Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionDraftList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_TransactionDraftList = new Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionDraftList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_TransactionDraftList.Refresh(PK_Id));
		}
	}
}
