...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'CountryTransactionPermissionTypeList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="CountryTransactionPermissionTypeList", SqlObjectDependancyRevision=208)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_CountryTransactionPermissionTypeList), "WebDropDownList.bmp")]
	public class WebDropDownList_CountryTransactionPermissionTypeList : System.Web.UI.WebControls.DropDownList {

		private Params.spS_CountryTransactionPermissionTypeList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_CountryTransactionPermissionTypeList oAbstract_CountryTransactionPermissionTypeList;
		...
		/// </summary>
		public Params.spS_CountryTransactionPermissionTypeList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'CountryTransactionPermissionTypeList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_CountryTransactionPermissionTypeList Abstract_CountryTransactionPermissionTypeList {

			get {

				return(this.oAbstract_CountryTransactionPermissionTypeList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_CountryTransactionPermissionTypeList = null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_CountryTransactionPermissionTypeList class.
		/// </summary>
		public WebDropDownList_CountryTransactionPermissionTypeList() : base() {
		...
		public void Initialize(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'CountryTransactionPermissionTypeList'";
		...
		public void RefreshData(System.Data.SqlTypes.SqlString PK_Value, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CountryTransactionPermissionTypeList_Display(true);
			...
			SPs.spS_CountryTransactionPermissionTypeList_Display SP = new SPs.spS_CountryTransactionPermissionTypeList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_CountryTransactionPermissionTypeList_Display"].DefaultView;
				this.DataValueField = SPs.spS_CountryTransactionPermissionTypeList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_CountryTransactionPermissionTypeList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_CountryTransactionPermissionTypeList : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the CountryTransactionPermissionTypeList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_CountryTransactionPermissionTypeList != null) {

					oAbstract_CountryTransactionPermissionTypeList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_CountryTransactionPermissionTypeList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_CountryTransactionPermissionTypeList = new Evernet.MoneyExchange.AbstractClasses.Abstract_CountryTransactionPermissionTypeList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_CountryTransactionPermissionTypeList = new Evernet.MoneyExchange.AbstractClasses.Abstract_CountryTransactionPermissionTypeList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_CountryTransactionPermissionTypeList.Refresh(PK_Value));
		}
	}
}
