...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'AgencyCommissionIncomeAccountDetails' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:37", SqlObjectDependancyName="AgencyCommissionIncomeAccountDetails", SqlObjectDependancyRevision=576)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_AgencyCommissionIncomeAccountDetails), "WebDropDownList.bmp")]
	public class WebDropDownList_AgencyCommissionIncomeAccountDetails : System.Web.UI.WebControls.DropDownList {

		private Params.spS_AgencyCommissionIncomeAccountDetails_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_AgencyCommissionIncomeAccountDetails oAbstract_AgencyCommissionIncomeAccountDetails;
		...
		/// </summary>
		public Params.spS_AgencyCommissionIncomeAccountDetails_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'AgencyCommissionIncomeAccountDetails' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_AgencyCommissionIncomeAccountDetails Abstract_AgencyCommissionIncomeAccountDetails {

			get {

				return(this.oAbstract_AgencyCommissionIncomeAccountDetails);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_AgencyCommissionIncomeAccountDetails = null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_AgencyCommissionIncomeAccountDetails class.
		/// </summary>
		public WebDropDownList_AgencyCommissionIncomeAccountDetails() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgencyCommissionIncomeAccountDetails_Display(true);
			...
			SPs.spS_AgencyCommissionIncomeAccountDetails_Display SP = new SPs.spS_AgencyCommissionIncomeAccountDetails_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_AgencyCommissionIncomeAccountDetails_Display"].DefaultView;
				this.DataValueField = SPs.spS_AgencyCommissionIncomeAccountDetails_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_AgencyCommissionIncomeAccountDetails_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_AgencyCommissionIncomeAccountDetails : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the AgencyCommissionIncomeAccountDetails abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_AgencyCommissionIncomeAccountDetails != null) {

					oAbstract_AgencyCommissionIncomeAccountDetails.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_AgencyCommissionIncomeAccountDetails == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_AgencyCommissionIncomeAccountDetails = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgencyCommissionIncomeAccountDetails(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_AgencyCommissionIncomeAccountDetails = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgencyCommissionIncomeAccountDetails(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_AgencyCommissionIncomeAccountDetails.Refresh(PK_Id));
		}
	}
}
