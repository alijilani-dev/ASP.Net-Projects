...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_MasterModuleList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:31", SqlObjectDependancyName="spS_MasterModuleList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_MasterModuleList), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_MasterModuleList : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_MasterModuleList param;
		...
		/// </summary>
		public Params.spS_MasterModuleList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_MasterModuleList class.
		/// </summary>
		public WebDropDownListCustom_spS_MasterModuleList() : base() {
		...
		/// You also need to supply the 'spS_MasterModuleList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_Value) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_MasterModuleList";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_MasterModuleList();
			...
			SPs.spS_MasterModuleList SP = new SPs.spS_MasterModuleList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_MasterModuleList", "RefreshData");
			}
