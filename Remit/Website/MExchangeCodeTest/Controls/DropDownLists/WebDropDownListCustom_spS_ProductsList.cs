...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_ProductsList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:31", SqlObjectDependancyName="spS_ProductsList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_ProductsList), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_ProductsList : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_ProductsList param;
		...
		/// </summary>
		public Params.spS_ProductsList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_ProductsList class.
		/// </summary>
		public WebDropDownListCustom_spS_ProductsList() : base() {
		...
		/// You also need to supply the 'spS_ProductsList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_ProductsList";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_ProductsList();
			...
			SPs.spS_ProductsList SP = new SPs.spS_ProductsList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_ProductsList", "RefreshData");
			}
