...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_CountryAllowedOutboundCurrencyList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:30", SqlObjectDependancyName="spS_CountryAllowedOutboundCurrencyList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_CountryAllowedOutboundCurrencyList), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_CountryAllowedOutboundCurrencyList : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_CountryAllowedOutboundCurrencyList param;
		...
		/// </summary>
		public Params.spS_CountryAllowedOutboundCurrencyList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_CountryAllowedOutboundCurrencyList class.
		/// </summary>
		public WebDropDownListCustom_spS_CountryAllowedOutboundCurrencyList() : base() {
		...
		/// You also need to supply the 'spS_CountryAllowedOutboundCurrencyList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id) {
		...
		/// <param name="displayMember">name of the field to be used for the content display.</param>
		/// <param name="param_Id">Value for the parameter @Id.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_CountryAllowedOutboundCurrencyList";
		...
		/// <param name="tableName">name of the table to use to populate the control.</param>
		/// <param name="param_Id">Value for the parameter @Id.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id) {
		...
		/// <param name="displayMember">name of the field to be used for the content display.</param>
		/// <param name="param_Id">Value for the parameter @Id.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CountryAllowedOutboundCurrencyList();
			...
			SPs.spS_CountryAllowedOutboundCurrencyList SP = new SPs.spS_CountryAllowedOutboundCurrencyList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_CountryAllowedOutboundCurrencyList", "RefreshData");
			}
