...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_UserRoleList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:32", SqlObjectDependancyName="spS_UserRoleList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_UserRoleList), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_UserRoleList : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_UserRoleList param;
		...
		/// </summary>
		public Params.spS_UserRoleList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_UserRoleList class.
		/// </summary>
		public WebDropDownListCustom_spS_UserRoleList() : base() {
		...
		/// You also need to supply the 'spS_UserRoleList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_Value, System.Data.SqlTypes.SqlString param_Module, System.Data.SqlTypes.SqlString param_Type) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_UserRoleList";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_UserRoleList();
			...
			SPs.spS_UserRoleList SP = new SPs.spS_UserRoleList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_UserRoleList", "RefreshData");
			}
