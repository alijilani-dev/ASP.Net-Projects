...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_CountryList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:30", SqlObjectDependancyName="spS_CountryList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_CountryList), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_CountryList : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_CountryList param;
		...
		/// </summary>
		public Params.spS_CountryList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_CountryList class.
		/// </summary>
		public WebDropDownListCustom_spS_CountryList() : base() {
		...
		/// You also need to supply the 'spS_CountryList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_BaseCurrency, System.Data.SqlTypes.SqlString param_AllowedInternationalTransactionType, System.Data.SqlTypes.SqlString param_AllowedDomesticTransactionType) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_CountryList";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CountryList();
			...
			SPs.spS_CountryList SP = new SPs.spS_CountryList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_CountryList", "RefreshData");
			}
