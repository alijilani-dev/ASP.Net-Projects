...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'AgentExchangeRateList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="AgentExchangeRateList", SqlObjectDependancyRevision=528)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_AgentExchangeRateList), "WebDropDownList.bmp")]
	public class WebDropDownList_AgentExchangeRateList : System.Web.UI.WebControls.DropDownList {

		private Params.spS_AgentExchangeRateList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_AgentExchangeRateList oAbstract_AgentExchangeRateList;
		private System.Data.SqlTypes.SqlGuid FK_AgentAccountId = System.Data.SqlTypes.SqlGuid.Null;
		private System.Data.SqlTypes.SqlGuid FK_AgencyExchangeRateId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_AgentExchangeRateList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'AgentExchangeRateList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_AgentExchangeRateList Abstract_AgentExchangeRateList {

			get {

				return(this.oAbstract_AgentExchangeRateList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_AgentExchangeRateList = null;

			this.FK_AgentAccountId = System.Data.SqlTypes.SqlGuid.Null;
			this.FK_AgencyExchangeRateId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_AgentExchangeRateList class.
		/// </summary>
		public WebDropDownList_AgentExchangeRateList() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_AgencyExchangeRateId) {
			...
			this.FK_AgencyExchangeRateId = FK_AgencyExchangeRateId;
		}
		...
		/// <param name="FK_AgentAccountId">Value for this foreign key.</param>
		/// <param name="FK_AgencyExchangeRateId">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_AgencyExchangeRateId) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgentExchangeRateList_Display(true);
			...
			this.param.Param_AgencyExchangeRateId = this.FK_AgencyExchangeRateId;

			System.Data.DataSet DS = null;
			
			SPs.spS_AgentExchangeRateList_Display SP = new SPs.spS_AgentExchangeRateList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_AgentExchangeRateList_Display"].DefaultView;
				this.DataValueField = SPs.spS_AgentExchangeRateList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_AgentExchangeRateList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_AgentExchangeRateList : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the AgentExchangeRateList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_AgentExchangeRateList != null) {

					oAbstract_AgentExchangeRateList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_AgentExchangeRateList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_AgentExchangeRateList = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgentExchangeRateList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_AgentExchangeRateList = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgentExchangeRateList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_AgentExchangeRateList.Refresh(PK_Id));
		}
	}
}
