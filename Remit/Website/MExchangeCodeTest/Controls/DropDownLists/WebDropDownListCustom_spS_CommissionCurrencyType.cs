...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_CommissionCurrencyType' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:30", SqlObjectDependancyName="spS_CommissionCurrencyType", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_CommissionCurrencyType), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_CommissionCurrencyType : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_CommissionCurrencyType param;
		...
		/// </summary>
		public Params.spS_CommissionCurrencyType SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_CommissionCurrencyType class.
		/// </summary>
		public WebDropDownListCustom_spS_CommissionCurrencyType() : base() {
		...
		/// You also need to supply the 'spS_CommissionCurrencyType' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_Value) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_CommissionCurrencyType";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CommissionCurrencyType();
			...
			SPs.spS_CommissionCurrencyType SP = new SPs.spS_CommissionCurrencyType();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_CommissionCurrencyType", "RefreshData");
			}
