...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_PayInAgentDifferenceIncomeAccount' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:31", SqlObjectDependancyName="spS_PayInAgentDifferenceIncomeAccount", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_PayInAgentDifferenceIncomeAccount), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_PayInAgentDifferenceIncomeAccount : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_PayInAgentDifferenceIncomeAccount param;
		...
		/// </summary>
		public Params.spS_PayInAgentDifferenceIncomeAccount SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_PayInAgentDifferenceIncomeAccount class.
		/// </summary>
		public WebDropDownListCustom_spS_PayInAgentDifferenceIncomeAccount() : base() {
		...
		/// You also need to supply the 'spS_PayInAgentDifferenceIncomeAccount' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_TranasctionId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_PayInAgentDifferenceIncomeAccount";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_PayInAgentDifferenceIncomeAccount();
			...
			SPs.spS_PayInAgentDifferenceIncomeAccount SP = new SPs.spS_PayInAgentDifferenceIncomeAccount();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_PayInAgentDifferenceIncomeAccount", "RefreshData");
			}
