...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_CustomerCardList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:30", SqlObjectDependancyName="spS_CustomerCardList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_CustomerCardList), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_CustomerCardList : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_CustomerCardList param;
		...
		/// </summary>
		public Params.spS_CustomerCardList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_CustomerCardList class.
		/// </summary>
		public WebDropDownListCustom_spS_CustomerCardList() : base() {
		...
		/// You also need to supply the 'spS_CustomerCardList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentId, System.Data.SqlTypes.SqlString param_Status) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_CustomerCardList";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CustomerCardList();
			...
			SPs.spS_CustomerCardList SP = new SPs.spS_CustomerCardList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_CustomerCardList", "RefreshData");
			}
