...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_TransactionSettlementHistory' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:32", SqlObjectDependancyName="spS_TransactionSettlementHistory", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_TransactionSettlementHistory), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_TransactionSettlementHistory : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_TransactionSettlementHistory param;
		...
		/// </summary>
		public Params.spS_TransactionSettlementHistory SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_TransactionSettlementHistory class.
		/// </summary>
		public WebDropDownListCustom_spS_TransactionSettlementHistory() : base() {
		...
		/// You also need to supply the 'spS_TransactionSettlementHistory' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PaymentId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_TransactionSettlementHistory";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_TransactionSettlementHistory();
			...
			SPs.spS_TransactionSettlementHistory SP = new SPs.spS_TransactionSettlementHistory();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_TransactionSettlementHistory", "RefreshData");
			}
