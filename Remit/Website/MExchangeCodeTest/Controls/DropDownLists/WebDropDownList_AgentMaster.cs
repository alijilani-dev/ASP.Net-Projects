...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'AgentMaster' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="AgentMaster", SqlObjectDependancyRevision=1520)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_AgentMaster), "WebDropDownList.bmp")]
	public class WebDropDownList_AgentMaster : System.Web.UI.WebControls.DropDownList {

		private Params.spS_AgentMaster_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_AgentMaster oAbstract_AgentMaster;
		...
		/// </summary>
		public Params.spS_AgentMaster_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'AgentMaster' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_AgentMaster Abstract_AgentMaster {

			get {

				return(this.oAbstract_AgentMaster);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_AgentMaster = null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_AgentMaster class.
		/// </summary>
		public WebDropDownList_AgentMaster() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgentMaster_Display(true);
			...
			SPs.spS_AgentMaster_Display SP = new SPs.spS_AgentMaster_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_AgentMaster_Display"].DefaultView;
				this.DataValueField = SPs.spS_AgentMaster_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_AgentMaster_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_AgentMaster : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the AgentMaster abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_AgentMaster != null) {

					oAbstract_AgentMaster.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_AgentMaster == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_AgentMaster = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgentMaster(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_AgentMaster = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgentMaster(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_AgentMaster.Refresh(PK_Id));
		}
	}
}
