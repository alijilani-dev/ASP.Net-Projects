...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_CommissionSlabMaster' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:30", SqlObjectDependancyName="spS_CommissionSlabMaster", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_CommissionSlabMaster), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_CommissionSlabMaster : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_CommissionSlabMaster param;
		...
		/// </summary>
		public Params.spS_CommissionSlabMaster SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_CommissionSlabMaster class.
		/// </summary>
		public WebDropDownListCustom_spS_CommissionSlabMaster() : base() {
		...
		/// You also need to supply the 'spS_CommissionSlabMaster' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PayInCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCountryId, System.Data.SqlTypes.SqlString param_ModeOfPayment, System.Data.SqlTypes.SqlString param_PayInCommissionType, System.Data.SqlTypes.SqlString param_PayOutCommissionType, System.Data.SqlTypes.SqlString param_PayOutCurrencyType) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_CommissionSlabMaster";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CommissionSlabMaster();
			...
			SPs.spS_CommissionSlabMaster SP = new SPs.spS_CommissionSlabMaster();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_CommissionSlabMaster", "RefreshData");
			}
