...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'TransactionModificationMessageList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="TransactionModificationMessageList", SqlObjectDependancyRevision=448)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_TransactionModificationMessageList), "WebDropDownList.bmp")]
	public class WebDropDownList_TransactionModificationMessageList : System.Web.UI.WebControls.DropDownList {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_TransactionModificationMessageList class.
		/// </summary>
		public WebDropDownList_TransactionModificationMessageList() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_TransactionModificationMessageList : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
