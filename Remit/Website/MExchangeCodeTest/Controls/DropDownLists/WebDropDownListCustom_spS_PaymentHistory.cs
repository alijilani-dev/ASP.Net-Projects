...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_PaymentHistory' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:31", SqlObjectDependancyName="spS_PaymentHistory", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_PaymentHistory), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_PaymentHistory : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_PaymentHistory param;
		...
		/// </summary>
		public Params.spS_PaymentHistory SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_PaymentHistory class.
		/// </summary>
		public WebDropDownListCustom_spS_PaymentHistory() : base() {
		...
		/// You also need to supply the 'spS_PaymentHistory' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PaymentCurrencyId, System.Data.SqlTypes.SqlString param_Type) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_PaymentHistory";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_PaymentHistory();
			...
			SPs.spS_PaymentHistory SP = new SPs.spS_PaymentHistory();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_PaymentHistory", "RefreshData");
			}
