...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'AgentCommissionSplitList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="AgentCommissionSplitList", SqlObjectDependancyRevision=544)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_AgentCommissionSplitList), "WebDropDownList.bmp")]
	public class WebDropDownList_AgentCommissionSplitList : System.Web.UI.WebControls.DropDownList {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_AgentCommissionSplitList class.
		/// </summary>
		public WebDropDownList_AgentCommissionSplitList() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_AgentCommissionSplitList : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
