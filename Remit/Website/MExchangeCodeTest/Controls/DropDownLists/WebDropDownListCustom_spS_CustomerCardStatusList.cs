...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_CustomerCardStatusList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:30", SqlObjectDependancyName="spS_CustomerCardStatusList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_CustomerCardStatusList), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_CustomerCardStatusList : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_CustomerCardStatusList param;
		...
		/// </summary>
		public Params.spS_CustomerCardStatusList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_CustomerCardStatusList class.
		/// </summary>
		public WebDropDownListCustom_spS_CustomerCardStatusList() : base() {
		...
		/// You also need to supply the 'spS_CustomerCardStatusList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_Value) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_CustomerCardStatusList";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CustomerCardStatusList();
			...
			SPs.spS_CustomerCardStatusList SP = new SPs.spS_CustomerCardStatusList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_CustomerCardStatusList", "RefreshData");
			}
