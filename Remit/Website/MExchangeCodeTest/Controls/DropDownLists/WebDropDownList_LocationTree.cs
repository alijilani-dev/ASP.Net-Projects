...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'LocationTree' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="LocationTree", SqlObjectDependancyRevision=336)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_LocationTree), "WebDropDownList.bmp")]
	public class WebDropDownList_LocationTree : System.Web.UI.WebControls.DropDownList {

		private Params.spS_LocationTree_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_LocationTree oAbstract_LocationTree;
		...
		/// </summary>
		public Params.spS_LocationTree_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'LocationTree' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_LocationTree Abstract_LocationTree {

			get {

				return(this.oAbstract_LocationTree);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_LocationTree = null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_LocationTree class.
		/// </summary>
		public WebDropDownList_LocationTree() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_LocationTree_Display(true);
			...
			SPs.spS_LocationTree_Display SP = new SPs.spS_LocationTree_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_LocationTree_Display"].DefaultView;
				this.DataValueField = SPs.spS_LocationTree_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_LocationTree_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_LocationTree : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the LocationTree abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_LocationTree != null) {

					oAbstract_LocationTree.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_LocationTree == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_LocationTree = new Evernet.MoneyExchange.AbstractClasses.Abstract_LocationTree(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_LocationTree = new Evernet.MoneyExchange.AbstractClasses.Abstract_LocationTree(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_LocationTree.Refresh(PK_Id));
		}
	}
}
