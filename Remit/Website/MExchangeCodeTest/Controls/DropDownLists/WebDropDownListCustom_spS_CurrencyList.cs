...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_CurrencyList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:30", SqlObjectDependancyName="spS_CurrencyList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_CurrencyList), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_CurrencyList : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_CurrencyList param;
		...
		/// </summary>
		public Params.spS_CurrencyList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_CurrencyList class.
		/// </summary>
		public WebDropDownListCustom_spS_CurrencyList() : base() {
		...
		/// You also need to supply the 'spS_CurrencyList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_CurrencyList";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CurrencyList();
			...
			SPs.spS_CurrencyList SP = new SPs.spS_CurrencyList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_CurrencyList", "RefreshData");
			}
