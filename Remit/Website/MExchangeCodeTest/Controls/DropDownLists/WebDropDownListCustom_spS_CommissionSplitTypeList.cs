...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_CommissionSplitTypeList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:30", SqlObjectDependancyName="spS_CommissionSplitTypeList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_CommissionSplitTypeList), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_CommissionSplitTypeList : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_CommissionSplitTypeList param;
		...
		/// </summary>
		public Params.spS_CommissionSplitTypeList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_CommissionSplitTypeList class.
		/// </summary>
		public WebDropDownListCustom_spS_CommissionSplitTypeList() : base() {
		...
		/// You also need to supply the 'spS_CommissionSplitTypeList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_Value) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_CommissionSplitTypeList";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CommissionSplitTypeList();
			...
			SPs.spS_CommissionSplitTypeList SP = new SPs.spS_CommissionSplitTypeList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_CommissionSplitTypeList", "RefreshData");
			}
