...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:30", SqlObjectDependancyName="spS_CountryTransactionPermissionList_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_CountryTransactionPermissionList_SelectDisplay), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_CountryTransactionPermissionList_SelectDisplay : System.Web.UI.WebControls.DropDownList {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_CountryTransactionPermissionList_SelectDisplay class.
		/// </summary>
		public WebDropDownListCustom_spS_CountryTransactionPermissionList_SelectDisplay() : base() {
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_BaseCountryId, System.Data.SqlTypes.SqlGuid param_TargetCountryId, System.Data.SqlTypes.SqlString param_PermissionType) {
		...
		/// <param name="param_TargetCountryId">Value for the parameter @TargetCountryId.</param>
		/// <param name="param_PermissionType">Value for the parameter @PermissionType.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_BaseCountryId, System.Data.SqlTypes.SqlGuid param_TargetCountryId, System.Data.SqlTypes.SqlString param_PermissionType) {
		...
		/// <param name="param_TargetCountryId">Value for the parameter @TargetCountryId.</param>
		/// <param name="param_PermissionType">Value for the parameter @PermissionType.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_BaseCountryId, System.Data.SqlTypes.SqlGuid param_TargetCountryId, System.Data.SqlTypes.SqlString param_PermissionType) {
		...
		/// <param name="param_TargetCountryId">Value for the parameter @TargetCountryId.</param>
		/// <param name="param_PermissionType">Value for the parameter @PermissionType.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_BaseCountryId, System.Data.SqlTypes.SqlGuid param_TargetCountryId, System.Data.SqlTypes.SqlString param_PermissionType) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_CountryTransactionPermissionList_SelectDisplay", "RefreshData");
			}
