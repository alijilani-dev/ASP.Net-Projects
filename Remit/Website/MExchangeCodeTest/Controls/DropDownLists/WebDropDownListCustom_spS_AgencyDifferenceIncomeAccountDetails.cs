...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_AgencyDifferenceIncomeAccountDetails' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:28", SqlObjectDependancyName="spS_AgencyDifferenceIncomeAccountDetails", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_AgencyDifferenceIncomeAccountDetails), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_AgencyDifferenceIncomeAccountDetails : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_AgencyDifferenceIncomeAccountDetails param;
		...
		/// </summary>
		public Params.spS_AgencyDifferenceIncomeAccountDetails SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_AgencyDifferenceIncomeAccountDetails class.
		/// </summary>
		public WebDropDownListCustom_spS_AgencyDifferenceIncomeAccountDetails() : base() {
		...
		/// You also need to supply the 'spS_AgencyDifferenceIncomeAccountDetails' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_TransactionId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_AgencyDifferenceIncomeAccountDetails";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgencyDifferenceIncomeAccountDetails();
			...
			SPs.spS_AgencyDifferenceIncomeAccountDetails SP = new SPs.spS_AgencyDifferenceIncomeAccountDetails();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_AgencyDifferenceIncomeAccountDetails", "RefreshData");
			}
