...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'PurposeOfTransferList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="PurposeOfTransferList", SqlObjectDependancyRevision=416)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_PurposeOfTransferList), "WebDropDownList.bmp")]
	public class WebDropDownList_PurposeOfTransferList : System.Web.UI.WebControls.DropDownList {

		private Params.spS_PurposeOfTransferList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_PurposeOfTransferList oAbstract_PurposeOfTransferList;
		private System.Data.SqlTypes.SqlString FK_PaymentModeBaseType = System.Data.SqlTypes.SqlString.Null;
		...
		/// </summary>
		public Params.spS_PurposeOfTransferList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'PurposeOfTransferList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_PurposeOfTransferList Abstract_PurposeOfTransferList {

			get {

				return(this.oAbstract_PurposeOfTransferList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_PurposeOfTransferList = null;

			this.FK_PaymentModeBaseType = System.Data.SqlTypes.SqlString.Null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_PurposeOfTransferList class.
		/// </summary>
		public WebDropDownList_PurposeOfTransferList() : base() {
		...
		/// <param name="FK_PaymentModeBaseType">Value for this foreign key.</param>
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlString FK_PaymentModeBaseType) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'PurposeOfTransferList'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "PurposeOfTransferList", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif

			this.FK_PaymentModeBaseType = FK_PaymentModeBaseType;
		}
		...
		/// </param>
		/// <param name="FK_PaymentModeBaseType">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_PaymentModeBaseType) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlString PK_Value, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_PurposeOfTransferList_Display(true);
			...
			this.param.Param_PaymentModeBaseType = this.FK_PaymentModeBaseType;

			System.Data.DataSet DS = null;
			
			SPs.spS_PurposeOfTransferList_Display SP = new SPs.spS_PurposeOfTransferList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_PurposeOfTransferList_Display"].DefaultView;
				this.DataValueField = SPs.spS_PurposeOfTransferList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_PurposeOfTransferList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_PurposeOfTransferList : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the PurposeOfTransferList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_PurposeOfTransferList != null) {

					oAbstract_PurposeOfTransferList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_PurposeOfTransferList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_PurposeOfTransferList = new Evernet.MoneyExchange.AbstractClasses.Abstract_PurposeOfTransferList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_PurposeOfTransferList = new Evernet.MoneyExchange.AbstractClasses.Abstract_PurposeOfTransferList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_PurposeOfTransferList.Refresh(PK_Value));
		}
	}
}
