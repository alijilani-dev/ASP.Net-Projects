...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'CountryTransactionPermissionList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="CountryTransactionPermissionList", SqlObjectDependancyRevision=560)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_CountryTransactionPermissionList), "WebDropDownList.bmp")]
	public class WebDropDownList_CountryTransactionPermissionList : System.Web.UI.WebControls.DropDownList {

		private Params.spS_CountryTransactionPermissionList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_CountryTransactionPermissionList oAbstract_CountryTransactionPermissionList;
		private System.Data.SqlTypes.SqlGuid FK_BaseCountryId = System.Data.SqlTypes.SqlGuid.Null;
		private System.Data.SqlTypes.SqlGuid FK_TargetCountryId = System.Data.SqlTypes.SqlGuid.Null;
		private System.Data.SqlTypes.SqlString FK_PermissionType = System.Data.SqlTypes.SqlString.Null;
		...
		/// </summary>
		public Params.spS_CountryTransactionPermissionList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'CountryTransactionPermissionList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_CountryTransactionPermissionList Abstract_CountryTransactionPermissionList {

			get {

				return(this.oAbstract_CountryTransactionPermissionList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_CountryTransactionPermissionList = null;

			this.FK_BaseCountryId = System.Data.SqlTypes.SqlGuid.Null;
			this.FK_TargetCountryId = System.Data.SqlTypes.SqlGuid.Null;
			this.FK_PermissionType = System.Data.SqlTypes.SqlString.Null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_CountryTransactionPermissionList class.
		/// </summary>
		public WebDropDownList_CountryTransactionPermissionList() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_BaseCountryId, System.Data.SqlTypes.SqlGuid FK_TargetCountryId, System.Data.SqlTypes.SqlString FK_PermissionType) {
			...
			this.FK_BaseCountryId = FK_BaseCountryId;
			this.FK_TargetCountryId = FK_TargetCountryId;
			this.FK_PermissionType = FK_PermissionType;
		}
		...
		/// <param name="FK_TargetCountryId">Value for this foreign key.</param>
		/// <param name="FK_PermissionType">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_BaseCountryId, System.Data.SqlTypes.SqlGuid FK_TargetCountryId, System.Data.SqlTypes.SqlString FK_PermissionType) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CountryTransactionPermissionList_Display(true);
			...
			this.param.Param_BaseCountryId = this.FK_BaseCountryId;
			this.param.Param_TargetCountryId = this.FK_TargetCountryId;
			this.param.Param_PermissionType = this.FK_PermissionType;

			System.Data.DataSet DS = null;
			
			SPs.spS_CountryTransactionPermissionList_Display SP = new SPs.spS_CountryTransactionPermissionList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_CountryTransactionPermissionList_Display"].DefaultView;
				this.DataValueField = SPs.spS_CountryTransactionPermissionList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_CountryTransactionPermissionList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_CountryTransactionPermissionList : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the CountryTransactionPermissionList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_CountryTransactionPermissionList != null) {

					oAbstract_CountryTransactionPermissionList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_CountryTransactionPermissionList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_CountryTransactionPermissionList = new Evernet.MoneyExchange.AbstractClasses.Abstract_CountryTransactionPermissionList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_CountryTransactionPermissionList = new Evernet.MoneyExchange.AbstractClasses.Abstract_CountryTransactionPermissionList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_CountryTransactionPermissionList.Refresh(PK_Id));
		}
	}
}
