...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_AgentAccountDetails' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:28", SqlObjectDependancyName="spS_AgentAccountDetails", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_AgentAccountDetails), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_AgentAccountDetails : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_AgentAccountDetails param;
		...
		/// </summary>
		public Params.spS_AgentAccountDetails SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_AgentAccountDetails class.
		/// </summary>
		public WebDropDownListCustom_spS_AgentAccountDetails() : base() {
		...
		/// You also need to supply the 'spS_AgentAccountDetails' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_AgentAccountDetails";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgentAccountDetails();
			...
			SPs.spS_AgentAccountDetails SP = new SPs.spS_AgentAccountDetails();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_AgentAccountDetails", "RefreshData");
			}
