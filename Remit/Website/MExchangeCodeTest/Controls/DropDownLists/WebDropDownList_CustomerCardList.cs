...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'CustomerCardList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="CustomerCardList", SqlObjectDependancyRevision=576)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_CustomerCardList), "WebDropDownList.bmp")]
	public class WebDropDownList_CustomerCardList : System.Web.UI.WebControls.DropDownList {

		private Params.spS_CustomerCardList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_CustomerCardList oAbstract_CustomerCardList;
		...
		/// </summary>
		public Params.spS_CustomerCardList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'CustomerCardList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_CustomerCardList Abstract_CustomerCardList {

			get {

				return(this.oAbstract_CustomerCardList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_CustomerCardList = null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_CustomerCardList class.
		/// </summary>
		public WebDropDownList_CustomerCardList() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_AgentId, System.Data.SqlTypes.SqlString FK_Status) {
		...
		/// <param name="FK_AgentId">Value for this foreign key.</param>
		/// <param name="FK_Status">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_AgentId, System.Data.SqlTypes.SqlString FK_Status) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CustomerCardList_Display(true);
			...
			SPs.spS_CustomerCardList_Display SP = new SPs.spS_CustomerCardList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_CustomerCardList_Display"].DefaultView;
				this.DataValueField = SPs.spS_CustomerCardList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_CustomerCardList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_CustomerCardList : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the CustomerCardList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_CustomerCardList != null) {

					oAbstract_CustomerCardList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_CustomerCardList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_CustomerCardList = new Evernet.MoneyExchange.AbstractClasses.Abstract_CustomerCardList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_CustomerCardList = new Evernet.MoneyExchange.AbstractClasses.Abstract_CustomerCardList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_CustomerCardList.Refresh(PK_Id));
		}
	}
}
