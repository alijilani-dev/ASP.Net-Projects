...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_UserRoleAssignmentList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:32", SqlObjectDependancyName="spS_UserRoleAssignmentList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_UserRoleAssignmentList), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_UserRoleAssignmentList : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_UserRoleAssignmentList param;
		...
		/// </summary>
		public Params.spS_UserRoleAssignmentList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_UserRoleAssignmentList class.
		/// </summary>
		public WebDropDownListCustom_spS_UserRoleAssignmentList() : base() {
		...
		/// You also need to supply the 'spS_UserRoleAssignmentList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_UserId, System.Data.SqlTypes.SqlString param_Role) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_UserRoleAssignmentList";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_UserRoleAssignmentList();
			...
			SPs.spS_UserRoleAssignmentList SP = new SPs.spS_UserRoleAssignmentList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_UserRoleAssignmentList", "RefreshData");
			}
