...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_PurposeOfTransferList_Full' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:31", SqlObjectDependancyName="spS_PurposeOfTransferList_Full", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_PurposeOfTransferList_Full), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_PurposeOfTransferList_Full : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_PurposeOfTransferList_Full param;
		...
		/// </summary>
		public Params.spS_PurposeOfTransferList_Full SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_PurposeOfTransferList_Full class.
		/// </summary>
		public WebDropDownListCustom_spS_PurposeOfTransferList_Full() : base() {
		...
		/// You also need to supply the 'spS_PurposeOfTransferList_Full' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_Value, System.Data.SqlTypes.SqlString param_PaymentModeBaseType) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_PurposeOfTransferList_Full";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_PurposeOfTransferList_Full();
			...
			SPs.spS_PurposeOfTransferList_Full SP = new SPs.spS_PurposeOfTransferList_Full();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_PurposeOfTransferList_Full", "RefreshData");
			}
