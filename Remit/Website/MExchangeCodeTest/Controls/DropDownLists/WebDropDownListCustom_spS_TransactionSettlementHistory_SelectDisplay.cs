/*
	This C# source code was automatically generated using:
		...
		SQL Server Centric .NET Code Generator
			...
			Generation Date: 11/30/2004 11:48:32 PM
...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_TransactionSettlementHistory_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:32", SqlObjectDependancyName="spS_TransactionSettlementHistory_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_TransactionSettlementHistory_SelectDisplay), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_TransactionSettlementHistory_SelectDisplay : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_TransactionSettlementHistory_SelectDisplay param;
		private System.Data.SqlTypes.SqlGuid param_Id = System.Data.SqlTypes.SqlGuid.Null;
		private System.Data.SqlTypes.SqlGuid param_PaymentId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_TransactionSettlementHistory_SelectDisplay SP_Parameter {
		...
		public override void Dispose() {
			...
			this.param_PaymentId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_TransactionSettlementHistory_SelectDisplay class.
		/// </summary>
		public WebDropDownListCustom_spS_TransactionSettlementHistory_SelectDisplay() : base() {
		...
		/// You also need to supply the 'spS_TransactionSettlementHistory_SelectDisplay' stored procedure parameters.
		/// </summary>
		...
		/// <param name="param_PaymentId">Value for the parameter @PaymentId.</param>
		/// <param name="param_TransactionId">Value for the parameter @TransactionId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PaymentId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
			...
			this.param_PaymentId = param_PaymentId;
		...
		/// <param name="param_PaymentId">Value for the parameter @PaymentId.</param>
		/// <param name="param_TransactionId">Value for the parameter @TransactionId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PaymentId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_TransactionSettlementHistory_SelectDisplay";
		...
		/// <param name="param_PaymentId">Value for the parameter @PaymentId.</param>
		/// <param name="param_TransactionId">Value for the parameter @TransactionId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PaymentId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
		...
		/// <param name="param_PaymentId">Value for the parameter @PaymentId.</param>
		/// <param name="param_TransactionId">Value for the parameter @TransactionId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PaymentId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_TransactionSettlementHistory_SelectDisplay();
			...
			if (!this.param_PaymentId.IsNull) {

				this.param.Param_PaymentId = this.param_PaymentId;
			}
			...
			SPs.spS_TransactionSettlementHistory_SelectDisplay SP = new SPs.spS_TransactionSettlementHistory_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_TransactionSettlementHistory_SelectDisplay", "RefreshData");
			}
