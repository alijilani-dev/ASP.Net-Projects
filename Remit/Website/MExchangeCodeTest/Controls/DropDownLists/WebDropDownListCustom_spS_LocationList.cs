...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_LocationList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:31", SqlObjectDependancyName="spS_LocationList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_LocationList), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_LocationList : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_LocationList param;
		...
		/// </summary>
		public Params.spS_LocationList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_LocationList class.
		/// </summary>
		public WebDropDownListCustom_spS_LocationList() : base() {
		...
		/// You also need to supply the 'spS_LocationList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_ParentId, System.Data.SqlTypes.SqlGuid param_CountryId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_LocationList";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_LocationList();
			...
			SPs.spS_LocationList SP = new SPs.spS_LocationList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_LocationList", "RefreshData");
			}
