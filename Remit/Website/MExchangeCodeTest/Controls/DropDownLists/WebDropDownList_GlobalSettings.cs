...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'GlobalSettings' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="GlobalSettings", SqlObjectDependancyRevision=832)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_GlobalSettings), "WebDropDownList.bmp")]
	public class WebDropDownList_GlobalSettings : System.Web.UI.WebControls.DropDownList {
		...
		/// </summary>
		public System.Data.SqlTypes.SqlByte SelectedRecordID {

			get {

				return(Convert.ToByte(this.SelectedItem.Value));
			}
		}
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_GlobalSettings class.
		/// </summary>
		public WebDropDownList_GlobalSettings() : base() {
		...
		public void RefreshData() {
			...
			this.RefreshData(System.Data.SqlTypes.SqlByte.Null, -1, -1);
		}
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.RefreshData(System.Data.SqlTypes.SqlByte.Null, startRecord, maxRecords);
		}
		...
		public void RefreshData(System.Data.SqlTypes.SqlByte PK_Id) {
		...
		/// <param name="startRecord">The zero-based record number to start with.</param>
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		public void RefreshData(System.Data.SqlTypes.SqlByte PK_Id, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_GlobalSettings : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
