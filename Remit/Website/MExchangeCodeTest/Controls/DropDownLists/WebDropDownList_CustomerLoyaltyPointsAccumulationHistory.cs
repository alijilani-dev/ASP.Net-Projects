...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'CustomerLoyaltyPointsAccumulationHistory' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="CustomerLoyaltyPointsAccumulationHistory", SqlObjectDependancyRevision=640)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_CustomerLoyaltyPointsAccumulationHistory), "WebDropDownList.bmp")]
	public class WebDropDownList_CustomerLoyaltyPointsAccumulationHistory : System.Web.UI.WebControls.DropDownList {

		private Params.spS_CustomerLoyaltyPointsAccumulationHistory_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_CustomerLoyaltyPointsAccumulationHistory oAbstract_CustomerLoyaltyPointsAccumulationHistory;
		...
		/// </summary>
		public Params.spS_CustomerLoyaltyPointsAccumulationHistory_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'CustomerLoyaltyPointsAccumulationHistory' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_CustomerLoyaltyPointsAccumulationHistory Abstract_CustomerLoyaltyPointsAccumulationHistory {

			get {

				return(this.oAbstract_CustomerLoyaltyPointsAccumulationHistory);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_CustomerLoyaltyPointsAccumulationHistory = null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_CustomerLoyaltyPointsAccumulationHistory class.
		/// </summary>
		public WebDropDownList_CustomerLoyaltyPointsAccumulationHistory() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CustomerLoyaltyPointsAccumulationHistory_Display(true);
			...
			SPs.spS_CustomerLoyaltyPointsAccumulationHistory_Display SP = new SPs.spS_CustomerLoyaltyPointsAccumulationHistory_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_CustomerLoyaltyPointsAccumulationHistory_Display"].DefaultView;
				this.DataValueField = SPs.spS_CustomerLoyaltyPointsAccumulationHistory_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_CustomerLoyaltyPointsAccumulationHistory_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_CustomerLoyaltyPointsAccumulationHistory : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the CustomerLoyaltyPointsAccumulationHistory abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_CustomerLoyaltyPointsAccumulationHistory != null) {

					oAbstract_CustomerLoyaltyPointsAccumulationHistory.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_CustomerLoyaltyPointsAccumulationHistory == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_CustomerLoyaltyPointsAccumulationHistory = new Evernet.MoneyExchange.AbstractClasses.Abstract_CustomerLoyaltyPointsAccumulationHistory(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_CustomerLoyaltyPointsAccumulationHistory = new Evernet.MoneyExchange.AbstractClasses.Abstract_CustomerLoyaltyPointsAccumulationHistory(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_CustomerLoyaltyPointsAccumulationHistory.Refresh(PK_Id));
		}
	}
}
