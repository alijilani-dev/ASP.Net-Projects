...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_TransactionDetails' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:31", SqlObjectDependancyName="spS_TransactionDetails", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_TransactionDetails), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_TransactionDetails : System.Web.UI.WebControls.DropDownList {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_TransactionDetails class.
		/// </summary>
		public WebDropDownListCustom_spS_TransactionDetails() : base() {
		...
		/// You also need to supply the 'spS_TransactionDetails' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CustomerId, System.Data.SqlTypes.SqlGuid param_BeneficeryId, System.Data.SqlTypes.SqlGuid param_BeneficeryBankId, System.Data.SqlTypes.SqlString param_PaymentMode, System.Data.SqlTypes.SqlString param_PurposeOfTransfer, System.Data.SqlTypes.SqlGuid param_PayInCurrencyId, System.Data.SqlTypes.SqlGuid param_PayOutCurrencyId, System.Data.SqlTypes.SqlGuid param_AssociatedBankId, System.Data.SqlTypes.SqlGuid param_PayInAgentUserId, System.Data.SqlTypes.SqlGuid param_PayInAgentLocationId, System.Data.SqlTypes.SqlGuid param_PayOutAgentUserId, System.Data.SqlTypes.SqlString param_Status, System.Data.SqlTypes.SqlString param_SettlementStatus) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_TransactionDetails";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_TransactionDetails();
			...
			SPs.spS_TransactionDetails SP = new SPs.spS_TransactionDetails();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_TransactionDetails", "RefreshData");
			}
