...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'UserRoleList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:45", SqlObjectDependancyName="UserRoleList", SqlObjectDependancyRevision=672)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_UserRoleList), "WebDropDownList.bmp")]
	public class WebDropDownList_UserRoleList : System.Web.UI.WebControls.DropDownList {

		private Params.spS_UserRoleList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_UserRoleList oAbstract_UserRoleList;
		private System.Data.SqlTypes.SqlString FK_Module = System.Data.SqlTypes.SqlString.Null;
		private System.Data.SqlTypes.SqlString FK_Type = System.Data.SqlTypes.SqlString.Null;
		...
		/// </summary>
		public Params.spS_UserRoleList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'UserRoleList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_UserRoleList Abstract_UserRoleList {

			get {

				return(this.oAbstract_UserRoleList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_UserRoleList = null;

			this.FK_Module = System.Data.SqlTypes.SqlString.Null;
			this.FK_Type = System.Data.SqlTypes.SqlString.Null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_UserRoleList class.
		/// </summary>
		public WebDropDownList_UserRoleList() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlString FK_Module, System.Data.SqlTypes.SqlString FK_Type) {
		...
		/// <param name="FK_Module">Value for this foreign key.</param>
		/// <param name="FK_Type">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlString FK_Module, System.Data.SqlTypes.SqlString FK_Type) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlString PK_Value, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_UserRoleList_Display(true);
			...
			this.param.Param_Module = this.FK_Module;
			this.param.Param_Type = this.FK_Type;

			System.Data.DataSet DS = null;
			
			SPs.spS_UserRoleList_Display SP = new SPs.spS_UserRoleList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_UserRoleList_Display"].DefaultView;
				this.DataValueField = SPs.spS_UserRoleList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_UserRoleList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_UserRoleList : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the UserRoleList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_UserRoleList != null) {

					oAbstract_UserRoleList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_UserRoleList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_UserRoleList = new Evernet.MoneyExchange.AbstractClasses.Abstract_UserRoleList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_UserRoleList = new Evernet.MoneyExchange.AbstractClasses.Abstract_UserRoleList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_UserRoleList.Refresh(PK_Value));
		}
	}
}
