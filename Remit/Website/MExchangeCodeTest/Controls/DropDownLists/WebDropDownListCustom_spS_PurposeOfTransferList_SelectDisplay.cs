...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_PurposeOfTransferList_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:31", SqlObjectDependancyName="spS_PurposeOfTransferList_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_PurposeOfTransferList_SelectDisplay), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_PurposeOfTransferList_SelectDisplay : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_PurposeOfTransferList_SelectDisplay param;
		private System.Data.SqlTypes.SqlString param_Value = System.Data.SqlTypes.SqlString.Null;
		private System.Data.SqlTypes.SqlString param_PaymentModeBaseType = System.Data.SqlTypes.SqlString.Null;
		...
		/// </summary>
		public Params.spS_PurposeOfTransferList_SelectDisplay SP_Parameter {
		...
		public override void Dispose() {
			...
			this.param_PaymentModeBaseType = System.Data.SqlTypes.SqlString.Null;
			if (this.param != null) {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_PurposeOfTransferList_SelectDisplay class.
		/// </summary>
		public WebDropDownListCustom_spS_PurposeOfTransferList_SelectDisplay() : base() {
		...
		/// You also need to supply the 'spS_PurposeOfTransferList_SelectDisplay' stored procedure parameters.
		/// </summary>
		...
		/// <param name="param_PaymentModeBaseType">Value for the parameter @PaymentModeBaseType.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlString param_Value, System.Data.SqlTypes.SqlString param_PaymentModeBaseType) {
			...
			this.param_PaymentModeBaseType = param_PaymentModeBaseType;
		}
		...
		/// <param name="param_Value">Value for the parameter @Value.</param>
		/// <param name="param_PaymentModeBaseType">Value for the parameter @PaymentModeBaseType.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_Value, System.Data.SqlTypes.SqlString param_PaymentModeBaseType) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_PurposeOfTransferList_SelectDisplay";
		...
		/// <param name="param_Value">Value for the parameter @Value.</param>
		/// <param name="param_PaymentModeBaseType">Value for the parameter @PaymentModeBaseType.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlString param_Value, System.Data.SqlTypes.SqlString param_PaymentModeBaseType) {
		...
		/// <param name="param_Value">Value for the parameter @Value.</param>
		/// <param name="param_PaymentModeBaseType">Value for the parameter @PaymentModeBaseType.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_Value, System.Data.SqlTypes.SqlString param_PaymentModeBaseType) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_PurposeOfTransferList_SelectDisplay();
			...
			if (!this.param_PaymentModeBaseType.IsNull) {

				this.param.Param_PaymentModeBaseType = this.param_PaymentModeBaseType;
			}


			System.Data.DataSet DS = null;
			
			SPs.spS_PurposeOfTransferList_SelectDisplay SP = new SPs.spS_PurposeOfTransferList_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_PurposeOfTransferList_SelectDisplay", "RefreshData");
			}
