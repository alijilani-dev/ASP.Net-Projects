...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_CurrencyExchangeType' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:30", SqlObjectDependancyName="spS_CurrencyExchangeType", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_CurrencyExchangeType), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_CurrencyExchangeType : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_CurrencyExchangeType param;
		...
		/// </summary>
		public Params.spS_CurrencyExchangeType SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_CurrencyExchangeType class.
		/// </summary>
		public WebDropDownListCustom_spS_CurrencyExchangeType() : base() {
		...
		/// You also need to supply the 'spS_CurrencyExchangeType' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_Value) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_CurrencyExchangeType";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CurrencyExchangeType();
			...
			SPs.spS_CurrencyExchangeType SP = new SPs.spS_CurrencyExchangeType();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_CurrencyExchangeType", "RefreshData");
			}
