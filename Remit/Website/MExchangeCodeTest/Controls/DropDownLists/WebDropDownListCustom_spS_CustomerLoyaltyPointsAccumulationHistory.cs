...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_CustomerLoyaltyPointsAccumulationHistory' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:30", SqlObjectDependancyName="spS_CustomerLoyaltyPointsAccumulationHistory", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_CustomerLoyaltyPointsAccumulationHistory), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_CustomerLoyaltyPointsAccumulationHistory : System.Web.UI.WebControls.DropDownList {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_CustomerLoyaltyPointsAccumulationHistory class.
		/// </summary>
		public WebDropDownListCustom_spS_CustomerLoyaltyPointsAccumulationHistory() : base() {
		...
		/// You also need to supply the 'spS_CustomerLoyaltyPointsAccumulationHistory' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CustomerId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_CustomerLoyaltyPointsAccumulationHistory";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CustomerLoyaltyPointsAccumulationHistory();
			...
			SPs.spS_CustomerLoyaltyPointsAccumulationHistory SP = new SPs.spS_CustomerLoyaltyPointsAccumulationHistory();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_CustomerLoyaltyPointsAccumulationHistory", "RefreshData");
			}
