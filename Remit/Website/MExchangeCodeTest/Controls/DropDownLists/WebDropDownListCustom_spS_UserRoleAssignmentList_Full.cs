...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_UserRoleAssignmentList_Full' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:32", SqlObjectDependancyName="spS_UserRoleAssignmentList_Full", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_UserRoleAssignmentList_Full), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_UserRoleAssignmentList_Full : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_UserRoleAssignmentList_Full param;
		...
		/// </summary>
		public Params.spS_UserRoleAssignmentList_Full SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_UserRoleAssignmentList_Full class.
		/// </summary>
		public WebDropDownListCustom_spS_UserRoleAssignmentList_Full() : base() {
		...
		/// You also need to supply the 'spS_UserRoleAssignmentList_Full' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_UserId, System.Data.SqlTypes.SqlString param_Role) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_UserRoleAssignmentList_Full";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_UserRoleAssignmentList_Full();
			...
			SPs.spS_UserRoleAssignmentList_Full SP = new SPs.spS_UserRoleAssignmentList_Full();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_UserRoleAssignmentList_Full", "RefreshData");
			}
