...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'CountryList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="CountryList", SqlObjectDependancyRevision=1776)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_CountryList), "WebDropDownList.bmp")]
	public class WebDropDownList_CountryList : System.Web.UI.WebControls.DropDownList {

		private Params.spS_CountryList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_CountryList oAbstract_CountryList;
		private System.Data.SqlTypes.SqlGuid FK_BaseCurrency = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_CountryList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'CountryList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_CountryList Abstract_CountryList {

			get {

				return(this.oAbstract_CountryList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_CountryList = null;

			this.FK_BaseCurrency = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_CountryList class.
		/// </summary>
		public WebDropDownList_CountryList() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_BaseCurrency, System.Data.SqlTypes.SqlString FK_AllowedInternationalTransactionType, System.Data.SqlTypes.SqlString FK_AllowedDomesticTransactionType) {
			...
			this.FK_BaseCurrency = FK_BaseCurrency;
		...
		/// <param name="FK_AllowedInternationalTransactionType">Value for this foreign key.</param>
		/// <param name="FK_AllowedDomesticTransactionType">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_BaseCurrency, System.Data.SqlTypes.SqlString FK_AllowedInternationalTransactionType, System.Data.SqlTypes.SqlString FK_AllowedDomesticTransactionType) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CountryList_Display(true);
			...
			this.param.Param_BaseCurrency = this.FK_BaseCurrency;
			...
			SPs.spS_CountryList_Display SP = new SPs.spS_CountryList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_CountryList_Display"].DefaultView;
				this.DataValueField = SPs.spS_CountryList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_CountryList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_CountryList : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the CountryList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_CountryList != null) {

					oAbstract_CountryList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_CountryList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_CountryList = new Evernet.MoneyExchange.AbstractClasses.Abstract_CountryList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_CountryList = new Evernet.MoneyExchange.AbstractClasses.Abstract_CountryList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_CountryList.Refresh(PK_Id));
		}
	}
}
