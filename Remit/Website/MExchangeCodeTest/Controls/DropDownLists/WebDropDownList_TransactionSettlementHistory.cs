...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.DropDownList class and was built to display the 'TransactionSettlementHistory' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:38", SqlObjectDependancyName="TransactionSettlementHistory", SqlObjectDependancyRevision=416)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownList_TransactionSettlementHistory), "WebDropDownList.bmp")]
	public class WebDropDownList_TransactionSettlementHistory : System.Web.UI.WebControls.DropDownList {

		private Params.spS_TransactionSettlementHistory_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionSettlementHistory oAbstract_TransactionSettlementHistory;
		private System.Data.SqlTypes.SqlGuid FK_PaymentId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_TransactionSettlementHistory_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'TransactionSettlementHistory' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionSettlementHistory Abstract_TransactionSettlementHistory {

			get {

				return(this.oAbstract_TransactionSettlementHistory);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_TransactionSettlementHistory = null;

			this.FK_PaymentId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.DropDownLists.WebDropDownList_TransactionSettlementHistory class.
		/// </summary>
		public WebDropDownList_TransactionSettlementHistory() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_PaymentId, System.Data.SqlTypes.SqlGuid FK_TransactionId) {
		...
		/// <param name="FK_PaymentId">Value for this foreign key.</param>
		/// <param name="FK_TransactionId">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_PaymentId, System.Data.SqlTypes.SqlGuid FK_TransactionId) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_TransactionSettlementHistory_Display(true);
			...
			this.param.Param_PaymentId = this.FK_PaymentId;
			this.param.Param_TransactionId = this.FK_TransactionId;

			System.Data.DataSet DS = null;
			
			SPs.spS_TransactionSettlementHistory_Display SP = new SPs.spS_TransactionSettlementHistory_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_TransactionSettlementHistory_Display"].DefaultView;
				this.DataValueField = SPs.spS_TransactionSettlementHistory_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_TransactionSettlementHistory_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownList_TransactionSettlementHistory : System.Web.UI.WebControls.DropDownList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the TransactionSettlementHistory abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_TransactionSettlementHistory != null) {

					oAbstract_TransactionSettlementHistory.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_TransactionSettlementHistory == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_TransactionSettlementHistory = new Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionSettlementHistory(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_TransactionSettlementHistory = new Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionSettlementHistory(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_TransactionSettlementHistory.Refresh(PK_Id));
		}
	}
}
