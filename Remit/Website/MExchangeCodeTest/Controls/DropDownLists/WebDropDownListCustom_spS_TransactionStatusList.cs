...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_TransactionStatusList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:32", SqlObjectDependancyName="spS_TransactionStatusList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_TransactionStatusList), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_TransactionStatusList : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_TransactionStatusList param;
		...
		/// </summary>
		public Params.spS_TransactionStatusList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_TransactionStatusList class.
		/// </summary>
		public WebDropDownListCustom_spS_TransactionStatusList() : base() {
		...
		/// You also need to supply the 'spS_TransactionStatusList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_Value) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_TransactionStatusList";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_TransactionStatusList();
			...
			SPs.spS_TransactionStatusList SP = new SPs.spS_TransactionStatusList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_TransactionStatusList", "RefreshData");
			}
