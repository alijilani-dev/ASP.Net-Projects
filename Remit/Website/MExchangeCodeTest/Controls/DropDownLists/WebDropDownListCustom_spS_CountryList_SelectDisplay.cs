...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:30", SqlObjectDependancyName="spS_CountryList_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_CountryList_SelectDisplay), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_CountryList_SelectDisplay : System.Web.UI.WebControls.DropDownList {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_CountryList_SelectDisplay class.
		/// </summary>
		public WebDropDownListCustom_spS_CountryList_SelectDisplay() : base() {
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_BaseCurrency, System.Data.SqlTypes.SqlString param_AllowedInternationalTransactionType, System.Data.SqlTypes.SqlString param_AllowedDomesticTransactionType) {
		...
		/// <param name="param_AllowedInternationalTransactionType">Value for the parameter @AllowedInternationalTransactionType.</param>
		/// <param name="param_AllowedDomesticTransactionType">Value for the parameter @AllowedDomesticTransactionType.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_BaseCurrency, System.Data.SqlTypes.SqlString param_AllowedInternationalTransactionType, System.Data.SqlTypes.SqlString param_AllowedDomesticTransactionType) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_CountryList_SelectDisplay", "RefreshData");
			}
