...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_UserList_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:32", SqlObjectDependancyName="spS_UserList_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_UserList_SelectDisplay), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_UserList_SelectDisplay : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_UserList_SelectDisplay param;
		...
		private System.Data.SqlTypes.SqlGuid param_AgentId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_UserList_SelectDisplay SP_Parameter {
		...
		public override void Dispose() {
			...
			this.param_AgentId = System.Data.SqlTypes.SqlGuid.Null;
			if (this.param != null) {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_UserList_SelectDisplay class.
		/// </summary>
		public WebDropDownListCustom_spS_UserList_SelectDisplay() : base() {
		...
		/// You also need to supply the 'spS_UserList_SelectDisplay' stored procedure parameters.
		/// </summary>
		...
		/// <param name="param_AgentId">Value for the parameter @AgentId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_AgentId) {
			...
			this.param_AgentId = param_AgentId;
		}
		...
		/// <param name="param_AgentAccountId">Value for the parameter @AgentAccountId.</param>
		/// <param name="param_AgentId">Value for the parameter @AgentId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_AgentId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_UserList_SelectDisplay";
		...
		/// <param name="param_AgentAccountId">Value for the parameter @AgentAccountId.</param>
		/// <param name="param_AgentId">Value for the parameter @AgentId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_AgentId) {
		...
		/// <param name="param_AgentAccountId">Value for the parameter @AgentAccountId.</param>
		/// <param name="param_AgentId">Value for the parameter @AgentId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_AgentId) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_UserList_SelectDisplay();
			...
			if (!this.param_AgentId.IsNull) {

				this.param.Param_AgentId = this.param_AgentId;
			}


			System.Data.DataSet DS = null;
			
			SPs.spS_UserList_SelectDisplay SP = new SPs.spS_UserList_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_UserList_SelectDisplay", "RefreshData");
			}
