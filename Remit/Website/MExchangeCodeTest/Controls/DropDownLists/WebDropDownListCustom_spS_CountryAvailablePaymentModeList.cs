...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_CountryAvailablePaymentModeList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:30", SqlObjectDependancyName="spS_CountryAvailablePaymentModeList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_CountryAvailablePaymentModeList), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_CountryAvailablePaymentModeList : System.Web.UI.WebControls.DropDownList {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_CountryAvailablePaymentModeList class.
		/// </summary>
		public WebDropDownListCustom_spS_CountryAvailablePaymentModeList() : base() {
		...
		/// You also need to supply the 'spS_CountryAvailablePaymentModeList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CountryId, System.Data.SqlTypes.SqlString param_PaymentMode) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_CountryAvailablePaymentModeList";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CountryAvailablePaymentModeList();
			...
			SPs.spS_CountryAvailablePaymentModeList SP = new SPs.spS_CountryAvailablePaymentModeList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_CountryAvailablePaymentModeList", "RefreshData");
			}
