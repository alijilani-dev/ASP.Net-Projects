...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_UserAuditList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:32", SqlObjectDependancyName="spS_UserAuditList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_UserAuditList), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_UserAuditList : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_UserAuditList param;
		...
		/// </summary>
		public Params.spS_UserAuditList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_UserAuditList class.
		/// </summary>
		public WebDropDownListCustom_spS_UserAuditList() : base() {
		...
		/// You also need to supply the 'spS_UserAuditList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_UserId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_UserAuditList";
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_UserAuditList();
			...
			SPs.spS_UserAuditList SP = new SPs.spS_UserAuditList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_UserAuditList", "RefreshData");
			}
