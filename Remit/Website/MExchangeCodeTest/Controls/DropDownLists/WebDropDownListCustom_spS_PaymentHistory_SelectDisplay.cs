...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_PaymentHistory_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:31", SqlObjectDependancyName="spS_PaymentHistory_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_PaymentHistory_SelectDisplay), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_PaymentHistory_SelectDisplay : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_PaymentHistory_SelectDisplay param;
		private System.Data.SqlTypes.SqlGuid param_Id = System.Data.SqlTypes.SqlGuid.Null;
		private System.Data.SqlTypes.SqlGuid param_PaymentCurrencyId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_PaymentHistory_SelectDisplay SP_Parameter {
		...
		public override void Dispose() {
			...
			this.param_PaymentCurrencyId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_PaymentHistory_SelectDisplay class.
		/// </summary>
		public WebDropDownListCustom_spS_PaymentHistory_SelectDisplay() : base() {
		...
		/// You also need to supply the 'spS_PaymentHistory_SelectDisplay' stored procedure parameters.
		/// </summary>
		...
		/// <param name="param_PaymentCurrencyId">Value for the parameter @PaymentCurrencyId.</param>
		/// <param name="param_Type">Value for the parameter @Type.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PaymentCurrencyId, System.Data.SqlTypes.SqlString param_Type) {
			...
			this.param_PaymentCurrencyId = param_PaymentCurrencyId;
		...
		/// <param name="param_PaymentCurrencyId">Value for the parameter @PaymentCurrencyId.</param>
		/// <param name="param_Type">Value for the parameter @Type.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PaymentCurrencyId, System.Data.SqlTypes.SqlString param_Type) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_PaymentHistory_SelectDisplay";
		...
		/// <param name="param_PaymentCurrencyId">Value for the parameter @PaymentCurrencyId.</param>
		/// <param name="param_Type">Value for the parameter @Type.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PaymentCurrencyId, System.Data.SqlTypes.SqlString param_Type) {
		...
		/// <param name="param_PaymentCurrencyId">Value for the parameter @PaymentCurrencyId.</param>
		/// <param name="param_Type">Value for the parameter @Type.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PaymentCurrencyId, System.Data.SqlTypes.SqlString param_Type) {
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_PaymentHistory_SelectDisplay();
			...
			if (!this.param_PaymentCurrencyId.IsNull) {

				this.param.Param_PaymentCurrencyId = this.param_PaymentCurrencyId;
			}
			...
			SPs.spS_PaymentHistory_SelectDisplay SP = new SPs.spS_PaymentHistory_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_PaymentHistory_SelectDisplay", "RefreshData");
			}
