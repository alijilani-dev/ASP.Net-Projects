...
namespace Evernet.MoneyExchange.Web.DropDownLists {
	...
	/// 'spS_UserList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:32", SqlObjectDependancyName="spS_UserList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebDropDownListCustom_spS_UserList), "WebDropDownList.bmp")]
	public class WebDropDownListCustom_spS_UserList : System.Web.UI.WebControls.DropDownList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_UserList param;
		...
		/// </summary>
		public Params.spS_UserList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebDropDownListCustom_spS_UserList class.
		/// </summary>
		public WebDropDownListCustom_spS_UserList() : base() {
		...
		/// You also need to supply the 'spS_UserList' stored procedure parameters.
		/// </summary>
		...
		public void RefreshData(object PrimaryKey, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_UserList();
			...
			SPs.spS_UserList SP = new SPs.spS_UserList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebDropDownListCustom_spS_UserList", "RefreshData");
			}
