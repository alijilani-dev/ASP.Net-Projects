...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:48", SqlObjectDependancyName="spS_TransactionDetails", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_TransactionDetails), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_TransactionDetails : System.Web.UI.WebControls.CheckBoxList {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_TransactionDetails class.
		/// </summary>
		public WebCheckBoxListCustom_spS_TransactionDetails() : base() {
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_TransactionDetails", "RefreshData");
			}
