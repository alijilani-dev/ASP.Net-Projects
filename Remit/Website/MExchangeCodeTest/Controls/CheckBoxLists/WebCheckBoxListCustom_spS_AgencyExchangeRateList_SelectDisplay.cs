...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:44", SqlObjectDependancyName="spS_AgencyExchangeRateList_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_AgencyExchangeRateList_SelectDisplay), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_AgencyExchangeRateList_SelectDisplay : System.Web.UI.WebControls.CheckBoxList {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_AgencyExchangeRateList_SelectDisplay class.
		/// </summary>
		public WebCheckBoxListCustom_spS_AgencyExchangeRateList_SelectDisplay() : base() {
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PayInCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCurrencyId) {
		...
		/// <param name="param_PayOutCountryId">Value for the parameter @PayOutCountryId.</param>
		/// <param name="param_PayOutCurrencyId">Value for the parameter @PayOutCurrencyId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PayInCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCurrencyId) {
		...
		/// <param name="param_PayOutCountryId">Value for the parameter @PayOutCountryId.</param>
		/// <param name="param_PayOutCurrencyId">Value for the parameter @PayOutCurrencyId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PayInCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCurrencyId) {
		...
		/// <param name="param_PayOutCountryId">Value for the parameter @PayOutCountryId.</param>
		/// <param name="param_PayOutCurrencyId">Value for the parameter @PayOutCurrencyId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_PayInCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCountryId, System.Data.SqlTypes.SqlGuid param_PayOutCurrencyId) {
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_AgencyExchangeRateList_SelectDisplay", "RefreshData");
			}
