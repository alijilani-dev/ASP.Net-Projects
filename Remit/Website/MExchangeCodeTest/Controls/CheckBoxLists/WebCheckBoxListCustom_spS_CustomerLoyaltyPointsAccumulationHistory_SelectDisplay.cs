...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:47", SqlObjectDependancyName="spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay param;
		...
		/// </summary>
		public Params.spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay class.
		/// </summary>
		public WebCheckBoxListCustom_spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay() : base() {
		...
		/// You also need to supply the 'spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CustomerId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
		...
		/// <param name="param_CustomerId">Value for the parameter @CustomerId.</param>
		/// <param name="param_TransactionId">Value for the parameter @TransactionId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CustomerId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay";
		...
		/// <param name="param_CustomerId">Value for the parameter @CustomerId.</param>
		/// <param name="param_TransactionId">Value for the parameter @TransactionId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CustomerId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
		...
		/// <param name="param_CustomerId">Value for the parameter @CustomerId.</param>
		/// <param name="param_TransactionId">Value for the parameter @TransactionId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CustomerId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay();
			...
			SPs.spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay SP = new SPs.spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_CustomerLoyaltyPointsAccumulationHistory_SelectDisplay", "RefreshData");
			}
