...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_BeneficeryBankList_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:46", SqlObjectDependancyName="spS_BeneficeryBankList_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_BeneficeryBankList_SelectDisplay), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_BeneficeryBankList_SelectDisplay : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_BeneficeryBankList_SelectDisplay param;
		...
		/// </summary>
		public Params.spS_BeneficeryBankList_SelectDisplay SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_BeneficeryBankList_SelectDisplay class.
		/// </summary>
		public WebCheckBoxListCustom_spS_BeneficeryBankList_SelectDisplay() : base() {
		...
		/// You also need to supply the 'spS_BeneficeryBankList_SelectDisplay' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CustomerId, System.Data.SqlTypes.SqlGuid param_CountryId) {
		...
		/// <param name="param_CustomerId">Value for the parameter @CustomerId.</param>
		/// <param name="param_CountryId">Value for the parameter @CountryId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CustomerId, System.Data.SqlTypes.SqlGuid param_CountryId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_BeneficeryBankList_SelectDisplay";
		...
		/// <param name="param_CustomerId">Value for the parameter @CustomerId.</param>
		/// <param name="param_CountryId">Value for the parameter @CountryId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CustomerId, System.Data.SqlTypes.SqlGuid param_CountryId) {
		...
		/// <param name="param_CustomerId">Value for the parameter @CustomerId.</param>
		/// <param name="param_CountryId">Value for the parameter @CountryId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CustomerId, System.Data.SqlTypes.SqlGuid param_CountryId) {
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_BeneficeryBankList_SelectDisplay();
			...
			SPs.spS_BeneficeryBankList_SelectDisplay SP = new SPs.spS_BeneficeryBankList_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_BeneficeryBankList_SelectDisplay", "RefreshData");
			}
