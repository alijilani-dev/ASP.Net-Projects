...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'GlobalSettings' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:47", SqlObjectDependancyName="GlobalSettings", SqlObjectDependancyRevision=832)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_GlobalSettings), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_GlobalSettings : System.Web.UI.WebControls.CheckBoxList {

		private Params.spS_GlobalSettings_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_GlobalSettings oAbstract_GlobalSettings;
		...
		/// </summary>
		public Params.spS_GlobalSettings_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'GlobalSettings' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_GlobalSettings Abstract_GlobalSettings {

			get {

				return(this.oAbstract_GlobalSettings);
			}
		}
			...
			get {
				...
				foreach(System.Web.UI.WebControls.ListItem currentItem in this.Items) {
					...
					if (currentItem.Selected) {
						...
						arrayList.Add(Convert.ToByte(currentItem.Value));
					}
				}
		...
		public override void Dispose() {
			...
			this.oAbstract_GlobalSettings = null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_GlobalSettings class.
		/// </summary>
		public WebCheckBoxList_GlobalSettings() : base() {
		...
		public void RefreshData() {
			...
			this.RefreshData(new System.Data.SqlTypes.SqlByte[0], -1, -1);
		}
		...
		public void RefreshData(int startRecord, int maxRecords) {
			...
			this.RefreshData(new System.Data.SqlTypes.SqlByte[0], startRecord, maxRecords);
		}
		...
		public void RefreshData(System.Collections.ArrayList ArrayOf_PK_Id, int startRecord, int maxRecords) {
			...
			if (ArrayOf_PK_Id != null && ArrayOf_PK_Id.Count > 0) {
				...
				System.Data.SqlTypes.SqlByte[] typedArray = new System.Data.SqlTypes.SqlByte[ArrayOf_PK_Id.Count];
				int index = 0;
				foreach(object item in ArrayOf_PK_Id) {

					if (item is System.Data.SqlTypes.SqlByte) {

						typedArray[index] = (System.Data.SqlTypes.SqlByte)item;
						index++;
					}
					else if (item is System.Byte) {

						typedArray[index] = (System.Byte)item;
						index++;
					}
					else {

						throw new InvalidOperationException("ArrayOf_PK_Id does not contain ONLY System.Data.SqlTypes.SqlByte or System.Byte elements.");
					}
				}
		...
		/// </summary>
		/// <param name="ArrayOf_PK_Id">Primary keys of the records you want to be checked by default.</param>
		public void RefreshData(System.Data.SqlTypes.SqlByte[] ArrayOf_PK_Id) {
		...
		/// <param name="startRecord">The zero-based record number to start with.</param>
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		public void RefreshData(System.Data.SqlTypes.SqlByte[] ArrayOf_PK_Id, int startRecord, int maxRecords) {

			this.param = new Params.spS_GlobalSettings_Display(true);
			...
			SPs.spS_GlobalSettings_Display SP = new SPs.spS_GlobalSettings_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_GlobalSettings_Display"].DefaultView;
				this.DataValueField = SPs.spS_GlobalSettings_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_GlobalSettings_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_GlobalSettings : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		/// <param name="ArrayOf_PK_Id">Primary keys of the records to set the check state for.</param>
		/// <param name="value">True if the records must be checked. Otherwise False.</param>
		public void SetRecordsChecked(System.Data.SqlTypes.SqlByte[] ArrayOf_PK_Id, bool value) {

			this.ClearSelection();

			if (ArrayOf_PK_Id != null) {

				foreach (System.Data.SqlTypes.SqlByte PK_Id in ArrayOf_PK_Id) {
		...
		/// <summary>
		/// Loads the GlobalSettings abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_GlobalSettings != null) {

					oAbstract_GlobalSettings.Reset();
				}
				return(false);
			}

			System.Data.SqlTypes.SqlByte PK_Id = Convert.ToByte(this.SelectedItem.Value);

			if (this.oAbstract_GlobalSettings == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_GlobalSettings = new Evernet.MoneyExchange.AbstractClasses.Abstract_GlobalSettings(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_GlobalSettings = new Evernet.MoneyExchange.AbstractClasses.Abstract_GlobalSettings(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_GlobalSettings.Refresh(PK_Id));
		}
	}
}
