...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'PaymentModeBaseTypeList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:47", SqlObjectDependancyName="PaymentModeBaseTypeList", SqlObjectDependancyRevision=224)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_PaymentModeBaseTypeList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_PaymentModeBaseTypeList : System.Web.UI.WebControls.CheckBoxList {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_PaymentModeBaseTypeList class.
		/// </summary>
		public WebCheckBoxList_PaymentModeBaseTypeList() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlString[] ArrayOf_PK_Value, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_PaymentModeBaseTypeList : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
