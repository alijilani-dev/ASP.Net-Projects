...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'CountryAvailablePaymentModeList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:47", SqlObjectDependancyName="CountryAvailablePaymentModeList", SqlObjectDependancyRevision=432)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_CountryAvailablePaymentModeList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_CountryAvailablePaymentModeList : System.Web.UI.WebControls.CheckBoxList {

		private Params.spS_CountryAvailablePaymentModeList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_CountryAvailablePaymentModeList oAbstract_CountryAvailablePaymentModeList;
		private System.Data.SqlTypes.SqlGuid FK_CountryId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_CountryAvailablePaymentModeList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'CountryAvailablePaymentModeList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_CountryAvailablePaymentModeList Abstract_CountryAvailablePaymentModeList {

			get {

				return(this.oAbstract_CountryAvailablePaymentModeList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_CountryAvailablePaymentModeList = null;

			this.FK_CountryId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_CountryAvailablePaymentModeList class.
		/// </summary>
		public WebCheckBoxList_CountryAvailablePaymentModeList() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_CountryId, System.Data.SqlTypes.SqlString FK_PaymentMode) {
		...
		/// <param name="FK_CountryId">Value for this foreign key.</param>
		/// <param name="FK_PaymentMode">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CountryId, System.Data.SqlTypes.SqlString FK_PaymentMode) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CountryAvailablePaymentModeList_Display(true);
			...
			this.param.Param_CountryId = this.FK_CountryId;
			this.param.Param_PaymentMode = this.FK_PaymentMode;

			System.Data.DataSet DS = null;
			
			SPs.spS_CountryAvailablePaymentModeList_Display SP = new SPs.spS_CountryAvailablePaymentModeList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_CountryAvailablePaymentModeList_Display"].DefaultView;
				this.DataValueField = SPs.spS_CountryAvailablePaymentModeList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_CountryAvailablePaymentModeList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_CountryAvailablePaymentModeList : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the CountryAvailablePaymentModeList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_CountryAvailablePaymentModeList != null) {

					oAbstract_CountryAvailablePaymentModeList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_CountryAvailablePaymentModeList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_CountryAvailablePaymentModeList = new Evernet.MoneyExchange.AbstractClasses.Abstract_CountryAvailablePaymentModeList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_CountryAvailablePaymentModeList = new Evernet.MoneyExchange.AbstractClasses.Abstract_CountryAvailablePaymentModeList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_CountryAvailablePaymentModeList.Refresh(PK_Id));
		}
	}
}
