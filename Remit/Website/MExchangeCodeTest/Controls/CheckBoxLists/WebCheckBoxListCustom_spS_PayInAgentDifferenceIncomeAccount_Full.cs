...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:47", SqlObjectDependancyName="spS_PayInAgentDifferenceIncomeAccount_Full", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_PayInAgentDifferenceIncomeAccount_Full), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_PayInAgentDifferenceIncomeAccount_Full : System.Web.UI.WebControls.CheckBoxList {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_PayInAgentDifferenceIncomeAccount_Full class.
		/// </summary>
		public WebCheckBoxListCustom_spS_PayInAgentDifferenceIncomeAccount_Full() : base() {
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_PayInAgentDifferenceIncomeAccount_Full", "RefreshData");
			}
