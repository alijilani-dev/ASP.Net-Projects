...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_MasterCountryList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:47", SqlObjectDependancyName="spS_MasterCountryList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_MasterCountryList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_MasterCountryList : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_MasterCountryList param;
		private System.Data.SqlTypes.SqlString param_Code = System.Data.SqlTypes.SqlString.Null;
		...
		/// </summary>
		public Params.spS_MasterCountryList SP_Parameter {
		...
		public override void Dispose() {
			...
			this.param_Code = System.Data.SqlTypes.SqlString.Null;
			if (this.param != null) {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_MasterCountryList class.
		/// </summary>
		public WebCheckBoxListCustom_spS_MasterCountryList() : base() {
		...
		/// You also need to supply the 'spS_MasterCountryList' stored procedure parameters.
		/// </summary>
		...
		/// <param name="param_Code">Value for the parameter @Code.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlString param_Code) {
		...
		/// <param name="displayMember">name of the field to be used for the content display.</param>
		/// <param name="param_Code">Value for the parameter @Code.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_Code) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_MasterCountryList";
		...
		/// <param name="tableName">name of the table to use to populate the control.</param>
		/// <param name="param_Code">Value for the parameter @Code.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlString param_Code) {
		...
		/// <param name="displayMember">name of the field to be used for the content display.</param>
		/// <param name="param_Code">Value for the parameter @Code.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_Code) {
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_MasterCountryList();
			...
			if (!this.param_Code.IsNull) {

				this.param.Param_Code = this.param_Code;
			}


			System.Data.DataSet DS = null;
			
			SPs.spS_MasterCountryList SP = new SPs.spS_MasterCountryList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_MasterCountryList", "RefreshData");
			}
