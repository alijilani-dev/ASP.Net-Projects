...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_LocationList_Full' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:47", SqlObjectDependancyName="spS_LocationList_Full", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_LocationList_Full), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_LocationList_Full : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_LocationList_Full param;
		...
		/// </summary>
		public Params.spS_LocationList_Full SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_LocationList_Full class.
		/// </summary>
		public WebCheckBoxListCustom_spS_LocationList_Full() : base() {
		...
		/// You also need to supply the 'spS_LocationList_Full' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_ParentId, System.Data.SqlTypes.SqlGuid param_CountryId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_LocationList_Full";
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_LocationList_Full();
			...
			SPs.spS_LocationList_Full SP = new SPs.spS_LocationList_Full();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_LocationList_Full", "RefreshData");
			}
