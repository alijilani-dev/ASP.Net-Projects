...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'CurrencyList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:47", SqlObjectDependancyName="CurrencyList", SqlObjectDependancyRevision=544)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_CurrencyList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_CurrencyList : System.Web.UI.WebControls.CheckBoxList {

		private Params.spS_CurrencyList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_CurrencyList oAbstract_CurrencyList;
		...
		/// </summary>
		public Params.spS_CurrencyList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'CurrencyList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_CurrencyList Abstract_CurrencyList {

			get {

				return(this.oAbstract_CurrencyList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_CurrencyList = null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_CurrencyList class.
		/// </summary>
		public WebCheckBoxList_CurrencyList() : base() {
		...
		public void Initialize(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'CurrencyList'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "CurrencyList", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CurrencyList_Display(true);
			...
			SPs.spS_CurrencyList_Display SP = new SPs.spS_CurrencyList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_CurrencyList_Display"].DefaultView;
				this.DataValueField = SPs.spS_CurrencyList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_CurrencyList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_CurrencyList : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the CurrencyList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_CurrencyList != null) {

					oAbstract_CurrencyList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_CurrencyList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_CurrencyList = new Evernet.MoneyExchange.AbstractClasses.Abstract_CurrencyList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_CurrencyList = new Evernet.MoneyExchange.AbstractClasses.Abstract_CurrencyList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_CurrencyList.Refresh(PK_Id));
		}
	}
}
