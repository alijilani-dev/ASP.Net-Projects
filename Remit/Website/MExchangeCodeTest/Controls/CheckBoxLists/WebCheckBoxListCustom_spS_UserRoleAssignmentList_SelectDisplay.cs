...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_UserRoleAssignmentList_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:49", SqlObjectDependancyName="spS_UserRoleAssignmentList_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_UserRoleAssignmentList_SelectDisplay), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_UserRoleAssignmentList_SelectDisplay : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_UserRoleAssignmentList_SelectDisplay param;
		...
		private System.Data.SqlTypes.SqlString param_Role = System.Data.SqlTypes.SqlString.Null;
		...
		/// </summary>
		public Params.spS_UserRoleAssignmentList_SelectDisplay SP_Parameter {
		...
		public override void Dispose() {
			...
			this.param_Role = System.Data.SqlTypes.SqlString.Null;
			if (this.param != null) {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_UserRoleAssignmentList_SelectDisplay class.
		/// </summary>
		public WebCheckBoxListCustom_spS_UserRoleAssignmentList_SelectDisplay() : base() {
		...
		/// You also need to supply the 'spS_UserRoleAssignmentList_SelectDisplay' stored procedure parameters.
		/// </summary>
		...
		/// <param name="param_Role">Value for the parameter @Role.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_UserId, System.Data.SqlTypes.SqlString param_Role) {
		...
		/// <param name="param_UserId">Value for the parameter @UserId.</param>
		/// <param name="param_Role">Value for the parameter @Role.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_UserId, System.Data.SqlTypes.SqlString param_Role) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_UserRoleAssignmentList_SelectDisplay";
		...
		/// <param name="param_UserId">Value for the parameter @UserId.</param>
		/// <param name="param_Role">Value for the parameter @Role.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_UserId, System.Data.SqlTypes.SqlString param_Role) {
		...
		/// <param name="param_UserId">Value for the parameter @UserId.</param>
		/// <param name="param_Role">Value for the parameter @Role.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_UserId, System.Data.SqlTypes.SqlString param_Role) {
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_UserRoleAssignmentList_SelectDisplay();
			...
			if (!this.param_Role.IsNull) {

				this.param.Param_Role = this.param_Role;
			}


			System.Data.DataSet DS = null;
			
			SPs.spS_UserRoleAssignmentList_SelectDisplay SP = new SPs.spS_UserRoleAssignmentList_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_UserRoleAssignmentList_SelectDisplay", "RefreshData");
			}
