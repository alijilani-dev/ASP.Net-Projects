...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_PaymentModeList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:47", SqlObjectDependancyName="spS_PaymentModeList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_PaymentModeList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_PaymentModeList : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_PaymentModeList param;
		...
		/// </summary>
		public Params.spS_PaymentModeList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_PaymentModeList class.
		/// </summary>
		public WebCheckBoxListCustom_spS_PaymentModeList() : base() {
		...
		/// You also need to supply the 'spS_PaymentModeList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_Value, System.Data.SqlTypes.SqlString param_BaseType, System.Data.SqlTypes.SqlString param_ChannelThrough, System.Data.SqlTypes.SqlString param_FinalEntity) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_PaymentModeList";
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_PaymentModeList();
			...
			SPs.spS_PaymentModeList SP = new SPs.spS_PaymentModeList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_PaymentModeList", "RefreshData");
			}
