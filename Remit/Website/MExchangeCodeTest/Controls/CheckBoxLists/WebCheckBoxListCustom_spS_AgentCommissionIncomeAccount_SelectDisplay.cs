...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_AgentCommissionIncomeAccount_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:44", SqlObjectDependancyName="spS_AgentCommissionIncomeAccount_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_AgentCommissionIncomeAccount_SelectDisplay), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_AgentCommissionIncomeAccount_SelectDisplay : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_AgentCommissionIncomeAccount_SelectDisplay param;
		...
		private System.Data.SqlTypes.SqlGuid param_TransactionId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_AgentCommissionIncomeAccount_SelectDisplay SP_Parameter {
		...
		public override void Dispose() {
			...
			this.param_TransactionId = System.Data.SqlTypes.SqlGuid.Null;
			if (this.param != null) {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_AgentCommissionIncomeAccount_SelectDisplay class.
		/// </summary>
		public WebCheckBoxListCustom_spS_AgentCommissionIncomeAccount_SelectDisplay() : base() {
		...
		/// You also need to supply the 'spS_AgentCommissionIncomeAccount_SelectDisplay' stored procedure parameters.
		/// </summary>
		...
		/// <param name="param_TransactionId">Value for the parameter @TransactionId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
			...
			this.param_TransactionId = param_TransactionId;
		}
		...
		/// <param name="param_AgentAccountId">Value for the parameter @AgentAccountId.</param>
		/// <param name="param_TransactionId">Value for the parameter @TransactionId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_AgentCommissionIncomeAccount_SelectDisplay";
		...
		/// <param name="param_AgentAccountId">Value for the parameter @AgentAccountId.</param>
		/// <param name="param_TransactionId">Value for the parameter @TransactionId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
		...
		/// <param name="param_AgentAccountId">Value for the parameter @AgentAccountId.</param>
		/// <param name="param_TransactionId">Value for the parameter @TransactionId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_TransactionId) {
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgentCommissionIncomeAccount_SelectDisplay();
			...
			if (!this.param_TransactionId.IsNull) {

				this.param.Param_TransactionId = this.param_TransactionId;
			}


			System.Data.DataSet DS = null;
			
			SPs.spS_AgentCommissionIncomeAccount_SelectDisplay SP = new SPs.spS_AgentCommissionIncomeAccount_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_AgentCommissionIncomeAccount_SelectDisplay", "RefreshData");
			}
