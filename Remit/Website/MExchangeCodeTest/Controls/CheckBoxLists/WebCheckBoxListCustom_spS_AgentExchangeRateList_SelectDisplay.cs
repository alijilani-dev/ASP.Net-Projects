...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_AgentExchangeRateList_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:45", SqlObjectDependancyName="spS_AgentExchangeRateList_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_AgentExchangeRateList_SelectDisplay), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_AgentExchangeRateList_SelectDisplay : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_AgentExchangeRateList_SelectDisplay param;
		...
		private System.Data.SqlTypes.SqlGuid param_AgencyExchangeRateId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_AgentExchangeRateList_SelectDisplay SP_Parameter {
		...
		public override void Dispose() {
			...
			this.param_AgencyExchangeRateId = System.Data.SqlTypes.SqlGuid.Null;
			if (this.param != null) {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_AgentExchangeRateList_SelectDisplay class.
		/// </summary>
		public WebCheckBoxListCustom_spS_AgentExchangeRateList_SelectDisplay() : base() {
		...
		/// You also need to supply the 'spS_AgentExchangeRateList_SelectDisplay' stored procedure parameters.
		/// </summary>
		...
		/// <param name="param_AgencyExchangeRateId">Value for the parameter @AgencyExchangeRateId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_AgencyExchangeRateId) {
			...
			this.param_AgencyExchangeRateId = param_AgencyExchangeRateId;
		}
		...
		/// <param name="param_AgentAccountId">Value for the parameter @AgentAccountId.</param>
		/// <param name="param_AgencyExchangeRateId">Value for the parameter @AgencyExchangeRateId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_AgencyExchangeRateId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_AgentExchangeRateList_SelectDisplay";
		...
		/// <param name="param_AgentAccountId">Value for the parameter @AgentAccountId.</param>
		/// <param name="param_AgencyExchangeRateId">Value for the parameter @AgencyExchangeRateId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_AgencyExchangeRateId) {
		...
		/// <param name="param_AgentAccountId">Value for the parameter @AgentAccountId.</param>
		/// <param name="param_AgencyExchangeRateId">Value for the parameter @AgencyExchangeRateId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_AgencyExchangeRateId) {
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgentExchangeRateList_SelectDisplay();
			...
			if (!this.param_AgencyExchangeRateId.IsNull) {

				this.param.Param_AgencyExchangeRateId = this.param_AgencyExchangeRateId;
			}


			System.Data.DataSet DS = null;
			
			SPs.spS_AgentExchangeRateList_SelectDisplay SP = new SPs.spS_AgentExchangeRateList_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_AgentExchangeRateList_SelectDisplay", "RefreshData");
			}
