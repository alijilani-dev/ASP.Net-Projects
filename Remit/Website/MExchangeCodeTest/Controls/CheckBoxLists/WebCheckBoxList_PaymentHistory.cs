...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'PaymentHistory' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:47", SqlObjectDependancyName="PaymentHistory", SqlObjectDependancyRevision=688)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_PaymentHistory), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_PaymentHistory : System.Web.UI.WebControls.CheckBoxList {

		private Params.spS_PaymentHistory_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_PaymentHistory oAbstract_PaymentHistory;
		private System.Data.SqlTypes.SqlGuid FK_PaymentCurrencyId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_PaymentHistory_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'PaymentHistory' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_PaymentHistory Abstract_PaymentHistory {

			get {

				return(this.oAbstract_PaymentHistory);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_PaymentHistory = null;

			this.FK_PaymentCurrencyId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_PaymentHistory class.
		/// </summary>
		public WebCheckBoxList_PaymentHistory() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_PaymentCurrencyId, System.Data.SqlTypes.SqlString FK_Type) {
			...
			this.FK_PaymentCurrencyId = FK_PaymentCurrencyId;
		...
		/// <param name="FK_PaymentCurrencyId">Value for this foreign key.</param>
		/// <param name="FK_Type">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_PaymentCurrencyId, System.Data.SqlTypes.SqlString FK_Type) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_PaymentHistory_Display(true);
			...
			this.param.Param_PaymentCurrencyId = this.FK_PaymentCurrencyId;
			this.param.Param_Type = this.FK_Type;

			System.Data.DataSet DS = null;
			
			SPs.spS_PaymentHistory_Display SP = new SPs.spS_PaymentHistory_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_PaymentHistory_Display"].DefaultView;
				this.DataValueField = SPs.spS_PaymentHistory_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_PaymentHistory_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_PaymentHistory : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the PaymentHistory abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_PaymentHistory != null) {

					oAbstract_PaymentHistory.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_PaymentHistory == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_PaymentHistory = new Evernet.MoneyExchange.AbstractClasses.Abstract_PaymentHistory(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_PaymentHistory = new Evernet.MoneyExchange.AbstractClasses.Abstract_PaymentHistory(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_PaymentHistory.Refresh(PK_Id));
		}
	}
}
