...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_OFACBannedNameList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:47", SqlObjectDependancyName="spS_OFACBannedNameList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_OFACBannedNameList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_OFACBannedNameList : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_OFACBannedNameList param;
		...
		/// </summary>
		public Params.spS_OFACBannedNameList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_OFACBannedNameList class.
		/// </summary>
		public WebCheckBoxListCustom_spS_OFACBannedNameList() : base() {
		...
		/// You also need to supply the 'spS_OFACBannedNameList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_OFACBannedNameList";
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_OFACBannedNameList();
			...
			SPs.spS_OFACBannedNameList SP = new SPs.spS_OFACBannedNameList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_OFACBannedNameList", "RefreshData");
			}
