...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_CustomerLoyaltyPointsRedeemHistory' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:47", SqlObjectDependancyName="spS_CustomerLoyaltyPointsRedeemHistory", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_CustomerLoyaltyPointsRedeemHistory), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_CustomerLoyaltyPointsRedeemHistory : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_CustomerLoyaltyPointsRedeemHistory param;
		...
		/// </summary>
		public Params.spS_CustomerLoyaltyPointsRedeemHistory SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_CustomerLoyaltyPointsRedeemHistory class.
		/// </summary>
		public WebCheckBoxListCustom_spS_CustomerLoyaltyPointsRedeemHistory() : base() {
		...
		/// You also need to supply the 'spS_CustomerLoyaltyPointsRedeemHistory' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CustomerId, System.Data.SqlTypes.SqlGuid param_ProductsId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_CustomerLoyaltyPointsRedeemHistory";
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CustomerLoyaltyPointsRedeemHistory();
			...
			SPs.spS_CustomerLoyaltyPointsRedeemHistory SP = new SPs.spS_CustomerLoyaltyPointsRedeemHistory();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_CustomerLoyaltyPointsRedeemHistory", "RefreshData");
			}
