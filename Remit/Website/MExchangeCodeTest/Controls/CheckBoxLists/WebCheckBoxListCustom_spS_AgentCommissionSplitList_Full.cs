...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_AgentCommissionSplitList_Full' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:44", SqlObjectDependancyName="spS_AgentCommissionSplitList_Full", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_AgentCommissionSplitList_Full), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_AgentCommissionSplitList_Full : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_AgentCommissionSplitList_Full param;
		...
		/// </summary>
		public Params.spS_AgentCommissionSplitList_Full SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_AgentCommissionSplitList_Full class.
		/// </summary>
		public WebCheckBoxListCustom_spS_AgentCommissionSplitList_Full() : base() {
		...
		/// You also need to supply the 'spS_AgentCommissionSplitList_Full' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CurrentAccountId, System.Data.SqlTypes.SqlGuid param_EndNodeAccountId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_AgentCommissionSplitList_Full";
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgentCommissionSplitList_Full();
			...
			SPs.spS_AgentCommissionSplitList_Full SP = new SPs.spS_AgentCommissionSplitList_Full();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_AgentCommissionSplitList_Full", "RefreshData");
			}
