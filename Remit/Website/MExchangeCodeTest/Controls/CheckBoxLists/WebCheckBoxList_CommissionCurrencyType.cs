...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'CommissionCurrencyType' table content.
	/// </summary>
...
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_CommissionCurrencyType), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_CommissionCurrencyType : System.Web.UI.WebControls.CheckBoxList {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_CommissionCurrencyType class.
		/// </summary>
		public WebCheckBoxList_CommissionCurrencyType() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlString[] ArrayOf_PK_Value, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_CommissionCurrencyType : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
