...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'BankList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:46", SqlObjectDependancyName="BankList", SqlObjectDependancyRevision=1280)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_BankList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_BankList : System.Web.UI.WebControls.CheckBoxList {

		private Params.spS_BankList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_BankList oAbstract_BankList;
		private System.Data.SqlTypes.SqlGuid FK_AccountId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_BankList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'BankList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_BankList Abstract_BankList {

			get {

				return(this.oAbstract_BankList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_BankList = null;

			this.FK_AccountId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_BankList class.
		/// </summary>
		public WebCheckBoxList_BankList() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_AccountId, System.Data.SqlTypes.SqlGuid FK_LocationId) {
		...
		/// <param name="FK_AccountId">Value for this foreign key.</param>
		/// <param name="FK_LocationId">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_AccountId, System.Data.SqlTypes.SqlGuid FK_LocationId) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_BankList_Display(true);
			...
			this.param.Param_AccountId = this.FK_AccountId;
			this.param.Param_LocationId = this.FK_LocationId;

			System.Data.DataSet DS = null;
			
			SPs.spS_BankList_Display SP = new SPs.spS_BankList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_BankList_Display"].DefaultView;
				this.DataValueField = SPs.spS_BankList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_BankList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_BankList : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the BankList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_BankList != null) {

					oAbstract_BankList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_BankList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_BankList = new Evernet.MoneyExchange.AbstractClasses.Abstract_BankList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_BankList = new Evernet.MoneyExchange.AbstractClasses.Abstract_BankList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_BankList.Refresh(PK_Id));
		}
	}
}
