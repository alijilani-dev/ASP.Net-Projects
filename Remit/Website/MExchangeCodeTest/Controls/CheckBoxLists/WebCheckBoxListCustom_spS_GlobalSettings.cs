...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_GlobalSettings' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:47", SqlObjectDependancyName="spS_GlobalSettings", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_GlobalSettings), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_GlobalSettings : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_GlobalSettings param;
		private System.Data.SqlTypes.SqlByte param_Id = System.Data.SqlTypes.SqlByte.Null;
		...
		/// </summary>
		public Params.spS_GlobalSettings SP_Parameter {
		...
		public override void Dispose() {
			...
			this.param_Id = System.Data.SqlTypes.SqlByte.Null;
			if (this.param != null) {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_GlobalSettings class.
		/// </summary>
		public WebCheckBoxListCustom_spS_GlobalSettings() : base() {
		...
		/// You also need to supply the 'spS_GlobalSettings' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlByte param_Id) {
		...
		/// <param name="displayMember">name of the field to be used for the content display.</param>
		/// <param name="param_Id">Value for the parameter @Id.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlByte param_Id) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_GlobalSettings";
		...
		/// <param name="tableName">name of the table to use to populate the control.</param>
		/// <param name="param_Id">Value for the parameter @Id.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlByte param_Id) {
		...
		/// <param name="displayMember">name of the field to be used for the content display.</param>
		/// <param name="param_Id">Value for the parameter @Id.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlByte param_Id) {
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_GlobalSettings();
			...
			SPs.spS_GlobalSettings SP = new SPs.spS_GlobalSettings();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_GlobalSettings", "RefreshData");
			}
