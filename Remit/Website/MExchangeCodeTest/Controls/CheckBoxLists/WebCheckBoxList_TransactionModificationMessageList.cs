...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'TransactionModificationMessageList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:47", SqlObjectDependancyName="TransactionModificationMessageList", SqlObjectDependancyRevision=448)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_TransactionModificationMessageList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_TransactionModificationMessageList : System.Web.UI.WebControls.CheckBoxList {

		private Params.spS_TransactionModificationMessageList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionModificationMessageList oAbstract_TransactionModificationMessageList;
		private System.Data.SqlTypes.SqlGuid FK_UserId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_TransactionModificationMessageList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'TransactionModificationMessageList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionModificationMessageList Abstract_TransactionModificationMessageList {

			get {

				return(this.oAbstract_TransactionModificationMessageList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_TransactionModificationMessageList = null;

			this.FK_UserId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_TransactionModificationMessageList class.
		/// </summary>
		public WebCheckBoxList_TransactionModificationMessageList() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_UserId) {
		...
		/// </param>
		/// <param name="FK_UserId">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_UserId) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_TransactionModificationMessageList_Display(true);
			...
			this.param.Param_UserId = this.FK_UserId;

			System.Data.DataSet DS = null;
			
			SPs.spS_TransactionModificationMessageList_Display SP = new SPs.spS_TransactionModificationMessageList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_TransactionModificationMessageList_Display"].DefaultView;
				this.DataValueField = SPs.spS_TransactionModificationMessageList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_TransactionModificationMessageList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_TransactionModificationMessageList : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the TransactionModificationMessageList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_TransactionModificationMessageList != null) {

					oAbstract_TransactionModificationMessageList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_TransactionModificationMessageList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_TransactionModificationMessageList = new Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionModificationMessageList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_TransactionModificationMessageList = new Evernet.MoneyExchange.AbstractClasses.Abstract_TransactionModificationMessageList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_TransactionModificationMessageList.Refresh(PK_Id));
		}
	}
}
