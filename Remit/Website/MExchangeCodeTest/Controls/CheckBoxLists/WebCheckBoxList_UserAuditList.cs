...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'UserAuditList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:47", SqlObjectDependancyName="UserAuditList", SqlObjectDependancyRevision=592)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_UserAuditList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_UserAuditList : System.Web.UI.WebControls.CheckBoxList {

		private Params.spS_UserAuditList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_UserAuditList oAbstract_UserAuditList;
		...
		/// </summary>
		public Params.spS_UserAuditList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'UserAuditList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_UserAuditList Abstract_UserAuditList {

			get {

				return(this.oAbstract_UserAuditList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_UserAuditList = null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_UserAuditList class.
		/// </summary>
		public WebCheckBoxList_UserAuditList() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_UserAuditList_Display(true);
			...
			SPs.spS_UserAuditList_Display SP = new SPs.spS_UserAuditList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_UserAuditList_Display"].DefaultView;
				this.DataValueField = SPs.spS_UserAuditList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_UserAuditList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_UserAuditList : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the UserAuditList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_UserAuditList != null) {

					oAbstract_UserAuditList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_UserAuditList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_UserAuditList = new Evernet.MoneyExchange.AbstractClasses.Abstract_UserAuditList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_UserAuditList = new Evernet.MoneyExchange.AbstractClasses.Abstract_UserAuditList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_UserAuditList.Refresh(PK_Id));
		}
	}
}
