...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'AgencyCommissionIncomeAccountDetails' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:46", SqlObjectDependancyName="AgencyCommissionIncomeAccountDetails", SqlObjectDependancyRevision=576)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_AgencyCommissionIncomeAccountDetails), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_AgencyCommissionIncomeAccountDetails : System.Web.UI.WebControls.CheckBoxList {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_AgencyCommissionIncomeAccountDetails class.
		/// </summary>
		public WebCheckBoxList_AgencyCommissionIncomeAccountDetails() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Id, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_AgencyCommissionIncomeAccountDetails : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
