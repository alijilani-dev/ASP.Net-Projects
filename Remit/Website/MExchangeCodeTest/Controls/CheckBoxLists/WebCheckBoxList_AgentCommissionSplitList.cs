...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'AgentCommissionSplitList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:46", SqlObjectDependancyName="AgentCommissionSplitList", SqlObjectDependancyRevision=544)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_AgentCommissionSplitList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_AgentCommissionSplitList : System.Web.UI.WebControls.CheckBoxList {

		private Params.spS_AgentCommissionSplitList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_AgentCommissionSplitList oAbstract_AgentCommissionSplitList;
		private System.Data.SqlTypes.SqlGuid FK_CurrentAccountId = System.Data.SqlTypes.SqlGuid.Null;
		private System.Data.SqlTypes.SqlGuid FK_EndNodeAccountId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_AgentCommissionSplitList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'AgentCommissionSplitList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_AgentCommissionSplitList Abstract_AgentCommissionSplitList {

			get {

				return(this.oAbstract_AgentCommissionSplitList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_AgentCommissionSplitList = null;

			this.FK_CurrentAccountId = System.Data.SqlTypes.SqlGuid.Null;
			this.FK_EndNodeAccountId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_AgentCommissionSplitList class.
		/// </summary>
		public WebCheckBoxList_AgentCommissionSplitList() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_CurrentAccountId, System.Data.SqlTypes.SqlGuid FK_EndNodeAccountId) {
			...
			this.FK_CurrentAccountId = FK_CurrentAccountId;
			this.FK_EndNodeAccountId = FK_EndNodeAccountId;
		}
		...
		/// <param name="FK_CurrentAccountId">Value for this foreign key.</param>
		/// <param name="FK_EndNodeAccountId">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CurrentAccountId, System.Data.SqlTypes.SqlGuid FK_EndNodeAccountId) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgentCommissionSplitList_Display(true);
			...
			this.param.Param_CurrentAccountId = this.FK_CurrentAccountId;
			this.param.Param_EndNodeAccountId = this.FK_EndNodeAccountId;

			System.Data.DataSet DS = null;
			
			SPs.spS_AgentCommissionSplitList_Display SP = new SPs.spS_AgentCommissionSplitList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_AgentCommissionSplitList_Display"].DefaultView;
				this.DataValueField = SPs.spS_AgentCommissionSplitList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_AgentCommissionSplitList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_AgentCommissionSplitList : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the AgentCommissionSplitList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_AgentCommissionSplitList != null) {

					oAbstract_AgentCommissionSplitList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_AgentCommissionSplitList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_AgentCommissionSplitList = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgentCommissionSplitList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_AgentCommissionSplitList = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgentCommissionSplitList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_AgentCommissionSplitList.Refresh(PK_Id));
		}
	}
}
