...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'MasterCountryList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:47", SqlObjectDependancyName="MasterCountryList", SqlObjectDependancyRevision=208)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_MasterCountryList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_MasterCountryList : System.Web.UI.WebControls.CheckBoxList {

		private Params.spS_MasterCountryList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_MasterCountryList oAbstract_MasterCountryList;
		...
		/// </summary>
		public Params.spS_MasterCountryList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'MasterCountryList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_MasterCountryList Abstract_MasterCountryList {

			get {

				return(this.oAbstract_MasterCountryList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_MasterCountryList = null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_MasterCountryList class.
		/// </summary>
		public WebCheckBoxList_MasterCountryList() : base() {
		...
		public void Initialize(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'MasterCountryList'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "MasterCountryList", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		/// </summary>
		/// <param name="ArrayOf_PK_Code">Primary keys of the records you want to be checked by default.</param>
		public void RefreshData(System.Collections.ArrayList ArrayOf_PK_Code) {

			this.RefreshData(ArrayOf_PK_Code, -1, -1);
		}
		...
		/// <param name="startRecord">The zero-based record number to start with.</param>
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		public void RefreshData(System.Collections.ArrayList ArrayOf_PK_Code, int startRecord, int maxRecords) {

			if (ArrayOf_PK_Code != null && ArrayOf_PK_Code.Count > 0) {

				System.Data.SqlTypes.SqlString[] typedArray = new System.Data.SqlTypes.SqlString[ArrayOf_PK_Code.Count];
				int index = 0;
				foreach(object item in ArrayOf_PK_Code) {
					...
					if (item is System.Data.SqlTypes.SqlString) {
						...
						throw new InvalidOperationException("ArrayOf_PK_Code does not contain ONLY System.Data.SqlTypes.SqlString or System.String elements.");
					}
				}
		...
		/// </summary>
		/// <param name="ArrayOf_PK_Code">Primary keys of the records you want to be checked by default.</param>
		public void RefreshData(System.Data.SqlTypes.SqlString[] ArrayOf_PK_Code) {
		...
		/// <param name="startRecord">The zero-based record number to start with.</param>
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		public void RefreshData(System.Data.SqlTypes.SqlString[] ArrayOf_PK_Code, int startRecord, int maxRecords) {

			this.param = new Params.spS_MasterCountryList_Display(true);
			...
			SPs.spS_MasterCountryList_Display SP = new SPs.spS_MasterCountryList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_MasterCountryList_Display"].DefaultView;
				this.DataValueField = SPs.spS_MasterCountryList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_MasterCountryList_Display.Resultset1.Fields.Column_Display.ColumnName;
				if (this.doDataBindAfterRefreshData) {

					this.DataBind();
				}

				if (ArrayOf_PK_Code != null) {

					this.SetRecordsChecked(ArrayOf_PK_Code, true);
				}
			}
			else {

				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_MasterCountryList : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		/// </summary>
		/// <param name="ArrayOf_PK_Code">Primary keys of the records to set the check state for.</param>
		/// <param name="value">True if the records must be checked. Otherwise False.</param>
		public void SetRecordsChecked(System.Collections.ArrayList ArrayOf_PK_Code, bool value) {
		...
		/// <param name="ArrayOf_PK_Code">Primary keys of the records to set the check state for.</param>
		/// <param name="value">True if the records must be checked. Otherwise False.</param>
		public void SetRecordsChecked(System.Data.SqlTypes.SqlString[] ArrayOf_PK_Code, bool value) {

			this.ClearSelection();

			if (ArrayOf_PK_Code != null) {

				foreach (System.Data.SqlTypes.SqlString PK_Code in ArrayOf_PK_Code) {

					System.Web.UI.WebControls.ListItem listItem = this.Items.FindByValue(PK_Code.Value.ToString());
					if (listItem != null) {
		...
		/// <summary>
		/// Loads the MasterCountryList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_MasterCountryList != null) {

					oAbstract_MasterCountryList.Reset();
				}
				return(false);
			}

			System.Data.SqlTypes.SqlString PK_Code = Convert.ToString(this.SelectedItem.Value);

			if (this.oAbstract_MasterCountryList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_MasterCountryList = new Evernet.MoneyExchange.AbstractClasses.Abstract_MasterCountryList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_MasterCountryList = new Evernet.MoneyExchange.AbstractClasses.Abstract_MasterCountryList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_MasterCountryList.Refresh(PK_Code));
		}
	}
}
