...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_AgentExchangeRateList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:44", SqlObjectDependancyName="spS_AgentExchangeRateList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_AgentExchangeRateList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_AgentExchangeRateList : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_AgentExchangeRateList param;
		...
		/// </summary>
		public Params.spS_AgentExchangeRateList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_AgentExchangeRateList class.
		/// </summary>
		public WebCheckBoxListCustom_spS_AgentExchangeRateList() : base() {
		...
		/// You also need to supply the 'spS_AgentExchangeRateList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_AgencyExchangeRateId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_AgentExchangeRateList";
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgentExchangeRateList();
			...
			SPs.spS_AgentExchangeRateList SP = new SPs.spS_AgentExchangeRateList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_AgentExchangeRateList", "RefreshData");
			}
