...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'AgentGroupList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:46", SqlObjectDependancyName="AgentGroupList", SqlObjectDependancyRevision=544)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_AgentGroupList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_AgentGroupList : System.Web.UI.WebControls.CheckBoxList {

		private Params.spS_AgentGroupList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_AgentGroupList oAbstract_AgentGroupList;
		...
		/// </summary>
		public Params.spS_AgentGroupList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'AgentGroupList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_AgentGroupList Abstract_AgentGroupList {

			get {

				return(this.oAbstract_AgentGroupList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_AgentGroupList = null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_AgentGroupList class.
		/// </summary>
		public WebCheckBoxList_AgentGroupList() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_AgentAccountId) {
		...
		/// </param>
		/// <param name="FK_AgentAccountId">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_AgentAccountId) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgentGroupList_Display(true);
			...
			SPs.spS_AgentGroupList_Display SP = new SPs.spS_AgentGroupList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_AgentGroupList_Display"].DefaultView;
				this.DataValueField = SPs.spS_AgentGroupList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_AgentGroupList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_AgentGroupList : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the AgentGroupList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_AgentGroupList != null) {

					oAbstract_AgentGroupList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_AgentGroupList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_AgentGroupList = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgentGroupList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_AgentGroupList = new Evernet.MoneyExchange.AbstractClasses.Abstract_AgentGroupList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_AgentGroupList.Refresh(PK_Id));
		}
	}
}
