...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_CustomerLoyaltyPointsRedeemHistory_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:47", SqlObjectDependancyName="spS_CustomerLoyaltyPointsRedeemHistory_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_CustomerLoyaltyPointsRedeemHistory_SelectDisplay), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_CustomerLoyaltyPointsRedeemHistory_SelectDisplay : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_CustomerLoyaltyPointsRedeemHistory_SelectDisplay param;
		...
		private System.Data.SqlTypes.SqlGuid param_ProductsId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_CustomerLoyaltyPointsRedeemHistory_SelectDisplay SP_Parameter {
		...
		public override void Dispose() {
			...
			this.param_ProductsId = System.Data.SqlTypes.SqlGuid.Null;
			if (this.param != null) {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_CustomerLoyaltyPointsRedeemHistory_SelectDisplay class.
		/// </summary>
		public WebCheckBoxListCustom_spS_CustomerLoyaltyPointsRedeemHistory_SelectDisplay() : base() {
		...
		/// You also need to supply the 'spS_CustomerLoyaltyPointsRedeemHistory_SelectDisplay' stored procedure parameters.
		/// </summary>
		...
		/// <param name="param_ProductsId">Value for the parameter @ProductsId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CustomerId, System.Data.SqlTypes.SqlGuid param_ProductsId) {
			...
			this.param_ProductsId = param_ProductsId;
		}
		...
		/// <param name="param_CustomerId">Value for the parameter @CustomerId.</param>
		/// <param name="param_ProductsId">Value for the parameter @ProductsId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CustomerId, System.Data.SqlTypes.SqlGuid param_ProductsId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_CustomerLoyaltyPointsRedeemHistory_SelectDisplay";
		...
		/// <param name="param_CustomerId">Value for the parameter @CustomerId.</param>
		/// <param name="param_ProductsId">Value for the parameter @ProductsId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CustomerId, System.Data.SqlTypes.SqlGuid param_ProductsId) {
		...
		/// <param name="param_CustomerId">Value for the parameter @CustomerId.</param>
		/// <param name="param_ProductsId">Value for the parameter @ProductsId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CustomerId, System.Data.SqlTypes.SqlGuid param_ProductsId) {
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CustomerLoyaltyPointsRedeemHistory_SelectDisplay();
			...
			if (!this.param_ProductsId.IsNull) {

				this.param.Param_ProductsId = this.param_ProductsId;
			}


			System.Data.DataSet DS = null;
			
			SPs.spS_CustomerLoyaltyPointsRedeemHistory_SelectDisplay SP = new SPs.spS_CustomerLoyaltyPointsRedeemHistory_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_CustomerLoyaltyPointsRedeemHistory_SelectDisplay", "RefreshData");
			}
