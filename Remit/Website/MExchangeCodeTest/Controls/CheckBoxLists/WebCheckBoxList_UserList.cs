...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'UserList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:47", SqlObjectDependancyName="UserList", SqlObjectDependancyRevision=1392)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_UserList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_UserList : System.Web.UI.WebControls.CheckBoxList {

		private Params.spS_UserList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_UserList oAbstract_UserList;
		...
		/// </summary>
		public Params.spS_UserList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'UserList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_UserList Abstract_UserList {

			get {

				return(this.oAbstract_UserList);
			}
		}
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_UserList class.
		/// </summary>
		public WebCheckBoxList_UserList() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_AgentId) {
		...
		/// <param name="FK_AgentAccountId">Value for this foreign key.</param>
		/// <param name="FK_AgentId">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_AgentAccountId, System.Data.SqlTypes.SqlGuid FK_AgentId) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_UserList_Display(true);
			...
			SPs.spS_UserList_Display SP = new SPs.spS_UserList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_UserList_Display"].DefaultView;
				this.DataValueField = SPs.spS_UserList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_UserList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_UserList : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the UserList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_UserList != null) {

					oAbstract_UserList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_UserList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_UserList = new Evernet.MoneyExchange.AbstractClasses.Abstract_UserList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_UserList = new Evernet.MoneyExchange.AbstractClasses.Abstract_UserList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_UserList.Refresh(PK_Id));
		}
	}
}
