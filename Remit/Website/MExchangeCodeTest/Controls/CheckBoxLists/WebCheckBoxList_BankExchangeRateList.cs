...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'BankExchangeRateList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:46", SqlObjectDependancyName="BankExchangeRateList", SqlObjectDependancyRevision=624)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_BankExchangeRateList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_BankExchangeRateList : System.Web.UI.WebControls.CheckBoxList {

		private Params.spS_BankExchangeRateList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_BankExchangeRateList oAbstract_BankExchangeRateList;
		private System.Data.SqlTypes.SqlGuid FK_CurrencyId = System.Data.SqlTypes.SqlGuid.Null;
		private System.Data.SqlTypes.SqlString FK_ExchangeType = System.Data.SqlTypes.SqlString.Null;
		...
		/// </summary>
		public Params.spS_BankExchangeRateList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'BankExchangeRateList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_BankExchangeRateList Abstract_BankExchangeRateList {

			get {

				return(this.oAbstract_BankExchangeRateList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_BankExchangeRateList = null;

			this.FK_CurrencyId = System.Data.SqlTypes.SqlGuid.Null;
			this.FK_ExchangeType = System.Data.SqlTypes.SqlString.Null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_BankExchangeRateList class.
		/// </summary>
		public WebCheckBoxList_BankExchangeRateList() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_CurrencyId, System.Data.SqlTypes.SqlString FK_ExchangeType) {
			...
			this.FK_CurrencyId = FK_CurrencyId;
			this.FK_ExchangeType = FK_ExchangeType;
		}
		...
		/// <param name="FK_CurrencyId">Value for this foreign key.</param>
		/// <param name="FK_ExchangeType">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CurrencyId, System.Data.SqlTypes.SqlString FK_ExchangeType) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_BankExchangeRateList_Display(true);
			...
			this.param.Param_CurrencyId = this.FK_CurrencyId;
			this.param.Param_ExchangeType = this.FK_ExchangeType;

			System.Data.DataSet DS = null;
			
			SPs.spS_BankExchangeRateList_Display SP = new SPs.spS_BankExchangeRateList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_BankExchangeRateList_Display"].DefaultView;
				this.DataValueField = SPs.spS_BankExchangeRateList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_BankExchangeRateList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_BankExchangeRateList : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the BankExchangeRateList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_BankExchangeRateList != null) {

					oAbstract_BankExchangeRateList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_BankExchangeRateList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_BankExchangeRateList = new Evernet.MoneyExchange.AbstractClasses.Abstract_BankExchangeRateList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_BankExchangeRateList = new Evernet.MoneyExchange.AbstractClasses.Abstract_BankExchangeRateList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_BankExchangeRateList.Refresh(PK_Id));
		}
	}
}
