...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_PaymentModeBaseTypeList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:47", SqlObjectDependancyName="spS_PaymentModeBaseTypeList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_PaymentModeBaseTypeList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_PaymentModeBaseTypeList : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_PaymentModeBaseTypeList param;
		...
		/// </summary>
		public Params.spS_PaymentModeBaseTypeList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_PaymentModeBaseTypeList class.
		/// </summary>
		public WebCheckBoxListCustom_spS_PaymentModeBaseTypeList() : base() {
		...
		/// You also need to supply the 'spS_PaymentModeBaseTypeList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_Value) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_PaymentModeBaseTypeList";
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_PaymentModeBaseTypeList();
			...
			SPs.spS_PaymentModeBaseTypeList SP = new SPs.spS_PaymentModeBaseTypeList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_PaymentModeBaseTypeList", "RefreshData");
			}
