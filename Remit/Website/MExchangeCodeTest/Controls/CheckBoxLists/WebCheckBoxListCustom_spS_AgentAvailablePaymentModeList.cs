...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_AgentAvailablePaymentModeList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:44", SqlObjectDependancyName="spS_AgentAvailablePaymentModeList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_AgentAvailablePaymentModeList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_AgentAvailablePaymentModeList : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_AgentAvailablePaymentModeList param;
		...
		/// </summary>
		public Params.spS_AgentAvailablePaymentModeList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_AgentAvailablePaymentModeList class.
		/// </summary>
		public WebCheckBoxListCustom_spS_AgentAvailablePaymentModeList() : base() {
		...
		/// You also need to supply the 'spS_AgentAvailablePaymentModeList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentId, System.Data.SqlTypes.SqlString param_PaymentMode) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_AgentAvailablePaymentModeList";
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgentAvailablePaymentModeList();
			...
			SPs.spS_AgentAvailablePaymentModeList SP = new SPs.spS_AgentAvailablePaymentModeList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_AgentAvailablePaymentModeList", "RefreshData");
			}
