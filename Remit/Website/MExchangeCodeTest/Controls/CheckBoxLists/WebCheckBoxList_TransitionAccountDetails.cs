...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'TransitionAccountDetails' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:47", SqlObjectDependancyName="TransitionAccountDetails", SqlObjectDependancyRevision=1264)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_TransitionAccountDetails), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_TransitionAccountDetails : System.Web.UI.WebControls.CheckBoxList {

		private Params.spS_TransitionAccountDetails_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_TransitionAccountDetails oAbstract_TransitionAccountDetails;
		...
		/// </summary>
		public Params.spS_TransitionAccountDetails_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'TransitionAccountDetails' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_TransitionAccountDetails Abstract_TransitionAccountDetails {

			get {

				return(this.oAbstract_TransitionAccountDetails);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_TransitionAccountDetails = null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_TransitionAccountDetails class.
		/// </summary>
		public WebCheckBoxList_TransitionAccountDetails() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_TransitionAccountDetails_Display(true);
			...
			SPs.spS_TransitionAccountDetails_Display SP = new SPs.spS_TransitionAccountDetails_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_TransitionAccountDetails_Display"].DefaultView;
				this.DataValueField = SPs.spS_TransitionAccountDetails_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_TransitionAccountDetails_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_TransitionAccountDetails : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the TransitionAccountDetails abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_TransitionAccountDetails != null) {

					oAbstract_TransitionAccountDetails.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_TransitionAccountDetails == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_TransitionAccountDetails = new Evernet.MoneyExchange.AbstractClasses.Abstract_TransitionAccountDetails(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_TransitionAccountDetails = new Evernet.MoneyExchange.AbstractClasses.Abstract_TransitionAccountDetails(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_TransitionAccountDetails.Refresh(PK_Id));
		}
	}
}
