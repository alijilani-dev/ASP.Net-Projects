...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_AgentLocationList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:45", SqlObjectDependancyName="spS_AgentLocationList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_AgentLocationList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_AgentLocationList : System.Web.UI.WebControls.CheckBoxList {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_AgentLocationList class.
		/// </summary>
		public WebCheckBoxListCustom_spS_AgentLocationList() : base() {
		...
		/// You also need to supply the 'spS_AgentLocationList' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AgentAccountId, System.Data.SqlTypes.SqlGuid param_AgentGroupId, System.Data.SqlTypes.SqlString param_AllowedDomesticTransactionType, System.Data.SqlTypes.SqlString param_AllowedInternationalTransactionType, System.Data.SqlTypes.SqlString param_ListOnWebFor, System.Data.SqlTypes.SqlGuid param_LocationId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_AgentLocationList";
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgentLocationList();
			...
			SPs.spS_AgentLocationList SP = new SPs.spS_AgentLocationList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_AgentLocationList", "RefreshData");
			}
