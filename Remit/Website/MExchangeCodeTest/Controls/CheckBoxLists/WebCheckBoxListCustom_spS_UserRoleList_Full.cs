...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_UserRoleList_Full' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:49", SqlObjectDependancyName="spS_UserRoleList_Full", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_UserRoleList_Full), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_UserRoleList_Full : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_UserRoleList_Full param;
		...
		/// </summary>
		public Params.spS_UserRoleList_Full SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_UserRoleList_Full class.
		/// </summary>
		public WebCheckBoxListCustom_spS_UserRoleList_Full() : base() {
		...
		/// You also need to supply the 'spS_UserRoleList_Full' stored procedure parameters.
		/// </summary>
		...
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlString param_Value, System.Data.SqlTypes.SqlString param_Module, System.Data.SqlTypes.SqlString param_Type) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_UserRoleList_Full";
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_UserRoleList_Full();
			...
			SPs.spS_UserRoleList_Full SP = new SPs.spS_UserRoleList_Full();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_UserRoleList_Full", "RefreshData");
			}
