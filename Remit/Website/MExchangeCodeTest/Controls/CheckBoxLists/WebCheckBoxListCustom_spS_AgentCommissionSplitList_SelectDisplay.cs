/*
	This C# source code was automatically generated using:
		...
		SQL Server Centric .NET Code Generator
			...
			Generation Date: 11/30/2004 11:48:44 PM
...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_AgentCommissionSplitList_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:44", SqlObjectDependancyName="spS_AgentCommissionSplitList_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_AgentCommissionSplitList_SelectDisplay), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_AgentCommissionSplitList_SelectDisplay : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_AgentCommissionSplitList_SelectDisplay param;
		private System.Data.SqlTypes.SqlGuid param_Id = System.Data.SqlTypes.SqlGuid.Null;
		private System.Data.SqlTypes.SqlGuid param_CurrentAccountId = System.Data.SqlTypes.SqlGuid.Null;
		private System.Data.SqlTypes.SqlGuid param_EndNodeAccountId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_AgentCommissionSplitList_SelectDisplay SP_Parameter {
		...
		public override void Dispose() {
			...
			this.param_CurrentAccountId = System.Data.SqlTypes.SqlGuid.Null;
			this.param_EndNodeAccountId = System.Data.SqlTypes.SqlGuid.Null;
			if (this.param != null) {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_AgentCommissionSplitList_SelectDisplay class.
		/// </summary>
		public WebCheckBoxListCustom_spS_AgentCommissionSplitList_SelectDisplay() : base() {
		...
		/// You also need to supply the 'spS_AgentCommissionSplitList_SelectDisplay' stored procedure parameters.
		/// </summary>
		...
		/// <param name="param_CurrentAccountId">Value for the parameter @CurrentAccountId.</param>
		/// <param name="param_EndNodeAccountId">Value for the parameter @EndNodeAccountId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CurrentAccountId, System.Data.SqlTypes.SqlGuid param_EndNodeAccountId) {
			...
			this.param_CurrentAccountId = param_CurrentAccountId;
			this.param_EndNodeAccountId = param_EndNodeAccountId;
		}
		...
		/// <param name="param_CurrentAccountId">Value for the parameter @CurrentAccountId.</param>
		/// <param name="param_EndNodeAccountId">Value for the parameter @EndNodeAccountId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CurrentAccountId, System.Data.SqlTypes.SqlGuid param_EndNodeAccountId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_AgentCommissionSplitList_SelectDisplay";
		...
		/// <param name="param_CurrentAccountId">Value for the parameter @CurrentAccountId.</param>
		/// <param name="param_EndNodeAccountId">Value for the parameter @EndNodeAccountId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CurrentAccountId, System.Data.SqlTypes.SqlGuid param_EndNodeAccountId) {
		...
		/// <param name="param_CurrentAccountId">Value for the parameter @CurrentAccountId.</param>
		/// <param name="param_EndNodeAccountId">Value for the parameter @EndNodeAccountId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_CurrentAccountId, System.Data.SqlTypes.SqlGuid param_EndNodeAccountId) {
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_AgentCommissionSplitList_SelectDisplay();
			...
			if (!this.param_CurrentAccountId.IsNull) {

				this.param.Param_CurrentAccountId = this.param_CurrentAccountId;
			}


			if (!this.param_EndNodeAccountId.IsNull) {

				this.param.Param_EndNodeAccountId = this.param_EndNodeAccountId;
			}


			System.Data.DataSet DS = null;
			
			SPs.spS_AgentCommissionSplitList_SelectDisplay SP = new SPs.spS_AgentCommissionSplitList_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_AgentCommissionSplitList_SelectDisplay", "RefreshData");
			}
