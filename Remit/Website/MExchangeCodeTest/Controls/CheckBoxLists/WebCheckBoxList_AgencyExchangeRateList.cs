...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'AgencyExchangeRateList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:46", SqlObjectDependancyName="AgencyExchangeRateList", SqlObjectDependancyRevision=960)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_AgencyExchangeRateList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_AgencyExchangeRateList : System.Web.UI.WebControls.CheckBoxList {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_AgencyExchangeRateList class.
		/// </summary>
		public WebCheckBoxList_AgencyExchangeRateList() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Id, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_AgencyExchangeRateList : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
