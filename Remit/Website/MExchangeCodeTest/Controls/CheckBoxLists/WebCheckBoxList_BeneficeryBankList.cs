...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'BeneficeryBankList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:46", SqlObjectDependancyName="BeneficeryBankList", SqlObjectDependancyRevision=1008)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_BeneficeryBankList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_BeneficeryBankList : System.Web.UI.WebControls.CheckBoxList {
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_BeneficeryBankList class.
		/// </summary>
		public WebCheckBoxList_BeneficeryBankList() : base() {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Id, int startRecord, int maxRecords) {
			...
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_BeneficeryBankList : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
