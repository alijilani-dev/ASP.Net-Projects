...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_BankList' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:45", SqlObjectDependancyName="spS_BankList", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_BankList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_BankList : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_BankList param;
		...
		/// </summary>
		public Params.spS_BankList SP_Parameter {
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_BankList class.
		/// </summary>
		public WebCheckBoxListCustom_spS_BankList() : base() {
		...
		/// You also need to supply the 'spS_BankList' stored procedure parameters.
		/// </summary>
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_BankList();
			...
			SPs.spS_BankList SP = new SPs.spS_BankList();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_BankList", "RefreshData");
			}
