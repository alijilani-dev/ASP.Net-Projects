...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'CustomerList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:47", SqlObjectDependancyName="CustomerList", SqlObjectDependancyRevision=1984)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_CustomerList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_CustomerList : System.Web.UI.WebControls.CheckBoxList {

		private Params.spS_CustomerList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_CustomerList oAbstract_CustomerList;
		private System.Data.SqlTypes.SqlGuid FK_CardId = System.Data.SqlTypes.SqlGuid.Null;
		private System.Data.SqlTypes.SqlString FK_Nationality = System.Data.SqlTypes.SqlString.Null;
		...
		/// </summary>
		public Params.spS_CustomerList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'CustomerList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_CustomerList Abstract_CustomerList {

			get {

				return(this.oAbstract_CustomerList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_CustomerList = null;

			this.FK_CardId = System.Data.SqlTypes.SqlGuid.Null;
			this.FK_Nationality = System.Data.SqlTypes.SqlString.Null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_CustomerList class.
		/// </summary>
		public WebCheckBoxList_CustomerList() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_CardId, System.Data.SqlTypes.SqlString FK_Nationality) {
			...
			this.FK_Nationality = FK_Nationality;
		}
		...
		/// <param name="FK_CardId">Value for this foreign key.</param>
		/// <param name="FK_Nationality">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_CardId, System.Data.SqlTypes.SqlString FK_Nationality) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CustomerList_Display(true);
			...
			this.param.Param_CardId = this.FK_CardId;
			this.param.Param_Nationality = this.FK_Nationality;

			System.Data.DataSet DS = null;
			
			SPs.spS_CustomerList_Display SP = new SPs.spS_CustomerList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_CustomerList_Display"].DefaultView;
				this.DataValueField = SPs.spS_CustomerList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_CustomerList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_CustomerList : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the CustomerList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_CustomerList != null) {

					oAbstract_CustomerList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_CustomerList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_CustomerList = new Evernet.MoneyExchange.AbstractClasses.Abstract_CustomerList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_CustomerList = new Evernet.MoneyExchange.AbstractClasses.Abstract_CustomerList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_CustomerList.Refresh(PK_Id));
		}
	}
}
