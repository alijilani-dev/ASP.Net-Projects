...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_BankList_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:45", SqlObjectDependancyName="spS_BankList_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_BankList_SelectDisplay), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_BankList_SelectDisplay : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_BankList_SelectDisplay param;
		private System.Data.SqlTypes.SqlGuid param_Id = System.Data.SqlTypes.SqlGuid.Null;
		private System.Data.SqlTypes.SqlGuid param_AccountId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_BankList_SelectDisplay SP_Parameter {
		...
		public override void Dispose() {
			...
			this.param_AccountId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_BankList_SelectDisplay class.
		/// </summary>
		public WebCheckBoxListCustom_spS_BankList_SelectDisplay() : base() {
		...
		/// You also need to supply the 'spS_BankList_SelectDisplay' stored procedure parameters.
		/// </summary>
		...
		/// <param name="param_AccountId">Value for the parameter @AccountId.</param>
		/// <param name="param_LocationId">Value for the parameter @LocationId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AccountId, System.Data.SqlTypes.SqlGuid param_LocationId) {
			...
			this.param_AccountId = param_AccountId;
		...
		/// <param name="param_AccountId">Value for the parameter @AccountId.</param>
		/// <param name="param_LocationId">Value for the parameter @LocationId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AccountId, System.Data.SqlTypes.SqlGuid param_LocationId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_BankList_SelectDisplay";
		...
		/// <param name="param_AccountId">Value for the parameter @AccountId.</param>
		/// <param name="param_LocationId">Value for the parameter @LocationId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AccountId, System.Data.SqlTypes.SqlGuid param_LocationId) {
		...
		/// <param name="param_AccountId">Value for the parameter @AccountId.</param>
		/// <param name="param_LocationId">Value for the parameter @LocationId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_AccountId, System.Data.SqlTypes.SqlGuid param_LocationId) {
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_BankList_SelectDisplay();
			...
			if (!this.param_AccountId.IsNull) {

				this.param.Param_AccountId = this.param_AccountId;
			}
			...
			SPs.spS_BankList_SelectDisplay SP = new SPs.spS_BankList_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_BankList_SelectDisplay", "RefreshData");
			}
