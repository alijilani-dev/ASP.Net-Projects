...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// 'spS_LocationList_SelectDisplay' stored procedure.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:48:47", SqlObjectDependancyName="spS_LocationList_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxListCustom_spS_LocationList_SelectDisplay), "WebCheckBoxList.bmp")]
	public class WebCheckBoxListCustom_spS_LocationList_SelectDisplay : System.Web.UI.WebControls.CheckBoxList {

		private string valueMember;
		private string displayMember;
		private string tableName;
		private Params.spS_LocationList_SelectDisplay param;
		private System.Data.SqlTypes.SqlGuid param_Id = System.Data.SqlTypes.SqlGuid.Null;
		private System.Data.SqlTypes.SqlGuid param_ParentId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		public Params.spS_LocationList_SelectDisplay SP_Parameter {
		...
		public override void Dispose() {
			...
			this.param_ParentId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// <summary>
		/// Create a new instance of the WebCheckBoxListCustom_spS_LocationList_SelectDisplay class.
		/// </summary>
		public WebCheckBoxListCustom_spS_LocationList_SelectDisplay() : base() {
		...
		/// You also need to supply the 'spS_LocationList_SelectDisplay' stored procedure parameters.
		/// </summary>
		...
		/// <param name="param_ParentId">Value for the parameter @ParentId.</param>
		/// <param name="param_CountryId">Value for the parameter @CountryId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_ParentId, System.Data.SqlTypes.SqlGuid param_CountryId) {
			...
			this.param_ParentId = param_ParentId;
		...
		/// <param name="param_ParentId">Value for the parameter @ParentId.</param>
		/// <param name="param_CountryId">Value for the parameter @CountryId.</param>
		public void Initialize(string connectionString, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_ParentId, System.Data.SqlTypes.SqlGuid param_CountryId) {
			...
			this.valueMember = valueMember;
			this.displayMember = displayMember;
			this.tableName = "spS_LocationList_SelectDisplay";
		...
		/// <param name="param_ParentId">Value for the parameter @ParentId.</param>
		/// <param name="param_CountryId">Value for the parameter @CountryId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, string tableName, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_ParentId, System.Data.SqlTypes.SqlGuid param_CountryId) {
		...
		/// <param name="param_ParentId">Value for the parameter @ParentId.</param>
		/// <param name="param_CountryId">Value for the parameter @CountryId.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, string valueMember, string displayMember, System.Data.SqlTypes.SqlGuid param_Id, System.Data.SqlTypes.SqlGuid param_ParentId, System.Data.SqlTypes.SqlGuid param_CountryId) {
		...
		public void RefreshData(object[] ArrayOf_PrimaryKeys, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_LocationList_SelectDisplay();
			...
			if (!this.param_ParentId.IsNull) {

				this.param.Param_ParentId = this.param_ParentId;
			}
			...
			SPs.spS_LocationList_SelectDisplay SP = new SPs.spS_LocationList_SelectDisplay();
			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxListCustom_spS_LocationList_SelectDisplay", "RefreshData");
			}
