...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'UserRoleAssignmentList' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:47", SqlObjectDependancyName="UserRoleAssignmentList", SqlObjectDependancyRevision=432)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_UserRoleAssignmentList), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_UserRoleAssignmentList : System.Web.UI.WebControls.CheckBoxList {

		private Params.spS_UserRoleAssignmentList_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_UserRoleAssignmentList oAbstract_UserRoleAssignmentList;
		private System.Data.SqlTypes.SqlGuid FK_UserId = System.Data.SqlTypes.SqlGuid.Null;
		private System.Data.SqlTypes.SqlString FK_Role = System.Data.SqlTypes.SqlString.Null;
		...
		/// </summary>
		public Params.spS_UserRoleAssignmentList_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'UserRoleAssignmentList' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_UserRoleAssignmentList Abstract_UserRoleAssignmentList {

			get {

				return(this.oAbstract_UserRoleAssignmentList);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_UserRoleAssignmentList = null;

			this.FK_UserId = System.Data.SqlTypes.SqlGuid.Null;
			this.FK_Role = System.Data.SqlTypes.SqlString.Null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_UserRoleAssignmentList class.
		/// </summary>
		public WebCheckBoxList_UserRoleAssignmentList() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_UserId, System.Data.SqlTypes.SqlString FK_Role) {
		...
		/// <param name="FK_UserId">Value for this foreign key.</param>
		/// <param name="FK_Role">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_UserId, System.Data.SqlTypes.SqlString FK_Role) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_UserRoleAssignmentList_Display(true);
			...
			this.param.Param_Role = this.FK_Role;

			System.Data.DataSet DS = null;
			
			SPs.spS_UserRoleAssignmentList_Display SP = new SPs.spS_UserRoleAssignmentList_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_UserRoleAssignmentList_Display"].DefaultView;
				this.DataValueField = SPs.spS_UserRoleAssignmentList_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_UserRoleAssignmentList_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_UserRoleAssignmentList : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the UserRoleAssignmentList abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_UserRoleAssignmentList != null) {

					oAbstract_UserRoleAssignmentList.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_UserRoleAssignmentList == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_UserRoleAssignmentList = new Evernet.MoneyExchange.AbstractClasses.Abstract_UserRoleAssignmentList(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_UserRoleAssignmentList = new Evernet.MoneyExchange.AbstractClasses.Abstract_UserRoleAssignmentList(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_UserRoleAssignmentList.Refresh(PK_Id));
		}
	}
}
