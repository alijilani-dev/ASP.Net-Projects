...
namespace Evernet.MoneyExchange.Web.CheckBoxLists {
	...
	/// <summary>
	/// This class derives from System.Web.UI.WebControls.CheckBoxList class and was built to display the 'CommissionSlabMaster' table content.
	/// </summary>
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:46", SqlObjectDependancyName="CommissionSlabMaster", SqlObjectDependancyRevision=1520)]
#endif
	[System.Drawing.ToolboxBitmap(typeof(WebCheckBoxList_CommissionSlabMaster), "WebCheckBoxList.bmp")]
	public class WebCheckBoxList_CommissionSlabMaster : System.Web.UI.WebControls.CheckBoxList {

		private Params.spS_CommissionSlabMaster_Display param;
		private Evernet.MoneyExchange.AbstractClasses.Abstract_CommissionSlabMaster oAbstract_CommissionSlabMaster;
		private System.Data.SqlTypes.SqlGuid FK_PayInCountryId = System.Data.SqlTypes.SqlGuid.Null;
		private System.Data.SqlTypes.SqlGuid FK_PayOutCountryId = System.Data.SqlTypes.SqlGuid.Null;
		private System.Data.SqlTypes.SqlString FK_ModeOfPayment = System.Data.SqlTypes.SqlString.Null;
		private System.Data.SqlTypes.SqlString FK_PayInCommissionType = System.Data.SqlTypes.SqlString.Null;
		private System.Data.SqlTypes.SqlString FK_PayOutCommissionType = System.Data.SqlTypes.SqlString.Null;
		private System.Data.SqlTypes.SqlString FK_PayOutCurrencyType = System.Data.SqlTypes.SqlString.Null;
		...
		/// </summary>
		public Params.spS_CommissionSlabMaster_Display SP_Parameter {
		...
		/// <summary>
		/// Returns the 'CommissionSlabMaster' abstract class so that you can access any table
		...
		/// </summary>
		public Evernet.MoneyExchange.AbstractClasses.Abstract_CommissionSlabMaster Abstract_CommissionSlabMaster {

			get {

				return(this.oAbstract_CommissionSlabMaster);
			}
		}
		...
		public override void Dispose() {
			...
			this.oAbstract_CommissionSlabMaster = null;

			this.FK_PayInCountryId = System.Data.SqlTypes.SqlGuid.Null;
			this.FK_PayOutCountryId = System.Data.SqlTypes.SqlGuid.Null;
			this.FK_ModeOfPayment = System.Data.SqlTypes.SqlString.Null;
			this.FK_PayInCommissionType = System.Data.SqlTypes.SqlString.Null;
			this.FK_PayOutCommissionType = System.Data.SqlTypes.SqlString.Null;
			this.FK_PayOutCurrencyType = System.Data.SqlTypes.SqlString.Null;
		...
		/// <summary>
		/// Create a new instance of the Evernet.MoneyExchange.Web.CheckBoxLists.WebCheckBoxList_CommissionSlabMaster class.
		/// </summary>
		public WebCheckBoxList_CommissionSlabMaster() : base() {
		...
		public void Initialize(string connectionString, System.Data.SqlTypes.SqlGuid FK_PayInCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCountryId, System.Data.SqlTypes.SqlString FK_ModeOfPayment, System.Data.SqlTypes.SqlString FK_PayInCommissionType, System.Data.SqlTypes.SqlString FK_PayOutCommissionType, System.Data.SqlTypes.SqlString FK_PayOutCurrencyType) {
			...
			this.FK_PayInCountryId = FK_PayInCountryId;
			this.FK_PayOutCountryId = FK_PayOutCountryId;
			this.FK_ModeOfPayment = FK_ModeOfPayment;
			this.FK_PayInCommissionType = FK_PayInCommissionType;
			this.FK_PayOutCommissionType = FK_PayOutCommissionType;
			this.FK_PayOutCurrencyType = FK_PayOutCurrencyType;
		}
		...
		/// <param name="FK_PayOutCommissionType">Value for this foreign key.</param>
		/// <param name="FK_PayOutCurrencyType">Value for this foreign key.</param>
		public void Initialize(System.Data.SqlClient.SqlConnection sqlConnection, System.Data.SqlTypes.SqlGuid FK_PayInCountryId, System.Data.SqlTypes.SqlGuid FK_PayOutCountryId, System.Data.SqlTypes.SqlString FK_ModeOfPayment, System.Data.SqlTypes.SqlString FK_PayInCommissionType, System.Data.SqlTypes.SqlString FK_PayOutCommissionType, System.Data.SqlTypes.SqlString FK_PayOutCurrencyType) {
		...
		public void RefreshData(System.Data.SqlTypes.SqlGuid[] ArrayOf_PK_Id, int startRecord, int maxRecords) {
			...
			this.param = new Params.spS_CommissionSlabMaster_Display(true);
			...
			this.param.Param_PayInCountryId = this.FK_PayInCountryId;
			this.param.Param_PayOutCountryId = this.FK_PayOutCountryId;
			this.param.Param_ModeOfPayment = this.FK_ModeOfPayment;
			this.param.Param_PayInCommissionType = this.FK_PayInCommissionType;
			this.param.Param_PayOutCommissionType = this.FK_PayOutCommissionType;
			this.param.Param_PayOutCurrencyType = this.FK_PayOutCurrencyType;

			System.Data.DataSet DS = null;
			
			SPs.spS_CommissionSlabMaster_Display SP = new SPs.spS_CommissionSlabMaster_Display(false);

			if (SP.Execute(ref this.param, ref DS, startRecord, maxRecords)) {

				this.DataSource = DS.Tables["spS_CommissionSlabMaster_Display"].DefaultView;
				this.DataValueField = SPs.spS_CommissionSlabMaster_Display.Resultset1.Fields.Column_ID1.ColumnName;
				this.DataTextField = SPs.spS_CommissionSlabMaster_Display.Resultset1.Fields.Column_Display.ColumnName;
				...
				SP.Dispose();
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.param, "WebCheckBoxList_CommissionSlabMaster : System.Web.UI.WebControls.CheckBoxList", "RefreshData");
			}
		...
		/// <summary>
		/// Loads the CommissionSlabMaster abstract class for the current selected record primary key.
		/// </summary>
		...
		public bool RefreshCurrentRecord() {
			...
			if (this.SelectedIndex == -1) {
				...
				if (oAbstract_CommissionSlabMaster != null) {

					oAbstract_CommissionSlabMaster.Reset();
				}
				return(false);
			}
			...
			if (this.oAbstract_CommissionSlabMaster == null) {

				switch (this.LastKnownConnectionType) {

					case Evernet.MoneyExchange.DataClasses.ConnectionType.ConnectionString:
							this.oAbstract_CommissionSlabMaster = new Evernet.MoneyExchange.AbstractClasses.Abstract_CommissionSlabMaster(this.connectionString);
						break;

					case Evernet.MoneyExchange.DataClasses.ConnectionType.SqlConnection:
							this.oAbstract_CommissionSlabMaster = new Evernet.MoneyExchange.AbstractClasses.Abstract_CommissionSlabMaster(this.sqlConnection);
						break;
				}
			}

			return(this.oAbstract_CommissionSlabMaster.Refresh(PK_Id));
		}
	}
}
