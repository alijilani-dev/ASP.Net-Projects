...
namespace Evernet.MoneyExchange.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [AgentAccountDetails] table.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:31", SqlObjectDependancyName="AgentAccountDetails", SqlObjectDependancyRevision=736)]
#endif
	public class Abstract_AgentAccountDetails {

		Params.spS_AgentAccountDetails Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_AgentAccountDetails class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_AgentAccountDetails(string connectionString) {
			...
			this.Param = new Params.spS_AgentAccountDetails(true);
		...
		public Abstract_AgentAccountDetails(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_AgentAccountDetails(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [AgentAccountDetails] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlGuid col_Id) {
			...
			SPs.spS_AgentAccountDetails SP = new SPs.spS_AgentAccountDetails(false);
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_AgentAccountDetails.Resultset1.Fields.Column_CreditDateTime.ColumnIndex)) {

						this.col_CreditDateTime = DR.GetSqlDateTime(SPs.spS_AgentAccountDetails.Resultset1.Fields.Column_CreditDateTime.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AgentAccountDetails.Resultset1.Fields.Column_DebitDateTime.ColumnIndex)) {

						this.col_DebitDateTime = DR.GetSqlDateTime(SPs.spS_AgentAccountDetails.Resultset1.Fields.Column_DebitDateTime.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AgentAccountDetails.Resultset1.Fields.Column_AgentAccountId.ColumnIndex)) {

						this.col_AgentAccountId = DR.GetSqlGuid(SPs.spS_AgentAccountDetails.Resultset1.Fields.Column_AgentAccountId.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AgentAccountDetails.Resultset1.Fields.Column_TransactionId.ColumnIndex)) {

						this.col_TransactionId = DR.GetSqlGuid(SPs.spS_AgentAccountDetails.Resultset1.Fields.Column_TransactionId.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AgentAccountDetails.Resultset1.Fields.Column_CreditLC.ColumnIndex)) {

						this.col_CreditLC = DR.GetSqlDecimal(SPs.spS_AgentAccountDetails.Resultset1.Fields.Column_CreditLC.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AgentAccountDetails.Resultset1.Fields.Column_CreditUSD.ColumnIndex)) {

						this.col_CreditUSD = DR.GetSqlDecimal(SPs.spS_AgentAccountDetails.Resultset1.Fields.Column_CreditUSD.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AgentAccountDetails.Resultset1.Fields.Column_DebitLC.ColumnIndex)) {

						this.col_DebitLC = DR.GetSqlDecimal(SPs.spS_AgentAccountDetails.Resultset1.Fields.Column_DebitLC.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_AgentAccountDetails.Resultset1.Fields.Column_DebitUSD.ColumnIndex)) {

						this.col_DebitUSD = DR.GetSqlDecimal(SPs.spS_AgentAccountDetails.Resultset1.Fields.Column_DebitUSD.ColumnIndex);
					}
				...
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.Param, "Evernet.MoneyExchange.AbstractClasses.Abstract_AgentAccountDetails", "Refresh");
			}
		}
	}
}
