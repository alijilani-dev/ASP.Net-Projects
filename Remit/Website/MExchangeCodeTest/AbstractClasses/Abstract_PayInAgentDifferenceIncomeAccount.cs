...
namespace Evernet.MoneyExchange.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [PayInAgentDifferenceIncomeAccount] table.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:32", SqlObjectDependancyName="PayInAgentDifferenceIncomeAccount", SqlObjectDependancyRevision=736)]
#endif
	public class Abstract_PayInAgentDifferenceIncomeAccount {

		Params.spS_PayInAgentDifferenceIncomeAccount Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_PayInAgentDifferenceIncomeAccount class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_PayInAgentDifferenceIncomeAccount(string connectionString) {
			...
			this.Param = new Params.spS_PayInAgentDifferenceIncomeAccount(true);
		...
		public Abstract_PayInAgentDifferenceIncomeAccount(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_PayInAgentDifferenceIncomeAccount(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		private System.Data.SqlTypes.SqlGuid col_TranasctionId;
		/// <summary>
		/// Returns the value of the TranasctionId column.
		/// More info on this column: Update this description in the &quot;Olymars/Description&quot; extended property of the &quot;TranasctionId&quot; column.
		/// </summary>
		public System.Data.SqlTypes.SqlGuid Col_TranasctionId {

			get {

				return (this.col_TranasctionId);
			}
		}
		...
		public void Reset() {
			...
			this.col_TranasctionId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// <summary>
		/// Allows you to load a specific record of the [PayInAgentDifferenceIncomeAccount] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlGuid col_Id) {
			...
			SPs.spS_PayInAgentDifferenceIncomeAccount SP = new SPs.spS_PayInAgentDifferenceIncomeAccount(false);
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_PayInAgentDifferenceIncomeAccount.Resultset1.Fields.Column_CreditDateTime.ColumnIndex)) {

						this.col_CreditDateTime = DR.GetSqlDateTime(SPs.spS_PayInAgentDifferenceIncomeAccount.Resultset1.Fields.Column_CreditDateTime.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_PayInAgentDifferenceIncomeAccount.Resultset1.Fields.Column_DebitDateTime.ColumnIndex)) {

						this.col_DebitDateTime = DR.GetSqlDateTime(SPs.spS_PayInAgentDifferenceIncomeAccount.Resultset1.Fields.Column_DebitDateTime.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_PayInAgentDifferenceIncomeAccount.Resultset1.Fields.Column_AgentAccountId.ColumnIndex)) {

						this.col_AgentAccountId = DR.GetSqlGuid(SPs.spS_PayInAgentDifferenceIncomeAccount.Resultset1.Fields.Column_AgentAccountId.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_PayInAgentDifferenceIncomeAccount.Resultset1.Fields.Column_TranasctionId.ColumnIndex)) {

						this.col_TranasctionId = DR.GetSqlGuid(SPs.spS_PayInAgentDifferenceIncomeAccount.Resultset1.Fields.Column_TranasctionId.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_PayInAgentDifferenceIncomeAccount.Resultset1.Fields.Column_CreditLC.ColumnIndex)) {

						this.col_CreditLC = DR.GetSqlMoney(SPs.spS_PayInAgentDifferenceIncomeAccount.Resultset1.Fields.Column_CreditLC.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_PayInAgentDifferenceIncomeAccount.Resultset1.Fields.Column_CreditUSD.ColumnIndex)) {

						this.col_CreditUSD = DR.GetSqlMoney(SPs.spS_PayInAgentDifferenceIncomeAccount.Resultset1.Fields.Column_CreditUSD.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_PayInAgentDifferenceIncomeAccount.Resultset1.Fields.Column_DebitLC.ColumnIndex)) {

						this.col_DebitLC = DR.GetSqlMoney(SPs.spS_PayInAgentDifferenceIncomeAccount.Resultset1.Fields.Column_DebitLC.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_PayInAgentDifferenceIncomeAccount.Resultset1.Fields.Column_DebitUSD.ColumnIndex)) {

						this.col_DebitUSD = DR.GetSqlMoney(SPs.spS_PayInAgentDifferenceIncomeAccount.Resultset1.Fields.Column_DebitUSD.ColumnIndex);
					}
				...
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.Param, "Evernet.MoneyExchange.AbstractClasses.Abstract_PayInAgentDifferenceIncomeAccount", "Refresh");
			}
		}
	}
}
