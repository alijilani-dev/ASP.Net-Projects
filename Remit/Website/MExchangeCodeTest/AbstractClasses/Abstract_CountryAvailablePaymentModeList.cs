...
namespace Evernet.MoneyExchange.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [CountryAvailablePaymentModeList] table.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:31", SqlObjectDependancyName="CountryAvailablePaymentModeList", SqlObjectDependancyRevision=432)]
#endif
	public class Abstract_CountryAvailablePaymentModeList {

		Params.spS_CountryAvailablePaymentModeList Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_CountryAvailablePaymentModeList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_CountryAvailablePaymentModeList(string connectionString) {
		...
		public Abstract_CountryAvailablePaymentModeList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_CountryAvailablePaymentModeList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [CountryAvailablePaymentModeList] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlGuid col_Id) {
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_CountryAvailablePaymentModeList.Resultset1.Fields.Column_CountryId.ColumnIndex)) {

						this.col_CountryId = DR.GetSqlGuid(SPs.spS_CountryAvailablePaymentModeList.Resultset1.Fields.Column_CountryId.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_CountryAvailablePaymentModeList.Resultset1.Fields.Column_PaymentMode.ColumnIndex)) {

						this.col_PaymentMode = DR.GetSqlString(SPs.spS_CountryAvailablePaymentModeList.Resultset1.Fields.Column_PaymentMode.ColumnIndex);
					}
				...
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.Param, "Evernet.MoneyExchange.AbstractClasses.Abstract_CountryAvailablePaymentModeList", "Refresh");
			}
		}
	}
}
