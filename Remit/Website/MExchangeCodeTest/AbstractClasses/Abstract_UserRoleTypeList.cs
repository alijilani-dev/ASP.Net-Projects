...
namespace Evernet.MoneyExchange.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [UserRoleTypeList] table.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:32", SqlObjectDependancyName="UserRoleTypeList", SqlObjectDependancyRevision=272)]
#endif
	public class Abstract_UserRoleTypeList {

		Params.spS_UserRoleTypeList Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_UserRoleTypeList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_UserRoleTypeList(string connectionString) {
		...
		public Abstract_UserRoleTypeList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_UserRoleTypeList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [UserRoleTypeList] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlString col_Value) {
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_UserRoleTypeList.Resultset1.Fields.Column_Name.ColumnIndex)) {

						this.col_Name = DR.GetSqlString(SPs.spS_UserRoleTypeList.Resultset1.Fields.Column_Name.ColumnIndex);
					}
				...
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.Param, "Evernet.MoneyExchange.AbstractClasses.Abstract_UserRoleTypeList", "Refresh");
			}
		}
	}
}
