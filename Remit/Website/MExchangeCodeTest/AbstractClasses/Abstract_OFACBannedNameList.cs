...
namespace Evernet.MoneyExchange.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [OFACBannedNameList] table.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:32", SqlObjectDependancyName="OFACBannedNameList", SqlObjectDependancyRevision=352)]
#endif
	public class Abstract_OFACBannedNameList {

		Params.spS_OFACBannedNameList Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_OFACBannedNameList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_OFACBannedNameList(string connectionString) {
			...
			this.Param = new Params.spS_OFACBannedNameList(true);
		...
		public Abstract_OFACBannedNameList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_OFACBannedNameList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [OFACBannedNameList] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlGuid col_Id) {
			...
			SPs.spS_OFACBannedNameList SP = new SPs.spS_OFACBannedNameList(false);
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_OFACBannedNameList.Resultset1.Fields.Column_Name.ColumnIndex)) {

						this.col_Name = DR.GetSqlString(SPs.spS_OFACBannedNameList.Resultset1.Fields.Column_Name.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_OFACBannedNameList.Resultset1.Fields.Column_Active.ColumnIndex)) {

						this.col_Active = DR.GetSqlBoolean(SPs.spS_OFACBannedNameList.Resultset1.Fields.Column_Active.ColumnIndex);
					}
				...
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.Param, "Evernet.MoneyExchange.AbstractClasses.Abstract_OFACBannedNameList", "Refresh");
			}
		}
	}
}
