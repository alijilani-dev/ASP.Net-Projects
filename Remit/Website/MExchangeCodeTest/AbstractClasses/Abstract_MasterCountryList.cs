...
namespace Evernet.MoneyExchange.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [MasterCountryList] table.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:32", SqlObjectDependancyName="MasterCountryList", SqlObjectDependancyRevision=208)]
#endif
	public class Abstract_MasterCountryList {

		Params.spS_MasterCountryList Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_MasterCountryList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_MasterCountryList(string connectionString) {
		...
		public Abstract_MasterCountryList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_MasterCountryList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [MasterCountryList] table.
		/// </summary>
		/// <param name="col_Code">Update this description in the &quot;Olymars/Description&quot; extended property of the &quot;Code&quot; column.</param>
		public bool Refresh(System.Data.SqlTypes.SqlString col_Code) {
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_MasterCountryList.Resultset1.Fields.Column_Name.ColumnIndex)) {

						this.col_Name = DR.GetSqlString(SPs.spS_MasterCountryList.Resultset1.Fields.Column_Name.ColumnIndex);
					}
				...
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.Param, "Evernet.MoneyExchange.AbstractClasses.Abstract_MasterCountryList", "Refresh");
			}
		}
	}
}
