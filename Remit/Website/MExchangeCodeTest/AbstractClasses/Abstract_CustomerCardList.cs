...
namespace Evernet.MoneyExchange.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [CustomerCardList] table.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:31", SqlObjectDependancyName="CustomerCardList", SqlObjectDependancyRevision=576)]
#endif
	public class Abstract_CustomerCardList {

		Params.spS_CustomerCardList Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_CustomerCardList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_CustomerCardList(string connectionString) {
		...
		public Abstract_CustomerCardList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_CustomerCardList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [CustomerCardList] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlGuid col_Id) {
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_CustomerCardList.Resultset1.Fields.Column_Code.ColumnIndex)) {

						this.col_Code = DR.GetSqlString(SPs.spS_CustomerCardList.Resultset1.Fields.Column_Code.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_CustomerCardList.Resultset1.Fields.Column_AgentId.ColumnIndex)) {

						this.col_AgentId = DR.GetSqlGuid(SPs.spS_CustomerCardList.Resultset1.Fields.Column_AgentId.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_CustomerCardList.Resultset1.Fields.Column_Status.ColumnIndex)) {

						this.col_Status = DR.GetSqlString(SPs.spS_CustomerCardList.Resultset1.Fields.Column_Status.ColumnIndex);
					}
				...
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.Param, "Evernet.MoneyExchange.AbstractClasses.Abstract_CustomerCardList", "Refresh");
			}
		}
	}
}
