...
namespace Evernet.MoneyExchange.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [TransitionAccountDetails] table.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:32", SqlObjectDependancyName="TransitionAccountDetails", SqlObjectDependancyRevision=1264)]
#endif
	public class Abstract_TransitionAccountDetails {

		Params.spS_TransitionAccountDetails Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_TransitionAccountDetails class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_TransitionAccountDetails(string connectionString) {
			...
			this.Param = new Params.spS_TransitionAccountDetails(true);
		...
		public Abstract_TransitionAccountDetails(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_TransitionAccountDetails(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [TransitionAccountDetails] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlGuid col_Id) {
			...
			SPs.spS_TransitionAccountDetails SP = new SPs.spS_TransitionAccountDetails(false);
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_CreditDateTime.ColumnIndex)) {

						this.col_CreditDateTime = DR.GetSqlDateTime(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_CreditDateTime.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_DebitDateTime.ColumnIndex)) {

						this.col_DebitDateTime = DR.GetSqlDateTime(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_DebitDateTime.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_TransactionId.ColumnIndex)) {

						this.col_TransactionId = DR.GetSqlGuid(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_TransactionId.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_CreditLC.ColumnIndex)) {

						this.col_CreditLC = DR.GetSqlDecimal(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_CreditLC.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_CreditUSD.ColumnIndex)) {

						this.col_CreditUSD = DR.GetSqlDecimal(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_CreditUSD.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_DebitLC.ColumnIndex)) {

						this.col_DebitLC = DR.GetSqlDecimal(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_DebitLC.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_DebitUSD.ColumnIndex)) {

						this.col_DebitUSD = DR.GetSqlDecimal(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_DebitUSD.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_CommissionCreditLC.ColumnIndex)) {

						this.col_CommissionCreditLC = DR.GetSqlDecimal(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_CommissionCreditLC.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_CommissionCreditUSD.ColumnIndex)) {

						this.col_CommissionCreditUSD = DR.GetSqlDecimal(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_CommissionCreditUSD.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_CommissionDebitLC.ColumnIndex)) {

						this.col_CommissionDebitLC = DR.GetSqlDecimal(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_CommissionDebitLC.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_CommissionDebitUSD.ColumnIndex)) {

						this.col_CommissionDebitUSD = DR.GetSqlDecimal(SPs.spS_TransitionAccountDetails.Resultset1.Fields.Column_CommissionDebitUSD.ColumnIndex);
					}
				...
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.Param, "Evernet.MoneyExchange.AbstractClasses.Abstract_TransitionAccountDetails", "Refresh");
			}
		}
	}
}
