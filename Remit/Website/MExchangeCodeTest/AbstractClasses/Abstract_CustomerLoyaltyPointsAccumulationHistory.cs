...
namespace Evernet.MoneyExchange.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [CustomerLoyaltyPointsAccumulationHistory] table.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:31", SqlObjectDependancyName="CustomerLoyaltyPointsAccumulationHistory", SqlObjectDependancyRevision=640)]
#endif
	public class Abstract_CustomerLoyaltyPointsAccumulationHistory {

		Params.spS_CustomerLoyaltyPointsAccumulationHistory Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_CustomerLoyaltyPointsAccumulationHistory class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_CustomerLoyaltyPointsAccumulationHistory(string connectionString) {
		...
		public Abstract_CustomerLoyaltyPointsAccumulationHistory(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_CustomerLoyaltyPointsAccumulationHistory(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [CustomerLoyaltyPointsAccumulationHistory] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlGuid col_Id) {
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_CustomerLoyaltyPointsAccumulationHistory.Resultset1.Fields.Column_Date.ColumnIndex)) {

						this.col_Date = DR.GetSqlDateTime(SPs.spS_CustomerLoyaltyPointsAccumulationHistory.Resultset1.Fields.Column_Date.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_CustomerLoyaltyPointsAccumulationHistory.Resultset1.Fields.Column_CustomerId.ColumnIndex)) {

						this.col_CustomerId = DR.GetSqlGuid(SPs.spS_CustomerLoyaltyPointsAccumulationHistory.Resultset1.Fields.Column_CustomerId.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_CustomerLoyaltyPointsAccumulationHistory.Resultset1.Fields.Column_TransactionId.ColumnIndex)) {

						this.col_TransactionId = DR.GetSqlGuid(SPs.spS_CustomerLoyaltyPointsAccumulationHistory.Resultset1.Fields.Column_TransactionId.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_CustomerLoyaltyPointsAccumulationHistory.Resultset1.Fields.Column_Points.ColumnIndex)) {

						this.col_Points = DR.GetSqlMoney(SPs.spS_CustomerLoyaltyPointsAccumulationHistory.Resultset1.Fields.Column_Points.ColumnIndex);
					}
				...
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.Param, "Evernet.MoneyExchange.AbstractClasses.Abstract_CustomerLoyaltyPointsAccumulationHistory", "Refresh");
			}
		}
	}
}
