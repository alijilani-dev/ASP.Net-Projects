...
namespace Evernet.MoneyExchange.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [CommissionSplitTypeList] table.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:31", SqlObjectDependancyName="CommissionSplitTypeList", SqlObjectDependancyRevision=224)]
#endif
	public class Abstract_CommissionSplitTypeList {

		Params.spS_CommissionSplitTypeList Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_CommissionSplitTypeList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_CommissionSplitTypeList(string connectionString) {
		...
		public Abstract_CommissionSplitTypeList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_CommissionSplitTypeList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [CommissionSplitTypeList] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlString col_Value) {
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_CommissionSplitTypeList.Resultset1.Fields.Column_Name.ColumnIndex)) {

						this.col_Name = DR.GetSqlString(SPs.spS_CommissionSplitTypeList.Resultset1.Fields.Column_Name.ColumnIndex);
					}
				...
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.Param, "Evernet.MoneyExchange.AbstractClasses.Abstract_CommissionSplitTypeList", "Refresh");
			}
		}
	}
}
