...
namespace Evernet.MoneyExchange.AbstractClasses {
	...
	/// <summary>
	/// This class allows you to very easily retrieve a record from the [ProductsList] table.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[Evernet.MoneyExchange.DataClasses.OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:32", SqlObjectDependancyName="ProductsList", SqlObjectDependancyRevision=272)]
#endif
	public class Abstract_ProductsList {

		Params.spS_ProductsList Param;
		private bool CloseConnectionAfterUse = true;

		/// <summary>
		/// Create a new instance of the Abstract_ProductsList class.
		/// </summary>
		/// <param name="connectionString">A valid connection string to the database.</param>
		public Abstract_ProductsList(string connectionString) {
		...
		public Abstract_ProductsList(System.Data.SqlClient.SqlConnection sqlConnection) {
		...
		public Abstract_ProductsList(System.Data.SqlClient.SqlTransaction sqlTransaction) {
		...
		/// <summary>
		/// Allows you to load a specific record of the [ProductsList] table.
		/// </summary>
		...
		public bool Refresh(System.Data.SqlTypes.SqlGuid col_Id) {
			...
			if (SP.Execute(ref this.Param, out DR)) {
				...
				if (DR.Read()) {
					...
					if (!DR.IsDBNull(SPs.spS_ProductsList.Resultset1.Fields.Column_Name.ColumnIndex)) {

						this.col_Name = DR.GetSqlString(SPs.spS_ProductsList.Resultset1.Fields.Column_Name.ColumnIndex);
					}

					if (!DR.IsDBNull(SPs.spS_ProductsList.Resultset1.Fields.Column_Points.ColumnIndex)) {

						this.col_Points = DR.GetSqlMoney(SPs.spS_ProductsList.Resultset1.Fields.Column_Points.ColumnIndex);
					}
				...
				throw new Evernet.MoneyExchange.DataClasses.CustomException(this.Param, "Evernet.MoneyExchange.AbstractClasses.Abstract_ProductsList", "Refresh");
			}
		}
	}
}
