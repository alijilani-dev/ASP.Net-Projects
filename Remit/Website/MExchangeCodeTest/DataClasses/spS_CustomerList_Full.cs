/*
	This C# source code was automatically generated using:
		...
		SQL Server Centric .NET Code Generator
			...
			Generation Date: 11/30/2004 11:46:57 PM
...
namespace Evernet.MoneyExchange.DataClasses.Parameters {
	...
	/// stored procedure 'spS_CustomerList_Full'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:46:57", SqlObjectDependancyName="spS_CustomerList_Full", SqlObjectDependancyRevision=0)]
#endif
	public class spS_CustomerList_Full : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spS_CustomerList_Full class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spS_CustomerList_Full() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spS_CustomerList_Full class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spS_CustomerList_Full(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spS_CustomerList_Full'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spS_CustomerList_Full", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		/// </summary>
		~spS_CustomerList_Full() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spS_CustomerList_Full'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spS_CustomerList_Full");
			}
		}
...
namespace Evernet.MoneyExchange.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spS_CustomerList_Full' stored procedure;
	...
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:46:57", SqlObjectDependancyName="spS_CustomerList_Full", SqlObjectDependancyRevision=0)]
#endif
	public class spS_CustomerList_Full : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spS_CustomerList_Full() : this(false) {
		...
		public spS_CustomerList_Full(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_CustomerList_Full parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_CustomerList_Full parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_CustomerList_Full object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_CustomerList_Full object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_CustomerList_Full object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.DataClasses.Parameters.spS_CustomerList_Full)");
						}
				...
				sqlCommand.CommandText = "spS_CustomerList_Full";
		...
		private bool DeclareParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_CustomerList_Full parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_CustomerList_Full parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spS_CustomerList_Full] stored procedure and retrieve back the data
		...
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_CustomerList_Full parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_CustomerList_Full parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'spS_CustomerList_Full'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_CustomerList_Full parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "spS_CustomerList_Full", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_CustomerList_Full parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "spS_CustomerList_Full", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_CustomerList_Full parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_CustomerList_Full parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
			...
			try {
				...
				dataset.Tables[tableName].Columns["Password"].Caption = "Password";
				dataset.Tables[tableName].Columns["FirstName"].Caption = "FirstName";
				dataset.Tables[tableName].Columns["LastName"].Caption = "LastName";
				dataset.Tables[tableName].Columns["CardId"].Caption = "Card";
				...
				dataset.Tables[tableName].Columns["Mobile"].Caption = "Mobile";
				dataset.Tables[tableName].Columns["Email"].Caption = "Email";
				dataset.Tables[tableName].Columns["IDType"].Caption = "IDType";
				dataset.Tables[tableName].Columns["IDDetails"].Caption = "IDDetails";
				dataset.Tables[tableName].Columns["IDExpirationDate"].Caption = "IDExpirationDate";
				dataset.Tables[tableName].Columns["Nationality"].Caption = "Nationality";
				dataset.Tables[tableName].Columns["Active"].Caption = "Active";
				dataset.Tables[tableName].Columns["AccountActivated"].Caption = "AccountActivated";
				dataset.Tables[tableName].Columns["CardIssued"].Caption = "CardIssued";
				dataset.Tables[tableName].Columns["CardId_Id"].Caption = "Id (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Id\" column)";
				dataset.Tables[tableName].Columns["CardId_Code"].Caption = "Code";
				dataset.Tables[tableName].Columns["CardId_AgentId"].Caption = "AgentId";
				dataset.Tables[tableName].Columns["CardId_Status"].Caption = "Status";
				dataset.Tables[tableName].Columns["Nationality_Name"].Caption = "Name (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Name\" column)";
				dataset.Tables[tableName].Columns["Nationality_Code"].Caption = "Code (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Code\" column)";
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_CustomerList_Full parameters, ref string xml) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_CustomerList_Full parameters, out System.Xml.XmlReader xmlReader) {
		...
		/// the Execute method of the 'spS_CustomerList_Full' class.
		/// </summary>
		public class Resultset1 {
			...
			public class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field FirstName via shared members
				/// </summary>
				public class Column_FirstName {

					/// <summary>
					/// Returns "FirstName"
					/// </summary>
					public const System.String ColumnName = "FirstName";
					/// <summary>
					/// Returns 3
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field LastName via shared members
				/// </summary>
				public class Column_LastName {

					/// <summary>
					/// Returns "LastName"
					/// </summary>
					public const System.String ColumnName = "LastName";
					/// <summary>
					/// Returns 4
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CardId via shared members
				/// </summary>
				public class Column_CardId {

					/// <summary>
					/// Returns "CardId"
					/// </summary>
					public const System.String ColumnName = "CardId";
					/// <summary>
					/// Returns 5
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Mobile via shared members
				/// </summary>
				public class Column_Mobile {

					/// <summary>
					/// Returns "Mobile"
					/// </summary>
					public const System.String ColumnName = "Mobile";
					/// <summary>
					/// Returns 9
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field IDType via shared members
				/// </summary>
				public class Column_IDType {

					/// <summary>
					/// Returns "IDType"
					/// </summary>
					public const System.String ColumnName = "IDType";
					/// <summary>
					/// Returns 11
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field IDDetails via shared members
				/// </summary>
				public class Column_IDDetails {

					/// <summary>
					/// Returns "IDDetails"
					/// </summary>
					public const System.String ColumnName = "IDDetails";
					/// <summary>
					/// Returns 12
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field IDExpirationDate via shared members
				/// </summary>
				public class Column_IDExpirationDate {

					/// <summary>
					/// Returns "IDExpirationDate"
					/// </summary>
					public const System.String ColumnName = "IDExpirationDate";
					/// <summary>
					/// Returns 13
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Nationality via shared members
				/// </summary>
				public class Column_Nationality {

					/// <summary>
					/// Returns "Nationality"
					/// </summary>
					public const System.String ColumnName = "Nationality";
					/// <summary>
					/// Returns 14
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AccountActivated via shared members
				/// </summary>
				public class Column_AccountActivated {

					/// <summary>
					/// Returns "AccountActivated"
					/// </summary>
					public const System.String ColumnName = "AccountActivated";
					/// <summary>
					/// Returns 16
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CardIssued via shared members
				/// </summary>
				public class Column_CardIssued {

					/// <summary>
					/// Returns "CardIssued"
					/// </summary>
					public const System.String ColumnName = "CardIssued";
					/// <summary>
					/// Returns 17
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CardId_Id via shared members
				/// </summary>
				public class Column_CardId_Id {

					/// <summary>
					/// Returns "CardId_Id"
					/// </summary>
					public const System.String ColumnName = "CardId_Id";
					/// <summary>
					/// Returns 18
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CardId_Code via shared members
				/// </summary>
				public class Column_CardId_Code {

					/// <summary>
					/// Returns "CardId_Code"
					/// </summary>
					public const System.String ColumnName = "CardId_Code";
					/// <summary>
					/// Returns 19
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CardId_AgentId via shared members
				/// </summary>
				public class Column_CardId_AgentId {

					/// <summary>
					/// Returns "CardId_AgentId"
					/// </summary>
					public const System.String ColumnName = "CardId_AgentId";
					/// <summary>
					/// Returns 20
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CardId_Status via shared members
				/// </summary>
				public class Column_CardId_Status {

					/// <summary>
					/// Returns "CardId_Status"
					/// </summary>
					public const System.String ColumnName = "CardId_Status";
					/// <summary>
					/// Returns 21
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Nationality_Name via shared members
				/// </summary>
				public class Column_Nationality_Name {

					/// <summary>
					/// Returns "Nationality_Name"
					/// </summary>
					public const System.String ColumnName = "Nationality_Name";
					/// <summary>
					/// Returns 22
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Nationality_Code via shared members
				/// </summary>
				public class Column_Nationality_Code {

					/// <summary>
					/// Returns "Nationality_Code"
					/// </summary>
					public const System.String ColumnName = "Nationality_Code";
					/// <summary>
					/// Returns 23
					/// </summary>
