...
namespace Evernet.MoneyExchange.DataClasses.Parameters {
	...
	/// stored procedure 'spS_AgentCommissionIncomeAccount_Full'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:46:52", SqlObjectDependancyName="spS_AgentCommissionIncomeAccount_Full", SqlObjectDependancyRevision=0)]
#endif
	public class spS_AgentCommissionIncomeAccount_Full : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spS_AgentCommissionIncomeAccount_Full class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spS_AgentCommissionIncomeAccount_Full() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spS_AgentCommissionIncomeAccount_Full class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spS_AgentCommissionIncomeAccount_Full(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spS_AgentCommissionIncomeAccount_Full'";
		...
		/// </summary>
		~spS_AgentCommissionIncomeAccount_Full() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spS_AgentCommissionIncomeAccount_Full'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spS_AgentCommissionIncomeAccount_Full");
			}
		}
...
namespace Evernet.MoneyExchange.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spS_AgentCommissionIncomeAccount_Full' stored procedure;
	...
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:46:52", SqlObjectDependancyName="spS_AgentCommissionIncomeAccount_Full", SqlObjectDependancyRevision=0)]
#endif
	public class spS_AgentCommissionIncomeAccount_Full : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spS_AgentCommissionIncomeAccount_Full() : this(false) {
		...
		public spS_AgentCommissionIncomeAccount_Full(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentCommissionIncomeAccount_Full parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentCommissionIncomeAccount_Full parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentCommissionIncomeAccount_Full object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentCommissionIncomeAccount_Full object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentCommissionIncomeAccount_Full object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentCommissionIncomeAccount_Full)");
						}
				...
				sqlCommand.CommandText = "spS_AgentCommissionIncomeAccount_Full";
		...
		private bool DeclareParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentCommissionIncomeAccount_Full parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentCommissionIncomeAccount_Full parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spS_AgentCommissionIncomeAccount_Full] stored procedure and retrieve back the data
		...
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentCommissionIncomeAccount_Full parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentCommissionIncomeAccount_Full parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'spS_AgentCommissionIncomeAccount_Full'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentCommissionIncomeAccount_Full parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "spS_AgentCommissionIncomeAccount_Full", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentCommissionIncomeAccount_Full parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "spS_AgentCommissionIncomeAccount_Full", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentCommissionIncomeAccount_Full parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentCommissionIncomeAccount_Full parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
			...
			try {
				...
				dataset.Tables[tableName].Columns["CommissionCreditLC"].Caption = "CommissionCreditLC (update this label in the \"Olymars/ColumnLabel\" extended property of the \"CommissionCreditLC\" column)";
				dataset.Tables[tableName].Columns["CommissionCreditUSD"].Caption = "CommissionCreditUSD (update this label in the \"Olymars/ColumnLabel\" extended property of the \"CommissionCreditUSD\" column)";
				dataset.Tables[tableName].Columns["CommissionDebitLC"].Caption = "CommissionDebitLC (update this label in the \"Olymars/ColumnLabel\" extended property of the \"CommissionDebitLC\" column)";
				dataset.Tables[tableName].Columns["CommissionDebitUSD"].Caption = "CommissionDebitUSD (update this label in the \"Olymars/ColumnLabel\" extended property of the \"CommissionDebitUSD\" column)";
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentCommissionIncomeAccount_Full parameters, ref string xml) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentCommissionIncomeAccount_Full parameters, out System.Xml.XmlReader xmlReader) {
		...
		/// the Execute method of the 'spS_AgentCommissionIncomeAccount_Full' class.
		/// </summary>
		public class Resultset1 {
			...
			public class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CommissionCreditLC via shared members
				/// </summary>
				public class Column_CommissionCreditLC {

					/// <summary>
					/// Returns "CommissionCreditLC"
					/// </summary>
					public const System.String ColumnName = "CommissionCreditLC";
					/// <summary>
					/// Returns 5
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CommissionCreditUSD via shared members
				/// </summary>
				public class Column_CommissionCreditUSD {

					/// <summary>
					/// Returns "CommissionCreditUSD"
					/// </summary>
					public const System.String ColumnName = "CommissionCreditUSD";
					/// <summary>
					/// Returns 6
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CommissionDebitLC via shared members
				/// </summary>
				public class Column_CommissionDebitLC {

					/// <summary>
					/// Returns "CommissionDebitLC"
					/// </summary>
					public const System.String ColumnName = "CommissionDebitLC";
					/// <summary>
					/// Returns 7
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CommissionDebitUSD via shared members
				/// </summary>
				public class Column_CommissionDebitUSD {

					/// <summary>
					/// Returns "CommissionDebitUSD"
					/// </summary>
					public const System.String ColumnName = "CommissionDebitUSD";
					/// <summary>
					/// Returns 8
					/// </summary>
