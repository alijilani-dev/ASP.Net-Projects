...
namespace Evernet.MoneyExchange.DataClasses.Parameters {
	...
	/// stored procedure 'spU_AgentGroupList'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:06", SqlObjectDependancyName="spU_AgentGroupList", SqlObjectDependancyRevision=0)]
#endif
	public class spU_AgentGroupList : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spU_AgentGroupList class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spU_AgentGroupList() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spU_AgentGroupList class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spU_AgentGroupList(bool useDefaultValue) {
			...
			this.internal_Param_PrefixCode_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_PrefixCode_UseDefaultValue = this.useDefaultValue;
		}
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spU_AgentGroupList'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spU_AgentGroupList", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_PrefixCode = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_PrefixCode = System.Data.SqlTypes.SqlBoolean.Null;
		...
		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spU_AgentGroupList'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spU_AgentGroupList");
			}
		}
		...
		private System.Data.SqlTypes.SqlString internal_Param_PrefixCode;
		internal bool internal_Param_PrefixCode_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_PrefixCode;
		internal bool internal_Param_ConsiderNull_PrefixCode_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@PrefixCode'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_PrefixCode_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlString Param_PrefixCode {

			get {

				if (this.internal_Param_PrefixCode_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_PrefixCode);
			}

			set {

				this.internal_Param_PrefixCode_UseDefaultValue = false;
				this.internal_Param_PrefixCode = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@PrefixCode' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_PrefixCode_UseDefaultValue() {

			this.internal_Param_PrefixCode_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_PrefixCode'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_PrefixCode_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_PrefixCode {

			get {

				if (this.internal_Param_ConsiderNull_PrefixCode_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_PrefixCode);
			}

			set {

				this.internal_Param_ConsiderNull_PrefixCode_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_PrefixCode = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_PrefixCode' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_PrefixCode_UseDefaultValue() {

			this.internal_Param_ConsiderNull_PrefixCode_UseDefaultValue = true;
		}
...
namespace Evernet.MoneyExchange.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spU_AgentGroupList' stored procedure;
	...
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:06", SqlObjectDependancyName="spU_AgentGroupList", SqlObjectDependancyRevision=0)]
#endif
	public class spU_AgentGroupList : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spU_AgentGroupList() : this(false) {
		...
		public spU_AgentGroupList(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Evernet.MoneyExchange.DataClasses.Parameters.spU_AgentGroupList parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Evernet.MoneyExchange.DataClasses.Parameters.spU_AgentGroupList parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spU_AgentGroupList object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spU_AgentGroupList object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spU_AgentGroupList object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.DataClasses.Parameters.spU_AgentGroupList)");
						}
				...
				sqlCommand.CommandText = "spU_AgentGroupList";
		...
		private bool DeclareParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spU_AgentGroupList parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@PrefixCode", System.Data.SqlDbType.NVarChar, 100);
				sqlParameter.SourceColumn = "PrefixCode";
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_PrefixCode_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_PrefixCode.IsNull) {

					sqlParameter.Value = parameters.Param_PrefixCode;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_PrefixCode", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_PrefixCode_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_PrefixCode.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_PrefixCode;
				}
				else {
		...
		private bool RetrieveParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spU_AgentGroupList parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spU_AgentGroupList] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spU_AgentGroupList parameters) {
