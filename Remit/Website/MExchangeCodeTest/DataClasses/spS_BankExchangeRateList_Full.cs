...
namespace Evernet.MoneyExchange.DataClasses.Parameters {
	...
	/// stored procedure 'spS_BankExchangeRateList_Full'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:46:53", SqlObjectDependancyName="spS_BankExchangeRateList_Full", SqlObjectDependancyRevision=0)]
#endif
	public class spS_BankExchangeRateList_Full : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spS_BankExchangeRateList_Full class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spS_BankExchangeRateList_Full() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spS_BankExchangeRateList_Full class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spS_BankExchangeRateList_Full(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spS_BankExchangeRateList_Full'";
		...
		/// </summary>
		~spS_BankExchangeRateList_Full() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spS_BankExchangeRateList_Full'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spS_BankExchangeRateList_Full");
			}
		}
...
namespace Evernet.MoneyExchange.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spS_BankExchangeRateList_Full' stored procedure;
	...
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:46:53", SqlObjectDependancyName="spS_BankExchangeRateList_Full", SqlObjectDependancyRevision=0)]
#endif
	public class spS_BankExchangeRateList_Full : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spS_BankExchangeRateList_Full() : this(false) {
		...
		public spS_BankExchangeRateList_Full(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankExchangeRateList_Full parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankExchangeRateList_Full parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_BankExchangeRateList_Full object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_BankExchangeRateList_Full object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_BankExchangeRateList_Full object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.DataClasses.Parameters.spS_BankExchangeRateList_Full)");
						}
				...
				sqlCommand.CommandText = "spS_BankExchangeRateList_Full";
		...
		private bool DeclareParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankExchangeRateList_Full parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankExchangeRateList_Full parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spS_BankExchangeRateList_Full] stored procedure and retrieve back the data
		...
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankExchangeRateList_Full parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankExchangeRateList_Full parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'spS_BankExchangeRateList_Full'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankExchangeRateList_Full parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "spS_BankExchangeRateList_Full", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankExchangeRateList_Full parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "spS_BankExchangeRateList_Full", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankExchangeRateList_Full parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankExchangeRateList_Full parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
			...
			try {
				...
				dataset.Tables[tableName].Columns["CurrencyId"].Caption = "Currency";
				dataset.Tables[tableName].Columns["ExchangeType"].Caption = "ExchangeType";
				dataset.Tables[tableName].Columns["BidRate"].Caption = "BidRate";
				dataset.Tables[tableName].Columns["OfferRate"].Caption = "OfferRate";
				dataset.Tables[tableName].Columns["CurrencyId_Id"].Caption = "Id (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Id\" column)";
				dataset.Tables[tableName].Columns["CurrencyId_Name"].Caption = "Name";
				dataset.Tables[tableName].Columns["CurrencyId_Code"].Caption = "Code";
				dataset.Tables[tableName].Columns["CurrencyId_Scale"].Caption = "Scale";
				dataset.Tables[tableName].Columns["ExchangeType_Name"].Caption = "Name (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Name\" column)";
				dataset.Tables[tableName].Columns["ExchangeType_Value"].Caption = "Value (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Value\" column)";
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankExchangeRateList_Full parameters, ref string xml) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankExchangeRateList_Full parameters, out System.Xml.XmlReader xmlReader) {
		...
		/// the Execute method of the 'spS_BankExchangeRateList_Full' class.
		/// </summary>
		public class Resultset1 {
			...
			public class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CurrencyId via shared members
				/// </summary>
				public class Column_CurrencyId {

					/// <summary>
					/// Returns "CurrencyId"
					/// </summary>
					public const System.String ColumnName = "CurrencyId";
					/// <summary>
					/// Returns 1
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field ExchangeType via shared members
				/// </summary>
				public class Column_ExchangeType {

					/// <summary>
					/// Returns "ExchangeType"
					/// </summary>
					public const System.String ColumnName = "ExchangeType";
					/// <summary>
					/// Returns 2
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field BidRate via shared members
				/// </summary>
				public class Column_BidRate {

					/// <summary>
					/// Returns "BidRate"
					/// </summary>
					public const System.String ColumnName = "BidRate";
					/// <summary>
					/// Returns 3
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field OfferRate via shared members
				/// </summary>
				public class Column_OfferRate {

					/// <summary>
					/// Returns "OfferRate"
					/// </summary>
					public const System.String ColumnName = "OfferRate";
					/// <summary>
					/// Returns 4
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CurrencyId_Id via shared members
				/// </summary>
				public class Column_CurrencyId_Id {

					/// <summary>
					/// Returns "CurrencyId_Id"
					/// </summary>
					public const System.String ColumnName = "CurrencyId_Id";
					/// <summary>
					/// Returns 5
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CurrencyId_Name via shared members
				/// </summary>
				public class Column_CurrencyId_Name {

					/// <summary>
					/// Returns "CurrencyId_Name"
					/// </summary>
					public const System.String ColumnName = "CurrencyId_Name";
					/// <summary>
					/// Returns 6
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CurrencyId_Code via shared members
				/// </summary>
				public class Column_CurrencyId_Code {

					/// <summary>
					/// Returns "CurrencyId_Code"
					/// </summary>
					public const System.String ColumnName = "CurrencyId_Code";
					/// <summary>
					/// Returns 7
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CurrencyId_Scale via shared members
				/// </summary>
				public class Column_CurrencyId_Scale {

					/// <summary>
					/// Returns "CurrencyId_Scale"
					/// </summary>
					public const System.String ColumnName = "CurrencyId_Scale";
					/// <summary>
					/// Returns 8
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field ExchangeType_Name via shared members
				/// </summary>
				public class Column_ExchangeType_Name {

					/// <summary>
					/// Returns "ExchangeType_Name"
					/// </summary>
					public const System.String ColumnName = "ExchangeType_Name";
					/// <summary>
					/// Returns 9
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field ExchangeType_Value via shared members
				/// </summary>
				public class Column_ExchangeType_Value {

					/// <summary>
					/// Returns "ExchangeType_Value"
					/// </summary>
					public const System.String ColumnName = "ExchangeType_Value";
					/// <summary>
					/// Returns 10
					/// </summary>
