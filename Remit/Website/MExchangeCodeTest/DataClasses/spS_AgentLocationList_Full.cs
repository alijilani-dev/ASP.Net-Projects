/*
	This C# source code was automatically generated using:
		...
		SQL Server Centric .NET Code Generator
			...
			Generation Date: 11/30/2004 11:46:53 PM
...
namespace Evernet.MoneyExchange.DataClasses.Parameters {
	...
	/// stored procedure 'spS_AgentLocationList_Full'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:46:53", SqlObjectDependancyName="spS_AgentLocationList_Full", SqlObjectDependancyRevision=0)]
#endif
	public class spS_AgentLocationList_Full : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spS_AgentLocationList_Full class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spS_AgentLocationList_Full() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spS_AgentLocationList_Full class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spS_AgentLocationList_Full(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spS_AgentLocationList_Full'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spS_AgentLocationList_Full", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		/// </summary>
		~spS_AgentLocationList_Full() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spS_AgentLocationList_Full'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spS_AgentLocationList_Full");
			}
		}
...
namespace Evernet.MoneyExchange.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spS_AgentLocationList_Full' stored procedure;
	...
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:46:53", SqlObjectDependancyName="spS_AgentLocationList_Full", SqlObjectDependancyRevision=0)]
#endif
	public class spS_AgentLocationList_Full : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spS_AgentLocationList_Full() : this(false) {
		...
		public spS_AgentLocationList_Full(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentLocationList_Full parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentLocationList_Full parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentLocationList_Full object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentLocationList_Full object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentLocationList_Full object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentLocationList_Full)");
						}
				...
				sqlCommand.CommandText = "spS_AgentLocationList_Full";
		...
		private bool DeclareParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentLocationList_Full parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentLocationList_Full parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spS_AgentLocationList_Full] stored procedure and retrieve back the data
		...
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentLocationList_Full parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentLocationList_Full parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'spS_AgentLocationList_Full'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentLocationList_Full parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "spS_AgentLocationList_Full", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentLocationList_Full parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "spS_AgentLocationList_Full", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentLocationList_Full parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentLocationList_Full parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
			...
			try {
				...
				dataset.Tables[tableName].Columns["AgentGroupId"].Caption = "AgentGroup";
				dataset.Tables[tableName].Columns["CreditLimitInUSD"].Caption = "CreditLimitInUSD";
				dataset.Tables[tableName].Columns["IndividualTransactionLimit"].Caption = "IndividualTransactionLimit";
				...
				dataset.Tables[tableName].Columns["ListOnWebFor"].Caption = "ListOnWebFor";
				dataset.Tables[tableName].Columns["Address"].Caption = "Address";
				dataset.Tables[tableName].Columns["Telephone"].Caption = "Telephone";
				dataset.Tables[tableName].Columns["Fax"].Caption = "Fax";
				dataset.Tables[tableName].Columns["Email"].Caption = "Email";
				dataset.Tables[tableName].Columns["LocationId"].Caption = "Location";
				dataset.Tables[tableName].Columns["ContactPerson"].Caption = "ContactPerson";
				...
				dataset.Tables[tableName].Columns["AgentGroupId_Id"].Caption = "Id (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Id\" column)";
				dataset.Tables[tableName].Columns["AgentGroupId_AgentAccountId"].Caption = "AgentAccount";
				dataset.Tables[tableName].Columns["AgentGroupId_Name"].Caption = "Name";
				dataset.Tables[tableName].Columns["AgentGroupId_PrefixCode"].Caption = "PrefixCode";
				...
				dataset.Tables[tableName].Columns["ListOnWebFor_Name"].Caption = "Name (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Name\" column)";
				dataset.Tables[tableName].Columns["ListOnWebFor_Value"].Caption = "Value (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Value\" column)";
				dataset.Tables[tableName].Columns["LocationId_Id"].Caption = "Id (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Id\" column)";
				dataset.Tables[tableName].Columns["LocationId_Name"].Caption = "Name";
				dataset.Tables[tableName].Columns["LocationId_ParentId"].Caption = "Parent";
				dataset.Tables[tableName].Columns["LocationId_CountryId"].Caption = "Country";
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentLocationList_Full parameters, ref string xml) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_AgentLocationList_Full parameters, out System.Xml.XmlReader xmlReader) {
		...
		/// the Execute method of the 'spS_AgentLocationList_Full' class.
		/// </summary>
		public class Resultset1 {
			...
			public class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AgentGroupId via shared members
				/// </summary>
				public class Column_AgentGroupId {

					/// <summary>
					/// Returns "AgentGroupId"
					/// </summary>
					public const System.String ColumnName = "AgentGroupId";
					/// <summary>
					/// Returns 4
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CreditLimitInUSD via shared members
				/// </summary>
				public class Column_CreditLimitInUSD {

					/// <summary>
					/// Returns "CreditLimitInUSD"
					/// </summary>
					public const System.String ColumnName = "CreditLimitInUSD";
					/// <summary>
					/// Returns 5
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field IndividualTransactionLimit via shared members
				/// </summary>
				public class Column_IndividualTransactionLimit {

					/// <summary>
					/// Returns "IndividualTransactionLimit"
					/// </summary>
					public const System.String ColumnName = "IndividualTransactionLimit";
					/// <summary>
					/// Returns 6
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field ListOnWebFor via shared members
				/// </summary>
				public class Column_ListOnWebFor {

					/// <summary>
					/// Returns "ListOnWebFor"
					/// </summary>
					public const System.String ColumnName = "ListOnWebFor";
					/// <summary>
					/// Returns 9
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Address via shared members
				/// </summary>
				public class Column_Address {

					/// <summary>
					/// Returns "Address"
					/// </summary>
					public const System.String ColumnName = "Address";
					/// <summary>
					/// Returns 10
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field Fax via shared members
				/// </summary>
				public class Column_Fax {

					/// <summary>
					/// Returns "Fax"
					/// </summary>
					public const System.String ColumnName = "Fax";
					/// <summary>
					/// Returns 12
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field LocationId via shared members
				/// </summary>
				public class Column_LocationId {

					/// <summary>
					/// Returns "LocationId"
					/// </summary>
					public const System.String ColumnName = "LocationId";
					/// <summary>
					/// Returns 14
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field ContactPerson via shared members
				/// </summary>
				public class Column_ContactPerson {

					/// <summary>
					/// Returns "ContactPerson"
					/// </summary>
					public const System.String ColumnName = "ContactPerson";
					/// <summary>
					/// Returns 15
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AgentGroupId_Id via shared members
				/// </summary>
				public class Column_AgentGroupId_Id {

					/// <summary>
					/// Returns "AgentGroupId_Id"
					/// </summary>
					public const System.String ColumnName = "AgentGroupId_Id";
					/// <summary>
					/// Returns 28
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AgentGroupId_AgentAccountId via shared members
				/// </summary>
				public class Column_AgentGroupId_AgentAccountId {

					/// <summary>
					/// Returns "AgentGroupId_AgentAccountId"
					/// </summary>
					public const System.String ColumnName = "AgentGroupId_AgentAccountId";
					/// <summary>
					/// Returns 29
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AgentGroupId_Name via shared members
				/// </summary>
				public class Column_AgentGroupId_Name {

					/// <summary>
					/// Returns "AgentGroupId_Name"
					/// </summary>
					public const System.String ColumnName = "AgentGroupId_Name";
					/// <summary>
					/// Returns 30
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AgentGroupId_PrefixCode via shared members
				/// </summary>
				public class Column_AgentGroupId_PrefixCode {

					/// <summary>
					/// Returns "AgentGroupId_PrefixCode"
					/// </summary>
					public const System.String ColumnName = "AgentGroupId_PrefixCode";
					/// <summary>
					/// Returns 31
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field ListOnWebFor_Name via shared members
				/// </summary>
				public class Column_ListOnWebFor_Name {

					/// <summary>
					/// Returns "ListOnWebFor_Name"
					/// </summary>
					public const System.String ColumnName = "ListOnWebFor_Name";
					/// <summary>
					/// Returns 36
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field ListOnWebFor_Value via shared members
				/// </summary>
				public class Column_ListOnWebFor_Value {

					/// <summary>
					/// Returns "ListOnWebFor_Value"
					/// </summary>
					public const System.String ColumnName = "ListOnWebFor_Value";
					/// <summary>
					/// Returns 37
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field LocationId_Id via shared members
				/// </summary>
				public class Column_LocationId_Id {

					/// <summary>
					/// Returns "LocationId_Id"
					/// </summary>
					public const System.String ColumnName = "LocationId_Id";
					/// <summary>
					/// Returns 38
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field LocationId_Name via shared members
				/// </summary>
				public class Column_LocationId_Name {

					/// <summary>
					/// Returns "LocationId_Name"
					/// </summary>
					public const System.String ColumnName = "LocationId_Name";
					/// <summary>
					/// Returns 39
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field LocationId_ParentId via shared members
				/// </summary>
				public class Column_LocationId_ParentId {

					/// <summary>
					/// Returns "LocationId_ParentId"
					/// </summary>
					public const System.String ColumnName = "LocationId_ParentId";
					/// <summary>
					/// Returns 40
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field LocationId_CountryId via shared members
				/// </summary>
				public class Column_LocationId_CountryId {

					/// <summary>
					/// Returns "LocationId_CountryId"
					/// </summary>
					public const System.String ColumnName = "LocationId_CountryId";
					/// <summary>
					/// Returns 41
					/// </summary>
