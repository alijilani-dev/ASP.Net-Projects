...
namespace Evernet.MoneyExchange.DataClasses.Parameters {
	...
	/// stored procedure 'spS_BankList_Full'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:46:54", SqlObjectDependancyName="spS_BankList_Full", SqlObjectDependancyRevision=0)]
#endif
	public class spS_BankList_Full : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spS_BankList_Full class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spS_BankList_Full() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spS_BankList_Full class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spS_BankList_Full(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spS_BankList_Full'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spS_BankList_Full", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spS_BankList_Full'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spS_BankList_Full");
			}
		}
...
namespace Evernet.MoneyExchange.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spS_BankList_Full' stored procedure;
	...
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:46:54", SqlObjectDependancyName="spS_BankList_Full", SqlObjectDependancyRevision=0)]
#endif
	public class spS_BankList_Full : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spS_BankList_Full() : this(false) {
		...
		public spS_BankList_Full(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankList_Full parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankList_Full parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_BankList_Full object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_BankList_Full object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_BankList_Full object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.DataClasses.Parameters.spS_BankList_Full)");
						}
				...
				sqlCommand.CommandText = "spS_BankList_Full";
		...
		private bool DeclareParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankList_Full parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankList_Full parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spS_BankList_Full] stored procedure and retrieve back the data
		...
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankList_Full parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankList_Full parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'spS_BankList_Full'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankList_Full parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "spS_BankList_Full", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankList_Full parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "spS_BankList_Full", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankList_Full parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankList_Full parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
			...
			try {
				...
				dataset.Tables[tableName].Columns["InternalCode"].Caption = "InternalCode";
				dataset.Tables[tableName].Columns["ExternalCode"].Caption = "ExternalCode";
				dataset.Tables[tableName].Columns["Address"].Caption = "Address";
				dataset.Tables[tableName].Columns["ZipCode"].Caption = "ZipCode";
				dataset.Tables[tableName].Columns["AccountId"].Caption = "Account";
				dataset.Tables[tableName].Columns["LocationId"].Caption = "City/Division";
				dataset.Tables[tableName].Columns["AccountId_Id"].Caption = "Id";
				dataset.Tables[tableName].Columns["AccountId_ParentId"].Caption = "Parent";
				dataset.Tables[tableName].Columns["AccountId_Name"].Caption = "Name";
				dataset.Tables[tableName].Columns["AccountId_Number"].Caption = "Number";
				dataset.Tables[tableName].Columns["AccountId_CreditLimitInUSD"].Caption = "CreditLimitInUSD";
				dataset.Tables[tableName].Columns["AccountId_PayInThreshold"].Caption = "PayInThreshold";
				dataset.Tables[tableName].Columns["AccountId_BankSwiftCode"].Caption = "BankSwiftCode";
				dataset.Tables[tableName].Columns["AccountId_DraftStatusUrl"].Caption = "DraftStatusUrl";
				dataset.Tables[tableName].Columns["AccountId_DraftStatusVariable"].Caption = "DraftStatusVariable";
				dataset.Tables[tableName].Columns["AccountId_CountryId"].Caption = "Country";
				dataset.Tables[tableName].Columns["AccountId_Active"].Caption = "Active";
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankList_Full parameters, ref string xml) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BankList_Full parameters, out System.Xml.XmlReader xmlReader) {
		...
		/// the Execute method of the 'spS_BankList_Full' class.
		/// </summary>
		public class Resultset1 {
			...
			public class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field InternalCode via shared members
				/// </summary>
				public class Column_InternalCode {

					/// <summary>
					/// Returns "InternalCode"
					/// </summary>
					public const System.String ColumnName = "InternalCode";
					/// <summary>
					/// Returns 3
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field ExternalCode via shared members
				/// </summary>
				public class Column_ExternalCode {

					/// <summary>
					/// Returns "ExternalCode"
					/// </summary>
					public const System.String ColumnName = "ExternalCode";
					/// <summary>
					/// Returns 4
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AccountId via shared members
				/// </summary>
				public class Column_AccountId {

					/// <summary>
					/// Returns "AccountId"
					/// </summary>
					public const System.String ColumnName = "AccountId";
					/// <summary>
					/// Returns 7
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AccountId_Id via shared members
				/// </summary>
				public class Column_AccountId_Id {

					/// <summary>
					/// Returns "AccountId_Id"
					/// </summary>
					public const System.String ColumnName = "AccountId_Id";
					/// <summary>
					/// Returns 9
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AccountId_ParentId via shared members
				/// </summary>
				public class Column_AccountId_ParentId {

					/// <summary>
					/// Returns "AccountId_ParentId"
					/// </summary>
					public const System.String ColumnName = "AccountId_ParentId";
					/// <summary>
					/// Returns 10
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AccountId_Name via shared members
				/// </summary>
				public class Column_AccountId_Name {

					/// <summary>
					/// Returns "AccountId_Name"
					/// </summary>
					public const System.String ColumnName = "AccountId_Name";
					/// <summary>
					/// Returns 11
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AccountId_Number via shared members
				/// </summary>
				public class Column_AccountId_Number {

					/// <summary>
					/// Returns "AccountId_Number"
					/// </summary>
					public const System.String ColumnName = "AccountId_Number";
					/// <summary>
					/// Returns 12
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AccountId_CreditLimitInUSD via shared members
				/// </summary>
				public class Column_AccountId_CreditLimitInUSD {

					/// <summary>
					/// Returns "AccountId_CreditLimitInUSD"
					/// </summary>
					public const System.String ColumnName = "AccountId_CreditLimitInUSD";
					/// <summary>
					/// Returns 13
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AccountId_PayInThreshold via shared members
				/// </summary>
				public class Column_AccountId_PayInThreshold {

					/// <summary>
					/// Returns "AccountId_PayInThreshold"
					/// </summary>
					public const System.String ColumnName = "AccountId_PayInThreshold";
					/// <summary>
					/// Returns 14
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AccountId_BankSwiftCode via shared members
				/// </summary>
				public class Column_AccountId_BankSwiftCode {

					/// <summary>
					/// Returns "AccountId_BankSwiftCode"
					/// </summary>
					public const System.String ColumnName = "AccountId_BankSwiftCode";
					/// <summary>
					/// Returns 15
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AccountId_DraftStatusUrl via shared members
				/// </summary>
				public class Column_AccountId_DraftStatusUrl {

					/// <summary>
					/// Returns "AccountId_DraftStatusUrl"
					/// </summary>
					public const System.String ColumnName = "AccountId_DraftStatusUrl";
					/// <summary>
					/// Returns 16
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AccountId_DraftStatusVariable via shared members
				/// </summary>
				public class Column_AccountId_DraftStatusVariable {

					/// <summary>
					/// Returns "AccountId_DraftStatusVariable"
					/// </summary>
					public const System.String ColumnName = "AccountId_DraftStatusVariable";
					/// <summary>
					/// Returns 17
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AccountId_CountryId via shared members
				/// </summary>
				public class Column_AccountId_CountryId {

					/// <summary>
					/// Returns "AccountId_CountryId"
					/// </summary>
					public const System.String ColumnName = "AccountId_CountryId";
					/// <summary>
					/// Returns 18
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AccountId_Active via shared members
				/// </summary>
				public class Column_AccountId_Active {

					/// <summary>
					/// Returns "AccountId_Active"
					/// </summary>
					public const System.String ColumnName = "AccountId_Active";
					/// <summary>
					/// Returns 19
					/// </summary>
