/*
	This C# source code was automatically generated using:
		...
		SQL Server Centric .NET Code Generator
			...
			Generation Date: 11/30/2004 11:47:04 PM
...
namespace Evernet.MoneyExchange.DataClasses.Parameters {
	...
	/// stored procedure 'spS_TransactionSettlementHistory_Full'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:04", SqlObjectDependancyName="spS_TransactionSettlementHistory_Full", SqlObjectDependancyRevision=0)]
#endif
	public class spS_TransactionSettlementHistory_Full : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spS_TransactionSettlementHistory_Full class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spS_TransactionSettlementHistory_Full() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spS_TransactionSettlementHistory_Full class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spS_TransactionSettlementHistory_Full(bool useDefaultValue) {

			this.useDefaultValue = useDefaultValue;

			this.internal_Param_Id_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_PaymentId_UseDefaultValue = this.useDefaultValue;
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spS_TransactionSettlementHistory_Full'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spS_TransactionSettlementHistory_Full", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_PaymentId = System.Data.SqlTypes.SqlGuid.Null;
		...
		/// </summary>
		~spS_TransactionSettlementHistory_Full() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spS_TransactionSettlementHistory_Full'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spS_TransactionSettlementHistory_Full");
			}
		}
		...
		private System.Data.SqlTypes.SqlGuid internal_Param_PaymentId;
		internal bool internal_Param_PaymentId_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@PaymentId'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_PaymentId_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlGuid Param_PaymentId {

			get {

				if (this.internal_Param_PaymentId_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_PaymentId);
			}

			set {

				this.internal_Param_PaymentId_UseDefaultValue = false;
				this.internal_Param_PaymentId = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@PaymentId' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_PaymentId_UseDefaultValue() {

			this.internal_Param_PaymentId_UseDefaultValue = true;
		}
...
namespace Evernet.MoneyExchange.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spS_TransactionSettlementHistory_Full' stored procedure;
	...
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:04", SqlObjectDependancyName="spS_TransactionSettlementHistory_Full", SqlObjectDependancyRevision=0)]
#endif
	public class spS_TransactionSettlementHistory_Full : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spS_TransactionSettlementHistory_Full() : this(false) {
		...
		public spS_TransactionSettlementHistory_Full(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionSettlementHistory_Full parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionSettlementHistory_Full parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionSettlementHistory_Full object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionSettlementHistory_Full object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionSettlementHistory_Full object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionSettlementHistory_Full)");
						}
				...
				sqlCommand.CommandText = "spS_TransactionSettlementHistory_Full";
		...
		private bool DeclareParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionSettlementHistory_Full parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@PaymentId", System.Data.SqlDbType.UniqueIdentifier, 16);
				sqlParameter.SourceColumn = "PaymentId";
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_PaymentId_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_PaymentId.IsNull) {

					sqlParameter.Value = parameters.Param_PaymentId;
				}
				else {
		...
		private bool RetrieveParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionSettlementHistory_Full parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spS_TransactionSettlementHistory_Full] stored procedure and retrieve back the data
		...
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionSettlementHistory_Full parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionSettlementHistory_Full parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'spS_TransactionSettlementHistory_Full'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionSettlementHistory_Full parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "spS_TransactionSettlementHistory_Full", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionSettlementHistory_Full parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "spS_TransactionSettlementHistory_Full", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionSettlementHistory_Full parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionSettlementHistory_Full parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
			...
			try {
				...
				dataset.Tables[tableName].Columns["PaymentId"].Caption = "PaymentId (update this label in the \"Olymars/ColumnLabel\" extended property of the \"PaymentId\" column)";
				...
				dataset.Tables[tableName].Columns["SettlementAmount"].Caption = "SettlementAmount (update this label in the \"Olymars/ColumnLabel\" extended property of the \"SettlementAmount\" column)";
				dataset.Tables[tableName].Columns["PaymentId_Id"].Caption = "Id (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Id\" column)";
				dataset.Tables[tableName].Columns["PaymentId_EntryDateTime"].Caption = "EntryDateTime (update this label in the \"Olymars/ColumnLabel\" extended property of the \"EntryDateTime\" column)";
				dataset.Tables[tableName].Columns["PaymentId_PaymentDateTime"].Caption = "PaymentDateTime (update this label in the \"Olymars/ColumnLabel\" extended property of the \"PaymentDateTime\" column)";
				dataset.Tables[tableName].Columns["PaymentId_PaymentCurrencyId"].Caption = "PaymentCurrencyId (update this label in the \"Olymars/ColumnLabel\" extended property of the \"PaymentCurrencyId\" column)";
				dataset.Tables[tableName].Columns["PaymentId_Debit"].Caption = "Debit (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Debit\" column)";
				dataset.Tables[tableName].Columns["PaymentId_Credit"].Caption = "Credit (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Credit\" column)";
				dataset.Tables[tableName].Columns["PaymentId_Type"].Caption = "Type (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Type\" column)";
				dataset.Tables[tableName].Columns["PaymentId_Particulars"].Caption = "Particulars (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Particulars\" column)";
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionSettlementHistory_Full parameters, ref string xml) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionSettlementHistory_Full parameters, out System.Xml.XmlReader xmlReader) {
		...
		/// the Execute method of the 'spS_TransactionSettlementHistory_Full' class.
		/// </summary>
		public class Resultset1 {
			...
			public class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PaymentId via shared members
				/// </summary>
				public class Column_PaymentId {

					/// <summary>
					/// Returns "PaymentId"
					/// </summary>
					public const System.String ColumnName = "PaymentId";
					/// <summary>
					/// Returns 1
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field SettlementAmount via shared members
				/// </summary>
				public class Column_SettlementAmount {

					/// <summary>
					/// Returns "SettlementAmount"
					/// </summary>
					public const System.String ColumnName = "SettlementAmount";
					/// <summary>
					/// Returns 3
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PaymentId_Id via shared members
				/// </summary>
				public class Column_PaymentId_Id {

					/// <summary>
					/// Returns "PaymentId_Id"
					/// </summary>
					public const System.String ColumnName = "PaymentId_Id";
					/// <summary>
					/// Returns 4
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PaymentId_EntryDateTime via shared members
				/// </summary>
				public class Column_PaymentId_EntryDateTime {

					/// <summary>
					/// Returns "PaymentId_EntryDateTime"
					/// </summary>
					public const System.String ColumnName = "PaymentId_EntryDateTime";
					/// <summary>
					/// Returns 5
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PaymentId_PaymentDateTime via shared members
				/// </summary>
				public class Column_PaymentId_PaymentDateTime {

					/// <summary>
					/// Returns "PaymentId_PaymentDateTime"
					/// </summary>
					public const System.String ColumnName = "PaymentId_PaymentDateTime";
					/// <summary>
					/// Returns 6
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PaymentId_PaymentCurrencyId via shared members
				/// </summary>
				public class Column_PaymentId_PaymentCurrencyId {

					/// <summary>
					/// Returns "PaymentId_PaymentCurrencyId"
					/// </summary>
					public const System.String ColumnName = "PaymentId_PaymentCurrencyId";
					/// <summary>
					/// Returns 7
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PaymentId_Debit via shared members
				/// </summary>
				public class Column_PaymentId_Debit {

					/// <summary>
					/// Returns "PaymentId_Debit"
					/// </summary>
					public const System.String ColumnName = "PaymentId_Debit";
					/// <summary>
					/// Returns 8
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PaymentId_Credit via shared members
				/// </summary>
				public class Column_PaymentId_Credit {

					/// <summary>
					/// Returns "PaymentId_Credit"
					/// </summary>
					public const System.String ColumnName = "PaymentId_Credit";
					/// <summary>
					/// Returns 9
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PaymentId_Type via shared members
				/// </summary>
				public class Column_PaymentId_Type {

					/// <summary>
					/// Returns "PaymentId_Type"
					/// </summary>
					public const System.String ColumnName = "PaymentId_Type";
					/// <summary>
					/// Returns 10
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PaymentId_Particulars via shared members
				/// </summary>
				public class Column_PaymentId_Particulars {

					/// <summary>
					/// Returns "PaymentId_Particulars"
					/// </summary>
					public const System.String ColumnName = "PaymentId_Particulars";
					/// <summary>
					/// Returns 11
					/// </summary>
