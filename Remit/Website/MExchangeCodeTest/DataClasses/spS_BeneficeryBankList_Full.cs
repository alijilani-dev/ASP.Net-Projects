/*
	This C# source code was automatically generated using:
		...
		SQL Server Centric .NET Code Generator
			...
			Generation Date: 11/30/2004 11:46:54 PM
...
namespace Evernet.MoneyExchange.DataClasses.Parameters {
	...
	/// stored procedure 'spS_BeneficeryBankList_Full'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:46:54", SqlObjectDependancyName="spS_BeneficeryBankList_Full", SqlObjectDependancyRevision=0)]
#endif
	public class spS_BeneficeryBankList_Full : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spS_BeneficeryBankList_Full class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spS_BeneficeryBankList_Full() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spS_BeneficeryBankList_Full class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spS_BeneficeryBankList_Full(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spS_BeneficeryBankList_Full'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spS_BeneficeryBankList_Full", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		/// </summary>
		~spS_BeneficeryBankList_Full() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spS_BeneficeryBankList_Full'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spS_BeneficeryBankList_Full");
			}
		}
...
namespace Evernet.MoneyExchange.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spS_BeneficeryBankList_Full' stored procedure;
	...
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:46:54", SqlObjectDependancyName="spS_BeneficeryBankList_Full", SqlObjectDependancyRevision=0)]
#endif
	public class spS_BeneficeryBankList_Full : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spS_BeneficeryBankList_Full() : this(false) {
		...
		public spS_BeneficeryBankList_Full(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BeneficeryBankList_Full parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BeneficeryBankList_Full parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_BeneficeryBankList_Full object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_BeneficeryBankList_Full object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_BeneficeryBankList_Full object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.DataClasses.Parameters.spS_BeneficeryBankList_Full)");
						}
				...
				sqlCommand.CommandText = "spS_BeneficeryBankList_Full";
		...
		private bool DeclareParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BeneficeryBankList_Full parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BeneficeryBankList_Full parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spS_BeneficeryBankList_Full] stored procedure and retrieve back the data
		...
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BeneficeryBankList_Full parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BeneficeryBankList_Full parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'spS_BeneficeryBankList_Full'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BeneficeryBankList_Full parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "spS_BeneficeryBankList_Full", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BeneficeryBankList_Full parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "spS_BeneficeryBankList_Full", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BeneficeryBankList_Full parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BeneficeryBankList_Full parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
			...
			try {
				...
				dataset.Tables[tableName].Columns["CustomerId"].Caption = "Customer";
				dataset.Tables[tableName].Columns["RegistrationDateTime"].Caption = "RegistrationDateTime (update this label in the \"Olymars/ColumnLabel\" extended property of the \"RegistrationDateTime\" column)";
				dataset.Tables[tableName].Columns["AccountNumber"].Caption = "AccountNumber";
				dataset.Tables[tableName].Columns["Name"].Caption = "Name";
				dataset.Tables[tableName].Columns["BranchName"].Caption = "BranchName";
				dataset.Tables[tableName].Columns["Address"].Caption = "Address";
				dataset.Tables[tableName].Columns["ZipCode"].Caption = "ZipCode";
				dataset.Tables[tableName].Columns["CountryId"].Caption = "Country";
				...
				dataset.Tables[tableName].Columns["CountryId_Id"].Caption = "Id (update this label in the \"Olymars/ColumnLabel\" extended property of the \"Id\" column)";
				dataset.Tables[tableName].Columns["CountryId_Name"].Caption = "Name";
				dataset.Tables[tableName].Columns["CountryId_Code"].Caption = "Code";
				dataset.Tables[tableName].Columns["CountryId_BaseCurrency"].Caption = "BaseCurrency";
				dataset.Tables[tableName].Columns["CountryId_AllowedInternationalTransactionType"].Caption = "AllowedInternationalTransactionType";
				dataset.Tables[tableName].Columns["CountryId_AllowedDomesticTransactionType"].Caption = "AllowedDomesticTransactionType";
				dataset.Tables[tableName].Columns["CountryId_TotalInboundThresholdPerYearPerPerson"].Caption = "TotalInboundThresholdPerYearPerPerson";
				dataset.Tables[tableName].Columns["CountryId_MaximumTransactionsPerYearPerPersonToOneBeneficery"].Caption = "MaximumTransactionsPerYearPerPersonToOneBeneficery";
				dataset.Tables[tableName].Columns["CountryId_TransactionYearStartDate"].Caption = "TransactionYearStartDate";
				dataset.Tables[tableName].Columns["CountryId_TransactionYearEndDate"].Caption = "TransactionYearEndDate";
				dataset.Tables[tableName].Columns["CountryId_OutboundIDRequirementThreshold"].Caption = "OutboundIDRequirementThreshold";
				dataset.Tables[tableName].Columns["CountryId_OutboundThresholdPerTransaction"].Caption = "OutboundThresholdPerTransaction";
				dataset.Tables[tableName].Columns["CountryId_CanPayOutUSD"].Caption = "CanPayOutUSD";
				dataset.Tables[tableName].Columns["CountryId_Active"].Caption = "Active";
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BeneficeryBankList_Full parameters, ref string xml) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_BeneficeryBankList_Full parameters, out System.Xml.XmlReader xmlReader) {
		...
		/// the Execute method of the 'spS_BeneficeryBankList_Full' class.
		/// </summary>
		public class Resultset1 {
			...
			public class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field RegistrationDateTime via shared members
				/// </summary>
				public class Column_RegistrationDateTime {

					/// <summary>
					/// Returns "RegistrationDateTime"
					/// </summary>
					public const System.String ColumnName = "RegistrationDateTime";
					/// <summary>
					/// Returns 2
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AccountNumber via shared members
				/// </summary>
				public class Column_AccountNumber {

					/// <summary>
					/// Returns "AccountNumber"
					/// </summary>
					public const System.String ColumnName = "AccountNumber";
					/// <summary>
					/// Returns 3
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field BranchName via shared members
				/// </summary>
				public class Column_BranchName {

					/// <summary>
					/// Returns "BranchName"
					/// </summary>
					public const System.String ColumnName = "BranchName";
					/// <summary>
					/// Returns 5
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field ZipCode via shared members
				/// </summary>
				public class Column_ZipCode {

					/// <summary>
					/// Returns "ZipCode"
					/// </summary>
					public const System.String ColumnName = "ZipCode";
					/// <summary>
					/// Returns 7
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CountryId via shared members
				/// </summary>
				public class Column_CountryId {

					/// <summary>
					/// Returns "CountryId"
					/// </summary>
					public const System.String ColumnName = "CountryId";
					/// <summary>
					/// Returns 8
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CountryId_Id via shared members
				/// </summary>
				public class Column_CountryId_Id {

					/// <summary>
					/// Returns "CountryId_Id"
					/// </summary>
					public const System.String ColumnName = "CountryId_Id";
					/// <summary>
					/// Returns 27
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CountryId_Name via shared members
				/// </summary>
				public class Column_CountryId_Name {

					/// <summary>
					/// Returns "CountryId_Name"
					/// </summary>
					public const System.String ColumnName = "CountryId_Name";
					/// <summary>
					/// Returns 28
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CountryId_Code via shared members
				/// </summary>
				public class Column_CountryId_Code {

					/// <summary>
					/// Returns "CountryId_Code"
					/// </summary>
					public const System.String ColumnName = "CountryId_Code";
					/// <summary>
					/// Returns 29
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CountryId_BaseCurrency via shared members
				/// </summary>
				public class Column_CountryId_BaseCurrency {

					/// <summary>
					/// Returns "CountryId_BaseCurrency"
					/// </summary>
					public const System.String ColumnName = "CountryId_BaseCurrency";
					/// <summary>
					/// Returns 30
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CountryId_AllowedInternationalTransactionType via shared members
				/// </summary>
				public class Column_CountryId_AllowedInternationalTransactionType {

					/// <summary>
					/// Returns "CountryId_AllowedInternationalTransactionType"
					/// </summary>
					public const System.String ColumnName = "CountryId_AllowedInternationalTransactionType";
					/// <summary>
					/// Returns 31
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CountryId_AllowedDomesticTransactionType via shared members
				/// </summary>
				public class Column_CountryId_AllowedDomesticTransactionType {

					/// <summary>
					/// Returns "CountryId_AllowedDomesticTransactionType"
					/// </summary>
					public const System.String ColumnName = "CountryId_AllowedDomesticTransactionType";
					/// <summary>
					/// Returns 32
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CountryId_TotalInboundThresholdPerYearPerPerson via shared members
				/// </summary>
				public class Column_CountryId_TotalInboundThresholdPerYearPerPerson {

					/// <summary>
					/// Returns "CountryId_TotalInboundThresholdPerYearPerPerson"
					/// </summary>
					public const System.String ColumnName = "CountryId_TotalInboundThresholdPerYearPerPerson";
					/// <summary>
					/// Returns 33
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CountryId_MaximumTransactionsPerYearPerPersonToOneBeneficery via shared members
				/// </summary>
				public class Column_CountryId_MaximumTransactionsPerYearPerPersonToOneBeneficery {

					/// <summary>
					/// Returns "CountryId_MaximumTransactionsPerYearPerPersonToOneBeneficery"
					/// </summary>
					public const System.String ColumnName = "CountryId_MaximumTransactionsPerYearPerPersonToOneBeneficery";
					/// <summary>
					/// Returns 34
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CountryId_TransactionYearStartDate via shared members
				/// </summary>
				public class Column_CountryId_TransactionYearStartDate {

					/// <summary>
					/// Returns "CountryId_TransactionYearStartDate"
					/// </summary>
					public const System.String ColumnName = "CountryId_TransactionYearStartDate";
					/// <summary>
					/// Returns 35
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CountryId_TransactionYearEndDate via shared members
				/// </summary>
				public class Column_CountryId_TransactionYearEndDate {

					/// <summary>
					/// Returns "CountryId_TransactionYearEndDate"
					/// </summary>
					public const System.String ColumnName = "CountryId_TransactionYearEndDate";
					/// <summary>
					/// Returns 36
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CountryId_OutboundIDRequirementThreshold via shared members
				/// </summary>
				public class Column_CountryId_OutboundIDRequirementThreshold {

					/// <summary>
					/// Returns "CountryId_OutboundIDRequirementThreshold"
					/// </summary>
					public const System.String ColumnName = "CountryId_OutboundIDRequirementThreshold";
					/// <summary>
					/// Returns 37
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CountryId_OutboundThresholdPerTransaction via shared members
				/// </summary>
				public class Column_CountryId_OutboundThresholdPerTransaction {

					/// <summary>
					/// Returns "CountryId_OutboundThresholdPerTransaction"
					/// </summary>
					public const System.String ColumnName = "CountryId_OutboundThresholdPerTransaction";
					/// <summary>
					/// Returns 38
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CountryId_CanPayOutUSD via shared members
				/// </summary>
				public class Column_CountryId_CanPayOutUSD {

					/// <summary>
					/// Returns "CountryId_CanPayOutUSD"
					/// </summary>
					public const System.String ColumnName = "CountryId_CanPayOutUSD";
					/// <summary>
					/// Returns 39
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CountryId_Active via shared members
				/// </summary>
				public class Column_CountryId_Active {

					/// <summary>
					/// Returns "CountryId_Active"
					/// </summary>
					public const System.String ColumnName = "CountryId_Active";
					/// <summary>
					/// Returns 40
					/// </summary>
