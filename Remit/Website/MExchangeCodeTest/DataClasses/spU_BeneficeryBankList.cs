...
namespace Evernet.MoneyExchange.DataClasses.Parameters {
	...
	/// stored procedure 'spU_BeneficeryBankList'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:06", SqlObjectDependancyName="spU_BeneficeryBankList", SqlObjectDependancyRevision=0)]
#endif
	public class spU_BeneficeryBankList : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spU_BeneficeryBankList class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spU_BeneficeryBankList() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spU_BeneficeryBankList class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spU_BeneficeryBankList(bool useDefaultValue) {
			...
			this.internal_Param_RegistrationDateTime_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_RegistrationDateTime_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_AccountNumber_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_AccountNumber_UseDefaultValue = this.useDefaultValue;
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spU_BeneficeryBankList'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spU_BeneficeryBankList", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_RegistrationDateTime = System.Data.SqlTypes.SqlDateTime.Null;
				this.internal_Param_ConsiderNull_RegistrationDateTime = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_AccountNumber = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_AccountNumber = System.Data.SqlTypes.SqlBoolean.Null;
		...
		/// </summary>
		~spU_BeneficeryBankList() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spU_BeneficeryBankList'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spU_BeneficeryBankList");
			}
		}
		...
		private System.Data.SqlTypes.SqlDateTime internal_Param_RegistrationDateTime;
		internal bool internal_Param_RegistrationDateTime_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_RegistrationDateTime;
		internal bool internal_Param_ConsiderNull_RegistrationDateTime_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlString internal_Param_AccountNumber;
		internal bool internal_Param_AccountNumber_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_AccountNumber;
		internal bool internal_Param_ConsiderNull_AccountNumber_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@RegistrationDateTime'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_RegistrationDateTime_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlDateTime Param_RegistrationDateTime {

			get {

				if (this.internal_Param_RegistrationDateTime_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_RegistrationDateTime);
			}

			set {

				this.internal_Param_RegistrationDateTime_UseDefaultValue = false;
				this.internal_Param_RegistrationDateTime = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@RegistrationDateTime' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_RegistrationDateTime_UseDefaultValue() {

			this.internal_Param_RegistrationDateTime_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_RegistrationDateTime'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_RegistrationDateTime_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_RegistrationDateTime {

			get {

				if (this.internal_Param_ConsiderNull_RegistrationDateTime_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_RegistrationDateTime);
			}

			set {

				this.internal_Param_ConsiderNull_RegistrationDateTime_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_RegistrationDateTime = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_RegistrationDateTime' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_RegistrationDateTime_UseDefaultValue() {

			this.internal_Param_ConsiderNull_RegistrationDateTime_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@AccountNumber'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_AccountNumber_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlString Param_AccountNumber {

			get {

				if (this.internal_Param_AccountNumber_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_AccountNumber);
			}

			set {

				this.internal_Param_AccountNumber_UseDefaultValue = false;
				this.internal_Param_AccountNumber = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@AccountNumber' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_AccountNumber_UseDefaultValue() {

			this.internal_Param_AccountNumber_UseDefaultValue = true;
		}

		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_AccountNumber'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_AccountNumber_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_AccountNumber {

			get {

				if (this.internal_Param_ConsiderNull_AccountNumber_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_AccountNumber);
			}

			set {

				this.internal_Param_ConsiderNull_AccountNumber_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_AccountNumber = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_AccountNumber' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_AccountNumber_UseDefaultValue() {

			this.internal_Param_ConsiderNull_AccountNumber_UseDefaultValue = true;
		}
...
namespace Evernet.MoneyExchange.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spU_BeneficeryBankList' stored procedure;
	...
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:06", SqlObjectDependancyName="spU_BeneficeryBankList", SqlObjectDependancyRevision=0)]
#endif
	public class spU_BeneficeryBankList : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spU_BeneficeryBankList() : this(false) {
		...
		public spU_BeneficeryBankList(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Evernet.MoneyExchange.DataClasses.Parameters.spU_BeneficeryBankList parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Evernet.MoneyExchange.DataClasses.Parameters.spU_BeneficeryBankList parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spU_BeneficeryBankList object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spU_BeneficeryBankList object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spU_BeneficeryBankList object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.DataClasses.Parameters.spU_BeneficeryBankList)");
						}
				...
				sqlCommand.CommandText = "spU_BeneficeryBankList";
		...
		private bool DeclareParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spU_BeneficeryBankList parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@RegistrationDateTime", System.Data.SqlDbType.DateTime, 16);
				sqlParameter.SourceColumn = "RegistrationDateTime";
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_RegistrationDateTime_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_RegistrationDateTime.IsNull) {

					sqlParameter.Value = parameters.Param_RegistrationDateTime;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_RegistrationDateTime", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_RegistrationDateTime_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_RegistrationDateTime.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_RegistrationDateTime;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@AccountNumber", System.Data.SqlDbType.NVarChar, 100);
				sqlParameter.SourceColumn = "AccountNumber";
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_AccountNumber_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_AccountNumber.IsNull) {

					sqlParameter.Value = parameters.Param_AccountNumber;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_AccountNumber", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_AccountNumber_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_AccountNumber.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_AccountNumber;
				}
				else {
		...
		private bool RetrieveParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spU_BeneficeryBankList parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spU_BeneficeryBankList] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spU_BeneficeryBankList parameters) {
