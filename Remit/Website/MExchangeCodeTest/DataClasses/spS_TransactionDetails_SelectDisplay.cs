...
namespace Evernet.MoneyExchange.DataClasses.Parameters {
	...
	/// stored procedure 'spS_TransactionDetails_SelectDisplay'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:03", SqlObjectDependancyName="spS_TransactionDetails_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	public class spS_TransactionDetails_SelectDisplay : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spS_TransactionDetails_SelectDisplay class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spS_TransactionDetails_SelectDisplay() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spS_TransactionDetails_SelectDisplay class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spS_TransactionDetails_SelectDisplay(bool useDefaultValue) {
		...
		/// </summary>
		~spS_TransactionDetails_SelectDisplay() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spS_TransactionDetails_SelectDisplay'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spS_TransactionDetails_SelectDisplay");
			}
		}
...
namespace Evernet.MoneyExchange.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spS_TransactionDetails_SelectDisplay' stored procedure;
	...
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:03", SqlObjectDependancyName="spS_TransactionDetails_SelectDisplay", SqlObjectDependancyRevision=0)]
#endif
	public class spS_TransactionDetails_SelectDisplay : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spS_TransactionDetails_SelectDisplay() : this(false) {
		...
		public spS_TransactionDetails_SelectDisplay(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionDetails_SelectDisplay parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionDetails_SelectDisplay parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionDetails_SelectDisplay object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionDetails_SelectDisplay object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionDetails_SelectDisplay object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionDetails_SelectDisplay)");
						}
				...
				sqlCommand.CommandText = "spS_TransactionDetails_SelectDisplay";
		...
		private bool DeclareParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionDetails_SelectDisplay parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionDetails_SelectDisplay parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spS_TransactionDetails_SelectDisplay] stored procedure and retrieve back the data
		...
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionDetails_SelectDisplay parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionDetails_SelectDisplay parameters, out System.Data.SqlClient.SqlDataReader sqlDataReader, System.Data.CommandBehavior commandBehavior) {
		...
		/// </param>
		/// <param name="dataset">
		/// Will be populated with the data after execution. The table based name used will be: 'spS_TransactionDetails_SelectDisplay'.
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionDetails_SelectDisplay parameters, ref System.Data.DataSet dataset) {

			return(Execute(ref parameters, ref dataset, "spS_TransactionDetails_SelectDisplay", -1, -1));
		}
		...
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionDetails_SelectDisplay parameters, ref System.Data.DataSet dataset, int startRecord, int maxRecords) {

			return(Execute(ref parameters, ref dataset, "spS_TransactionDetails_SelectDisplay", startRecord, maxRecords));
		}
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionDetails_SelectDisplay parameters, ref System.Data.DataSet dataset, string tableName) {
		...
		/// <param name="maxRecords">The maximum number of records to retrieve.</param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionDetails_SelectDisplay parameters, ref System.Data.DataSet dataset, string tableName, int startRecord, int maxRecords) {
			...
			try {
				...
				dataset.Tables[tableName].Columns["CustomerId_Display"].Caption = "CustomerList_Record";
				...
				dataset.Tables[tableName].Columns["BeneficeryId_Display"].Caption = "CustomerList_Record";
				...
				dataset.Tables[tableName].Columns["BeneficeryBankId_Display"].Caption = "BeneficeryBankList_Record";
				...
				dataset.Tables[tableName].Columns["PaymentMode_Display"].Caption = "PaymentModeList_Record";
				...
				dataset.Tables[tableName].Columns["PurposeOfTransfer_Display"].Caption = "PurposeOfTransferList_Record";
				...
				dataset.Tables[tableName].Columns["PayInCurrencyId_Display"].Caption = "CurrencyList_Record";
				...
				dataset.Tables[tableName].Columns["PayOutCurrencyId_Display"].Caption = "CurrencyList_Record";
				...
				dataset.Tables[tableName].Columns["AssociatedBankId_Display"].Caption = "BankList_Record";
				...
				dataset.Tables[tableName].Columns["PayInAgentUserId_Display"].Caption = "UserList_Record";
				...
				dataset.Tables[tableName].Columns["PayInAgentLocationId_Display"].Caption = "AgentLocationList_Record";
				...
				dataset.Tables[tableName].Columns["PayOutAgentUserId_Display"].Caption = "UserList_Record";
				...
				dataset.Tables[tableName].Columns["Status_Display"].Caption = "TransactionStatusList_Record";
				...
				dataset.Tables[tableName].Columns["SettlementStatus_Display"].Caption = "TransactionSettlementStatusList_Record";
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionDetails_SelectDisplay parameters, ref string xml) {
		...
		/// </param>
		/// <returns>True if the call was successful. Otherwise, it returns False.</returns>
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spS_TransactionDetails_SelectDisplay parameters, out System.Xml.XmlReader xmlReader) {
		...
		/// the Execute method of the 'spS_TransactionDetails_SelectDisplay' class.
		/// </summary>
		public class Resultset1 {
			...
			public class Fields {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field CustomerId_Display via shared members
				/// </summary>
				public class Column_CustomerId_Display {

					/// <summary>
					/// Returns "CustomerId_Display"
					/// </summary>
					public const System.String ColumnName = "CustomerId_Display";
					/// <summary>
					/// Returns 4
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field BeneficeryId_Display via shared members
				/// </summary>
				public class Column_BeneficeryId_Display {

					/// <summary>
					/// Returns "BeneficeryId_Display"
					/// </summary>
					public const System.String ColumnName = "BeneficeryId_Display";
					/// <summary>
					/// Returns 6
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field BeneficeryBankId_Display via shared members
				/// </summary>
				public class Column_BeneficeryBankId_Display {

					/// <summary>
					/// Returns "BeneficeryBankId_Display"
					/// </summary>
					public const System.String ColumnName = "BeneficeryBankId_Display";
					/// <summary>
					/// Returns 8
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PaymentMode_Display via shared members
				/// </summary>
				public class Column_PaymentMode_Display {

					/// <summary>
					/// Returns "PaymentMode_Display"
					/// </summary>
					public const System.String ColumnName = "PaymentMode_Display";
					/// <summary>
					/// Returns 10
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PurposeOfTransfer_Display via shared members
				/// </summary>
				public class Column_PurposeOfTransfer_Display {

					/// <summary>
					/// Returns "PurposeOfTransfer_Display"
					/// </summary>
					public const System.String ColumnName = "PurposeOfTransfer_Display";
					/// <summary>
					/// Returns 12
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PayInCurrencyId_Display via shared members
				/// </summary>
				public class Column_PayInCurrencyId_Display {

					/// <summary>
					/// Returns "PayInCurrencyId_Display"
					/// </summary>
					public const System.String ColumnName = "PayInCurrencyId_Display";
					/// <summary>
					/// Returns 14
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PayOutCurrencyId_Display via shared members
				/// </summary>
				public class Column_PayOutCurrencyId_Display {

					/// <summary>
					/// Returns "PayOutCurrencyId_Display"
					/// </summary>
					public const System.String ColumnName = "PayOutCurrencyId_Display";
					/// <summary>
					/// Returns 17
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field AssociatedBankId_Display via shared members
				/// </summary>
				public class Column_AssociatedBankId_Display {

					/// <summary>
					/// Returns "AssociatedBankId_Display"
					/// </summary>
					public const System.String ColumnName = "AssociatedBankId_Display";
					/// <summary>
					/// Returns 34
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PayInAgentUserId_Display via shared members
				/// </summary>
				public class Column_PayInAgentUserId_Display {

					/// <summary>
					/// Returns "PayInAgentUserId_Display"
					/// </summary>
					public const System.String ColumnName = "PayInAgentUserId_Display";
					/// <summary>
					/// Returns 37
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PayInAgentLocationId_Display via shared members
				/// </summary>
				public class Column_PayInAgentLocationId_Display {

					/// <summary>
					/// Returns "PayInAgentLocationId_Display"
					/// </summary>
					public const System.String ColumnName = "PayInAgentLocationId_Display";
					/// <summary>
					/// Returns 39
					/// </summary>
				...
				/// <summary>
				/// Allows to get the Index and Name of the field PayOutAgentUserId_Display via shared members
				/// </summary>
				public class Column_PayOutAgentUserId_Display {

					/// <summary>
					/// Returns "PayOutAgentUserId_Display"
					/// </summary>
					public const System.String ColumnName = "PayOutAgentUserId_Display";
					/// <summary>
					/// Returns 44
					/// </summary>
				...
				/// </summary>
				public class Column_Status_Display {
				...
				/// <summary>
				/// Allows to get the Index and Name of the field SettlementStatus_Display via shared members
				/// </summary>
				public class Column_SettlementStatus_Display {

					/// <summary>
					/// Returns "SettlementStatus_Display"
					/// </summary>
					public const System.String ColumnName = "SettlementStatus_Display";
					/// <summary>
					/// Returns 51
					/// </summary>
