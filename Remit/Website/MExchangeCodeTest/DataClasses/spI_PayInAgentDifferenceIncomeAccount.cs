...
namespace Evernet.MoneyExchange.DataClasses.Parameters {
	...
	/// stored procedure 'spI_PayInAgentDifferenceIncomeAccount'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:46:45", SqlObjectDependancyName="spI_PayInAgentDifferenceIncomeAccount", SqlObjectDependancyRevision=0)]
#endif
	public class spI_PayInAgentDifferenceIncomeAccount : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spI_PayInAgentDifferenceIncomeAccount class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spI_PayInAgentDifferenceIncomeAccount() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spI_PayInAgentDifferenceIncomeAccount class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spI_PayInAgentDifferenceIncomeAccount(bool useDefaultValue) {
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spI_PayInAgentDifferenceIncomeAccount'";
		...
		/// </summary>
		~spI_PayInAgentDifferenceIncomeAccount() {

			Dispose(false);
		}

		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spI_PayInAgentDifferenceIncomeAccount'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spI_PayInAgentDifferenceIncomeAccount");
			}
		}
...
namespace Evernet.MoneyExchange.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spI_PayInAgentDifferenceIncomeAccount' stored procedure;
	...
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:46:45", SqlObjectDependancyName="spI_PayInAgentDifferenceIncomeAccount", SqlObjectDependancyRevision=0)]
#endif
	public class spI_PayInAgentDifferenceIncomeAccount : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spI_PayInAgentDifferenceIncomeAccount() : this(false) {
		...
		public spI_PayInAgentDifferenceIncomeAccount(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Evernet.MoneyExchange.DataClasses.Parameters.spI_PayInAgentDifferenceIncomeAccount parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Evernet.MoneyExchange.DataClasses.Parameters.spI_PayInAgentDifferenceIncomeAccount parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spI_PayInAgentDifferenceIncomeAccount object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spI_PayInAgentDifferenceIncomeAccount object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spI_PayInAgentDifferenceIncomeAccount object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.DataClasses.Parameters.spI_PayInAgentDifferenceIncomeAccount)");
						}
				...
				sqlCommand.CommandText = "spI_PayInAgentDifferenceIncomeAccount";
		...
		private bool DeclareParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spI_PayInAgentDifferenceIncomeAccount parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		private bool RetrieveParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spI_PayInAgentDifferenceIncomeAccount parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spI_PayInAgentDifferenceIncomeAccount] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spI_PayInAgentDifferenceIncomeAccount parameters) {
