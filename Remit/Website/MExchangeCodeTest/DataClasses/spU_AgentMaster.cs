...
namespace Evernet.MoneyExchange.DataClasses.Parameters {
	...
	/// stored procedure 'spU_AgentMaster'. It allows also to specify specific connection
	/// information such as the ConnectionString to be use, the command time-out and so forth.
	/// </summary>
	[Serializable()]
#if OLYMARS_ATTRIBUTE || OLYMARS_DEBUG
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:06", SqlObjectDependancyName="spU_AgentMaster", SqlObjectDependancyRevision=0)]
#endif
	public class spU_AgentMaster : MarshalByRefObject, IDisposable, IParameter {
		...
		/// <summary>
		/// Initializes a new instance of the spU_AgentMaster class. If you use this constructor version,
		/// not assigning parameter values implies using the parameter default values.
		/// </summary>
		public spU_AgentMaster() : this(true) {

		}

		/// <summary>
		/// Initializes a new instance of the spU_AgentMaster class.
		/// </summary>
		/// <param name="useDefaultValue">If True, this parameter indicates that "not assigning parameter values" implies "using the parameter default values". If False, this parameter indicates that "not assigning parameter values" implies "using the SQL Server Null value".</param>
		public spU_AgentMaster(bool useDefaultValue) {
			...
			this.internal_Param_ConsiderNull_ParentId_UseDefaultValue = this.useDefaultValue;
			...
			this.internal_Param_ConsiderNull_Number_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_CreditLimitInUSD_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_CreditLimitInUSD_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_PayInThreshold_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_PayInThreshold_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_BankSwiftCode_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_BankSwiftCode_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_DraftStatusUrl_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_DraftStatusUrl_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_DraftStatusVariable_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_DraftStatusVariable_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_CountryId_UseDefaultValue = this.useDefaultValue;
			this.internal_Param_ConsiderNull_CountryId_UseDefaultValue = this.useDefaultValue;
		...
		public void SetUpConnection(string connectionString) {
			...
			if (olymarsDebugCheck == null || (string)olymarsDebugCheck == "True") {
				...
				if (DebugConnectionString.Length != 0) {
					...
					sqlCommand.CommandText = "Select sysobjects.schema_ver from sysobjects where sysobjects.name = 'spU_AgentMaster'";
					...
					if (CurrentRevision != OriginalRevision) {
						...
						throw new System.InvalidOperationException(System.String.Format("OLYMARS: This code is not in sync anymore with [{0}]. It was generated when [{0}] version was: {2}. Current [{0}] version is: {1}{3}{3}You can either regenerate the code for this class so that it will be based on the new version or edit the configuration file of the class caller application and paste the following code:{3}{3}<?xml version=\"1.0\" encoding=\"utf-8\" ?>{3}<configuration>{3}\t<appSettings>{3}\t\t<add key=\"OlymarsDebugCheck\" value=\"False\" />{3}\t</appSettings>{3}</configuration>{3}{3}You will need to reload the caller application if it is a Windows Forms based application.", "spU_AgentMaster", CurrentRevision, OriginalRevision, System.Environment.NewLine));
					}
				}
			}
#endif
		...
		private void Dispose(bool disposing) {
			...
			if (disposing) {
				...
				this.internal_Param_ConsiderNull_ParentId = System.Data.SqlTypes.SqlBoolean.Null;
				...
				this.internal_Param_ConsiderNull_Number = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_CreditLimitInUSD = System.Data.SqlTypes.SqlDecimal.Null;
				this.internal_Param_ConsiderNull_CreditLimitInUSD = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_PayInThreshold = System.Data.SqlTypes.SqlDecimal.Null;
				this.internal_Param_ConsiderNull_PayInThreshold = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_BankSwiftCode = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_BankSwiftCode = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_DraftStatusUrl = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_DraftStatusUrl = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_DraftStatusVariable = System.Data.SqlTypes.SqlString.Null;
				this.internal_Param_ConsiderNull_DraftStatusVariable = System.Data.SqlTypes.SqlBoolean.Null;
				this.internal_Param_CountryId = System.Data.SqlTypes.SqlGuid.Null;
				this.internal_Param_ConsiderNull_CountryId = System.Data.SqlTypes.SqlBoolean.Null;
		...
		/// <summary>
		/// Returns the stored procedure name for which this class was built, i.e. 'spU_AgentMaster'.
		/// </summary>
		public string StoredProcedureName {

			get {

				return("spU_AgentMaster");
			}
		}
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_ParentId;
		internal bool internal_Param_ConsiderNull_ParentId_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_Number;
		internal bool internal_Param_ConsiderNull_Number_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_CreditLimitInUSD;
		internal bool internal_Param_ConsiderNull_CreditLimitInUSD_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_PayInThreshold;
		internal bool internal_Param_ConsiderNull_PayInThreshold_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_BankSwiftCode;
		internal bool internal_Param_ConsiderNull_BankSwiftCode_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_DraftStatusUrl;
		internal bool internal_Param_ConsiderNull_DraftStatusUrl_UseDefaultValue = true;
		...
		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_DraftStatusVariable;
		internal bool internal_Param_ConsiderNull_DraftStatusVariable_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlGuid internal_Param_CountryId;
		internal bool internal_Param_CountryId_UseDefaultValue = true;

		private System.Data.SqlTypes.SqlBoolean internal_Param_ConsiderNull_CountryId;
		internal bool internal_Param_ConsiderNull_CountryId_UseDefaultValue = true;
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_ParentId'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_ParentId_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_ParentId {

			get {

				if (this.internal_Param_ConsiderNull_ParentId_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_ParentId);
			}

			set {

				this.internal_Param_ConsiderNull_ParentId_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_ParentId = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_ParentId' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_ParentId_UseDefaultValue() {

			this.internal_Param_ConsiderNull_ParentId_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_Number'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_Number_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_Number {

			get {

				if (this.internal_Param_ConsiderNull_Number_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_Number);
			}

			set {

				this.internal_Param_ConsiderNull_Number_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_Number = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_Number' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_Number_UseDefaultValue() {

			this.internal_Param_ConsiderNull_Number_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_CreditLimitInUSD'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_CreditLimitInUSD_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_CreditLimitInUSD {

			get {

				if (this.internal_Param_ConsiderNull_CreditLimitInUSD_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_CreditLimitInUSD);
			}

			set {

				this.internal_Param_ConsiderNull_CreditLimitInUSD_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_CreditLimitInUSD = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_CreditLimitInUSD' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_CreditLimitInUSD_UseDefaultValue() {

			this.internal_Param_ConsiderNull_CreditLimitInUSD_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_PayInThreshold'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_PayInThreshold_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_PayInThreshold {

			get {

				if (this.internal_Param_ConsiderNull_PayInThreshold_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_PayInThreshold);
			}

			set {

				this.internal_Param_ConsiderNull_PayInThreshold_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_PayInThreshold = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_PayInThreshold' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_PayInThreshold_UseDefaultValue() {

			this.internal_Param_ConsiderNull_PayInThreshold_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_BankSwiftCode'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_BankSwiftCode_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_BankSwiftCode {

			get {

				if (this.internal_Param_ConsiderNull_BankSwiftCode_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_BankSwiftCode);
			}

			set {

				this.internal_Param_ConsiderNull_BankSwiftCode_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_BankSwiftCode = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_BankSwiftCode' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_BankSwiftCode_UseDefaultValue() {

			this.internal_Param_ConsiderNull_BankSwiftCode_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_DraftStatusUrl'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_DraftStatusUrl_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_DraftStatusUrl {

			get {

				if (this.internal_Param_ConsiderNull_DraftStatusUrl_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_DraftStatusUrl);
			}

			set {

				this.internal_Param_ConsiderNull_DraftStatusUrl_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_DraftStatusUrl = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_DraftStatusUrl' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_DraftStatusUrl_UseDefaultValue() {

			this.internal_Param_ConsiderNull_DraftStatusUrl_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_DraftStatusVariable'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_DraftStatusVariable_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_DraftStatusVariable {

			get {

				if (this.internal_Param_ConsiderNull_DraftStatusVariable_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_DraftStatusVariable);
			}

			set {

				this.internal_Param_ConsiderNull_DraftStatusVariable_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_DraftStatusVariable = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_DraftStatusVariable' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_DraftStatusVariable_UseDefaultValue() {

			this.internal_Param_ConsiderNull_DraftStatusVariable_UseDefaultValue = true;
		}
		...
		/// <summary>
		/// Sets the value of the stored procedure INPUT parameter '@ConsiderNull_CountryId'.
		/// </summary>
		/// <remarks>
		/// <list type="number">
		/// <item>
		...
		/// If this parameter is not set before the stored procedure call occurs, a Null (SQL Server meaning) value
		/// will be supplied to the corresponding parameter when the call is made. If you wish to use
		/// the parameter default value, consider calling the Param_ConsiderNull_CountryId_UseDefaultValue() method.
		/// </description>
		/// </item>
		/// </list>
		/// </remarks>
		public System.Data.SqlTypes.SqlBoolean Param_ConsiderNull_CountryId {

			get {

				if (this.internal_Param_ConsiderNull_CountryId_UseDefaultValue) {
				
					throw new InvalidOperationException("This parameter is not assigned and maps to the stored procedure parameter default value.");
				}
				return(this.internal_Param_ConsiderNull_CountryId);
			}

			set {

				this.internal_Param_ConsiderNull_CountryId_UseDefaultValue = false;
				this.internal_Param_ConsiderNull_CountryId = value;
			}
		}            

		/// <summary>
		/// Indicates that the '@ConsiderNull_CountryId' parameter value is not supplied and that the default value should be used.
		/// </summary>
		public void Param_ConsiderNull_CountryId_UseDefaultValue() {

			this.internal_Param_ConsiderNull_CountryId_UseDefaultValue = true;
		}
...
namespace Evernet.MoneyExchange.DataClasses.StoredProcedures {
	...
	/// <summary>
	/// This class allows you to execute the 'spU_AgentMaster' stored procedure;
	...
	[OlymarsInformation(DeveloperName="Evernet Technologies LLC", GeneratedOn="2004/11/30 19:47:06", SqlObjectDependancyName="spU_AgentMaster", SqlObjectDependancyRevision=0)]
#endif
	public class spU_AgentMaster : MarshalByRefObject, IDisposable {
		...
		/// </summary>
		public spU_AgentMaster() : this(false) {
		...
		public spU_AgentMaster(bool throwExceptionOnExecute) {
		...
		private void ResetParameter(ref Evernet.MoneyExchange.DataClasses.Parameters.spU_AgentMaster parameters) {

			parameters.internal_Set_RETURN_VALUE (System.Data.SqlTypes.SqlInt32.Null);
		}

		private bool InitializeConnection(ref Evernet.MoneyExchange.DataClasses.Parameters.spU_AgentMaster parameters, out System.Data.SqlClient.SqlCommand sqlCommand, ref bool connectionMustBeClosed) {
			...
			try {
				...
				if (parameters.ConnectionType == ConnectionType.None) {
					...
					throw new InvalidOperationException("No connection information was supplied. Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spU_AgentMaster object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlConnection && parameters.SqlConnection == null) {

					throw new InvalidOperationException("No connection information was supplied (SqlConnection == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spU_AgentMaster object before doing this call.");
				}

				if (parameters.ConnectionType == ConnectionType.SqlTransaction && parameters.SqlTransaction== null) {

					throw new InvalidOperationException("No connection information was supplied (SqlTransaction == null). Consider calling the 'SetUpConnection' method of the Evernet.MoneyExchange.DataClasses.Parameters.spU_AgentMaster object before doing this call.");
				}
				...
				switch (parameters.ConnectionType) {
					...
					case ConnectionType.ConnectionString:
						...
						if (connectionString.Length == 0) {
							...
							throw new System.InvalidOperationException("No connection information was supplied (ConnectionString == \"\")! (Evernet.MoneyExchange.DataClasses.Parameters.spU_AgentMaster)");
						}
				...
				sqlCommand.CommandText = "spU_AgentMaster";
		...
		private bool DeclareParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spU_AgentMaster parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
			...
			try {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_ParentId", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_ParentId_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_ParentId.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_ParentId;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_Number", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_Number_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_Number.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_Number;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_CreditLimitInUSD", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_CreditLimitInUSD_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_CreditLimitInUSD.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_CreditLimitInUSD;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_PayInThreshold", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_PayInThreshold_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_PayInThreshold.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_PayInThreshold;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_BankSwiftCode", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_BankSwiftCode_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_BankSwiftCode.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_BankSwiftCode;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_DraftStatusUrl", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_DraftStatusUrl_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_DraftStatusUrl.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_DraftStatusUrl;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_DraftStatusVariable", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_DraftStatusVariable_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_DraftStatusVariable.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_DraftStatusVariable;
				}
				else {
				...
				sqlParameter = new System.Data.SqlClient.SqlParameter("@ConsiderNull_CountryId", System.Data.SqlDbType.Bit, 1);
				sqlParameter.Direction = System.Data.ParameterDirection.Input;
				if (parameters.internal_Param_ConsiderNull_CountryId_UseDefaultValue) {

					sqlParameter.Value = null;				
				}
				else if (!parameters.Param_ConsiderNull_CountryId.IsNull) {

					sqlParameter.Value = parameters.Param_ConsiderNull_CountryId;
				}
				else {
		...
		private bool RetrieveParameters(ref Evernet.MoneyExchange.DataClasses.Parameters.spU_AgentMaster parameters, ref System.Data.SqlClient.SqlCommand sqlCommand) {
		...
		/// <summary>
		/// This method allows you to execute the [spU_AgentMaster] stored procedure.
		/// </summary>
		...
		public bool Execute(ref Evernet.MoneyExchange.DataClasses.Parameters.spU_AgentMaster parameters) {
