...
namespace ARYETP
{
	...
	public class FTPClient
	{
		...
		// m_strErrorMessage Testing New UploadFile..
...
Trace.WriteLine("Inside Exception2" + e.Message);
		...
		/*public int UploadFile(string l_strFullPath,string l_strFileName,char l_chTransferType,int l_iUploadSize)
		{
			...
			System.Net.Sockets.TcpListener l_DataListener = null;
			Socket l_ClientDataSocket = null;
			bool l_bAcceptFailed = false;
			...
			try 
			{
				...
				{
					l_ClientDataSocket = l_DataListener.AcceptSocket();
				}
				else 
				{
					/*	Else return from the upload function with error *
				...
				/* Set Socket options *
				//l_ClientDataSocket.SetSocketOption(SocketOption.SolSocket,SocketOption.SoSndTimeo,m_iSendTimeout);
