...
namespace FTPExplorer
{
    ...
    public class FTPClient
    {
        ...
        public FTPClient()
        {
			...
			m_iDataPort = 12000;	/*	Start with 10000 */
		...
		private int Login(){
			...
			if ( lstr_temp == "UNIX" ) {
				...
				m_strErrorMessage = "FTP Exploring on non Unix Operating System not supported in Beta 1 version. This will be enabled in future versions.";
				CloseConnection();
				return 0;
			}
...
*/
		...
		*/
		...
		public int DownLoadFile(DownloadFileData l_FileObject,char l_chTransferType){
			...
			int l_iBytesRevd = 0, l_iBufferLimit = 1023;
