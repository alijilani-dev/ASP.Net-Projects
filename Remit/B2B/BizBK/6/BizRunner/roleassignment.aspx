<%@ Page language="c#" Codebehind="roleassignment.aspx.cs" Inherits="BizRunner.RoleAssignment" AutoEventWireup="false" %>
...
<body Xmlns:mobile="http://schemas.microsoft.com/Mobile/WebForm">
	<P>
		<mobile:Form id="Form1" runat="server">
			...
			<mobile:Label id="lblAvailableRoles" runat="server" Font-Name="Verdana" Font-Size="Small" Font-Bold="True">Available Roles</mobile:Label>
			<mobile:List id="lstAvailableRoles" runat="server" Font-Name="Verdana" Font-Size="Small" DataValueField="value"
				DataTextField="Name" Wrapping="NoWrap" Decoration="Numbered"></mobile:List>
			<mobile:Command id="cmdAssign" runat="server">Assign Role</mobile:Command>
			<mobile:Command id="cmdRemove" runat="server">Remove Role</mobile:Command>
			<mobile:Label id="lblAssignedRoles" runat="server" Font-Name="Verdana" Font-Size="Small" Font-Bold="True">Assigned Roles</mobile:Label>
			<mobile:List id="lstAssignedRoles" runat="server" DataValueField="Value" DataTextField="Name"
				Wrapping="NoWrap" Decoration="Numbered"></mobile:List>
		</mobile:Form>
	</P>
	<P>
		<mobile:form id="frmUserDetails" title="User Details" runat="server" StyleReference="subcommand"
			Alignment="Left" Wrapping="NoWrap">
