	...
	<TABLE id="tblCustomers" cellSpacing="1" cellPadding="1" border="0">
		<TR>
			<TD width="100" colSpan="2">
				<mobile:List id="CustomersList" runat="server" Font-Bold="False" DataTextField="CompanyName"
					DataValueField="Id" Wrapping="NoWrap" StyleReference="title" Decoration="Numbered" Font-Name="Verdana"
					Font-Size="Small"></mobile:List></TD>
		</TR>
		<TR>
			<TD width="100">
