...
<body Xmlns:mobile="http://schemas.microsoft.com/Mobile/WebForm">
	<mobile:form id="frmServicesView" title="Task View" Wrapping="NoWrap" runat="server">
		...
		<mobile:List id="ServicesList" runat="server" Wrapping="NoWrap" Alignment="Left" DataValueField="Id"
			DataTextField="Title" Decoration="Numbered" Font-Size="Small" Font-Name="Verdana"></mobile:List>
