...
<body Xmlns:mobile="http://schemas.microsoft.com/Mobile/WebForm">
	<mobile:Form id="frmSecurityView" runat="server" title="Security View">
		<mobile:List id="lstSecurity" runat="server" DataTextField="LoginName" DataValueField="Id" Decoration="Numbered"
			Font-Size="Small" Font-Name="Verdana" Wrapping="NoWrap"></mobile:List>
		<mobile:Label id="lblTotalCost" runat="server" Font-Size="Small" Font-Name="Verdana" Font-Bold="True">Total Users:</mobile:Label>
