	...
	<mobile:Form id="frmControlPanel" runat="server" title="Control Panel">
		<TABLE>
			...
			<TR>
				<TD></TD>
				<TD align="centre">
					<mobile:Image id="imgCustomerView" runat="server" NavigateUrl="customerview.aspx" ImageUrl="file:///C:\Documents and Settings\Administrator\Desktop\CustomerView.jpg"></mobile:Image>
				</TD>
				<TD></TD>
			</TR>
			<TR>
				<TD></TD>
				<TD align="centre">
					<mobile:Image id="imgTaskView" runat="server" NavigateUrl="taskview.aspx" ImageUrl="file:///C:\Documents and Settings\Administrator\Desktop\Task View.jpg"></mobile:Image>
				</TD>
				<TD></TD>
			</TR>
			<TR>
