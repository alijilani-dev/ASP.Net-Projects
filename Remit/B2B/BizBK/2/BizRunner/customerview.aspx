...
<mobile:form id="frmCustomers" title="Customers View" runat="server" BackColor="LightBlue" Alignment="Left">
	<TABLE id="tblCustomers" cellSpacing="1" cellPadding="1" border="1">
		<TR>
		...
		<TR>
			<TD width="100">
				<mobile:Command id="cmdAddCustomer" runat="server">Add Customer</mobile:Command></TD>
			<TD width="100">
				<mobile:Command id="cmdReturn" runat="server">Return to Menu</mobile:Command></TD>
		</TR>
	</TABLE>
</mobile:form>
<mobile:form id="frmCustomerDetails" title="Customer Details" runat="server" BackColor="LightBlue"
	...
	<TABLE id="tblDetails" cellSpacing="1" cellPadding="1" border="1">
		<TR>
			<TD width="100" colSpan="2">
		...
		<TR>
			<TD width="100" colSpan="2" height="3">
				<mobile:Command id="cmdBack" runat="server" Visible="False">Back</mobile:Command></TD>
			<TD width="100" colSpan="2" height="3"></TD>
			<TD width="100" height="3">
				<mobile:Command id="cmdCancel" runat="server" Visible="False">Cancel</mobile:Command></TD>
		</TR>
		<TR>
