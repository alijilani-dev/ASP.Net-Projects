...
<body Xmlns:mobile="http://schemas.microsoft.com/Mobile/WebForm">
	<mobile:Form id="frmResourceView" runat="server" title="Sales View">
		<mobile:List id="lstResources" runat="server" Wrapping="NoWrap" Font-Name="Verdana" Font-Size="Small"
			Decoration="Numbered" DataValueField="Id" DataTextField="Name"></mobile:List>
		<mobile:Label id="lblTotalCost" runat="server" Font-Name="Verdana" Font-Size="Small" Font-Bold="True">Total Cost:</mobile:Label>
		...
		<TABLE id="Table2" cellSpacing="1" cellPadding="1" border="1">
			...
			<TR>
				...
				<TD width="100" height="3">
					<mobile:TextBox id="txtDate" runat="server"></mobile:TextBox>
				</TD>
