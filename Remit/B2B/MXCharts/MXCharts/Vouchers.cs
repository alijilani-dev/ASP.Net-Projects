...
namespace MXCharts
{
	public class Vouchers : System.Windows.Forms.Form
	{
		...
		public Vouchers()
		{
			ConnectionString =((string) System.Configuration.ConfigurationSettings.AppSettings.GetValues("MXCharts.ConnectionString").GetValue(0));
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Vouchers));
			...
			// btn_NewRecord
			// 
			this.btn_NewRecord.Location = new System.Drawing.Point(536, 352);
			...
			this.txt_VoucherNumber.Location = new System.Drawing.Point(120, 352);
			this.txt_VoucherNumber.Name = "txt_VoucherNumber";
			this.txt_VoucherNumber.Size = new System.Drawing.Size(328, 20);
			...
			// btn_RemoveRecords
			// 
			this.btn_RemoveRecords.Location = new System.Drawing.Point(16, 320);
			...
			// txt_VoucherDate
			// 
			this.txt_VoucherDate.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.txt_VoucherDate.Location = new System.Drawing.Point(112, 8);
			this.txt_VoucherDate.Name = "txt_VoucherDate";
			this.txt_VoucherDate.Size = new System.Drawing.Size(344, 21);
			...
			// txt_ValueDate
			// 
			this.txt_ValueDate.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.txt_ValueDate.Location = new System.Drawing.Point(552, 8);
			this.txt_ValueDate.Name = "txt_ValueDate";
			this.txt_ValueDate.Size = new System.Drawing.Size(296, 21);
			...
			// btn_Insert
			// 
			this.btn_Insert.Location = new System.Drawing.Point(656, 352);
			...
			// btn_Exit
			// 
			this.btn_Exit.Location = new System.Drawing.Point(776, 352);
			...
			this.groupBox2.Size = new System.Drawing.Size(864, 208);
			...
			// lblNetCredit
			// 
			this.lblNetCredit.Location = new System.Drawing.Point(760, 184);
			...
			// lblNetDebit
			// 
			this.lblNetDebit.Location = new System.Drawing.Point(568, 184);
			...
			this.label6.Location = new System.Drawing.Point(656, 184);
			...
			this.dg_Vouchers.Size = new System.Drawing.Size(832, 152);
			this.dg_Vouchers.TabIndex = 0;
			// 
			// txt_Narration
			// 
			this.txt_Narration.Font = new System.Drawing.Font("Microsoft Sans Serif", 10F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.txt_Narration.Location = new System.Drawing.Point(88, 288);
			this.txt_Narration.Multiline = true;
			this.txt_Narration.Name = "txt_Narration";
			this.txt_Narration.Size = new System.Drawing.Size(776, 48);
		...
		#endregion Wizard Generated Code.
		#region Events.
		...
		{
			if((((ComboBox)sender).SelectedValue) != DBNull.Value)
			{
			...
			}else MessageBox.Show(((ComboBox)sender).SelectedText.Trim());
		}
		private void txt_Narration_Enter(object sender, System.EventArgs e)
		{
		...
		private void txt_Narration_Leave(object sender, System.EventArgs e)
		{
			...
			{MessageBox.Show("Your Data has already been updated.","MXCharts",MessageBoxButtons.OK);}
		...
		{
			int n_ValidRow = 0;
			for (n_ValidRow=0; n_ValidRow <dsv.Tables["VoucherDetails"].Rows.Count; n_ValidRow++)
				if(dsv.Tables["VoucherDetails"].Rows[n_ValidRow]["AgentAccountID"]== DBNull.Value)
					break;
			for (int n_Counter = 0; n_Counter < n_ValidRow ; n_Counter++)
			{
				string strVal = (dsv.Tables["VoucherDetails"].Rows[n_Counter]["AgentAccountID"]).ToString();
				if((strVal!=string.Empty)||(strVal!="")||(strVal!=null)||(dsv.Tables["VoucherDetails"].Rows[n_Counter]["AgentAccountID"]!=DBNull.Value))
				{
					if(IsValidGroup)
					{
						string strQuery = GetQuery(Actions.AddDetails,dsv.Tables["VoucherDetails"].Rows[n_Counter]);
						SqlCommand cmd_Add = new SqlCommand(strQuery,ARYFL_Conn);
						Guid AgentAccountID = new Guid(((string)dsv.Tables["VoucherDetails"].Rows[n_Counter]["AgentAccountID"]).ToString());
			...
			if(expMaster == string.Empty)
			{
				if(IsValidGroup == true)
				{
					...
					{posted = true;MessageBox.Show("Your data has been successfully posted.","MXCharts",MessageBoxButtons.OK);}
					else
					{MessageBox.Show("Please insert valid Narration and records." + expDetails.ToString(),"MXCharts",MessageBoxButtons.OK);}
				}
				else
				{
					if(expDetails==string.Empty)
		...
		{
			DataTable dt = new DataTable("AgentMaster");
			dt.Columns.Add(new DataColumn("Id", Type.GetType("System.String")));
			dt.Columns.Add(new DataColumn("Name", Type.GetType("System.String")));
			
			DataRow dr = dt.NewRow();
			dr["Id"] = DBNull.Value;
			dr["Name"] = "Please Select a value.";
			dt.Rows.Add(dr);

			string str_Query = "Select Name + ' [' + Number + '.1]' Name, id from AgentMaster union Select Name + ' [' + Number + '.2]' Name, id from AgentMaster order by Name";
		...
		private void EmbedComboColumn()
		{
			...
			for(int i = 0; i < dt_Vouchers.Columns.Count; ++i)
			{
				...
				{
					#region DataGridComboBoxNew.
					Debug.WriteLine("----------Inserting ComboColumn..-------------");
					DataGridComboBoxColumn ComboTextCol = new DataGridComboBoxColumn(dsv.Tables["AgentMaster"], "Name", "Id");
					//tableStyle.GridColumnStyles.Add(new DataGridComboBoxColumn(dsv.Tables["AgentMaster"], "Name", "Id"));
					ComboTextCol.MappingName = "AgentAccountID";
					ComboTextCol.HeaderText = "Agent Account";
					ComboTextCol.NullText = string.Empty;
					ComboTextCol.Width = 250;
					ComboTextCol.Combo.SelectionChangeCommitted += new System.EventHandler(this.cmb_SelectedValueChanged);
					ComboTextCol.Alignment = HorizontalAlignment.Left;
					tableStyle.PreferredRowHeight = ComboTextCol.Combo.Height + 2;
					tableStyle.GridColumnStyles.Add(ComboTextCol);
					#endregion DataGridComboBoxNew.
					#region DataGridComboBoxColumn.Commented.
				/*	DataGridComboBoxColumn ComboTextCol = new DataGridComboBoxColumn(dsv.Tables["AgentMaster"], "Name", "ID");
					...
					tableStyle.GridColumnStyles.Add(ComboTextCol);*/
					#endregion DataGridComboBoxColumn.Commented
					#region DataGridComboBoxColumnold.
					...
					tableStyle.PreferredRowHeight = ComboTextCol.ColumnComboBox.Height + 2;
					tableStyle.GridColumnStyles.Add(ComboTextCol);*/
					#endregion DataGridComboBoxColumnold.
				}
			}
		...
		private void InsertBlankRow()
		{
			...
			drvd["AgentAccountID"] = DBNull.Value;
			drvd["MasterID"] = "";
			drvd["Rate"] = "";
			drvd["CurrencyCode"] = "";
			drvd["Principal"] = "";
		...
		private void ShowReport(int n_MasterID)
		{
			VoucherReport frm_VReport = new VoucherReport(n_MasterID);
			frm_VReport.Show();
		}
		#endregion Facade.
	}
