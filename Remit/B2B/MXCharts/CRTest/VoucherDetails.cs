...
namespace CRTest {
    ...
    public class VoucherDetails : ReportClass {
    ...
    public class CachedVoucherDetails : Component, ICachedReport {
        
        public CachedVoucherDetails() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            VoucherDetails rpt = new VoucherDetails();
            rpt.Site = this.Site;
            return rpt;
        }
