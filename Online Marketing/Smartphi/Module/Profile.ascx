<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Profile.ascx.vb" Inherits="Smartphi.Profile" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<div align="center">
