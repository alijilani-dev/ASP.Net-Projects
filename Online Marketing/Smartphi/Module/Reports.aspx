...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Reports.aspx.vb" Inherits="Smartphi.Reports" %>
											...
											<TR>
												<TD>
													<TABLE id="table9" bgColor="#D2E1F1" class="txt" height="22" cellSpacing="0" cellPadding="0"
														width="100%" bgColor="#ffdfe4" border="0">
														<TR>
											...
											<TR>
												<TD>
													<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0" runat="server">
														<TR>
															<TD id="tdContent" colSpan="2" style="BORDER-RIGHT: #d2e1f1 1px solid; BORDER-TOP: #d2e1f1 1px solid; BORDER-LEFT: #d2e1f1 1px solid; BORDER-BOTTOM: #d2e1f1 1px solid" runat="server"></TD>
														</TR>
														<TR>
															<TD colSpan="2"></TD>
														</TR>
