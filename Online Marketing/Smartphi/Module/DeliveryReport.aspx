...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DeliveryReport.aspx.vb" Inherits="Smartphi.DeliveryReport" %>
<%@ Register TagPrefix="uc1" TagName="ContactList" Src="ContactList.ascx" %>
<%@ Register TagPrefix="uc1" TagName="DeliveryReport" Src="DeliveryReport.ascx" %>
...
<HTML>
	<HEAD>
		...
		function ShowPreview() 
		{
			...
			var dlgSettings = "center:yes;help:No;resizable:No;status:No;scroll:Yes;dialogWidth=800px;dialogHeight=600px;dialogHide:true;";
								...
								<TD>
									<DIV align="center">
										<TABLE id="table7" cellSpacing="1" cellPadding="0" width="90%" border="0">
														...
														<TABLE id="table8" cellSpacing="1" cellPadding="0" border="0">
															<TR>
																...
																<TD align="center"><A href="Reports.aspx"><IMG id="img8" onmouseover="FP_swapImg(1,1,/*id*/'img8',/*url*/'../images/btn_reports_ovr.jpg');"
																			onmouseout="FP_swapImgRestore()" src="../images/btn_reports_ovr.jpg" border="0"></A></TD>
											...
											<TR>
												<TD>
													<TABLE id="table9" bgColor="#d2e1f1" class="txt" height="22" cellSpacing="0" cellPadding="0"
														width="100%" border="0">
														<TR>
															<TD>&nbsp;<img border="0" src="../images/bullet.gif" width="5" height="9">&nbsp;<asp:HyperLink id="hlnkTrackRpt" runat="server" NavigateUrl="Reports.aspx?module=1">Track Report</asp:HyperLink></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
											<TR>
												<TD style="BORDER-RIGHT: #d2e1f1 1px solid; BORDER-TOP: #d2e1f1 1px solid; BORDER-LEFT: #d2e1f1 1px solid; BORDER-BOTTOM: #d2e1f1 1px solid"><uc1:DeliveryReport id="DeliveryReport1" runat="server"></uc1:DeliveryReport>
												</TD>
											</TR>
										</TABLE>
									</DIV>
