...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Tracking.aspx.vb" Inherits="Smartphi.Tracking" %>
<%@ Register TagPrefix="uc1" TagName="TrackReport" Src="TrackReport.ascx" %>
											...
											<TR>
												<TD>
													<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0" runat="server">
														<TR>
															<TD id="tdContent" colSpan="2" style="BORDER-RIGHT: #d2e1f1 1px solid; BORDER-TOP: #d2e1f1 1px solid; BORDER-LEFT: #d2e1f1 1px solid; BORDER-BOTTOM: #d2e1f1 1px solid"
																runat="server">
																<uc1:TrackReport id="TrackReport1" runat="server"></uc1:TrackReport></TD>
														</TR>
														<TR>
															<TD colSpan="2"></TD>
														</TR>
