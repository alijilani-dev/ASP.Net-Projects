<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MyProfile.aspx.vb" Inherits="Smartphi.MyProfile" %>
														...
														<TABLE id="table8" cellSpacing="1" cellPadding="0" border="0">
															<TR>
																...
																<TD align="center"><A href="MyProfile.aspx"><IMG id="img9" onmouseover="FP_swapImg(1,1,/*id*/'img9',/*url*/'../images/btn_myprofile_ovr.jpg');"
																			onmouseout="FP_swapImgRestore(); FP_swapImgRestore()" src="../images/btn_myprofile_ovr.jpg" border="0"></A></TD>
															</TR>
														</TABLE>
													</DIV>
												</TD>
													...
													<TABLE id="table9" bgColor="#d2e1f1" class="txt" height="22" cellSpacing="0" cellPadding="0"
														...
														<TR>
															<TD>&nbsp;<img border="0" src="../images/bullet.gif" width="5" height="9">
																<asp:HyperLink id="hlnkProfile" runat="server" NavigateUrl="MyProfile.aspx?module=1">Update Profile</asp:HyperLink>&nbsp;&nbsp;<img border="0" src="../images/bullet.gif" width="5" height="9">&nbsp;
																<asp:HyperLink id="hlnkConfig" runat="server" NavigateUrl="MyProfile.aspx?module=2">Update Mail Settings</asp:HyperLink>&nbsp;
																<img border="0" src="../images/bullet.gif" width="5" height="9">
																<asp:HyperLink id="hlnkUpdatewd" runat="server" NavigateUrl="MyProfile.aspx?module=3">Change Password</asp:HyperLink>
															</TD>
														</TR>
													</TABLE>
												</TD>
											...
											<TR>
												<TD style="BORDER-RIGHT: #d2e1f1 1px solid; BORDER-TOP: #d2e1f1 1px solid; BORDER-LEFT: #d2e1f1 1px solid; BORDER-BOTTOM: #d2e1f1 1px solid">
													<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0" runat="server">
														<TR>
															<TD id="tdContent" colSpan="2" runat="server"></TD>
														</TR>
														<TR>
															<TD colSpan="2"></TD>
														</TR>
