...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Preview.aspx.vb" Inherits="Smartphi.Preview" %>
...
<HTML>
	<HEAD>
		...
		function GetPopup(params,wndSize) 
		{
			var dialogInputArg = new Array("Param1", "Param2");
			var dlgSettings = "center:yes;help:No;resizable:No;status:No;scroll:Yes;" + wndSize;
								...
								<TD>
									<DIV align="center">
										<TABLE id="table7" cellSpacing="1" cellPadding="0" width="90%" border="0">
											...
											<TR>
												<TD>
													<TABLE id="table9" class="txt" bgColor="#D2E1F1" height="22" cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffdfe4" border="0">
														<TR>
															<TD>&nbsp;</TD>
														</TR>
													</TABLE>
											...
											<TR>
												<TD><uc1:EditTemplate id="EditTemplate1" runat="server"></uc1:EditTemplate>
												</TD>
											</TR>
										</TABLE>
									</DIV>
