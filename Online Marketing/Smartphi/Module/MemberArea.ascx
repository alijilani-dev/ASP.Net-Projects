<%@ Control Language="vb" AutoEventWireup="false" Codebehind="MemberArea.ascx.vb" Inherits="Smartphi.MemberArea" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<TD>
			<DIV align="center">
				<TABLE id="table7" cellSpacing="1" cellPadding="0" width="90%" border="0">
					...
					<TR>
						<TD>
							<TABLE id="table10" style="BORDER-RIGHT: #ffdfe4 1px solid; BORDER-TOP: #ffdfe4 1px solid; BORDER-LEFT: #ffdfe4 1px solid; BORDER-BOTTOM: #ffdfe4 1px solid"
