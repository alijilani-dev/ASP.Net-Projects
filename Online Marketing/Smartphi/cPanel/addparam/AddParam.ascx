		...
		<TR id="trGridView" runat="server">
			<TD align="center" colSpan="2"><asp:datagrid id="dgParams" runat="server" GridLines="Horizontal" BackColor="White" BorderWidth="1px"
					...
					<Columns>
						...
						<asp:TemplateColumn Visible="True" HeaderText="ID">
							<ItemTemplate>
			...
			<TD align="center" colSpan="2">
				<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0">
					...
					<TR>
						...
						<TD style="HEIGHT: 13px"><asp:textbox id="txtParamType" Visible="False" runat="server"></asp:textbox><asp:dropdownlist id="ddlParamType" runat="server" DataTextField="ParamType" DataValueField="ParamTypeID">
					...
					<TR>
						...
						<TD><asp:textbox id="txtParamValue" Visible="False" runat="server"></asp:textbox><asp:requiredfieldvalidator id="rfvDefaultValue" Visible="False" runat="server" ControlToValidate="txtParamValue"
								ErrorMessage="Please provide a Default Value" Enabled="False">*</asp:requiredfieldvalidator></TD>
					</TR>
					<TR>
