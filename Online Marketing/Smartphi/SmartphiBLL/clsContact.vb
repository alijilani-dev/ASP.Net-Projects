...
#Region "Private Variables"
    ...
    Private pi_str_ContactAddress As String
...
#Region "Properties"
    ...
    Public Property ContactAddress() As String
        Get
            Return pi_str_ContactAddress
        End Get
        Set(ByVal Value As String)
            pi_str_ContactAddress = Value
        End Set
    End Property
...
#Region "Insert"
    ...
    Public Function Update(ByVal prm_Mode As Integer) As Boolean
        ...
        idbparameter(3) = GlobalData.DataHelper.GetParameter("@Contact_Address", DbType.String, 255, ParameterDirection.Input)
        idbparameter(3).Value = Me.ContactAddress
        ...
        Try
            If prm_Mode = 1 Then 'insert
                pi_helper.ExecuteNonQuery(objTransaction, CommandType.StoredProcedure, "USP_INSERT_CONTACT", idbparameter)
            ElseIf prm_Mode = 2 Then 'update
                pi_helper.ExecuteNonQuery(objTransaction, CommandType.StoredProcedure, "USP_UPDATE_CONTACT", idbparameter)
            End If
