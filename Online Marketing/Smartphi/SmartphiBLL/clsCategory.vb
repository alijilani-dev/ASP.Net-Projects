...
#Region "GET Template"
    ...
    Public Function GetCategory(Optional ByVal category_id As Integer = 0) As DataTable
        ...
        Try
            ...
            ds = pi_helper.ExecuteDataset(GlobalData.ConnectionString, CommandType.StoredProcedure, "USP_SELECT_CATEGORY", idbparameter)
