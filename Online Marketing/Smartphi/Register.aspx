<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Register.aspx.vb" Inherits="Smartphi.Register"%>
			...
			<TABLE id="Template" cellSpacing="0" cellPadding="0" width="701" align="center" bgColor="#ffffff"
				...
				<TR id="Middle" runat="server">
					<TD style="BORDER-RIGHT: #dedede 1px solid; BORDER-LEFT: #dedede 1px solid">
						<div align="center"><BR>
							<BR>
							<TABLE class="txt" id="table6" style="BORDER-RIGHT: #aaccff 1px solid; BORDER-TOP: #aaccff 1px solid; BORDER-LEFT: #aaccff 1px solid; BORDER-BOTTOM: #aaccff 1px solid"
												...
												<TR>
													<TD width="593" valign="top" colspan="2">
														<asp:textbox id="txtTerms" class="txtbox" runat="server" Width="422px" Height="100px" TextMode="MultiLine"
															ReadOnly="True">SmartPhi End User Licence Agreement 
The terms and conditions in this agreement will govern your access to SmartPhi Services. SmartPhi grants to the User a non-exclusive right during the term of this Agreement to use the Services pursuant to the terms and conditions set out herein. At all times, the ownership rights remain with SmartPhi or its third party suppliers, as the case may be. 
SmartPhi Services
SmartPhi provides e-mail marketing tool, storage and support to the Users. Users can create and send email campaigns using the application to distribute content provided by the User to a list of email addresses also supplied by the User. The User acknowledges that SmartPhi does not create or publish any content for the User. The User further recognizes that SmartPhi does not rent or sell email lists. SmartPhi retains its right to cancel and delete an account if the User violates any of the policies explicitly published in 'Terms & Conditions', 'Privacy Policy', 'Prohibited Content' and 'Anti-spam' policy. SmartPhi disclaims all copyright and other rights in such content and all responsibility for them.
SmartPhi specifically disclaims liability for direct, consequential or incidental damages arising from such campaigns. By posting an email campaign using SmartPhi, the User warrants that the content is true, and that User will indemnify SmartPhi against any and all, direct, indirect or consequential claims and alleged claims that may arise from User's use of the services. 
Eligibility
Our E-mail Marketing Services are available to individuals who are eighteen (18) years of age or older as well as corporations and other organizations capable of legally binding contracts under applicable law. If you do not meet the criteria, please do not attempt to use the Services. The User acknowledges to provide true, accurate, current information about himself as requested by the sign up, registration or billing process. SmartPhi may refuse to offer the Services to any person and may change the criteria for eligibility, at any time, and is subject to its sole discretion. 
SmartPhi holds the right to terminate your account without refund and your rights to use the Services if there are reasonable grounds to believe that any data you provide is or becomes untrue, inaccurate, not current or is incomplete.

Description of Services
You understand and agree that the service is provided "AS-IS" and that SmartPhi LLC. assumes no responsibility for the timeliness, deletion, mis-delivery or failure to store any user communications or personalization settings.

SmartPhi provides its member's access to its various resources as agreed in the terms and conditions while sign-up. Unless explicitly stated otherwise, any new features that augment or enhance the current service, including the release of new SmartPhi Features shall be subject to the 'Terms and Conditions'. 
You are responsible for obtaining access to SmartPhi account by paying Monthly fees as specified or agreed upon and that access to the internet may involve third party (Internet Service Provider). In addition, you must provide and are responsible for all equipment necessary to access the service.
Personal and Non-commercial Use Limitation 
Unless otherwise specified, the Services are for your personal and non-commercial use. You may not modify, copy, distribute, transmit, display, perform, reproduce, publish, license, create derivative works from, transfer, or sell any information, software, products or services obtained from the Services.

Modification to the Services
SmartPhi reserves the right to modify or discontinue the Services, temporarily or permanently, with or without notice to the User and is not obligated to support or update the Services. 

Change in Terms and Conditions
SmartPhi may, at any time and at its sole discretion, modify the terms and conditions of this Agreement. User agrees to assume responsibility for periodically reviewing this Agreement. By continuing to use the service, following the posting date of changes by SmartPhi, it will be assumed that the User agrees to be bound by the amended Agreement. 

Member Account, Password, and Security 
SmartPhi requires you to open an account by providing us with current, complete and accurate information as prompted by the applicable registration form. You also will choose a username and password. You are entirely responsible for maintaining the confidentiality of your password and account. Furthermore, you are entirely responsible for any and all activities that occur during the use of services. You agree to notify SmartPhi to immediately report of any unauthorized use of your account or breach of security. SmartPhi will not be liable for any loss that you may incur as a result of someone else using your password or account, either with or without your knowledge. However, you could be held liable for losses incurred by SmartPhi or its Partner due to misuse of your account or password. You may not use anyone else's account at any time, without the permission of the account holder.
Use and Storage
SmartPhi may store User information, content, contact lists, emails, campaign activity statistics, reports and other information in its databases for the User. However, SmartPhi has no responsibility or liability for the deletion or failure to store any messages, content or other information maintained or transmitted through the Services. At any time, SmartPhi may decide that User information can no longer be stored by it or deem User information to be inappropriate and remove it from its databases with or without notice to the User. 

Charges for Services
SmartPhi services are charged according to the monthly price plan selected and agreed upon by the User. Presently, there are four types of pricing plans(monthly), "Plan A", "Plan B", "Plan C" and "Plan D". Pricing may vary at any time based on changes to fee schedules. All prices are in US dollars. The User is responsible for reviewing the pricing from time to time and keeping himself aware of the fees charged by SmartPhi.
...
The User acknowledges and agrees that the SmartPhi logo, trade name and services are the property of SmartPhi LLC. SmartPhi affiliate logo's and trade names are property of the respective affiliates. User also recognizes that SmartPhi owns and/or has all requisite rights in and to any software necessary to provide the Services under this Agreement. 
The User understands and acknowledges that, except as strictly necessary for personal viewing and use of the Services, the User is not granted any right or license to use, link to, reproduce, reverse engineer, modify, duplicate, distribute, display or perform any such copyrighted materials used or displayed on this Website or to permit others to do the same, and that all such uses are prohibited without the prior written consent of SmartPhi.
Disclaimer of Warranties
THE SERVICES AND THE INFORMATION ARE PROVIDED BY SmartPhi ON AN "AS IS" BASIS, AND SmartPhi EXPRESSLY DISCLAIMS ANY AND ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING WITHOUT LIMITATION WARRANTIES OF MERCHANTABILITY, AVAILABILITY, ACCURACY, OMISSIONS, COMPLETENESS, TIMELINESS OR DELAYS WITH RESPECT TO THE SERVICE, INFORMATION OR PRODUCTS. 
IN NO CIRCUMSTANCES, WILL SmartPhi BE LIABLE FOR ANY DAMAGES OF ANY KIND WHATSOEVER WITH RESPECT TO THE SERVICES, INFORMATION OR PRODUCTS PROVIDED ON THE WEBSITE. IN PARTICULAR, SmartPhi WILL NOT BE LIABLE FOR SPECIAL, INDIRECT, CONSEQUENTIAL OR INCIDENTAL DAMAGES, OR DAMAGES FOR LOST PROFITS, LOSS OF REVENUE, OR LOSS OF USE, ARISING OUT OF OR RELATED TO THE USE OF SmartPhi'S SERVICES, ITS WEBSITE OR THE INFORMATION OR DATA CONTAINED THEREIN, WHETHER SUCH DAMAGES ARISE IN CONTRACT, NEGLIGENCE, TORT, UNDER STATUTE, IN EQUITY, AT LAW OR OTHERWISE. 
SmartPhi, ITS AFFILIATES ENTIRE LIABILITY UNDER THIS AGREEMENT, IF ANY, FOR ANY CLAIM(S) FOR DAMAGES RELATING TO THE SERVICE, INDIVIDUALLY OR JOINTLY, WHETHER BASED IN CONTRACT OR TORT, WILL BE LIMITED TO THE AGGREGATE AMOUNT OF CHARGES FOR SERVICES PAID BY THE USER TO SmartPhi WITH RESPECT TO ANY SERVICES DURING THE TWELVE MONTH PERIOD PRECEDING THE EVENT GIVING RISE TO ANY SUCH CLAIM(S). 

Termination
This Agreement may be terminated by SmartPhi at any time; and also by the User upon prior written or email notice to SmartPhi. The termination of the Agreement by either party will not affect the User obligation to pay the charges incurred for services consumed, and of SmartPhi's responsibility to return the Users funds for Services not consumed in the event that the User has prepaid for Services for a period greater than one month. 

Acceptance of Terms
The services that SmartPhi provides to you are subject to the Terms and Conditions. SmartPhi reserves the right to update the 'Terms and Conditions' at any time without notice to you. 
</asp:textbox></TD>
												</TR>
												<TR>
													<TD width="593" height="5" colspan="2"></TD>
