...
#Region "Insert / Update Methods"
    ...
    Public Function Update(ByVal prm_Mode As Integer) As Boolean
        ...
        'idbparameter(13) = GlobalData.DataHelper.GetParameter("@Password", DbType.String, 50, ParameterDirection.Input)
        'idbparameter(13).Value = Me.Password
        If prm_Mode = 1 Then '
...
#Region "Get Members function"
    ...
    Public Function GetMemberMasterCode(ByVal Member_ID As Integer) As Integer
        Dim idbparameter(1) As IDataParameter
        Dim ds As New DataSet
        ...
        Try
            ...
            ds = pi_helper.ExecuteDataset(GlobalData.ConnectionString, CommandType.StoredProcedure, "USP_GET_MEMBER_MASTERCODE", idbparameter)
