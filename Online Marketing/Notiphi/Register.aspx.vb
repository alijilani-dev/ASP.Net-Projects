...
#End Region
    ...
    Private Sub SendThanksMail(ByVal prmGUID As String)
        ...
        objMessage.HTMLBody = CStr("" & strHTML) ''''[$track$])
        ...
        objMessage.Configuration.Fields.Item _
        ("http://schemas.microsoft.com/cdo/configuration/smtpserver") = "10.4.29.4" '"213.42.18.90" '
    ...
    Private Function GetThanksMessage(ByVal prmGUID As String) As String
        ...
        ''strActivationCode = StrBasePath & "/activate.aspx?Activate=" & prmGUID & "&code=" & Session.SessionID & "&identifier=" & Mid(prmGUID, 1, 2) & Mid(prmGUID, 6, 2) & Mid(prmGUID, Len(prmGUID) - 2, 2)
        ''strBodyText.Append("<html><head><title>Thank you for Registering</title></head><body><p> Dear ")
        ''strBodyText.Append(txtMemberName.Text)
        ''strBodyText.Append(",</p><p>Thank you for registering with us on Notiphi.com. </p><p>Kindly click the following link to activate your account on Notiphi.")
        ''strBodyText.Append("<p><a href='")
        ''strBodyText.Append(strActivationCode & "' >")
        ''strBodyText.Append(strActivationCode & " </a></p>")
        ''strBodyText.Append("<p>Sincerely,</p></p>Customer Services<br>Notiphi.com</p><p>&nbsp;</p><p>&nbsp;</p>")
        ''strBodyText.Append("</body></html>")
        ''Return strBodyText.ToString
