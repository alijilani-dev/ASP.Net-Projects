...
#End Region
    ...
    Private Sub LoadGroupNames()
        ...
        lstGroup.DataSource = pi_obj_Groups.GetGroups(Session(Session_str_MemberID), True)
        lstGroup.DataBind()
    ...
    Private Sub LoadGroupNameForEdit(ByVal prmGoupID As Integer)
        ...
        Try
            dtGroup = pi_obj_Groups.GetGroups(Session(Session_str_MemberID), True, prmGoupID)
        Catch ex As Exception
            System.Diagnostics.Debug.WriteLine(ex.Message)
        End Try
