<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CreditPurchase.aspx.vb" Inherits="Notiphi.CreditPurchase" %>
<%@ Register TagPrefix="uc1" TagName="Purchase" Src="Purchase.ascx" %>
													...
													<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0" runat="server">
														<TR>
															<TD id="tdContent" colSpan="2" runat="server">
																<uc1:Purchase id="Purchase1" runat="server"></uc1:Purchase></TD>
														</TR>
														<TR>
															<TD colSpan="2"></TD>
														</TR>
