<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ChangePassword.ascx.vb" Inherits="Notiphi.ChangePassword" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<div align="center">
